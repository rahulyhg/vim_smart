...
class UnifiedOrder_pub_two extends Wxpay_client_pub

{
    public $car_sub_mch_id;
...

    {
        ...
        $this->car_sub_mch_id = $this->getSub_mch_id();
...

    {
...

        {
            ...
            $this->parameters["sub_mch_id"] = $this->car_sub_mch_id;//子商户号  目前为大头仔
