...
function appendItemHtml(has_more, list){
	...
	for(var i=0;i<list.length;i++){
		...
		var content="<li class='item-list-container'>"+
			...
			"<p class='item-img'><span><a class=''href='"+detailurl+"&village_id="+item.village_id+"&log_id="+item.log_id+"'><img src='"+staticpath+"images/xqt.png' width='50'height='23'/></a></span>"+"</p>"
			"</div>"+
