    ...
    return {
        ...
        initCharts: function() {
            ...
            if ($('#todays').size() != 0) {
                ...
                var plot_statistics = $.plot($("#todays"), [{
                        data: visitors,
                        lines: {
                            fill: 0.6,
                            lineWidth: 0
                ...
                $("#todays").bind("plothover", function(event, pos, item) {
            ...
            if ($('#months').size() != 0) {
                ...
                var plot_statistics = $.plot($("#months"), [{
                        data: visitors,
                        lines: {
                            fill: 0.6,
                            lineWidth: 0
                ...
                var previousPoint = null;
                $("#months").bind("plothover", function(event, pos, item) {
                    $("#x").text(pos.x.toFixed(2));
                    $("#y").text(pos.y.toFixed(2));
                    if (item) {
                        if (previousPoint != item.dataIndex) {
            ...
            if ($('#month1').size() != 0) {
                ...
                var plot_statistics = $.plot($("#month1"), [{
                        data: visitors,
                        lines: {
                            fill: 0.6,
                            lineWidth: 0
                ...
                var previousPoint = null;
                $("#month1").bind("plothover", function(event, pos, item) {
                    $("#x").text(pos.x.toFixed(2));
                    $("#y").text(pos.y.toFixed(2));
                    if (item) {
                        if (previousPoint != item.dataIndex) {
            ...
            if ($('#month').size() != 0) {
                ...
                var plot_statistics = $.plot($("#month"), [{
                        data: visitors,
                        lines: {
                            fill: 0.6,
                            lineWidth: 0
