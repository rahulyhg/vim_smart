...
.zi {width:40px; height:40px; border:1px #eaeaea solid; text-align:center; color:#a3a3a3; font-size:15px; line-height:40px; float:left; margin:5px; background-color:#FFFFFF;}
                        ...
                        <div class="col-md-6 ">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <form role="form" action="/?m=Home&c=Servicerecord&a=new_record" method="post" formborder="0" >
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <div id="car_no_pre_div" class="input-group-btn">
                                                        ...
                                                        <div id="car_A" class="dropdown" style="display: none;width: 400%;">
                                                            
                                                            <?php for($i=65;$i<91;$i++){ ?>
                                                            <div class="zi" style="float: left;width: 30px;"><?php echo strtoupper(chr($i)); ?></div>
                                                            <?php } ?>
                                                    ...
                                                    <span class="input-group-btn">
                                                        <button class="btn blue" type="submit" ><img src="<?php echo (C("STATICS_URL")); ?>car_bind/images/fdj.png" style="width:25px; height:25px;"></button>
                                                    </span>
                                                    <!-- /btn-group -->
                                                </div>
                                                <!-- /input-group -->
							...
							<div class="portlet-title">
								<div style="height:44px;background-color: #f6f6f6;border: 1px #ededed solid; border-radius:4px 4px 0 0; text-align:center; line-height:44px; color:#389ffe; font-family:'微软雅黑'; font-size:16px; margin-top:10px;">查询到以下结果，点击自己的车牌再搜索</div>
                                                                <?php if(is_array($like_datas)): foreach($like_datas as $key=>$v): ?><div style="height:45px;background-color: #f6f6f6;border: 1px #ededed solid; border-top:none; border-radius:0 0 4px 4px ; text-align:center; line-height:45px; color:#888888; font-family:'微软雅黑'; font-size:16px;" onclick="get_this_val(this)"><?php echo ($v["attributes"]["carNo"]); ?></div><?php endforeach; endif; ?>>
							</div>
                        </div>
                    </div>
                            ...
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo (C("STATICS_URL")); ?>car_bind/images/avatar3.jpg" alt="...">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?php echo (C("STATICS_URL")); ?>car_bind/images/avatar1.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo (C("STATICS_URL")); ?>car_bind/images/avatar4.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?php echo (C("STATICS_URL")); ?>car_bind/images/avatar2.jpg" alt="...">
                                        <div class="media-body">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo (C("STATICS_URL")); ?>car_bind/images/avatar6.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo (C("STATICS_URL")); ?>car_bind/images/avatar7.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?php echo (C("STATICS_URL")); ?>car_bind/images/avatar8.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo (C("STATICS_URL")); ?>car_bind/images/avatar9.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?php echo (C("STATICS_URL")); ?>car_bind/images/avatar10.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo (C("STATICS_URL")); ?>car_bind/images/avatar11.jpg" alt="...">
                                        <div class="media-body">
                            ...
                            <div class="page-quick-sidebar-item">
                                <div class="page-quick-sidebar-chat-user">
                                    ...
                                    <div class="page-quick-sidebar-chat-user-messages">
                                        <div class="post out">
                                            <img class="avatar" alt="" src="<?php echo (C("STATICS_URL")); ?>car_bind/images/avatar3.jpg" />
                                            <div class="message">
                                        ...
                                        <div class="post in">
                                            <img class="avatar" alt="" src="<?php echo (C("STATICS_URL")); ?>car_bind/images/avatar2.jpg" />
                                            <div class="message">
                                                <span class="arrow"></span>
