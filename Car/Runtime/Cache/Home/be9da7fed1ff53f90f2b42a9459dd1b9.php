                        ...
                        <div class="col-md-6 ">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <form role="form" action="/index.php?m=Home&c=Car&a=binding_car" method="post" formborder="0" >
                                        <div class="row">
                                            <div class="col-md-12">
							...
							<div class="portlet-title">
								<div style="height:44px;background-color: #f6f6f6;border: 1px #ededed solid; border-radius:4px 4px 0 0; text-align:center; line-height:44px; color:#389ffe; font-family:'微软雅黑'; font-size:16px; margin-top:10px;">请选择地区和输入车牌后五位进行绑定</div>
