                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo U('add');?>">
                                                        <button id="sample_editable_1_new" class="btn sbold green"> 添加权限
                                                            <i class="fa fa-plus"></i>
                                                        </button>
                                                    </a>
                                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <?php if(is_array($auth_infos)): foreach($auth_infos as $key=>$v): ?><tr class="odd gradeX">
                                                    <td>
                                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                    ...
                                                    <td class="center">
                                                        <a href="#"><?php echo ($v["auth_pid"]); ?></a>
                                                    </td>
                                                    <td class="center"><?php echo ($v["auth_c"]); ?></td>
                                                    <td class="center"><?php echo ($v["auth_a"]); ?></td>
                                                    <td class="center"><?php echo ($v["auth_path"]); ?></td>
                                                    <td class="center"><?php echo ($v["auth_level"]); ?></td>
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                <li>
                                                                    <a href="/index.php/Admin/Auth/update/auth_id/<?php echo ($v["auth_id"]); ?>">
                                                                        <i class="icon-docs"></i> 更新 </a>
                                                                </li>
                                                                <li onclick="destory_auth(this)" id="<?php echo ($v["auth_id"]); ?>">
                                                                    <a href="javascript:;">
...
<![endif]-->
        ...
        <script type="text/javascript">
            //获取将要删除的记录对应的id
            function destory_auth(obj){
                layer.msg('你确定要删除么？本操作不可恢复！', {
                    time: 0 //不自动关闭
                    ,btn: ['确定', '取消']
                    ,yes: function(index){
                        layer.close(index);
                        var auth_id=$(obj).attr('id');
                        //通过ajax异步删除
                        $.ajax({
