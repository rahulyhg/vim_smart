            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- <div class="m-heading-1 border-green m-bordered">
                        <h3>使用提示</h3>
                        <p>本操作仅供开发人员测试使用或者后台管理人员临时补充数据之用，其它情况请慎用，此权限请勿随便给予</p>
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <div class="btn-group btn-group-devided" data-toggle="buttons">
                                            <label class="btn btn-transparent dark btn-outline btn-circle btn-sm active" onclick="window.location.href='/index.php/Admin/Servicerecord/recycle'">
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                <li>
                                                                    <a href="/index.php/Admin/Servicerecord/update/recod_id/<?php echo ($v["serv_id"]); ?>">
                                                                        <i class="icon-docs"></i> 更新 </a>
                                                                </li>
                                                                <li onclick="delete_serv_record(this)" id="<?php echo ($v["serv_id"]); ?>">
                                                                    <a href="javascript:;">
...
<![endif]-->
        ...
        <script type="text/javascript">
            //获取将要删除的记录对应的id
            function delete_serv_record(obj){
                layer.msg('你确定要删除么？', {
                    time: 0 //不自动关闭
                    ,btn: ['确定', '取消']
                    ,yes: function(index){
