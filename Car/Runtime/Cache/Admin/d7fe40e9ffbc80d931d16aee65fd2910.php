...
<html lang="en">
    ...
    <!--***************************************************************停车系统开始************************************************-->
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="/index.php/Admin/user/showlist" class="nav-link ">
                                        <span class="title">车辆消费记录表</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <form action="#" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input" id="car_no">
                                                <label class="col-md-3 control-label" for="form_control_1">车牌号
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="car_nos[]" value="<?php echo ($user_info['car_nos'][0]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请参考系统已有格式录入。临时添加的输入项点击可以删除！ ”</span>
                                                </div>
                                            </div>   
                                            
                                            <?php if(is_array($user_info["car_nos"])): foreach($user_info["car_nos"] as $k=>$v): if($k > '0'): ?><div class="form-group form-md-line-input">
                                                        <label class="col-md-3 control-label" for="form_control_1">车牌号
                                                            <span class="required">*</span>
                                                        </label>
                                                        <span onclick='remove_car_no_form(this)'>[-]</span>
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" placeholder="" name="car_nos[]" value="<?php echo ($v); ?>">
                                                            <div class="form-control-focus"> </div>
                                                            <span class="help-block">请参考系统已有格式录入。临时添加的输入项点击可以删除！ ”</span>
                                                        </div>
                                                    </div><?php endif; endforeach; endif; ?>
                                            <button type="button" class="btn green-haze dropdown-toggle" data-toggle="dropdown" aria-expanded="false" onclick="add_more_car(this)"> 添加更多车辆
                                                            <i class="fa fa-angle-down"></i>
                                            </button>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="user_name" value="<?php echo ($user_info["user_name"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">密码留空为不修改，保留原来的密码</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">确认密码
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="password" class="form-control" placeholder="" name="user_pwd2">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请再次输入密码，不修改留空</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="user_phone" value="<?php echo ($user_info["user_phone"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入11位常用手机号码</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">用户微信
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="user_wxid" value="<?php echo ($user_info["user_wxid"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入微信号</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">微信昵称
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="user_wxnik" value="<?php echo ($user_info["user_wxnik"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入微信昵称</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-radios">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="md-radio-inline">
                                                        <?php if($user_info['user_sex'] == '0'): ?><div class="md-radio">
                                                                <input type="radio" checked="checked" id="checkbox1_8" name="user_sex" value="0" class="md-radiobtn">
                                                                <label for="checkbox1_8">
                                                                    <span></span>
                                                                    <span class="check"></span>
                                                                    <span class="box"></span> 保密 </label>
                                                            </div>
                                                        <?php else: ?>
                                                            <div class="md-radio">
                                                                <input type="radio" id="checkbox1_8" name="user_sex" value="0" class="md-radiobtn">
                                                                <label for="checkbox1_8">
                                                                    <span></span>
                                                                    <span class="check"></span>
                                                                    <span class="box"></span> 保密 </label>
                                                            </div><?php endif; ?>
                                                        <?php if($user_info['user_sex'] == '1'): ?><div class="md-radio">
                                                                <input type="radio" checked="checked" id="checkbox1_9" name="user_sex" value="1" class="md-radiobtn">
                                                        ...
                                                        <?php else: ?>    
                                                            <div class="md-radio">
                                                                <input type="radio" id="checkbox1_9" name="user_sex" value="1" class="md-radiobtn">
                                                                <label for="checkbox1_9">
                                                                    <span></span>
                                                                    <span class="check"></span>
                                                                    <span class="box"></span> 男 </label>
                                                            </div><?php endif; ?>
                                                        <?php if($user_info['user_sex'] == '2'): ?><div class="md-radio">
                                                                <input type="radio" checked="checked" id="checkbox1_10" name="user_sex" value="2 " class="md-radiobtn">
                                                        ...
                                                        <?php else: ?>    
                                                            <div class="md-radio">
                                                                <input type="radio" id="checkbox1_10" name="user_sex" value="2 " class="md-radiobtn">
                                                                <label for="checkbox1_10">
                                                                    <span></span>
                                                                    <span class="check"></span>
                                                                    <span class="box"></span> 女 </label>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">用户住址
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="user_addr" value="<?php echo ($user_info["user_addr"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入用户的大致居住地址</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">用户等级
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <select class="form-control" name="user_level" autocomplete="off">
                                                        <option value="">--请选择--</option>
                                                        <?php if($user_info['user_level'] == '0'): ?><option value="0" selected="selected">普通</option>
                                                        <?php else: ?>
                                                            <option value="0">普通</option><?php endif; ?>
                                                        <?php if($user_info['user_level'] == '1'): ?><option value="1" selected="selected">会员</option>
                                                        <?php else: ?>
                                                            <option value="1">会员</option><?php endif; ?>
                                                        <?php if($user_info['user_level'] == '2'): ?><option value="2" selected="selected">贵宾</option>
                                                        <?php else: ?>
                                                            <option value="2">贵宾</option><?php endif; ?>
                                                    </select>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">用户头像
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="file" name="user_logo" id="image_file" onchange="fileSelected();" />
                                                    <div class="form-control-focus"> </div>
                                                    <?php if(!empty($user_info["user_logo"])): ?><img id="preview" src="<?php echo (C("WEB_DOMAIN")); ?>/<?php echo ($user_info["user_logo"]); ?>" style="width:80px;" />
                                                    <?php else: ?>
                                                    <img id="preview" style="width:80px;" /><?php endif; ?>
                                                </div>
                                                <input type="hidden" name="old_user_logo" value="<?php echo ($user_info["user_logo"]); ?>">
                                            </div>
...
<![endif]-->
        ...
        <!--引入文件上传插件js开始-->
        <script src="<?php echo (C("ADMIN_JS_URL")); ?>uploadPlugjs/script.js" type="text/javascript"></script>
        <!--引入文件上传插件js结束-->
        
        
        <!--
        <div class="form-group form-md-line-input" id="car_no">
            <label class="col-md-3 control-label" for="form_control_1">用户车辆
                <span class="required">*</span>
            </label>
            <div class="col-md-9">
        ...
        <script type='text/javascript'>
            //点击产生车牌号录入表单
            var i=1;
            function add_more_car(obj){
                var input_form=$('#car_no').clone();//录入表单模板
                //----模板制作开始----
                var laber=input_form.find('label');
                laber.html('更多车牌号');//修改内容
                input_form.removeAttr('id');//移除id属性
                input_form.find('input').val("");//清空输入框内容
                var notice="<span onclick='remove_car_no_form(this)'>[-]</span>";//设置一个删除临时增加项按钮
                laber.before(notice);
                //----模板制作结束----
                $('#car_no').after(input_form);
                
            }
            
            //点击删除临时添加的车牌输入框
            function remove_car_no_form(obj){
                $(obj).parent().remove();
            }
