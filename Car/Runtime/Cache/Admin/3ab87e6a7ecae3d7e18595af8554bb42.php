                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="portlet blue-hoki box">
                                                            ...
                                                            <div class="portlet-body">
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 车主姓名: </div>
                                                                    <div class="col-md-7 value"> <?php echo ($car_info["user_wxnik"]); ?> </div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 车主地址: </div>
                                                                    <div class="col-md-7 value"> <?php echo ($car_info["user_addr"]); ?> </div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 车主手机号码: </div>
                                                                    <div class="col-md-7 value"> <?php echo ($car_info["user_phone"]); ?> </div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 车主等级: </div>
                                                                    <div class="col-md-7 value"> <?php echo ($car_info["user_level"]); ?> </div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 车主积分: </div>
                                                                    <div class="col-md-7 value"> <?php echo ($car_info["score_count"]); ?> </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
