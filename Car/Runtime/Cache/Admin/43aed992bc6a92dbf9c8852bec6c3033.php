                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>用户资料详情页 
                                <small>这里你可以查看所有关于当前用户的信息</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">用户资料详情页</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase" id="headname"> 用户资料
                                        </span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    <div class="tabbable-line">
                                        <ul class="nav nav-tabs nav-tabs-lg">
                                            <li class="active">
                                                <a href="#tab_1" data-toggle="tab"> 用户资料 </a>
                                            </li>
                                            <li>
                                                <a href="#tab_2" data-toggle="tab"> 订单记录
                                                    <!--<span class="badge badge-success">4</span>-->
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#tab_3" data-toggle="tab"> 消费记录 </a>
                                            </li>
                                            <li>
                                                <a href="#tab_4" data-toggle="tab"> 发票记录 </a>
                                            </li>
                                            <!--<li>-->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="portlet yellow-crusta box">
                                                            ...
                                                            <div class="portlet-body">
                                                                <img src="<?php echo ($user_info["user_headerimg"]); ?>" style="width: 100px;">
                                                                ...
                                                                <div class="row static-info">
                                                                    ...
                                                                    <div class="col-md-7 value"> <?php echo (date("Y年m月d日 H点i分s秒",$user_info["add_time"])); ?> </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="portlet blue-hoki box">
                                                            ...
                                                            <div class="portlet-body">
                                                                <?php if(is_array($car_nos)): foreach($car_nos as $key=>$v): ?><div class="row static-info">
                                                                        <div class="col-md-5 name"> 车牌号: </div>
                                                                        <div class="col-md-7 value"> <?php echo ($v["car_no"]); ?> <a href="javascript:;" style="float: right;">详情</a></div>
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="portlet blue-hoki box">
                                                            ...
                                                            <div class="portlet-body">
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 消费总金额: </div>
                                                                    <div class="col-md-7 value"> <?php echo ($sum["sum2"]); ?>元</div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 已领取金额: </div>
                                                                    <div class="col-md-7 value"> <?php echo ($sum["sum1"]); ?>元</div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 可领取金额: </div>
                                                                    <div class="col-md-7 value"> <?php echo ($sum["sum3"]); ?>元</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
												<div class="row2"><input type="button" onclick="window.location.href='http://www.hdhsmart.com/Car/index.php?s=/Admin/Servicerecord/showlist.html'" class="btn green-sharp btn-outline  btn-block sbold uppercase" value="点击返回"></div>
                                                <!--<div class="row">-->
                                                    <!--<div class="col-md-6 col-sm-12">-->
                                                ...
                                                <div class="table-container">
                                                    <div class="table-actions-wrapper">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
                                                            ...
                                                            <tbody>
                                                            <?php if(is_array($money_info)): foreach($money_info as $key=>$v): ?><tr class="odd gradeX">
                                                                    <td>
                                                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                                            <input type="checkbox" class="checkboxes" value="1" />
                                                                            <span></span>
                                            ...
                                            <div class="tab-pane" id="tab_4">
                                                <div class="table-container">
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_3">
                                                        ...
                                                        <tbody>
                                                        <?php if(is_array($all_bill)): foreach($all_bill as $key=>$vo): ?><tr class="odd gradeX">
                                                                <td>
                                                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                                        <input type="checkbox" class="checkboxes" value="1" />
                                                                        <span></span>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:;"> <?php echo ($vo["bill_id"]); ?> </a>
                                                                </td>
                                                                <td>
                                                                    <?php if(is_array($vo['car_no'])): foreach($vo['car_no'] as $key=>$v): echo ($v); ?><br/><?php endforeach; endif; ?>
                                                                </td>
                                                                <td> <?php echo ($vo["sum"]); ?> </td>
                                                                <td>
                                                                    <?php echo ($vo["bill_status"]); ?>
                                                                </td>
...
<script>
    $(function () {
        $('.tabbable-line ul li').on('click',function () {
           var el=$(this).text();
            $('#headname').text(el);
        })
    })
