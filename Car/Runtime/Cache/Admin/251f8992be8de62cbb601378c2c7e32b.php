                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>后台用户角色管理
                                <small>在此你可以进行觉得的添加修改和删除，同时给觉得分配不同的权限</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                    ...
                    <!-- <div class="m-heading-1 border-green m-bordered">
                        <h3>使用提示</h3>
                        <p>给予角色对应的权限后，该角色就会拥有对应的操作权限，为了系统安全考虑，请谨慎给予</p>
                        <p> 合理分配权限能提高工作的效率！
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <div class="btn-group btn-group-devided" data-toggle="buttons">
                                            <label class="btn btn-transparent dark btn-outline btn-circle btn-sm active" onclick="window.location.href='/index.php/Admin/Role/recycle'">
                                ...
                                <div class="portlet-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo U('add');?>">
                                                        <button id="sample_editable_1_new" class="btn sbold green"> 添加管角色
                                                            <i class="fa fa-plus"></i>
                                                        </button>
                                                    </a>
                                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <?php if(is_array($roles)): foreach($roles as $key=>$v): ?><tr class="odd gradeX">
                                                    <td>
                                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                    ...
                                                    <td class="center"><?php echo ($v["role_auth_ids"]); ?></td>
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                <li>
                                                                    <a href="/index.php/Admin/Role/update/role_id/<?php echo ($v["role_id"]); ?>">
                                                                        <i class="icon-docs"></i> 更新 </a>
                                                                </li>
                                                                <li onclick="destory_role(this)" id="<?php echo ($v["role_id"]); ?>">
                                                                    <a href="javascript:;">
