                                    ...
                                    <form action="#" method="post" class="form-horizontal" id="form_sample_1">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">上级地区
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <select class="form-control" name="zone_pid" autocomplete="off">
                                                        <option value="0">--请选择--</option>
                                                        <?php if(is_array($zone_infos)): foreach($zone_infos as $key=>$v): if($v['zone_id'] == $zone_info['zone_pid']): ?><option selected="selected" value="<?php echo ($v["zone_id"]); ?>"><?php echo str_repeat("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;",$v['zone_level']); ?>┢━<?php echo ($v["zone_name"]); ?></option>
                                                            <?php else: ?>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">地区名称
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="zone_name" value="<?php echo ($zone_info["zone_name"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入将要添加的地区名称</span>
                                                </div>
                                            </div>
