            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- <div class="m-heading-1 border-green m-bordered">
                        <h3>使用提示</h3>
                        <p> 本操作是给予系统程序已有方法进行操作的，所以此方法仅限开发级别人员使用！
                                    ...
                                    <form action="#" method="post" class="form-horizontal" id="form_sample_1">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">权限名称
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="auth_name" value="<?php echo ($auth_infos["auth_name"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入权限名称</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">父级id
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <select class="form-control" name="auth_pid">
                                                        <option value="">--请选择--</option>
                                                        <?php if(is_array($pid)): foreach($pid as $key=>$v): if($v['auth_id'] == $auth_infos['auth_pid']): ?><option selected="selected" value="<?php echo ($v["auth_id"]); ?>"><?php echo ($v["auth_name"]); ?></option>
                                                            <?php else: ?>
                                                                <option value="<?php echo ($v["auth_id"]); ?>"><?php echo ($v["auth_name"]); ?></option><?php endif; endforeach; endif; ?>
                                                    </select>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">控制器
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="auth_c" value="<?php echo ($auth_infos["auth_c"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入控制器</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">操作方法
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="auth_a" value="<?php echo ($auth_infos["auth_a"]); ?>">
                                                    <div class="form-control-focus"> </div>
