                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>车辆信息回收站
                                <small>出入停车场的车辆信息被删除的会记录在此，在此你可以查看车辆的一般信息会执行恢复和彻底删除等操作</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">车辆信息回收站</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo U('showlist');?>">
                                                        <button id="sample_editable_1_new" class="btn sbold green"> 返回车辆信息列表
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <?php if(is_array($car_infos)): foreach($car_infos as $key=>$v): ?><tr class="odd gradeX">
                                                    <td>
                                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                    ...
                                                    <?php if(!empty($v["upd_time"])): ?><td class="center"><?php echo (date("Y-m-d H:i:s",$v["upd_time"])); ?></td>
                                                    <?php else: ?>
                                                    <td class="center">暂无更新</td><?php endif; ?>
                                                    <td class="center">
                                                        <a href="">点击查看</a>
                                                    </td> 
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                <li onclick="recover_car_info(this)" id="<?php echo ($v["car_id"]); ?>">
                                                                    <a href="javascript:;">
                                                                        <i class="icon-docs"></i> 恢复 </a>
                                                                </li>
                                                                <li onclick="destroy_car_info(this)" id="<?php echo ($v["car_id"]); ?>">
                                                                    <a href="javascript:;">
