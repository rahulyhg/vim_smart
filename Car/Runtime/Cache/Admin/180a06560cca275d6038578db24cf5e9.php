                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>后台用户信息资料修改更新
                                <small>在此超级管理员可以进行后台人员相应信息修改，后台人员将拥有一定的后台管理操作</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                    ...
                    <!-- <div class="m-heading-1 border-green m-bordered">
                        <h3>使用提示</h3>
                        <p> 本操作仅限超级管理员使用，因为分配的用户将有用一定的后台管理操作权限
                                    ...
                                    <form action="#" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="ad_name" value="<?php echo ($admin_info["ad_name"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入用户名，后期将使用此作为用户名登录</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">请设置此用户登录密码
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="password" class="form-control" placeholder="" name="ad_pwd" value="<?php echo ($admin_info["ad_pwd"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请给此管理员初始化一个登录密码</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">再次确认密码
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="password" class="form-control" placeholder="" name="ad_pwd2" value="<?php echo ($admin_info["ad_pwd"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请再次输入密码</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">所在车场
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="garage_id" value="<?php echo ($admin_info["garage_id"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请给该管理员进行分配车场</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">真实姓名</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="ad_tname" value="<?php echo ($admin_info["ad_tname"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入该管理员的真实姓名</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-radios">
                                                <label class="col-md-3 control-label" for="form_control_1">请选择性别</label>
                                                <div class="col-md-9">
                                                    <div class="md-radio-inline">
                                                        <?php if($admin_info['ad_sex'] == '1'): ?><div class="md-radio">
                                                                <input type="radio" checked="checked" id="checkbox1_9" name="ad_sex" value="1" class="md-radiobtn">
                                                        ...
                                                        <?php else: ?>
                                                            <div class="md-radio">
                                                                <input type="radio" id="checkbox1_9" name="ad_sex" value="1" class="md-radiobtn">
                                                                <label for="checkbox1_9">
                                                                    <span></span>
                                                                    <span class="check"></span>
                                                                    <span class="box"></span> 男 </label>
                                                            </div><?php endif; ?>
                                                        <?php if($admin_info['ad_sex'] == '2'): ?><div class="md-radio">
                                                                <input type="radio" checked="checked" id="checkbox1_10" name="ad_sex" value="2 " class="md-radiobtn">
                                                        ...
                                                        <?php else: ?>
                                                            <div class="md-radio">
                                                                <input type="radio" id="checkbox1_10" name="ad_sex" value="2 " class="md-radiobtn">
                                                                <label for="checkbox1_10">
                                                                    <span></span>
                                                                    <span class="check"></span>
                                                                    <span class="box"></span> 女 </label>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">年龄</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="ad_age" value="<?php echo ($admin_info["ad_age"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入该管理员的年龄</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">工作编号</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="ad_no" value="<?php echo ($admin_info["ad_no"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请给该管理员进行工号分配</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">身份证号</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="ad_sfz" value="<?php echo ($admin_info["ad_sfz"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入该管理员的真实身份证号码</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">身份证正面
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="file" name="ad_sfzimg1" id="image_file" onchange="fileSelected();" />
                                                    <input type="hidden" name="old_sfzimg1" value="<?php echo ($admin_info["ad_sfzimg1"]); ?>" />
                                                    <div class="form-control-focus"> </div>
                                                    <img id="preview" style="width:120px; height: 60px;" />
                                                </div>
                                                
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <?php if(!empty($admin_info['ad_sfzimg1'])): ?><img src="<?php echo (C("WEB_DOMAIN")); ?>/<?php echo ($admin_info["ad_sfzimg1"]); ?>" style="width: 200px; height: 100px;" /><?php endif; ?>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">身份证背面
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="file" name="ad_sfzimg2" id="image_file2" onchange="fileSelected();" />
                                                    <input type="hidden" name="old_sfzimg2" value="<?php echo ($admin_info["ad_sfzimg2"]); ?>" />
                                                    <div class="form-control-focus"> </div>
                                                    <img id="preview2" style="width:120px; height: 60px;" />
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <?php if(!empty($admin_info['ad_sfzimg2'])): ?><img src="<?php echo (C("WEB_DOMAIN")); ?>/<?php echo ($admin_info["ad_sfzimg2"]); ?>" style="width: 200px; height: 100px;" /><?php endif; ?>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">手机号码</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="ad_phone" value="<?php echo ($admin_info["ad_phone"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入11为有效的手机号码</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">角色分配
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <select class="form-control" name="role_id" autocomplete="off">
                                                        <option value="">--请选择--</option>
                                                        <?php if(is_array($role_infos)): foreach($role_infos as $key=>$v): if($admin_info['role_id'] == $v['role_id']): ?><option selected="selected" value="<?php echo ($v["role_id"]); ?>"><?php echo ($v["role_name"]); ?></option>
                                                            <?php else: ?>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">微信id</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="ad_wxid" value="<?php echo ($admin_info["ad_wxid"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入此管理员的微信号</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">微信昵称</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="ad_wxnk" value="<?php echo ($admin_info["ad_wxnk"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入此管理员的微信昵称</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">大致住址</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="ad_addr" value="<?php echo ($admin_info["ad_addr"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入此管理员的大致住址</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">是否现在通过审核
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <select class="form-control" name="is_check" autocomplete="off">
                                                        <option value="">--请选择--</option>
                                                        <?php if($admin_info['is_check'] == '0'): ?><option selected="selected" value="0">现在通过</option>
                                                        <?php else: ?>
                                                            <option value="0">现在通过</option><?php endif; ?>
                                                        <?php if($admin_info['is_check'] == '1'): ?><option selected="selected" value="1">暂不通过</option>
                                                        <?php else: ?>
                                                            <option value="1">暂不通过</option><?php endif; ?>
                                                    </select>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
...
<![endif]-->
        ...
        <!--引入文件上传插件js开始-->
        <script src="<?php echo (C("ADMIN_JS_URL")); ?>uploadPlugjs/script2.js" type="text/javascript"></script>
        <!--引入文件上传插件js结束-->
