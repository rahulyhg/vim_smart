                                    ...
                                    <form action="#" method="post" class="form-horizontal" id="form_sample_1">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="car_no" value="<?php echo ($serv_info["car_no"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入完整车牌号：请参考系统已有格式录入”</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">入库时间
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" id="datetimepicker" class="form-control" placeholder="" name="start_time" value="<?php echo (date('Y-m-d H:i:s',$serv_info["start_time"])); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请勿手动输入：请点击右边的下拉按钮进行选择时间”</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">出库时间
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" id="datetimepicker2" class="form-control" placeholder="" name="end_time" value="<?php echo (date('Y-m-d H:i:s',$serv_info["end_time"])); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请勿手动输入：请点击右边的下拉按钮进行选择时间”</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">所在车位
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="parking_space" value="<?php echo ($serv_info["parking_space"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入车辆所在停车场内的具体位置</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">所在车库
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="garage_id" value="<?php echo ($serv_info["garage_id"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">缴费记录
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        <input type="text" class="form-control" name="pay_record" placeholder="请输入缴费时系统产生的缴费流水号" value="<?php echo ($serv_info["pay_record"]); ?>">
                                                        <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">值岗人员
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        <input type="text" class="form-control" name="waiter" placeholder="请输入此车辆出入时当值工作人员编号，留空为当前登录用户编号" value="<?php echo ($serv_info["waiter"]); ?>">
                                                        <div class="form-control-focus"> </div>
                                                        <i class="fa fa-cc-visa font-green"></i>
                                                    </div>
                                                </div>
