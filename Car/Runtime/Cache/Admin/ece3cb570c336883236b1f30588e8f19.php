                                    ...
                                    <form action="#" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="garage_name">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入你将要添加的车场的名称</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">车场编号
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="garage_no">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请给该车场分配编号</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="park_sp_num">
                                                    <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <select class="form-control" name="zone_id">
                                                        ...
                                                        <?php if(is_array($zone_infos)): foreach($zone_infos as $key=>$v): ?><option value="<?php echo ($v["zone_id"]); ?>"><?php echo str_repeat("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;",$v['zone_level']); ?>┢━<?php echo ($v["zone_name"]); ?></option><?php endforeach; endif; ?>
                                                    </select>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="park_d_addr">
                                                    <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="park_status">
                                                    <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="park_host">
                                                    <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">车场相册2
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="file" class="form-control" placeholder="" name="park_photo[]">
                                                    <button type="button" onclick="add_more(this)">添加更多</button>
                                                </div>
                                            </div>
        ...
        <script type='text/javascript'>
           ...
           //点击添加新照片上传按钮，方便多图上传
            function add_more(obj){
                $(obj).before('<span style="cursor: pointer;" onclick="remove_self(this)">[-]</span><input type="file" class="form-control" name="park_photo[]">');
            }
