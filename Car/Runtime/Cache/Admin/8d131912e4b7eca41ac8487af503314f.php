                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <div class="btn-group btn-group-devided" data-toggle="buttons">
                                            <label class="btn btn-transparent dark btn-outline btn-circle btn-sm active" onclick="window.location.href='/index.php/Admin/Car/recycle'">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <?php if(is_array($car_infos)): foreach($car_infos as $key=>$v): ?><tr class="odd gradeX">
                                                    ...
                                                    <td class="center">
                                                        <a href="/index.php/Admin/Car/detail/car_id/<?php echo ($v["car_id"]); ?>">点击查看</a>
                                                    </td> 
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                <li>
                                                                    <a href="/index.php/Admin/Car/update/car_id/<?php echo ($v["car_id"]); ?>">
                                                                        <i class="icon-docs"></i> 更新 </a>
                                                                </li>
                                                                <li onclick="delete_car_info(this)" id="<?php echo ($v["car_id"]); ?>">
                                                                    <a href="javascript:;">
