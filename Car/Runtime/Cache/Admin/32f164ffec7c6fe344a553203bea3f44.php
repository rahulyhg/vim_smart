                                    ...
                                    <form action="#" method="post" class="form-horizontal" id="form_sample_1">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="car_no" value="<?php echo ($car_info["car_no"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入完整车牌号：请参考系统已有格式录入”</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">车辆车主
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="user_id" value="<?php echo ($car_info["user_id"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入用户id”</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">购入价格
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="car_price" value="<?php echo ($car_info["car_price"]); ?>">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请输入车辆购入价格</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">车辆描述</label>
                                                <div class="col-md-9">
                                                    <textarea class="form-control" name="car_type" rows="3"><?php echo ($car_info["car_type"]); ?></textarea>
                                                    <div class="form-control-focus"> </div>
