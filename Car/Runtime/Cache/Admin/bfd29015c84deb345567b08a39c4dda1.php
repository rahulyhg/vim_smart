            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- <div class="m-heading-1 border-green m-bordered">
                        <h3>使用提示</h3>
                        <p> 本操作仅向超级管理开放，若有特殊情况，也可以向部分管理员开放，但是要注意修改后自己无权限的情况！
                                    ...
                                    <form action="#" method="post" class="form-horizontal" id="form_sample_1">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="role_name" value="<?php echo ($role_info["role_name"]); ?>">
                                            ...
                                            <div class="form-group form-md-checkboxes">
                                                ...
                                                <table border='1'>
                                                    <?php if(is_array($auth_infosA)): foreach($auth_infosA as $key=>$v): ?><tr>
                                                            <td>
                                                                <?php if(in_array(($v["auth_id"]), is_array($role_info['role_auth_ids'])?$role_info['role_auth_ids']:explode(',',$role_info['role_auth_ids']))): ?><div class="md-checkbox" style="width: 110px; float: left;">
                                                                        <input type="checkbox" checked="checked" id="checkbox1_<?php echo ($v["auth_id"]); ?>" name="role_auth_ids[]" value="<?php echo ($v["auth_id"]); ?>" class="md-check" onclick="parent_controller(this)">
                                                                                <label for="checkbox1_<?php echo ($v["auth_id"]); ?>">
                                                                                    <span></span>
                                                                                    <span class="check"></span>
                                                                                    <span class="box"></span> <?php echo ($v["auth_name"]); ?> </label>
                                                                    </div>
                                                                <?php else: ?>
                                                                    <div class="md-checkbox" style="width: 110px; float: left;">
                                                                        <input type="checkbox" id="checkbox1_<?php echo ($v["auth_id"]); ?>" name="role_auth_ids[]" value="<?php echo ($v["auth_id"]); ?>" class="md-check" onclick="parent_controller(this)">
                                                                                <label for="checkbox1_<?php echo ($v["auth_id"]); ?>">
                                                                                    <span></span>
                                                                                    <span class="check"></span>
                                                                                    <span class="box"></span> <?php echo ($v["auth_name"]); ?> </label>
                                                            ...
                                                            <td>
                                                                <?php if(is_array($auth_infosB)): foreach($auth_infosB as $key=>$vv): if($vv['auth_pid'] == $v['auth_id']): if(in_array(($vv["auth_id"]), is_array($role_info['role_auth_ids'])?$role_info['role_auth_ids']:explode(',',$role_info['role_auth_ids']))): ?><div class="md-checkbox" style="width: 150px; float: left;">
                                                                                <input type="checkbox" checked="checked" id="checkbox1_<?php echo ($vv["auth_id"]); ?>" name="role_auth_ids[]" value="<?php echo ($vv["auth_id"]); ?>" class="md-check" onclick="check_parent(this)">
                                                                                <label for="checkbox1_<?php echo ($vv["auth_id"]); ?>">
                                                                                    <span></span>
                                                                                    <span class="check"></span>
                                                                                    <span class="box"></span> <?php echo ($vv["auth_name"]); ?> </label>
                                                                            </div>
                                                                        <?php else: ?>
                                                                            <div class="md-checkbox" style="width: 150px; float: left;">
                                                                                <input type="checkbox" id="checkbox1_<?php echo ($vv["auth_id"]); ?>" name="role_auth_ids[]" value="<?php echo ($vv["auth_id"]); ?>" class="md-check" onclick="check_parent(this)">
                                                                                <label for="checkbox1_<?php echo ($vv["auth_id"]); ?>">
                                                                                    <span></span>
                                                                                    <span class="check"></span>
                                                                                    <span class="box"></span> <?php echo ($vv["auth_name"]); ?> </label>
