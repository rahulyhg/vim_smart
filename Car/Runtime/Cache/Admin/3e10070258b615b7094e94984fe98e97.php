                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <div class="btn-group btn-group-devided" data-toggle="buttons">
                                            <label class="btn btn-transparent dark btn-outline btn-circle btn-sm active" onclick="window.location.href='/index.php/Admin/Garage/recycle'">
                                ...
                                <div class="portlet-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo U('add');?>">
                                                        <button id="sample_editable_1_new" class="btn sbold green"> 添加停车场
                                                            <i class="fa fa-plus"></i>
                                                        </button>
                                                    </a>
                                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <?php if(is_array($garage_infos)): foreach($garage_infos as $key=>$v): ?><tr class="odd gradeX">
                                                    ...
                                                    <td class="center">
                                                        <a href="/index.php/Admin/Garage/detail/garage_id/<?php echo ($v["garage_id"]); ?>">查看详情</a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                ...
                                                                <li onclick="delete_garage_info(this)" id="<?php echo ($v["garage_id"]); ?>">
                                                                    <a href="javascript:;">
...
<![endif]-->
        ...
        <script type="text/javascript">
            //获取将要删除的记录对应的id
            function delete_garage_info(obj){
                layer.msg('你确定要删除么？', {
                    time: 0 //不自动关闭
                    ,btn: ['确定', '取消']
                    ,yes: function(index){
