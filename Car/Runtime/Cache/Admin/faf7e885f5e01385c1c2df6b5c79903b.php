                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>车库信息回收站
                                <small>在此你可以查看你权限下的已被删除的车库的信息</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                    ...
                    <!-- <div class="m-heading-1 border-green m-bordered">
                        <h3>使用提示</h3>
                        <p>为了数据的完整性，请勿随意改动停车场的所属地区或者删除停车场</p>
                        <p> 不遵守提示使用者，数据无价，后果自负！
                            <a class="btn red btn-outline" href="#" target="_blank">点此查看使用操作或联系技术人员服务</a>
                        </p>
                    </div> -->
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo U('showlist');?>">
                                                        <button id="sample_editable_1_new" class="btn sbold green"> 返回停车场列表
                                                        </button>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <?php if(is_array($garage_infos)): foreach($garage_infos as $key=>$v): ?><tr class="odd gradeX">
                                                    <td>
                                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                    ...
                                                    <td> <?php echo ($v["garage_id"]); ?> </td>
                                                    <td><?php echo ($v["garage_name"]); ?></td>
                                                    <td class="center"><?php echo ($v["park_sp_num"]); ?></td>
                                                    <td class="center">计算出</td>
                                                    <td class="center"><?php echo ($v["zone_id"]); ?></td>
                                                    <td class="center">
                                                        <a href="#"><?php echo ($v["park_host"]); ?></a>
                                                    </td>
                                                    <td class="center">
                                                        <a href="#"><?php echo ($v["park_wking"]); ?></a>
                                                    </td>
                                                    <td class="center">
                                                        <a href="#">查看详情</a>
                                                    </td>
                                                    <td>
                                                        <span class="label label-sm label-success"><?php echo ($v["park_status"]); ?></span>
                                                    </td>
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                <li>
                                                                    <a href="/index.php/Admin/Garage/update/garage_id/<?php echo ($v["garage_id"]); ?>">
                                                                        <i class="icon-docs"></i> 更新 </a>
                                                                </li>
                                                                <li onclick="recover_garage_info(this)" id="<?php echo ($v["garage_id"]); ?>">
                                                                    <a href="javascript:;">
                                                                        <i class="icon-tag"></i> 恢复 </a>
                                                                </li>
                                                                <li onclick="destory_garage_info(this)" id="<?php echo ($v["garage_id"]); ?>">
                                                                    <a href="javascript:;">
...
<![endif]-->
        ...
        <script type="text/javascript">
            //获取将要删除的记录对应的id
            function destory_garage_info(obj){
                layer.msg('你确定要删除么？此操作会导致某些信息无车场信息且此操作不可恢复！', {
                    time: 0 //不自动关闭
                    ,btn: ['确定', '取消']
                    ,yes: function(index){
                        layer.close(index);
                        var garage_id=$(obj).attr('id');
                        //通过ajax异步删除
                        $.ajax({
            ...
            //点击恢复对应的信息
            function recover_garage_info(obj){
                layer.msg('你确定要恢复么？', {
                    time: 0 //不自动关闭
                    ,btn: ['确定', '取消']
                    ,yes: function(index){
