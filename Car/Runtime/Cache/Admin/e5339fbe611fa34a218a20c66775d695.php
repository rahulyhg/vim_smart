                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>车主用户回收站
                                <small>你可以在此查看被删除的车主的普通个人信息</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">普通用户信息列表</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                    ...
                    <!-- <div class="m-heading-1 border-green m-bordered">
                        <h3>使用提示</h3>
                        <p>一个用户下面关联多个表信息，请勿随意删除用户，否则可能会影响该用户的其它所有数据信息</p>
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo U('showlist');?>">
                                                        <button id="sample_editable_1_new" class="btn sbold green"> 返回用户列表
                                                        </button>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <?php if(is_array($user_infos)): foreach($user_infos as $key=>$v): ?><tr class="odd gradeX">
                                                    <td>
                                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                    ...
                                                    <td class="center"><?php echo ($v["user_wxnik"]); ?></td>
                                                    <td class="center"><?php echo ($v["user_level"]); ?></td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                <li onclick="recover_user(this)" id="<?php echo ($v["user_id"]); ?>">
                                                                    <a href="javascript:;">
                                                                        <i class="icon-docs"></i> 恢复 </a>
                                                                </li>
                                                                <li onclick="destroy_user(this)" id="<?php echo ($v["user_id"]); ?>">
                                                                    <a href="javascript:;">
