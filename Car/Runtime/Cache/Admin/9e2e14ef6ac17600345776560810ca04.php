                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>消费信息详情页 
                                <small>这里你可以查看所有关于本条消费的所有信息</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                                    ...
                                    <div class="tabbable-line">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab_1">
                                                <div class="row">
                                                        ...
                                                        <div class="portlet blue-hoki box">
                                                            ...
                                                            <div class="portlet-body">
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 消费类型: </div>
                                                                    <div class="col-md-7 value">
                                                                        <?php if($pr_info['pay_type'] == '1'): ?>停车消费<?php endif; ?>
                                                                        <?php if($pr_info['pay_type'] == '2'): ?>洗车消费<?php endif; ?>
                                                                        <?php if($pr_info['pay_type'] == '3'): ?>美容消费<?php endif; ?>
                                                                    </div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 应付金额: </div>
                                                                    <div class="col-md-7 value">
                                                                        <?php echo ($pr_info["payment"]); ?> &nbsp;元
                                                                    </div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 优惠金额: </div>
                                                                    <div class="col-md-7 value">
                                                                        <?php echo ($pr_info["cp_loan"]); ?> &nbsp;元
                                                                    </div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 折后应付: </div>
                                                                    <div class="col-md-7 value">
                                                                        <?php echo ($pr_info["pay_loan"]); ?> &nbsp;元
                                                                    </div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 支付方式: </div>
                                                                    <div class="col-md-7 value">
                                                                        <?php if($pr_info['pay_mode'] == '0'): ?>暂未支付<?php endif; ?>
                                                                        <?php if($pr_info['pay_mode'] == '1'): ?>微信支付<?php endif; ?>
                                                                        <?php if($pr_info['pay_mode'] == '2'): ?>支付宝付<?php endif; ?>
                                                                        <?php if($pr_info['pay_mode'] == '3'): ?>刷卡消费<?php endif; ?>
                                                                        <?php if($pr_info['pay_mode'] == '4'): ?>现金消费<?php endif; ?>
                                                                    </div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 产生时间: </div>
                                                                    <div class="col-md-7 value">
                                                                        <?php echo (date("Y年m月d日 H时i分s秒",$pr_info["start_time"])); ?>
                                                                    </div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 支付时间: </div>
                                                                    <div class="col-md-7 value">
                                                                        <?php if(!empty($$pr_info['pay_time'])): echo (date("Y年m月d日 H时i分s秒",$pr_info["pay_time"])); ?>
                                                                        <?php else: ?>
                                                                            暂未支付<?php endif; ?>
                                                                    </div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 流水编号: </div>
                                                                    <div class="col-md-7 value">
                                                                        <?php echo ($pr_info["pay_no"]); ?>
                                                                    </div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 支付状态: </div>
                                                                        <?php if($pr_info['pay_status'] == '0'): ?><div class="col-md-7 value"> <span class="label label-success"> 未支付 </span> </div><?php endif; ?>
                                                                        <?php if($pr_info['pay_status'] == '1'): ?><div class="col-md-7 value"> <span class="label label-success"> 已支付 </span> </div><?php endif; ?>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="portlet yellow-crusta box">
                                                            <div class="portlet-title">
                                                                <div class="caption">
                                                                    <i class="fa fa-cogs"></i>用户基本信息 </div>
                                                                <div class="actions">
                                                                    <a href="javascript:;" class="btn btn-default btn-sm">
                                                                        <i class="fa fa-pencil"></i> Edit </a>
                                                                </div>
                                                            ...
                                                            <div class="portlet-body">
                                                                <img src="<?php echo (C("WEB_DOMAIN")); ?>/<?php echo ($user_info["user_logo"]); ?>" style="width: 120px;">
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 用户名: </div>
                                                                    <div class="col-md-7 value"> 
                                                                        <span class="label label-info label-sm" style="font-weight: bold;"> <?php echo ($user_info["user_name"]); ?> </span>
                                                                    </div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 用户姓名: </div>
                                                                    <div class="col-md-7 value"> <?php echo ($user_info["user_t_name"]); ?></div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 用户级别: </div>
                                                                    <?php if($user_info['user_level'] == '0'): ?><div class="col-md-7 value"> <span class="label label-success"> 普通 </span> </div><?php endif; ?>
                                                                    <?php if($user_info['user_level'] == '1'): ?><div class="col-md-7 value"> <span class="label label-success"> 会员 </span> </div><?php endif; ?>
                                                                    <?php if($user_info['user_level'] == '2'): ?><div class="col-md-7 value"> <span class="label label-success"> 贵宾 </span> </div><?php endif; ?>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 用户状态: </div>
                                                                    <div class="col-md-7 value">
                                                                        <?php if($user_info["is_del"] == '0'): ?><span class="label label-success"> 正常 </span>
                                                                        <?php else: ?>
                                                                        <span class="label label-success"> 审核中或被删除 </span><?php endif; ?>
                                                                    </div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 注册时间: </div>
                                                                    <div class="col-md-7 value"> <?php echo (date("Y年m月d日 H时i分s秒",$user_info["add_time"])); ?> </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <?php if($pr_info['pay_type'] == '1'): ?><div class="col-md-6 col-sm-12">
                                                        <div class="portlet red-sunglo box">
                                                            <div class="portlet-title">
                                                                <div class="caption">
                                                                    <i class="fa fa-cogs"></i>消费产生明细 </div>
                                                                <div class="actions">
                                                                    <a href="javascript:;" class="btn btn-default btn-sm">
                                                                        <i class="fa fa-pencil"></i> Edit </a>
                                                                </div>
                                                            ...
                                                            <div class="portlet-body">
                                                                    <div class="row static-info">
                                                                        ...
                                                                        <div class="col-md-7 value"> <?php echo ($serv_info["car_no"]); ?></div>
                                                                    </div>
                                                                    <div class="row static-info">
                                                                        <div class="col-md-5 name"> 进库时间: </div>
                                                                        <div class="col-md-7 value"> <?php echo (date("Y年m月d日 H时i分s秒",$serv_info["start_time"])); ?></div>
                                                                    </div>
                                                                    <div class="row static-info">
                                                                        <div class="col-md-5 name"> 出库时间: </div>
                                                                        <div class="col-md-7 value"> <?php echo (date("Y年m月d日 H时i分s秒",$serv_info["end_time"])); ?></div>
                                                                    </div>
                                                                    <div class="row static-info">
                                                                        <div class="col-md-5 name"> 所在车场: </div>
                                                                        <div class="col-md-7 value"><?php echo ($serv_info["garage_id"]); ?></div>
                                                                    </div>
                                                                    <div class="row static-info">
                                                                        <div class="col-md-5 name"> 当值人员: </div>
                                                                        <div class="col-md-7 value"> <?php echo ($serv_info["waiter"]); ?></div>
                                                                    </div>
                                                            </div>
                                                        </div>
                                                    </div><?php endif; ?>
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="portlet green-meadow box">
                                                            <div class="portlet-title">
                                                                <div class="caption">
                                                                    <i class="fa fa-cogs"></i>用户其它信息 </div>
                                                                <div class="actions">
                                                                    <a href="javascript:;" class="btn btn-default btn-sm">
                                                                        <i class="fa fa-pencil"></i> Edit </a>
                                                                </div>
                                                            ...
                                                            <div class="portlet-body">
                                                                    <div class="row static-info">
                                                                        ...
                                                                        <div class="col-md-7 value"> <?php echo ($user_info["user_phone"]); ?></div>
                                                                    </div>
                                                                    <div class="row static-info">
                                                                        <div class="col-md-5 name"> 微信/微信号: </div>
                                                                        <div class="col-md-7 value"> <?php echo ($user_info["user_wxnik"]); ?>&nbsp;/&nbsp;<?php echo ($user_info["user_wxid"]); ?></div>
                                                                    </div>
                                                                    <div class="row static-info">
                                                                        <div class="col-md-5 name"> 性别/年龄: </div>
                                                                        <div class="col-md-7 value">
                                                                            <?php if($user_info['user_sex'] == '0'): ?>保密<?php endif; ?>
                                                                            <?php if($user_info['user_sex'] == '1'): ?>男<?php endif; ?>
                                                                            <?php if($user_info['user_sex'] == '2'): ?>女<?php endif; ?>
                                                                            &nbsp;/&nbsp;<?php echo ($user_info["user_age"]); ?></div>
                                                                    </div>
                                                                    <div class="row static-info">
                                                                        <div class="col-md-5 name"> 家庭住址: </div>
                                                                        <div class="col-md-7 value"> <?php echo ($user_info["user_addr"]); ?></div>
                                                                    </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="well">
                                                            <div class="row static-info align-reverse">
                                                                <div class="col-md-8 name"> 总停车服务费 : </div>
                                                                <div class="col-md-3 value"> $1,124.50 </div>
                                                            </div>
                                                            <div class="row static-info align-reverse">
                                                                <div class="col-md-8 name"> 停车平均 消费: </div>
                                                                <div class="col-md-3 value"> $40.50 </div>
                                                            </div>
                                                            <div class="row static-info align-reverse">
                                                                <div class="col-md-8 name"> 总洗车服务费: </div>
                                                                <div class="col-md-3 value"> $1,260.00 </div>
                                                            </div>
                                                            <div class="row static-info align-reverse">
                                                                <div class="col-md-8 name"> 洗车平均消费: </div>
                                                                <div class="col-md-3 value"> $1,260.00 </div>
                                                            </div>
                                                            <div class="row static-info align-reverse">
                                                                <div class="col-md-8 name"> 总保养服务费: </div>
                                                                <div class="col-md-3 value"> $0.00 </div>
                                                            </div>
                                                            <div class="row static-info align-reverse">
                                                                <div class="col-md-8 name"> 保养平均消费: </div>
                                                                <div class="col-md-3 value"> $1,124.50 </div>
                                                            </div>
                                                        </div>
                                                    </div>
