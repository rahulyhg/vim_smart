        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 login-container bs-reset">
                    <img class="login-logo login-6" src="<?php echo (C("ADMIN_ASSETS_URL")); ?>pages/img/login/login-invert3.png" />
                    <div class="login-content">
                        <h1>邻钱智慧停车管理系统</h1>
                        <!--<p> 汇得行智能停车系统是武汉邻钱科技有限公司完全自主研发的一套停车场收费系统，致力于各类型停车场智能停车收费管理以及停车场的增值服务，具备停车场收费以及潜在服务和商业数据分析等功能 </p>-->
                        <form action="/Car/index.php?s=/Admin/Login/admlogin.html" class="login-form" method="post">
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <img src="<?php echo U('Admin/checkCode');?>" onclick='this.src="/Car/index.php?s=/Admin/Admin/checkCode?"+Math.random()'><span id="code_notice"></span> </div>
                                <div class="col-xs-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 text-right">
                                    ...
                                    <button id="goin_system" class="btn blue" type="submit">开启智慧停车系统</button>
                                </div>
                            </div>
                        </form>
