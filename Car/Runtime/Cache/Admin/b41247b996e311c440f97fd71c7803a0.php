                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <?php if(is_array($zone_info)): foreach($zone_info as $key=>$v): ?><tr class="odd gradeX">
                                                    <td>
                                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                    ...
                                                    <td> <?php echo ($v["zone_id"]); ?> </td>
                                                    <td><?php echo ($v["zone_name"]); ?></td>
                                                    <td class="center"><?php echo ($v["zone_pid"]); ?></td>
                                                    <td class="center"><?php echo ($v["zone_path"]); ?></td>
                                                    <td class="center"><?php echo ($v["zone_level"]); ?></td>
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                <li>
                                                                    <a href="javascript:;" onclick="check_is_next_zone(this)" id="<?php echo ($v["zone_id"]); ?>">
                                                                        <i class="icon-docs"></i> 更新 </a>
                                                                </li>
                                                                <li onclick="destroy_zone(this)" id="<?php echo ($v["zone_id"]); ?>">
                                                                    <a href="javascript:;">
...
<![endif]-->
        ...
        <script type="text/javascript">
            ...
            //检查是否存在下级地区，如果存在，给出相关提示
            function check_is_next_zone(obj){
                var zone_id=$(obj).attr('id');
                //通过ajax异步检测
                        $.ajax({
                            url:"<?php echo U('check_child_zone');?>",
                            ...
                            success:function(delmsg){
                                if(delmsg==='1'){
                                    //存在下级地区！
                                    layer.msg('警告！该地区存在下级地区，为了数据的完整性在修改时请勿删除或者修改其地区级别！', {
                                    time: 0 //不自动关闭
                                    ,btn: ['好！我知道了！', '取消']
                                    ,yes: function(index){
                                        layer.close(index);
                                        //跳转到修改页面
                                        window.location.href="update/zone_id/"+zone_id;
                                    }
                                    });
                                }else{
                                    //直接跳转到修改页面
            ...
            //永久删除地区
            function destroy_zone(obj){
                layer.msg('本操作数据不可恢复！你确定要删除么？', {
                    time: 0 //不自动关闭
                    ,btn: ['确定', '取消']
                    ,yes: function(index){
                        layer.close(index);
                        ...
                        $.ajax({
                            ...
                            success:function(delmsg){
                                if(delmsg==='1'){
                                    ...
                                    //存在下级地区导致删除失败！
                                    layer.msg('此地区存在下级地区，禁止删除！', {icon: 5});
                                }
                            }
