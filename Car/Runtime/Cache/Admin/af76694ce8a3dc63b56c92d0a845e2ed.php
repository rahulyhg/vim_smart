                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>停车记录回收站
                                <small>车辆出入停车场的记录会记录在此，在此你可以查看车辆的出入时间，车牌号，缴费信息等状态</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">停车记录回收站</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                    ...
                    <!-- <div class="m-heading-1 border-green m-bordered">
                        <h3>使用提示</h3>
                        <p>在回收站(本页面)执行删除操作务必要格外小心，因为此处的删除操作不可恢复！</p>
                        <p> 数据无价，随意删除后果自负！
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo U('showlist');?>">
                                                        <button id="sample_editable_1_new" class="btn sbold green"> 返回停车记录列表 
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <?php if(is_array($serv_infos)): foreach($serv_infos as $key=>$v): ?><tr class="odd gradeX">
                                                    <td>
                                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                    ...
                                                    <td> <?php echo ($v["serv_id"]); ?> </td>
                                                    <td>
                                                        <a href="#"> <?php echo ($v["car_no"]); ?> </a>
                                                    </td>
                                                    <td class="center"><?php echo (date("Y-m-d H:i:s",$v["start_time"])); ?></td>
                                                    <td class="center"><?php echo (date("Y-m-d H:i:s",$v["end_time"])); ?></td>
                                                    <td class="center"><?php echo ($v["parking_space"]); ?></td>
                                                    <td class="center">
                                                        <a href="#"><?php echo ($v["pay_record"]); ?></a>
                                                    </td>
                                                    <td class="center">
                                                        <a href="#"><?php echo ($v["garage_id"]); ?></a>
                                                    </td>
                                                    <td class="center">
                                                        <a href="#"><?php echo ($v["waiter"]); ?></a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                <li onclick="recover_serv_record(this)" id="<?php echo ($v["serv_id"]); ?>">
                                                                    <a href="javascript:;">
                                                                        <i class="icon-docs"></i> 恢复 </a>
                                                                </li>
                                                                <li onclick="destory_serv_record(this)" id="<?php echo ($v["serv_id"]); ?>">
                                                                    <a href="javascript:;">
...
<![endif]-->
        ...
        <script type="text/javascript">
            //恢复被逻辑删除的记录
            function recover_serv_record(obj){
                layer.msg('你确定要恢复么？', {
                    time: 0 //不自动关闭
                    ,btn: ['确定', '取消']
                    ,yes: function(index){
                        layer.close(index);
                        var recod_id=$(obj).attr('id');
                        //通过ajax恢复被逻辑删除的记录
                        $.ajax({
                            url:"<?php echo U('recover');?>",
                            data:{'recod_id':recod_id},
                            dataType:'json',
                            type:'get',
            ...
            //物理删除停车记录(不可恢复)
            function destory_serv_record(obj){
                layer.msg('警告！此操作不可恢复！确定要删除么？', {
                    time: 0 //不自动关闭
                    ,btn: ['确定永久删除', '取消']
                    ,yes: function(index){
                        layer.close(index);
                        ...
                        $.ajax({
                            ...
                            success:function(remsg){
                                if(remsg==='1'){
                                    //删除成功！
                                    layer.msg('永久删除成功！', {icon: 6});
                                    //同时刷新页面
                                    window.location.reload();
                                }else{
                                    //删除失败！
                                    layer.msg('永久删除失败！', {icon: 5});
                                }
                            }
                        });
                    }
