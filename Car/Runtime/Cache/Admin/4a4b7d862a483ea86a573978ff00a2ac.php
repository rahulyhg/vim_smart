                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <div class="btn-group btn-group-devided" data-toggle="buttons">
                                            <label class="btn btn-transparent dark btn-outline btn-circle btn-sm active" onclick="window.location.href='/index.php/Admin/Payrecord/recycle'">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="showlist">
                                                        <button id="sample_editable_1_new" class="btn sbold green"> 返回消费记录表
                                                        </button>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <?php if(is_array($pr_infos)): foreach($pr_infos as $key=>$v): ?><tr class="odd gradeX">
                                                    <td>
                                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                    ...
                                                    <td class="center">
                                                        <a href="#"><?php echo ($v["user_id"]); ?></a>
                                                    </td>
                                                    <td class="center"><?php echo ($v["payment"]); ?></td>
                                                    <td class="center"><?php echo (date("Y-m-d H:i:s",$v["start_time"])); ?></td>
                                                    <td class="center">
                                                        <?php if($v['pay_type'] == '1'): ?>停车消费<?php endif; ?>
                                                        <?php if($v['pay_type'] == '2'): ?>洗车消费<?php endif; ?>
                                                        <?php if($v['pay_type'] == '3'): ?>美容消费<?php endif; ?>
                                                    </td>
                                                    <td>
                                                        <?php if($v['pay_status'] == '1'): ?><span class="label label-sm label-success">已支付</span>
                                                        <?php else: ?>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                <li onclick="recover_pay_record(this)" id="<?php echo ($v["pay_id"]); ?>">
                                                                    <a href="javascript:;">
                                                                        <i class="icon-docs"></i> 恢复 </a>
                                                                </li>
                                                                <li onclick="destory_pr_info(this)" id="<?php echo ($v["pay_id"]); ?>">
                                                                    <a href="javascript:;">
...
<![endif]-->
        ...
        <script type="text/javascript">
            //恢复被逻辑删除的记录
            function recover_pay_record(obj){
                layer.msg('你确定要恢复么？', {
                    time: 0 //不自动关闭
                    ,btn: ['确定', '取消']
                    ,yes: function(index){
