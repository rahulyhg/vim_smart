                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>车场详情页 
                                <small>这里你可以浏览和查看本车场的风景和相关信息</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="portlet blue-hoki box">
                                                            ...
                                                            <div class="portlet-body">
                                                                ...
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 车主邮箱: </div>
                                                                ...
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 车主微信号码: </div>
                                                                    <div class="col-md-7 value"> 12234389 </div>
                                                                </div>
                                                                <div class="row static-info">
                                                                    <div class="col-md-5 name"> 车主所在地区: </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="portlet grey-cascade box">
                                                            <div class="portlet-title">
                                                                <div class="caption">
                                                                    <i class="fa fa-cogs"></i>本车辆消费记录 </div>
                                                                <div class="actions">
                                                                    <a href="javascript:;" class="btn btn-default btn-sm">
                                                                        <i class="fa fa-pencil"></i> Edit </a>
                                                                </div>
