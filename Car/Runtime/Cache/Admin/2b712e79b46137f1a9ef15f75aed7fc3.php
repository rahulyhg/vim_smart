                                    ...
                                    <form action="#" method="post" class="form-horizontal" id="form_sample_1">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="datetimepicker" class="form-control" placeholder="" name="start_time">
                                                    <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="datetimepicker2" class="form-control" placeholder="" name="end_time">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">请勿手动输入：请点击右边的下拉按钮进行选择时间”</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" placeholder="" name="parking_space">
                                                    <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        <input type="text" class="form-control" name="pay_record" placeholder="请输入缴费时系统产生的缴费流水号">
                                                        <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        <input type="text" class="form-control" name="waiter" placeholder="请输入此车辆出入时当值工作人员编号，留空为当前登录用户编号">
                                                        <div class="form-control-focus"> </div>
                                                        <i class="fa fa-cc-visa font-green"></i>
                                                    </div>
                                                </div>
