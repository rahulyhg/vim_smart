                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-9">
                                                    <select class="form-control" name="zone_pid">
                                                        ...
                                                        <?php if(is_array($zone_info)): foreach($zone_info as $key=>$v): ?><option value="<?php echo ($v["zone_id"]); ?>"><?php echo str_repeat("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;",$v['zone_level']); ?>┢━<?php echo ($v["zone_name"]); ?></option><?php endforeach; endif; ?>
                                                    </select>
