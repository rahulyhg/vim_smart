            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">车辆消费记录表</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <div class="btn-group btn-group-devided" data-toggle="buttons">
                                            <label class="btn btn-transparent dark btn-outline btn-circle btn-sm active" onclick="window.location.href='/index.php/Admin/User/recycle'">
                                ...
                                <div class="portlet-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo U('add');?>">
                                                        <button id="sample_editable_1_new" class="btn sbold green"> 手动添加用户
                                                            <i class="fa fa-plus"></i>
                                                        </button>
                                                    </a>
                                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <?php if(is_array($user_infos)): foreach($user_infos as $key=>$v): ?><tr class="odd gradeX">
                                                    ...
                                                    <td class="center">
                                                        <a href="detail/uid/<?php echo ($v["user_id"]); ?>">查看详情</a>
                                                    </td>
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                <li>
                                                                    <a href="/index.php/Admin/User/update/uid/<?php echo ($v["user_id"]); ?>">
                                                                        <i class="icon-docs"></i> 更新 </a>
                                                                </li>
                                                                <li onclick="delete_user(this)" id="<?php echo ($v["user_id"]); ?>">
                                                                    <a href="javascript:;">
