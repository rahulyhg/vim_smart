            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">待审后台用户列表</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo U('showlist');?>">
                                                        <button id="sample_editable_1_new" class="btn sbold green"> 返回已审列表
                                                        </button>
                                                    </a>
                                                </div>
                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                ...
                                                                <li onclick="recover_admin_check(this)" id="<?php echo ($v["ad_id"]); ?>">
                                                                    <a href="javascript:;">
                                                                        <i class="icon-tag"></i> 恢复审核 </a>
                                                                </li>
...
<![endif]-->
        ...
        <script type="text/javascript">
            ...
            //执行审核操作
            function recover_admin_check(obj){
                layer.msg('你确定要恢复审核么？', {
                    time: 0 //不自动关闭
                    ,btn: ['确定', '取消']
                    ,yes: function(index){
