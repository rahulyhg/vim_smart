...
class ConfigModel extends Model{
	...
	public function get_config(){
		...
		// !isset($config['waimai_alias_name']) && $config['waimai_alias_name']='外卖';

		!isset($config['appoint_alias_name']) && $config['appoint_alias_name']='预约';
		...
		!isset($config['weidian_url']) && $config['weidian_url']='http://v.xxxxx.com';
