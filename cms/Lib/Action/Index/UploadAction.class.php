...
class UploadAction extends BaseAction{
    public function editor_ajax_upload(){
		if(!in_array($_GET['upload_dir'],array('group/content','merchant/news','activity/content','system/image','activity/index_pic','appoint/content','system/news','system/intro','bbs/category'))){
