...
class UcService
{
    ...
    {
        //include_once(WBLOG_ROOT_PATH.'conf/config_ucenter.php');//ucenter的配置处理类文件
        //include_once(WBLOG_ROOT_PATH.'uc_client/client.php');//客户文件
		include_once('conf/config_ucenter.php');//ucenter的配置处理类文件
		include_once('uc_client/client.php');//客户文件
    }
    /**
     * 会员注册
     *
...
//        return intval($uid);
    ...
    public function check_avatar($uid){
		//echo C('config.site_url').'/uc_client/client.php';
		//exit;
