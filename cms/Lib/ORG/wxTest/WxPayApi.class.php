<?php
import("@.ORG.wxTest.WxPayException");
import("@.ORG.wxTest.WxPayConfig");
import("@.ORG.wxTest.WxPayDataBase");
import("@.ORG.wxTest.WxPayResults");
import("@.ORG.wxTest.WxPayReport");
import("@.ORG.wxTest.WxPayJsApiPay");
/**
 *
...
class WxPayApi
{
    ...
    public static function unifiedOrder($inputObj, $timeOut = 6)
    {
        ...
        $inputObj->SetSub_mch_id(1489131162);//随机字符串
