...
class JsSdkPay {
  ...
  public $SSLCERT_PATH = '/u02/vhi99/vhi_smart/conf/cert/datouzai/apiclient_cert.pem';
  //public $SSLKEY_PATH = '/xxx/xxx/xxxx/WxPayPubHelper/cacert/apiclient_key.pem';
  public $SSLKEY_PATH = '/u02/vhi99/vhi_smart/conf/cert/datouzai/apiclient_key.pem';
