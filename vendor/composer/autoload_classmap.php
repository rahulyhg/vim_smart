...
return array(
    ...
    'Com\\JsSdkPay' => $vendorDir . '/Wechat/JsSdkPay.class.php',
    'Com\\Wxauth' => $vendorDir . '/Wechat/Wxauth.class.php',
    'EasyWechat' => $vendorDir . '/Wechat/EasyWechat.class.php',
    'ErrorCode' => $vendorDir . '/Wechat/wechat.class.php',
    ...
    'PKCS7Encoder' => $vendorDir . '/Wechat/wechat.class.php',
    'Prpcrypt' => $vendorDir . '/Wechat/wechat.class.php',
    'SEA' => $vendorDir . '/mpdf/mpdf/classes/sea.php',
    'SVG' => $vendorDir . '/mpdf/mpdf/classes/svg.php',
    'TPWechat' => $vendorDir . '/Wechat/TPWechat.class.php',
    ...
    'Wechat' => $vendorDir . '/Wechat/wechat.class.php',
