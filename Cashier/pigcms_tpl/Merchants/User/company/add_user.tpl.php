        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <?php if($mid){echo "<a href=$this->SiteUrl/merchants.php?m=User&c=company&a=user_manage&company_id=$company_id&group_id=$group_id&mid=$mid>成员管理</a>";}
                        else{echo "<a href=$this->SiteUrl/merchants.php?m=User&c=company&a=user_manage&company_id=$company_id&group_id=$group_id>成员管理</a>";}?>
                    </li>
                    <li class="active">
                        <strong>添加组员</strong>
                    </li>
...
<!--            <label>当前分组：--><?php //echo $group_name;?><!--</label><br/>-->
<!--            --><?php //if($mid){echo "<button onclick='user_manage()'>成员管理</button>";}else{
//                echo "<button onclick='user_manage2()'>成员管理</button>";
//            }?>
            <form action="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=company&a=au_submit" method="post">
...
//        window.location.href ="<?php //echo $this->SiteUrl;?>///merchants.php?m=User&c=company&a=user_manage&company_id=<?php //echo $company_id;?>//&group_id=<?php //echo $group_id;?>//&mid=<?php //echo $mid;?>//";
//    }
//    function user_manage2(){
//        window.location.href ="<?php //echo $this->SiteUrl;?>///merchants.php?m=User&c=company&a=user_manage&company_id=<?php //echo $company_id;?>//&group_id=<?php //echo $group_id;?>//";
//    }
</script>
</body>
</html>