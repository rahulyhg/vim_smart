...
.fe6:hover {background-color: #0e6fad;}
    </style>
</head>
<body>
<div id="wrapper">
                ...
                <?php if(!empty($user_list)){
                    foreach($user_list as $value){
                        ...
                        <tr>
                            ...
                            <td><?php if(!empty($value['in_money']))echo $value['in_money'];else{echo '0.00';}?></td>
                            <td><?php if(!empty($value['out_money']))echo $value['out_money'];else{echo '0.00';}?></td>
                            <td><?php if(!empty($value['money']))echo $value['money'];else{echo '0.00';}?></td>
                            <td><div style="margin: 0px auto; width:216px;"><a href="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=company&a=recharge&company_id=<?php echo $value['company_id']?>&mid=<?php echo $mid;?>&uid=<?php echo $value['uid']?>"><div class="fe4">充值</div></a>
                            <a href="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=company&a=user_edit&company_id=<?php echo $value['company_id']?>&mid=<?php echo $mid;?>&uid=<?php echo $value['uid']?>"><div class="fe5">编辑</div></a>
                            <a href="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=company&a=detail&company_id=<?php echo $value['company_id']?>&mid=<?php echo $mid;?>&uid=<?php echo $value['uid']?>"><div class="fe6">明细</div></a>
                            </div></td>
                        </tr>
                    <?php }}else{?>
