        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <?php if($mid){echo "<a href=$this->SiteUrl/merchants.php?m=User&c=company&a=user_list&company_id=$company_id&mid=$mid>员工列表</a>";}
                        else{echo "<a href=$this->SiteUrl/merchants.php?m=User&c=company&a=left_userList&company_id=$company_id>员工列表</a>";}?>
                    </li>
                    <li class="active">
                        <strong>员工编辑</strong>
                    </li>
...
<!--           --><?php //if($mid){echo '<button onclick="group()">分组管理</button>';}?>
            ...
            <form action="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=company&a=ue_submit" method="post">
