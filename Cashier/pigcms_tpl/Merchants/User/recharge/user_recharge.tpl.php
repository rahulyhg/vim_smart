...
<!--            <button onclick="record()">充值记录</button>-->
            <form action="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=recharge&a=user_recharge_submit" method="post">
...
//    }
    $('.fe3').click(function () {
        ...
        if(result==true){
            //alert(2);
            $.ajax({
                'url':"?m=User&c=recharge&a=user_recharge_submit",
