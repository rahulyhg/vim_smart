                ...
                <?php if(!empty($arr)){
                    foreach($arr as $value){
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=cashier&a=user_manage&company_id=<?php echo $value['company_id']?>&group_id=<?php echo $value['group_id']?>"><div class="fe kd2">成员管理</div></a></td>
                            <td>
							<div style="width:216px; margin:0px auto;">
								<div style="float:left; margin-left:10px; margin-right:10px;"><a href="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=cashier&a=group_recharge&company_id=<?php echo $value['company_id']?>&group_id=<?php echo $value['group_id']?>"><div class="fe3 kd">充值</div></a></div>
                                <div style="float:left; margin-left:10px; margin-right:10px;"><a href="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=cashier&a=group_edit&company_id=<?php echo $value['company_id']?>&group_id=<?php echo $value['group_id']?>"><div class="fe2 kd">编辑</div></a></div>
                                <div style="float:left; margin-left:10px; margin-right:10px;"><a href="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=cashier&a=group_del&company_id=<?php echo $value['company_id']?>&group_id=<?php echo $value['group_id']?>"><div class="fe4">删除</div></a></div>
...
//    }
    function add_group(){
        window.location.href ="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=cashier&a=add_group&company_id=<?php echo $company_id;?>";
    }
</script>
</body>
</html>