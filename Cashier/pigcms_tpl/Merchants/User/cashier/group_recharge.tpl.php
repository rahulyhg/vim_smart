...
<!--            <button onclick="group()">分组管理</button>-->
            <form action="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=cashier&a=gr_submit" method="post">
                <input type="hidden" name="group_id" value="<?php echo $group_id;?>"/>
                <input type="hidden" name="company_id" value="<?php echo $company_id;?>"/>
                <table>
                    <tr>
                        <td>
							<div style="width:100%;"><label>分组名称</label></div>
...
//    }
    $('.fe3').click(function () {
        ...
        if(result==true){
            //alert(2);
            $.ajax({
                'url':"?m=User&c=cashier&a=gr_submit",
