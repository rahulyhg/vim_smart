                ...
                <?php if(!empty($user_list)){
                    foreach($user_list as $value){
                        ...
                        <tr>
                            ...
                            <td><div style="margin: 0px auto; width:144px;"><a href="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=cashier&a=user_recharge&company_id=<?php echo $value['company_id']?>&uid=<?php echo $value['uid']?>"><div class="fe4">充值</div></a>
                            <a href="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=cashier&a=user_edit&company_id=<?php echo $value['company_id']?>&uid=<?php echo $value['uid']?>"><div class="fe5">编辑</div></a>
                            </div></td>
                        </tr>
                    <?php }}else{?>
