...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=cashier&a=user_manage&company_id=<?php echo $company_id;?>&group_id=<?php echo $group_id;?>">成员管理</a>
                    </li>
                    <li class="active">
                        <strong>添加成员</strong>
                    </li>
		...
		<div class="wrapper page-heading iconList">
            <form action="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=cashier&a=au_submit" method="post">
...
<script>
    ...
    function user_manage(){
        window.location.href ="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=cashier&a=user_manage&company_id=<?php echo $company_id;?>&group_id=<?php echo $group_id;?>";
    }
</script>
</body>
</html>