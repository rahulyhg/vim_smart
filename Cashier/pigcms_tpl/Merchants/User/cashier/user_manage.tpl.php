        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=cashier&a=group&company_id=<?php echo $company_id;?>">分组管理</a>
                    </li>
                    <li>
...
<!--           <button onClick="record()" class="fe2">充值记录</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
		   ...
		   <div style="clear:both"></div>
            ...
            <form action="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=cashier&a=move_user" method="post" style="margin-top:20px;">
                    ...
                    <?php if(!empty($user)){
                        foreach($user as $value){
                            ...
                            <tr>
                                ...
                                <td class="td_left" width="5%"><a href="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=cashier&a=user_del&company_id=<?php echo $company_id;?>&group_id=<?php echo $group_id;?>&uid=<?php echo $value['uid']?>"><div class="ff2">删除</div></a></td>
                            </tr>
                        <?php }}else{?>
...
<script>
    ...
    function add_user(){
        window.location.href ="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=cashier&a=add_user&company_id=<?php echo $company_id;?>&group_id=<?php echo $group_id;?>";
    }
...
//    }
    function all_del(){
        ...
        if(uid_arr=="" || uid_arr=="null"){
            ...
            $.ajax({
                'url':"?m=User&c=cashier&a=all_del",
