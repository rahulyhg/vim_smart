...
<!--									<td><button class="btn btn-info " type="button"><i class="fa fa-paste"></i>春哥下个版本开发</button></td>-->
<!--									<td></td>-->
									<td><button class="btn btn-info " type="button" <?php if($payConfig['configData']['alipay']['isOpen'] == 1){ echo 'checked="checked"'; }?> data-toggle="modal" data-target="#alipaySetting"><i class="fa fa-paste"></i>配置信息</button></td>
									<td></td>
								</tr>
                                <tr>
                                    <?php if($payConfig['configData']['chinaPay']['isOpen'] == 1){ echo 'checked="checked"'; }?>
                                    <td><img style="margin-left: 15px" src="<?php echo $this->RlStaticResource;?>pay_icon/weixin.png"></td>
                                    <td style="padding-top: 14px;">银联B2B</td>
                                    <td id="wxapiinfo1"><button class="btn btn-info " type="button" <?php if($payConfig['configData']['chinaPay']['isOpen'] == 1){ echo 'checked="checked"'; }?> data-toggle="modal" data-target="#chinaPaySetting"><i class="fa fa-paste"></i>配置信息</button></td>
                                </tr>
							</table>
						</div>
					</div>
				...
				<div class="modal-body">
					<div class="setting_rows">
						<div id="new_wxpay_box" class="wxpay_box">
							...
							<div class="form-group">
								<label>pid</label>
								<input type="text" placeholder="pid" value="<?php echo $payConfig['configData']['alipay']['pid']; ?>" name="alipay[pid]" class="form-control">
							</div>
							<div class="form-group">
								<label>授权token</label>
								<input type="text" placeholder="Key" value="<?php echo $payConfig['configData']['alipay']['token']; ?>" name="alipay[token]" class="form-control">
							</div>
<!--							<div class="form-group">-->
<!--								<label>卖家账号</label>-->
...
<div class="modal inmodal" tabindex="-1" role="dialog" aria-hidden="true" id="chinaPaySetting">
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                    <i class="fa fa-wrench modal-icon"></i>
                    <h4 class="modal-title">银联B2B 支付配置</h4>
                </div>
                <div class="modal-body">
                    <div class="setting_rows">
                        <div id="new_wxpay_box" class="wxpay_box">
                            ...
                            <div class="form-group">
                                <label>商户编号</label>
                                <input type="text" placeholder="MerId" value="<?php echo $payConfig['configData']['chinaPay']['MerId']; ?>" name="chinaPay[MerId]" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
