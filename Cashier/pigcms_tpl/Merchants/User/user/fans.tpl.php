                                            ...
                                            <div class="ui-box">
                                                <table class="ui-table ui-table-list" style="padding: 0px;">
                                                    ...
                                                    <tr class="widget-list-header">
                                                        ...
                                                        <th>公司</th>
                                                        <th>头像</th>
                                                        <th data-hide="phone" id="all_money">支付总额</th>
                                                        <th>消费情况</th>
                                                    ...
                                                    <?php if(!empty($fansarr)){
                                                        foreach($fansarr as $ovv){
                                                            ...
                                                            <tr class="widget-list-item">
                                                                ...
                                                                <td><?php if(!empty($ovv['phone'])){echo $ovv['phone'];}else{echo "无";}?></td>
                                                                <td><?php if(!empty($ovv['company_name'])){echo $ovv['company_name'];}else{echo "无";}?></td>
                                                                ...
                                                                <td><?php echo $ovv['month_money'].'元|'.$ovv['month_count'].'笔'?></td>
                                                                <td><?php echo $ovv['score']?></td>
                                                                <td><?php if($ovv['is_subscribe']>0){ echo "已关注";}else{echo "未关注";}?></td>
                                                            </tr>
                                                        <?php }}else{?>
                                                        <tr class="widget-list-item"><td colspan="9">暂无粉丝支付</td></tr>
                                                    <?php }?>
                                                    </tbody>
                                                </table>
