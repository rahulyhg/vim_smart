<nav role="navigation" class="navbar-default navbar-static-side">
            ...
            <ul id="side-menu" class="nav metismenu">
				...
				<li <?php if(ROUTE_CONTROL=='cashier') echo 'class="active"';?>>
                    ...
                    <ul class="nav nav-second-level collapse <?php if(ROUTE_CONTROL=='cashier') echo 'in';?>">
						...
						<li <?php if(ROUTE_CONTROL=='cashier' && ROUTE_ACTION=='ewmChange') echo 'class="active"';?>><a href="./merchants.php?m=User&c=cashier&a=ewmChange" target="_blank">收款二维码</a></li>
						<li <?php if(ROUTE_CONTROL=='cashier' && ROUTE_ACTION=='onLinepay') echo 'class="active"';?>><a href="./merchants.php?m=User&c=cashier&a=onLinepay">在线收款</a></li>
                        <li <?php if(ROUTE_CONTROL=='cashier' && ROUTE_ACTION=='coupon') echo 'class="active"';?>><a href="./merchants.php?m=User&c=cashier&a=coupon">优惠信息</a></li>
                        <li <?php if(ROUTE_CONTROL=='cashier' && ROUTE_ACTION=='money') echo 'class="active"';?>><a href="./merchants.php?m=User&c=cashier&a=money">刷卡支付</a></li>
					</ul>
                </li>
                <li <?php if(ROUTE_CONTROL=='recharge') echo 'class="active"';?>>
                    <a href="#"><i class="fa fa-laptop"></i> <span class="nav-label">企业充值</span><span class="label label-info pull-right">NEW</span></a>
                    <ul class="nav nav-second-level collapse <?php if(ROUTE_CONTROL=='recharge') echo 'in';?>">
                        <?php if($this->is_recharge==1){?><li <?php if(ROUTE_CONTROL=='recharge' && ROUTE_ACTION=='up') echo 'class="active"';?>><a href="./merchants.php?m=User&c=recharge&a=up">公司充值</a></li><?php }?>
                    </ul>
                </li>

                <li <?php if(ROUTE_CONTROL=='user' && ROUTE_ACTION=='fans') echo 'class="active"';?>>
                    <a href="./merchants.php?m=User&c=user&a=fans"><i class="fa fa-laptop"></i> <span class="nav-label">用户列表</span><span class="label label-info pull-right"></span></a>
                </li>
		...
		<div style="width:220px; position:fixed; bottom:10px; line-height:2; text-align:center; color:#FFFFFF;">版权所有：<br/>武汉邻钱网络科技有限公司</div>
    </nav>