			...
			function callpay(){
				WeixinJSBridge.invoke("getBrandWCPayRequest",param,function(res){
					...
					if(res.err_msg=="get_brand_wcpay_request:ok"){
						...
						var mid="<?php echo $wx_user['mid']?>";
						var orderid="<?php echo $orderinfo['orderid']?>";
						//window.location.href='http://www.hdhsmart.com/Cashier/pay/wxpay/wxasyn_notice.php?merid='+mid+'&ordid='+orderid;
	...
	<body style="padding-top:20px;">
		<div id="payDom" class="cardexplain">
			...
			<div class="footReturn" style="text-align:center">
				<button type="button" style="margin:0 auto 20px auto;width:100%"  onclick="callpay()"  class="submitbtn  btn-pay btn btn-block btn-large btn-umpay  btn-green"   id="submit_run"  value="点击进行微信支付" />点击进行微信支付</button>
			</div>
		</div>
		<div id="failDom" style="display:none" class="cardexplain">
			...
			<div class="footReturn" style="text-align:center">
				<input type="button" style="margin:0 auto 20px auto;width:100%"  onclick="callpay()"  class="submitbtn  btn-pay btn btn-block btn-large btn-umpay  btn-green" value="重新进行支付" />
			</div>
		</div>
