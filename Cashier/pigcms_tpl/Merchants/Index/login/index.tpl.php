...
<div class="addBg">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
		<div style="width:300px; font-size:30px; line-height:2;">邻钱收银台管理系统</div>
        <div>
            <form class="m-t" role="form" id="form" method="post" action="?m=Index&c=login&a=signin">
				...
				<div class="form-group">
                    ...
                    <div class="radio radio-inline">
                        <input type="radio" value="company" name="type" <?php if($ltyp>0){echo 'checked="checked"';}?> id="inlineRadio3">
                        <label for="inlineRadio3"> 公司账号登录</label>
                    </div>
                </div>
			  ...
			  <p class="m-t"> <!--<small>Copyright：<?php echo str_replace('http://','',$_SERVER['HTTP_HOST'])?> &copy; <?php echo date('Y');?></small>--> 
			  <small>Copyright：武汉邻钱网络科技有限公司 © 2018</small></p>
        </div>
    </div>
</div>
    <!-- Mainly scripts -->
