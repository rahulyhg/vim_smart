...
//	    $sql='select * from pigcms_cashier_fans where mid='.$this->mid;
//        $sqlObj = new model();
//        $neworder = $sqlObj->selectBySql($sql);
//        dump($neworder);exit;
//	    $sql2='select * from pigcms_user';
//        $neworder = $sqlObj->selectBySql($sql2);
//        foreach ($neworder as $k=>$value){
//            M('cashier_fans')->update(array('totalfee'=>$value['score_count']))
//        }
//        dump($neworder);exit;
