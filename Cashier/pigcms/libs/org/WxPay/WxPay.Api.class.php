...
class WxPayApi
{
    ...
    public static function refund($inputObj, $timeOut = 6)
    {
        ...
        if(defined('WxPay_SUBAPPID')){ $inputObj->SetSubAppid(WxPay_SUBAPPID); } //子公众账号ID
        if(defined('WxPay_SUBMCHID')){ $inputObj->SetSubMch_id(WxPay_SUBMCHID); } //子商户号
        ///$inputObj->SetSubMch_id('1392691402');
        $inputObj->SetNonce_str(self::getNonceStr());//随机字符串
...
//            curl_setopt($ch,CURLOPT_SSLCERT, getcwd().WxPay_SSLCERT_PATH);
            curl_setopt($ch,CURLOPT_SSLCERT, '/u02/vhi99/vhi_smart/Cashier/pigcms/libs/org/WxPay/apiclient_cert.pem');
            curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
//            curl_setopt($ch,CURLOPT_SSLKEY, getcwd().WxPay_SSLKEY_PATH);
            curl_setopt($ch,CURLOPT_SSLKEY, '/u02/vhi99/vhi_smart/Cashier/pigcms/libs/org/WxPay/apiclient_key.pem');
