...
require_once dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'./../model/result/AlipayF2FPayResult.class.php';
require_once dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'../model/result/AlipayF2FQueryResult.class.php';
require_once dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'../model/result/AlipayF2FRefundResult.class.php';
require_once dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'../model/result/AlipayF2FPrecreateResult.class.php';
require_once dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'../model/builder/AlipayTradeQueryContentBuilder.class.php';
require_once dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'../model/builder/AlipayTradeCancelContentBuilder.class.php';
...
class AlipayTradeService {
	...
	function __construct($config){
		...
		//$this->appid = "2016102702360184";
		$this->appid = $config['alipay_appid'];
		$this->private_key = $config['alipay_private_key'];
		//$this->private_key = "";
...
//		$myfile = fopen("R.log", "a+") or die("Unable to open file!");
//		fwrite($myfile, $appAuthToken);
...
//		$myfile = fopen("w.log", "a+") or die("Unable to open file!");
//		fwrite($myfile, $bizContent);
...
//		$myfile = fopen("w.log", "a+") or die("Unable to open file!");
//		fwrite($myfile, $queryResult->trade_status);
		return $queryResult;
	}
