...
class usersmodel {
	...
	function add_user($username, $password, $email, $uid = 0, $questionid = '', $answer = '', $regip = '') {
		...
		$this->db->query("INSERT INTO ".UC_DBTABLEPRE."members SET $sqladd username='$username', password='$password', phone='$email', regip='$regip', regdate='".$this->base->time."', salt='$salt'");
