...
function uc_user_register($username, $password, $phone, $questionid = '', $answer = '', $regip = '',$regdate='') {
	return call_user_func(UC_API_FUNC, 'user', 'register', array('username'=>$username, 'password'=>$password, 'phone'=>$phone, 'questionid'=>$questionid, 'answer'=>$answer, 'regip' => $regip,'regdate'=>$regdate));
}
