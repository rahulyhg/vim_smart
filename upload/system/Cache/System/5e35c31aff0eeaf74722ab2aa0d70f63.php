...
<a href="<?php if($_GET['iskeyword'] == 1): echo U('Link/insert', array('iskeyword' => 1));?> <?php else: ?> <?php echo U('Link/insert'); endif; ?>">
点击这里返回模块选择</a></div>
