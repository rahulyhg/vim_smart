...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 var  meal_alias_name = "<?php echo ($config["meal_alias_name"]); ?>";
    ...
    <form id="myform" method="post" action="<?php echo U('House/department_edit');?>" frame="true" refresh="true" onSubmit="return checkForm()">
    ...
    <table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
        ...
        <tr>
            ...
            <td>
                <div class="mr15">
                    <select name="pid">
						<?php if($department_info['pid'] == 0 AND $department_info['id'] != 0): ?><option selected="selected" value="0">请选择父级名称</option><?php endif; ?>
