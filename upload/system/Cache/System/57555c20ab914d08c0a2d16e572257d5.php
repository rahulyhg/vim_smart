...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 var  meal_alias_name = "<?php echo ($config["meal_alias_name"]); ?>";
	...
	<form id="myform" method="post" action="<?php echo U('Area/modify');?>" frame="true" refresh="true">
		<input type="hidden" name="area_type" value="<?php echo ($_GET['type']); ?>"/>
		<input type="hidden" name="area_pid" value="<?php echo ($_GET['pid']); ?>"/>
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<?php if($_GET['type'] == 2 || $_GET['type'] == 4): ?><tr>
					<th width="80">首字母</th>
			...
			<?php if($_GET['type'] > 1 && $_GET['type'] < 4): ?><tr>
					<th width="80">IP标识</th>
