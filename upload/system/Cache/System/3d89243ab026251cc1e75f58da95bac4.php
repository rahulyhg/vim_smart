...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 var  meal_alias_name = "<?php echo ($config["meal_alias_name"]); ?>";
	...
	<form id="myform" method="post" action="<?php echo U('User/amend');?>" frame="true" refresh="true" autocomplete="off">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				...
				<th width="15%">手机号</th>
				<td width="35%"><input type="text" class="input fl" name="phone" size="20" validate="mobile:true" value="<?php echo ($now_user["phone"]); ?>" autocomplete="off"/></td>
			</tr>
			<tr>
				<th width="15%">密码</th>
