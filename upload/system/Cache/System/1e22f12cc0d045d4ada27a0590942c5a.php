...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 var  meal_alias_name = "<?php echo ($config["meal_alias_name"]); ?>";
	...
	<form id="myform" method="post" action="<?php echo U('Group/cat_amend');?>" enctype="multipart/form-data">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<?php if(empty($now_category['cat_fid'])): if(!empty($now_category['cat_pic'])): ?><tr>
				...
				<tr>
					...
					<td><input type="file" class="input fl" name="cat_pic" style="width:200px;" placeholder="分类LOGO图片" <?php if(empty($now_category['cat_pic'])): ?>validate="required:true"<?php endif; ?> tips="分类LOGO小图标，建议尺寸100*100"/></td>
				</tr><?php endif; ?>
			<tr>
				<th width="80">分类排序</th>
