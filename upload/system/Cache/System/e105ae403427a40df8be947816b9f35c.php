    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px #dfdfdf solid; border-top:none;">
        <tr>
            ...
            <td width="76%" height="42" style="border:1px #dfdfdf solid; border-left:none; border-right:none; background-color:#f5f5f5;">
                <div class="wz1 dept_nameVal"><!--武汉微嗨科技有限公司--><?php echo ($department_info["deptname"]); ?></div>
                <div class="wz2">部门</div>
                <div class="wz3 dept_idVal">
					<!--<a href="javascript:void(0);" onclick="window.top.artiframe('<?php echo U('House/department_edit',array('id'=>$vo['id']));?>','编辑部门',520,350,true,false,false,editbtn,'edit',true);" class="frr">编辑部门</a>-->
					<input type="hidden" name="dept_idVal" value="<?php echo ($department_info["id"]); ?>">
        ...
        <tr>
            <td colspan="4" align="center" valign="top" style="border:1px #dfdfdf solid; border-top:none; border-left:none; border-bottom:none;">
			 <table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><div class="chu">
				<div class="q1"><a href="javascript:void(0);" onclick="window.top.artiframe('<?php echo U('House/department_edit');?>','添加部门',520,380,true,false,false,addbtn,'add',true);" class="cbs">
					<div class="uz"></div>
					<div class="uz2">添加部门</div></a>
				</div>
				<div class="q2"><a href="javascript:void(0);" onclick="window.top.artiframe('<?php echo U('House/employee_edit');?>','添加员工',700,470,true,false,false,addbtn,'add',true);" class="cbs">
					<div class="utz"></div>
					<div class="utz2">添加员工</div></a>
				</div>
				<div class="q3"><a href="#" class="cbs" onclick="window.top.artiframe('<?php echo U('House/employExecl');?>','导入员工',700,445,true,false,false,'',true);">
					<div class="uwz"></div>
					...
					<td><table width="95%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td height="33" style="border:1px #dedede solid; -moz-border-radius:8px; -webkit-border-radius:8px; border-radius:8px">
								<div class="fdj dept_select"><img src="<?php echo ($static_path); ?>images/fdj.jpg" width="24" height="24"/></div>
								<div class="wb">
				...
				<tr>
					...
					<div class="xdp"><img src="<?php echo ($static_path); ?>images/hyt.png" width="22" height="17" /></div>
					<div class="xdp2 st_tree"><!--武汉微嗨科技有限公司-->
						<div style="margin-top:10px;"><?php echo ($department_tree); ?></div>
					</div>
					<div class="both"></div></td>
				</tr>
			 </table>
            ...
            <td align="center" valign="top"><table width="95%" border="0" cellspacing="0" cellpadding="0" style="margin-top:20px; margin-bottom:20px;">
				<tr>
					<td width="3%" height="46" align="left"><img src="<?php echo ($static_path); ?>images/ry.jpg" width="39" height="29" /></td>
				  ...
				  <div class="fer">批量启用</div></a></td>
					...
					<td width="8%" height="46" colspan="2" align="left" class="but2"><a href="javascript:void(0);" onclick="window.top.artiframe('<?php echo U('House/employee_edit');?>','添加员工',700,380,true,false,false,addbtn,'add',true);" class="cbs"><div class="fe">添加员工</div>
					</a></td>
				</tr>
				<tr>
					<td colspan="5" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;" class="table_list">
						<tr>
							...
							<td class="td_left" width="30%">真实姓名</td>
						...
						<?php if($user_arr['user_list']): if(is_array($user_arr['user_list'])): $i = 0; $__LIST__ = $user_arr['user_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									<td class="td_checkbox2"><input type="checkbox"  name="checkbox2" value="<?php echo ($vo["id"]); ?>" /> </td>
									<td class="td_left2"><?php echo ($vo["account"]); ?></td>
									<td class="td_left2"><?php echo ($vo["truename"]); ?></td>									
									<td class="td_left2"><?php echo ($vo["phone"]); ?></td>
									<td class="td_left2"><?php echo (date('Y-m-d H:i:s',$vo["add_time"])); ?></td>
									<td class="td_center2"><span data_id="<?php echo ($vo["id"]); ?>" data_status="<?php echo ($vo["status"]); ?>" class="clickChange"><?php if($vo["status"] == '1' ): ?>已启用<?php else: ?>已禁用<?php endif; ?></span></td>
									<td class="td_center2">
									<a href="javascript:void(0);" onclick="window.top.artiframe('<?php echo U('House/employee_edit',array('id'=>$vo['id']));?>','编辑员工',700,380,true,false,false,editbtn,'edit',true);" class="bj">编辑</a> |
									<a href="javascript:void(0);" class="delete_row bj" parameter="id=<?php echo ($vo["id"]); ?>" url="<?php echo U('House/employee_del');?>">删除</a></td>
								</tr><?php endforeach; endif; else: echo "" ;endif; ?>
							<tr style="height:40px;"><td class="textcenter pagebar" colspan="7"><?php echo ($user_arr['pagebar']); ?></td></tr>
							<?php else: ?>
							<tr><td class="textcenter black" colspan="8">列表为空！</td></tr><?php endif; ?>
					</table></td>
				</tr>
			</table></td>
        </tr>
...
<link rel="stylesheet" type="text/css" href="<?php echo ($static_path); ?>css/SimpleTree.css" />
<script type="text/javascript" src="<?php echo ($static_path); ?>js/SimpleTree.js"></script>
<script type="text/javascript" src="./static/js/artdialog/jquery.artDialog.js"></script>
<script type="text/javascript" src="<?php echo ($static_public); ?>js/ajaxfileupload.js"></script>
<script type="text/javascript">
var del_url="<?php echo U('House/employee_del');?>";
$(function(){
	//搜索部门
	$('.dept_select').click(function(){		
		...
		//}else{
			$.ajax({
				'url':"<?php echo U('House/dept_select',array('isajax'=>1));?>",
	...
	$('.ss2').click(function(){		
		...
		//}else{
			$.ajax({
				'url':"<?php echo U('House/employee',array('isajax'=>1));?>",
				'data':{'keyword':keyword},
				'type':'get',
				'dataType':'JSON',
				'success':function(msg){
...
function employeeChange(){	
	$('.clickChange').click(function(){	
		...
		$.ajax({
			'url':"<?php echo U('House/employee_status');?>",
