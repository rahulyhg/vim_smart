	...
	<body width="100%" <?php if($bg_color): ?>style="background:<?php echo ($bg_color); ?>;"<?php endif; ?>>
		<div class="mainbox">
			<div id="nav" class="mainnav_title">
				<ul>
					<a href="<?php echo U('Home/first');?>" class="on">首次关注回复</a>
				</ul>
			</div>
			<form method="post" action="" refresh="true" enctype="multipart/form-data" >
				<table cellpadding="0" cellspacing="0" class="table_form" width="100%">
					<tr>
						...
						<label><input type="radio" name="type" class="type" value="4" <?php if($first['type'] == 4): ?>checked<?php endif; ?>>本站推荐的<?php echo ($config["waimai_alias_name"]); ?>店铺</label>
						</td>
					</tr>
