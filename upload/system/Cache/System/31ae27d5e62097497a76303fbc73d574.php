...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 var  meal_alias_name = "<?php echo ($config["meal_alias_name"]); ?>";
	...
	<form id="myform" method="post" action="<?php echo U('House/village_import');?>" enctype="multipart/form-data">
		<input type="hidden" name="cat_id" value="<?php echo ($now_category["cat_id"]); ?>"/>
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			<tr>
				<th width="80">示例表格</th>
				<td><a target="_blank" href="<?php echo ($static_public); ?>file/village_sample.xls" class="button" style="margin-left:0px;">点击下载</a></td>
			</tr>
			<tr>
