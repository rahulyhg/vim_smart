...
<div class="mright">
<?php if($m['sub']): ?><a href="<?php if (!$m['linkurl']){?>?g=System&c=Link&a=<?php echo ($m["module"]); ?>&iskeyword=<?php echo intval($_GET['iskeyword']); }else{echo $m['linkurl'];}?>">详细</a><?php endif; ?>
<?php if($m['canselected']): ?><a href="###" onclick="returnHomepage('<?php if (!intval($_GET['iskeyword'])){ echo ($m["linkcode"]); }else{ echo ($m["keyword"]); }?>')" style="margin-left:14px;">选中</a><?php endif; ?>
</div>
