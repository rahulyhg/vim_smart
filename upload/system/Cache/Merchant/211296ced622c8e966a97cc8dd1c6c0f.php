...
<div class="main-content">
	...
	<div class="page-content">
		<div class="page-content-area">
			<div class="profile-user-info profile-user-info-striped">
				<div class="profile-info-row">
					...
					<div class="profile-info-value">
						<span class="editable"><?php echo ($reply_detail["pigcms_id"]); ?></span>
					</div>
				</div>
				<div class="profile-info-row">
					<div class="profile-info-name">订单ID</div>
					<div class="profile-info-value">
						<span class="editable"><?php echo ($reply_detail["order_id"]); ?></span>
					</div>
				</div>
				<div class="profile-info-row">
					<div class="profile-info-name">顾客ID</div>
					<div class="profile-info-value">
						<span class="editable"><?php echo ($reply_detail["uid"]); ?></span>
					</div>
				</div>
				<div class="profile-info-row">
					<div class="profile-info-name">店铺名称</div>
					<div class="profile-info-value">
						<span class="editable"><?php echo ($now_store["name"]); ?></span>
					</div>
				</div>
				<div class="profile-info-row">
					<div class="profile-info-name">订单名称</div>
					<div class="profile-info-value">
						<span class="editable"><?php echo ($reply_detail["order_name"]); ?></span>
					</div>
				</div>
				<div class="profile-info-row">
					<div class="profile-info-name">评论内容</div>
					<div class="profile-info-value">
						<span class="editable"><?php echo ($reply_detail["comment"]); ?></span>
					</div>
				</div>
				<div class="profile-info-row">
					<div class="profile-info-name">评论时间</div>
					<div class="profile-info-value">
						<span class="editable"><?php echo (date('Y-m-d H:i:s',$reply_detail["add_time"])); ?></span>
					</div>
				</div>
				<div class="profile-info-row">
					<div class="profile-info-name">评分</div>
					<div class="profile-info-value">
						<span class="editable"><?php echo ($reply_detail["score"]); ?></span>
					</div>
				</div>
				<?php if($reply_detail['merchant_reply_time']): ?><div class="profile-info-row">
						<div class="profile-info-name">回复内容</div>
						<div class="profile-info-value">
							<span class="editable"><?php echo ($reply_detail["merchant_reply_content"]); ?></span>
						</div>
					</div>
					<div class="profile-info-row">
						<div class="profile-info-name">回复时间</div>
						<div class="profile-info-value">
							<span class="editable"><?php echo (date('Y-m-d H:i:s',$reply_detail["merchant_reply_time"])); ?></span>
						</div>
					</div>
				<?php else: ?>
					<div class="profile-info-row">
			...
			<?php if(!$reply_detail['merchant_reply_time']): ?><div style="margin-top:20px;">
