				...
				<div class="col-xs-12">
					<div class="tabbable">
						<ul class="nav nav-tabs" id="myTab">	
							...
							<!-- <li>
								<a href="<?php echo U('Config/store_add');?>">2.图文列表模板风格</a>
							</li>	
							<li>
								<a href="<?php echo U('Config/store_add');?>">3.图文详细页模板风格</a>
							</li>	
							<li>
								<a href="<?php echo U('Config/store_add');?>">4.颜色风格&预览</a>
							</li> -->
						</ul>
					            ...
					            <fieldset>
									...
									<ul class="cateradio g grid" id="grid">
										...
										<?php if(is_array($tpl)): $i = 0; $__LIST__ = $tpl;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tpl): $mod = ($i % 2 );++$i;?><li class="mix <?php echo ($tpl["attr"]); if($info['tpltypeid'] == $tpl['tpltypeid']){echo ' ck active';} ?>">
												...
												<label>
													<img src="<?php echo ($config["site_url"]); ?>/static/tmpls/images/loading.png" data-original="<?php echo ($config["site_url"]); ?>/static/images/site/<?php echo ($tpl["tplview"]); ?>">
...
<link href="<?php echo ($static_path); ?>css/style-1.css?id=103" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="<?php echo ($static_path); ?>css/style_2_common.css?BPm">
