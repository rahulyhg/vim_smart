...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li><a href="<?php echo U('Message/meal_reply');?>"><?php echo ($config["meal_alias_name"]); ?>评论</a></li>
		</ul>
	</div>
	<!-- 内容头部 -->
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<?php if($reply_list): if(is_array($reply_list)): $i = 0; $__LIST__ = $reply_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
											...
											<td><a style="width: 60px;" class="label label-sm label-info" title="评论列表" href="<?php echo U('Message/meal_reply_detail',array('id'=>$vo['pigcms_id']));?>">评论详情</a></td>
