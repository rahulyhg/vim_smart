...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active">新建<?php echo ($config["group_alias_name"]); ?>套餐</li>
		</ul>
	</div>
	<!-- 内容头部 -->
	<div class="page-content">
		<div class="page-content-area">
			<div class="row">
				<div class="col-xs-12">
					<form enctype="multipart/form-data" class="form-horizontal" method="post" id="edit_form" action="<?php echo U('Group/mpackageadd');?>">
					   <input  name="idx" type="hidden" value="<?php echo ($mpackage['id']); ?>"/>
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								<div class="form-group">
									<label class="col-sm-1"><label for="title">套餐标示名称</label></label>
									<input class="col-sm-2" size="80" name="title" id="title" type="text" value="<?php echo ($mpackage['title']); ?>"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="red">（必填）</span>
								</div>
							<div class="form-group">
								<label class="col-sm-1"><label for="sort">简短描述</label></label>
								<textarea id="description" name="description"  placeholder="写上一些此套餐的简短描述" rows="10" cols="50"><?php echo (htmlspecialchars_decode($mpackage['description'],ENT_QUOTES)); ?></textarea> 
							</div>
						<div class="space"></div>
