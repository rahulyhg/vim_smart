	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			<li>
				...
				<a href="<?php echo U('Tmpls/index');?>">微网站</a>
			</li>
				...
				<div class="col-xs-12">
					<div class="tabbable">
						<ul class="nav nav-tabs" id="myTab">	
							<li>
								<a href="<?php echo U('Catemenu/index');?>">底部菜单分类设置</a>
							</li>
							<li>
								<a href="<?php echo U('Catemenu/styleSet');?>">底部菜单风格选择</a>
							</li>
							<li class="active">
								<a href="<?php echo U('Catemenu/plugmenu');?>">菜单颜色与版权</a>
							</li>
							<li>
								<a href="<?php echo U('Catemenu/music');?>">背景音乐设置</a>
							</li>
						</ul>
						...
						<div class="tab-content">
							<div class="tab-pane active">
								...
								<div class="form-group">
									<label class="col-sm-1"><label for="contact_name"><div class="plug-menu" id="plugmenucolor" style="background-color:<?php echo ($homeInfo["plugmenucolor"]); ?>"><span class="close"></span></div></label></label>
									<label class="col-sm-2">请选择快捷菜单的颜色</label>
									<input type="text" name="plugmenucolor" id="themeStyle" value="<?php echo ($homeInfo["plugmenucolor"]); ?>" class="col-sm-1 color" style="width: 75px; background-image: none; background-color:<?php echo ($homeInfo["plugmenucolor"]); ?>; color: rgb(255, 255, 255);" onblur="document.getElementById('plugmenucolor').style.backgroundColor=document.getElementById('themeStyle').value;">
									<span class="form_tips">请在手机上查看效果!</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="contact_name">设置页面版权</label></label>
									<input type="text" class="col-sm-3" name="copyright" value="<?php echo ($homeInfo["copyright"]); ?>" />
