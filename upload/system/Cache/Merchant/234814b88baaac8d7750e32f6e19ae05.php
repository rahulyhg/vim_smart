...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active">编辑商品 - 【<?php echo ($now_meal["name"]); ?>】</li>
		</ul>
	</div>
	<!-- 内容头部 -->
				...
				<div class="col-xs-12">
					<div class="tabbable">
						<ul class="nav nav-tabs" id="myTab">				
							<li class="active">
								<a href="<?php echo U('Meal/meal_edit',array('meal_id'=>$now_meal['meal_id']));?>">编辑商品</a>
							</li>
						</ul>
					</div>
							...
							<form enctype="multipart/form-data" class="form-horizontal" method="post">
								...
								<div class="form-group">
									...
									<select name="status" id="Food_status">
										<option value="1" <?php if($now_meal['status'] == 1): ?>selected="selected"<?php endif; ?>>正常</option>
										<option value="0" <?php if($now_meal['status'] == 0): ?>selected="selected"<?php endif; ?>>停售</option>
									</select>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="radio">
										<label>
											<input name="waimai_status" value="1" type="radio" <?php if($now_meal['waimai_status'] == 1): ?>checked="checked"<?php endif; ?>/>
											<span class="lbl" style="z-index: 1">是</span>
										</label>　
										<label>
											<input name="waimai_status" value="0" type="radio" <?php if($now_meal['waimai_status'] == 0): ?>checked="checked"<?php endif; ?>/>
								...
								<div class="form-group">
									...
									<span id="image_preview_box">
										<?php if($now_meal['see_image']): ?><img src="<?php echo ($now_meal["see_image"]); ?>" style="width:120px;height:120px"/><?php endif; ?>
									</span>
								</div>
								<div class="form-group">
								...
								<?php if($print_list): ?><div class="form-group">
									...
									<select name="print_id" id="print_id">
										<option value="0" <?php if($now_meal['print_id'] == 0): ?>selected<?php endif; ?>>选择打印机</option>
										<?php if(is_array($print_list)): $i = 0; $__LIST__ = $print_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$print): $mod = ($i % 2 );++$i;?><option value="<?php echo ($print['pigcms_id']); ?>" <?php if($now_meal['print_id'] == $print['pigcms_id']): ?>selected<?php endif; ?>><?php echo ($print['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
