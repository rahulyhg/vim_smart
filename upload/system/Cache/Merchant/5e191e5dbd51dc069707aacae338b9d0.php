...
<div class="main-content">
	...
	<div class="row wrapper page-heading iconList">
		<ul>
			<li class="col-xs-4">
				<a href="<?php echo U('Cashier/cash',array('type'=>1));?>"><i class="fa fa-inbox animated bounceIn"></i>刷卡收款</a>
			</li>
			<li class="col-xs-4">
				<a href="<?php echo U('Cashier/cash',array('type'=>2));?>"><i class="fa fa-undo animated bounceIn"></i>退款</a>
			</li>
			<li class="col-xs-4">
				<a href=""><i class="fa fa-money animated bounceIn"></i>卡券核销</a>
			</li>
			<li class="col-xs-4">
				<a href="<?php echo U('Cashier/ewmPay');?>"><i class="fa fa-qrcode animated bounceIn"></i>收款二维码</a>
			</li>
			<li class="col-xs-4">
				<a href="<?php echo U('Cashier/payRecord');?>"><i class="fa fa-pencil animated bounceIn"></i>收款记录</a>
			</li>
			<li class="col-xs-4">
