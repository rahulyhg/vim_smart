...
<div class="main-content">
	...
	<div class="page-content">
		<div class="page-content-area">
			<div class="row">
				<div class="col-xs-12">
					<?php if(empty($bind)): if($url): ?><div id="shopList" class="grid-view">
								<div class="span12" style="margin-top:10px;">
									<div class="form-actions">
										<a class="btn btn-success cert-setting-btn js-wxauth-btn" target="_blank" data-url="<?php echo ($url); ?>" href="<?php echo ($url); ?>"><i class="ace-icon fa fa-wechat"></i>我有微信公众号，立即设置</a>
									</div>
								</div>
							</div>
						<?php else: ?>
						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								<div class="form-group">
									...
									<input class="col-sm-2" size="20" value="<?php echo ($bind['alias']); ?>" type="text" style="border:none;background:white!important;" readonly="readonly"/>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label>公众号昵称</label></label>
									<input class="col-sm-2" size="20" value="<?php echo ($bind['nick_name']); ?>" type="text" style="border:none;background:white!important;" readonly="readonly"/>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label>微信账号类型</label></label>
									<input class="col-sm-2" size="20" value="<?php echo ($bind['type_info']); ?>" type="text" style="border:none;background:white!important;" readonly="readonly"/>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label>公众号二维码</label></label>
									<div id="upload_pic_box"><img width="158" height="158" src="http://open.weixin.qq.com/qr/code/?username=<?php echo ($bind['alias']); ?>"/></div>
								</div>
							</div>
						</div>
					</form><?php endif; ?>
...
<?php if(empty($bind)): ?><script type="text/javascript">
...
<link rel="stylesheet" href="<?php echo ($static_path); ?>css/base.css">
<style>
.form-actions {
