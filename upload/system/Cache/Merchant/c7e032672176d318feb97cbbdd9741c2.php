						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								...
								<div class="form-group">
									...
									<input class="col-sm-2" size="20" name="name" id="name" value="<?php echo ($now_store["name"]); ?>" type="text"/>
								</div>
								<div class="form-group"><label class="col-sm-1">是否设置成主店</label><label><input type="radio" name="ismain" value="1" <?php if($now_store['ismain'] == 1): ?>checked="checked"<?php endif; ?>>&nbsp;&nbsp;是</label>
									&nbsp;&nbsp;&nbsp;
									<label><input type="radio" name="ismain" value="0" <?php if($now_store['ismain'] != 1): ?>checked="checked"<?php endif; ?>>&nbsp;&nbsp;否</label>
							   ...
							   <div class="form-group">
								...
								<div class="form-group">
									...
									<input class="col-sm-2" style="width:600px" name="feature" id="feature" type="text" value="<?php echo ($now_store["feature"]); ?>" />
								...
								<?php if($config['store_open_meal']): ?><div class="form-group">
										...
										<select name="have_meal" id="have_meal">
											<option value="0" <?php if($now_store['have_meal'] == 0): ?>selected="selected"<?php endif; ?>>关闭</option>
											<option value="1" <?php if($now_store['have_meal'] == 1): ?>selected="selected"<?php endif; ?>>开启</option>
										</select>
									</div><?php endif; ?>
								<?php if($config['store_open_meal']): ?><div class="form-group">
										<label class="col-sm-1" for="store_type"><?php echo ($config["meal_alias_name"]); ?>类型</label>
										<select name="store_type" id="store_type">
											<option value="0" <?php if($now_store['store_type'] == 0): ?>selected="selected"<?php endif; ?>>订餐和外卖</option>
											<option value="1" <?php if($now_store['store_type'] == 1): ?>selected="selected"<?php endif; ?>>订餐</option>
											<option value="2" <?php if($now_store['store_type'] == 2): ?>selected="selected"<?php endif; ?>>其他</option>
										</select>
								...
								<?php if($config['store_open_group']): ?><div class="form-group">
										...
										<select name="have_group" id="have_group">
											<option value="0" <?php if($now_store['have_group'] == 0): ?>selected="selected"<?php endif; ?>>关闭</option>
											<option value="1" <?php if($now_store['have_group'] == 1): ?>selected="selected"<?php endif; ?>>开启</option>
										</select>
									</div><?php endif; ?>
								<?php if($config['store_open_waimai']): ?><div class="form-group">
										<label class="col-sm-1" for="have_waimai"><?php echo ($config["waimai_alias_name"]); ?></label>
							...
							<div id="txtstore" class="tab-pane">
								<div class="form-group">
									...
									<textarea class="col-sm-5" rows="5" name="txt_info"><?php echo ($now_store["txt_info"]); ?></textarea>
								</div>
								<div class="form-group">
							...
							<div id="discount" class="tab-pane">
								...
								<div class="form-group">
									...
									<label><input type="radio" name="discount_type" value="1" <?php if($now_store['discount_txt']['discount_type'] == 1): ?>checked="checked"<?php endif; ?>>&nbsp;&nbsp;折扣</label>&nbsp;&nbsp;&nbsp;
									<label><input type="radio" name="discount_type" value="2" <?php if($now_store['discount_txt']['discount_type'] == 2): ?>checked="checked"<?php endif; ?>>&nbsp;&nbsp;满减</label>&nbsp;&nbsp;&nbsp;
								</div>
								<div class="form-group" <?php if($now_store['discount_txt']['discount_type'] != 1): ?>style="display:none"<?php endif; ?> id="percent">
									<label class="col-sm-1">折扣率</label>
									<input class="col-sm-2" style="width:60px" name="discount_percent"  type="text" value="<?php echo ($now_store['discount_txt']['discount_percent']); ?>" /><b style="color:red">折</b>
									<span class="form_tips">0~10之间的数字，支持一位小数</span>
								</div>
								<div class="form-group" <?php if($now_store['discount_txt']['discount_type'] != 2): ?>style="display:none"<?php endif; ?> id="condition">
									<label class="col-sm-1">每满</label>
									<input class="col-sm-2" style="width:60px" name="condition_price"  type="text" value="<?php echo ($now_store['discount_txt']['condition_price']); ?>" />
									<label class="col-sm-1" style="color:red;width: 60px;">元，减</label>
									<input class="col-sm-2" style="width:60px" name="minus_price"  type="text" value="<?php echo ($now_store['discount_txt']['minus_price']); ?>" />
