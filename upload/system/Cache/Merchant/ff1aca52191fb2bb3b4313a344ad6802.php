	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			<li>
				...
				<a href="<?php echo U('Catemenu/index');?>">微网站</a>
			</li>
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											<?php if($info): if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
														...
														<td><div class="cateimg" style="margin-left:13px"><img src="<?php echo ($vo["picurl"]); ?>" class="cateimg_small" width="50" height="50"/></div></td>
														<td><?php echo ($vo["url"]); ?></td>
														<td><?php if($vo['status'] == 0): ?>不显示<?php else: ?>显示<?php endif; ?></td>
														<td class="button-column" nowrap="nowrap">
														   <a href="<?php echo U('Catemenu/index',array('fid'=>$vo['id']));?>">子菜单</a> 
															<a title="修改" class="green" style="padding-right:8px;" href="<?php echo U('Catemenu/edit',array('id'=>$vo['id'], 'fid'=>$vo['fid']));?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>
															<a title="删除" class="red" style="padding-right:8px;" href="<?php echo U('Catemenu/del',array('id'=>$vo['id']));?>">
...
function CreateShop(){
	window.location.href = "<?php echo U('Catemenu/add', array('fid' => $fid));?>";
}
