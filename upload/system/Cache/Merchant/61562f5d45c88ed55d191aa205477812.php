								...
								<div class="ibox float-e-margins">
									<div class="ibox-title clearfix">
										<ul class="nav nav-tabs"> 
											...
											<li> <a href="<?php echo U('Cashier/payRecord');?>">收款记录</a> </li> 
											<li class="active"> <a href="<?php echo U('Cashier/ewmRecord');?>">二维码记录</a> </li> 
										</ul> 
									</div>
														...
														<div class="ui-box"> 
															...
															<tbody class="js-list-body-region">
															   ...
															   <tr class="widget-list-item">
																...
																<td><?php  if($ovv['ispay']>0){ echo '<font color="green">已支付</font>'; }else{ echo '<font color="red">未支付</font>'; }?><br/><br/>
																	<?php if($ovv['refund']==1){?>
																			 退款中...
