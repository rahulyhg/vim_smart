...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li>微店管理</li>
			<!--li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo ($weidian_url); ?>" target="_blank">新页面打开微店管理页面</a></li-->
		</ul>
	</div>
	<!-- 内容头部 -->
	<iframe src="<?php echo ($weidian_url); ?>" style="width:100%;height:100%;border:0;" id="weidian_url"></iframe>
