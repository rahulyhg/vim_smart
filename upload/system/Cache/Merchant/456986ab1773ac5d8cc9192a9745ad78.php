...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="<?php echo U('Meal/meal_sort',array('store_id'=>$now_store['store_id']));?>"><?php echo ($now_store["name"]); ?></a></li>
				...
				<div class="col-xs-12">
					<div class="tabbable">
						<ul class="nav nav-tabs" id="myTab">				
							<li class="active">
								<a href="<?php echo U('Meal/sort_add',array('store_id'=>$now_store['store_id']));?>">添加分类</a>
							</li>
						</ul>
					</div>
						...
						<div class="grid-view">
							<form enctype="multipart/form-data" class="form-horizontal" method="post">
								<div class="form-group">
									...
									<input class="col-sm-2" size="20" name="sort_name" id="sort_name" type="text" value="<?php echo ($now_sort["sort_name"]); ?>"/>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="sort">店铺排序</label></label>
									<input class="col-sm-1" size="10" name="sort" id="sort" type="text" value="<?php echo (($now_sort["sort"])?($now_sort["sort"]):'0'); ?>"/>
