				...
				<div class="col-xs-12">
					...
					<form enctype="multipart/form-data" class="form-horizontal" method="post" id="add_form">
						<div class="tab-content">				
							...
							<div id="spread" class="tab-pane"  style="display:none;">
								<div class="form-group">
									<label class="col-sm-1">用户分享佣金比例：</label>
									<input class="col-sm-1" maxlength="20" name="spread_rate" type="text" value="0" /><span class="form_tips">用户分享链接购买商品获得佣金比例（百分比 0-100）微信中分享有效！</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1">子用户分享佣金比：</label>
									<input class="col-sm-1" maxlength="20" name="sub_spread_rate" type="text" value="0" /><span class="form_tips">子用户（分享用户再次分享的用户）分享链接购买商品获得佣金比例（百分比 0-100）微信中分享有效！如果此值用户分享的佣金值和大于100，则取100减去用户分享的佣金值</span>
								</div>
							</div>
