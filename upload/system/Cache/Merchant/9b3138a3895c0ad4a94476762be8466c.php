											...
											<table class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php if($order_list): if(is_array($order_list)): $i = 0; $__LIST__ = $order_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
																...
																<td><?php if($vo['total_price'] > 0): echo (round($vo["total_price"],2)); else: echo (round($vo["price"],2)); endif; ?></td>
																<td><?php echo ($vo["balance_pay"]); ?></td>
																<td><?php echo ($vo["payment_money"]); ?></td>
																<td><?php echo ($vo["merchant_balance"]); ?></td>
																<td><strong style="color: green"><?php echo (round($vo["cash"],2)); ?></strong></td>
														...
														<tr class="even">
															<td colspan="18">
																本页总金额：<strong style="color: green"><?php echo (round($total,2)); ?></strong>　本页已出账金额：<strong style="color: red"><?php echo (round($finshtotal,2)); ?></strong><br/> 
																总金额：<strong style="color: green"><?php echo (round($alltotal+$alltotalfinsh,2)); ?></strong>　总已出账金额：<strong style="color: red"><?php echo (round($alltotalfinsh,2)); ?></strong><br/>
															</td>
														</tr>
														<tr class="odd">
