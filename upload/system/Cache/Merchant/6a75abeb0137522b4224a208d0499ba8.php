                ...
                <div class="col-sm-12">
                    ...
                    <div class="tabbable" style="margin-top:20px;">
                        <ul class="nav nav-tabs" id="myTab">
                            <li>
                                <a data-toggle="tab" href="#couponinfo" title="<?php echo ($config["group_alias_name"]); ?>统计">
                                    现金劵统计
                                </a>
                            </li>
                        </ul>
                                        ...
                                        <div class="grid-view">
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <?php if(is_array($request_list)): $i = 0; $__LIST__ = $request_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>even<?php else: ?>odd<?php endif; ?>">
                                                        ...
                                                        <td style="width: 120px"><?php echo (($vo["coupon_money"])?($vo["coupon_money"]):"0"); if(stripos($vo["coupon_money"] ,'.') == false): ?>.00<?php endif; ?></td>
                                                        <td style="width: 120px"><?php echo (($vo["coupon_pay_money"])?($vo["coupon_pay_money"]):"0"); if(stripos($vo["coupon_pay_money"] ,'.') == false): ?>.00<?php endif; ?></td>
                                                        <td>￥<?php echo (($vo["coupon_all_money"])?($vo["coupon_all_money"]):"0"); if(stripos($vo["coupon_all_money"] ,'.') == false): ?>.00<?php endif; ?></td>
...
<script type="text/javascript">
    function location_count(day){
        window.location.href = "<?php echo U('Promote/couponStatistics');?>&day="+day;
    }
    function CreateShop(){
        ...
        series : [
            {
                ...
                type:'line',
                tiled: '总量',
                data: [<?php echo ($coupon_money_txt); ?>]
            },
            {
                "name":'支付的金额',
                "type":'line',
                "tiled": '总量',
                data:[<?php echo ($coupon_pay_money_txt); ?>]
            },
            {
                "name":'实际总金额',
                "type":'line',
                "tiled": '总量',
                data:[<?php echo ($coupon_all_money_txt); ?>]
            }
