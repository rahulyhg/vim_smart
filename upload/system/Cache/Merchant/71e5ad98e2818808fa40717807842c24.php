...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active">【<?php echo ($now_store["name"]); ?>】 店员列表</li>
		</ul>
	</div>
	<!-- 内容头部 -->
										...
										<tbody>
											<?php if($staff_list): if(is_array($staff_list)): $i = 0; $__LIST__ = $staff_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$staff): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
														...
														<td class="button-column">
															<a class="green" style="padding-right:8px;" href="<?php echo U('Config/staffSet', array('itemid'=>$staff['id'],'store_id'=>$now_store['store_id']));?>" >
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>
															<a title="删除" class="red" style="padding-right:8px;" href="<?php echo U('Config/staffDelete',array('itemid'=>$staff['id'],'store_id'=>$now_store['store_id']));?>">
																<i class="ace-icon fa fa-trash-o bigger-130"></i>
															</a>
														</td>
													</tr><?php endforeach; endif; else: echo "" ;endif; ?>
											<?php else: ?>
												<tr class="odd"><td class="button-column" colspan="5" >无内容</td></tr><?php endif; ?>
										</tbody>
									</table>
								</div>
							</div>
