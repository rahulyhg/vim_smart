			...
			<div class="row">
				<div class="col-xs-12">
					<form enctype="multipart/form-data" class="form-horizontal" method="post">
					  <input  name="idx" type="hidden" value="<?php echo ($classify['id']); ?>"/>
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								<div class="form-group">
									<label class="col-sm-1"><label for="cyname">分类名称</label></label>
									<input class="col-sm-2" size="30" name="cyname" id="cyname" value="<?php echo ($classify['cyname']); ?>" type="text" />
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label>类型</label></label>
									<select name="typ" style="height: 35px;width: 220px;">
									<option value="0" <?php if($classify['typ'] == 0): ?>selected="selected"<?php endif; ?>>商家动态</option>
									<option value="1" <?php if($classify['typ'] == 1): ?>selected="selected"<?php endif; ?>>商家相册</option>
									</select>
								</div>
							<div class="form-group">
									<label class="col-sm-1"><label for="sort">排序</label></label>
									<input class="col-sm-2" size="20" name="sort" id="sort" type="text" value="<?php echo ($classify['sort']); ?>" onkeyup="value=value.replace(/[^1234567890]+/g,'')"/>
							</div>
							</div>
