	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			<li>
				...
				<a href="<?php echo U('Card/focus');?>">会员卡</a>
			</li>
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="tab-content">
						<div class="grid-view">
							<form enctype="multipart/form-data" class="form-horizontal" method="post" action="<?php echo U('Card/focusAdd');?>">
								<div class="form-group">
									<label class="col-sm-1"><label for="contact_info">幻灯片描述</label></label>
									<input type="text" class="col-sm-3" name="info" value="<?php echo ($info["info"]); ?>" />
								...
								<div class="form-group" style="width:417px;padding-left:140px;">
									...
									<div><a href="#modal-table" class="btn btn-sm btn-success" onclick="selectImg('image_preview_box')">选择图片</a></div>
								
									<div id="image_preview_box"><img style="width:417px;height:200px" id="img" src="<?php echo ($info["img"]); ?>"></div>
								</div>
								
								<div class="form-group">
									<label class="col-sm-1"><label for="contant_url">幻灯片链接地址  </label></label>
									<input type="text" class="col-sm-3" name="url" value="<?php echo ($info["url"]); ?>" id="url"/>
