						...
						<div class="tab-content">
							<div class="tab-pane active">
								...
								<div class="form-group">
									...
									<input type="text" class="col-sm-3" name="musicurl" id="musicurl" value="<?php echo ($homeInfo["musicurl"]); ?>" />　
								...
								<div class="form-group">
									...
									<a style="width:120px;" id="musicurl_href" class="audio {skin:'green'}" href="<?php echo ($homeInfo["musicurl"]); ?>">音乐播放</a>
								</div>
