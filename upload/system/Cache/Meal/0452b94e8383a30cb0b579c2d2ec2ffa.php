...
<title><?php echo ($config["meal_alias_name"]); ?>列表_<?php echo ($config["seo_title"]); ?></title>
								...
								<span class="breadcrumb_item__option">
									<span class="option-list--wrap inline-block">
										<span class="option-list--inner inline-block">
											...
											<?php if(is_array($all_category_list_meal)): $i = 0; $__LIST__ = $all_category_list_meal;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="<?php if($vo['cat_id'] == $top_category['cat_id']): ?>current<?php endif; ?> log-mod-viewed" href="<?php echo ($vo["url"]); ?>"><?php echo ($vo["cat_name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
										</span>
									</span>
								</span>
							</span>
