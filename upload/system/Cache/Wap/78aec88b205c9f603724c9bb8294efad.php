...
<link rel="stylesheet" type="text/css" href="<?php echo ($static_path); ?>css/lib_5e96991.css">
<link rel="stylesheet" type="text/css" href="<?php echo ($static_path); ?>css/style_dd39d16.css">
<link rel="stylesheet" type="text/css" href="<?php echo ($static_path); ?>css/address_9d295cd.css">
<script type="text/javascript" src="<?php echo ($static_path); ?>js/jquery-1.7.2.js"></script>
<script type="text/javascript" src="<?php echo ($static_path); ?>js/jquery.cookie.js"></script>
<div id="fis_elm__1"></div>
<img src="<?php echo ($static_path); ?>images/hm.gif" width="0" height="0" style="display:block">
