...
<div class="container js_container">
    <div class="page slideIn msg">
        <div class="weui_msg">
            <div class="weui_icon_area"><img src="<?php echo ($static_path); ?>images/lq.png"></div>
            <div class="weui_text_area">
                 <p> 我的零钱</p>
                 <div style="margin-top:-10px;margin-left:-4px;"><span id="weui_mone" >￥</span><span id="weui_title"><?php echo ($now_user["now_money"]); ?></span></div>
                
                
            </div>
            <div class="weui_opr_area">
                <p class="weui_btn_area">
                    <a href="<?php echo U('My/recharge');?>" class="weui_btn weui_btn_primary">充值</a>
                    <a href="<?php echo U('My/mx_money');?>" class="weui_btn weui_btn_default">明细</a>
                </p>
            </div>
        </div>
    </div>
