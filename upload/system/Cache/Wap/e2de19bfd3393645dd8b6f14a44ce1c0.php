...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="<?php echo ($static_path); ?>css/allcss/cate<?php echo (($tpl["tpltypeid"])?($tpl["tpltypeid"]):2); ?>_<?php echo (($tpl["color_id"])?($tpl["color_id"]):0); ?>.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo ($static_path); ?>css/102/iscroll.css" rel="stylesheet" type="text/css" />
        <style>


        </style>
        <script src="<?php echo ($static_path); ?>css/102/iscroll.js" type="text/javascript"></script>
