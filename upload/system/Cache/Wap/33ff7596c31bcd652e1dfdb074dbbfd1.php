...
<form id="access_form" onSubmit="return false;">
    <div class="shtx_dkx">
        <div class="shtx_xm">
            ...
            <div class="shtx_kk"><!--刘德华--><?php echo ($suggest_info["name"]); ?></div>
            <div class="both"></div>
        </div>
        <div class="shtx_xm">
            ...
            <div class="shtx_kk"><!--18086681360--><?php echo ($suggest_info["usernum"]); ?></div>
            <div class="both"></div>
        </div>
    </div>
    <div class="shtx_dk2">
        <div class="shtx_xm">
            ...
            <div class="shtx_kk"><!--武汉微嗨科技有限公司--><?php echo ($suggest_info["phone"]); ?>
            </div>
            <div class="both"></div>
        </div>
        <div class="shtx_xm">
            ...
            <div class="shtx_kk"><!--技术部--><?php echo (date('Y-m-d H:i:s',$suggest_info["time"])); ?></div>
            <div class="both"></div>
        </div>
        <div class="shtx_xm">
            ...
            <div class="shtx_kk"><!--广发银行大厦2008--><?php echo ($suggest_info["address"]); ?></div>
            <div class="both"></div>
        </div>
    </div>
                ...
                <div class="weui_uploader">
                    ...
                    <div class="upload_box">
                        <ul class="upload_list clearfix" id="upload_list">
                            <?php if($suggest_info['pic']): $pic=explode('|',$suggest_info['pic']) ?>
    ...
    <div style="width:92%; margin:10px auto; margin-bottom:0px; background-color:#FFFFFF;border-radius: 10px;" id="desc_show"><textarea id="description" name="content" readonly="readonly"  placeholder="报修内容" style="width:97%;height:50px; border:none; font-size:14px; line-height:25px; padding-left:5px;"><?php echo ($suggest_info["content"]); ?></textarea></div>
    <!--<div class="zkd">
        <div style="float:left;width:48%;"><a href="javascript:;" class="weui_btn weui_btn_warn btn_check" data_status="2" data_idVal="<?php echo ($suggest_info["pigcms_id"]); ?>" data_uid="<?php echo ($suggest_info["uid"]); ?>">通过</a></div>
        <div style="float:right;width:48%;"><a href="javascript:;" class="weui_btn weui_btn_warn btn_check" data_status="3" data_idVal="<?php echo ($suggest_info["pigcms_id"]); ?>" data_uid="<?php echo ($suggest_info["uid"]); ?>">不通过</a></div>
