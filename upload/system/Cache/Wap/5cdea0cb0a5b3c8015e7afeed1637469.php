...
<head>
    <meta charset="utf-8"/>
	<title><?php echo ($config["appoint_alias_name"]); ?>订单列表</title>
...
<body id="index">
        ...
        <dl class="list" style="margin-top:0px;">
		    <dd>
				<ul class="orderindex">
					<li><a href="<?php echo U('My/appoint_order_list');?>" class="react <?php if(empty($_GET['status'])): ?>hover<?php endif; ?>">
						<i class="text-icon">⌺</i>
						<span>全部</span>
					</a>
					</li><li><a href="<?php echo U('My/appoint_order_list',array('status'=>1));?>" class="react <?php if($_GET['status'] == '1'): ?>hover<?php endif; ?>">
						<i class="text-icon">⌸</i>
						<span>未服务</span>
					</a>
					</li><li><a href="<?php echo U('My/appoint_order_list',array('status'=>2));?>" class="react <?php if($_GET['status'] == '2'): ?>hover<?php endif; ?>">
						<i class="text-icon">⌻</i>
						<span>已服务</span>
					</a></li>
				</ul>
