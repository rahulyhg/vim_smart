...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo ($static_path); ?>css/animate.css"/><!--7.18晚-->
	...
	<script src="<?php echo ($static_public); ?>js/zepto.min.js"></script><!--7.18晚-->
...
<form id="access_form" onSubmit="return false;">
	<div class="shtx_dkx">
		<div class="shtx_xm">
			...
			<div class="shtx_kk"><!--刘德华--><?php echo ($user_info["name"]); ?></div>
			<div class="both"></div>
		</div>
		<div class="shtx_xm">
			...
			<div class="shtx_kk"><!--18086681360--><?php echo ($user_info["phone"]); ?></div>
			<div class="both"></div>
		</div>
		<div class="shtx_xm">
			...
			<div class="shtx_kek"><?php echo ($user_info["company_name"]); ?>
			</div>
			<div class="both"></div>
		</div>
	</div>
	<div class="shtx_dk2">
		<div class="shtx_xm">
			<div class="shtx_pic"><img src="<?php echo ($static_path); ?>images/fww.png" style="width:12px; height:10px; margin-top:12px;"/></div>
			<div class="kkw">证件类型&nbsp;&nbsp;</div>
			<div class="shtx_kk"><?php if($user_info["card_type"] == 1): ?>现场审核<?php endif; if($user_info["card_type"] == 2): ?>门禁卡<?php endif; if($user_info["card_type"] == 3): ?>身份证<?php endif; if($user_info["card_type"] == 4): ?>工作牌<?php endif; ?></div>
			<div class="both"></div>
		</div>
		<!--<div class="shtx_xm">
			...
			<div class="shtx_kk"><?php echo ($user_info["department"]); ?></div>
			<div class="both"></div>
		</div>
		<div class="shtx_xm">
			...
			<div class="shtx_kk"><?php echo ($user_info["address"]); ?></div>
			<div class="both"></div>
		</div>-->
		<?php if($user_info["card_type"] != 1 and $user_info["card_type"] != 4): ?><div class="shtx_xm">
			...
			<div class="shtx_kk"><!--9527--><?php echo ($user_info["usernum"]); ?></div>
			<div class="both"></div>
		</div><?php endif; ?>
	</div>

	<?php if($user_info["card_type"] != 1): ?><div class="weui_cells weui_cells_form">
		<div class="weui_cell">
	...
	<div style="width:92%; margin:10px auto; margin-bottom:0px; background-color:#FFFFFF;border-radius: 10px;" id="desc_show"><textarea id="description" name="ac_desc"  placeholder="请输入不通过原因" style="width:97%;height:50px; border:none; font-size:14px; line-height:25px; padding-left:5px;"><?php echo ($user_info["ac_desc"]); ?></textarea></div>
	<div class="zkd">
		<div style="float:left;width:48%;"><a href="javascript:;" class="weui_btn weui_btn_warn btn_check" data_status="2" data_idVal="<?php echo ($user_info["pigcms_id"]); ?>" data_uid="<?php echo ($user_info["uid"]); ?>">通过</a></div>
		<div style="float:right;width:48%;"><a href="javascript:;" class="weui_btn weui_btn_warn btn_check" data_status="3" data_idVal="<?php echo ($user_info["pigcms_id"]); ?>" data_uid="<?php echo ($user_info["uid"]); ?>">不通过</a></div>
