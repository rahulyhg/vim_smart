...
<head>
    <meta charset="utf-8"/>
	<title><?php echo ($config["group_alias_name"]); ?>评价</title>
...
<body id="index" data-com="pagecommon">
        <header  class="navbar">
            ...
            <h1 class="nav-header"><?php echo ($config["group_alias_name"]); ?>评价</h1>
        ...
        <form id="form" method="post" action="<?php echo U('My/group_feedback',array('order_id'=>$now_order['order_id']));?>">
			<dl class="list">
				<dd class="dd-padding">
					<h6>评分</h6>
					<div class="score">
