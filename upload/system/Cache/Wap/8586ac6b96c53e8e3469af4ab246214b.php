...
<head>
    <meta charset="utf-8"/>
	<title><?php if($now_order['meal_type']): ?>外卖<?php else: echo ($config["meal_alias_name"]); endif; ?>评价</title>
	...
	<link href="<?php echo ($static_path); ?>css/wap_uploadimg.css" rel="stylesheet"/>
<style>
    h6 {
        font-size: .3rem;
        font-weight: normal;
...
<body id="index" data-com="pagecommon">
        <header  class="navbar">
            ...
            <h1 class="nav-header"><?php if($now_order['meal_type']): ?>外卖<?php else: echo ($config["meal_alias_name"]); endif; ?>评价</h1>
            ...
            <div id="nav-dropdown" class="nav-dropdown">
                <ul>
                    <li><a class="react" href="<?php echo U('Home/index');?>"><i class="text-icon">⟰</i>
                        ...
                        <space></space>我的</a>
                    </li><li><a class="react" href="<?php echo U('Search/index',array('type'=>'meal'));?>"><i class="text-icon">⌕</i>
                        <space></space>搜索</a>
                </li></ul>
            </div>
        </header>
        <div id="tips" class="tips"></div>
        <form id="form" method="post" action="<?php echo U('My/meal_feedback',array('order_id'=>$now_order['order_id']));?>">
			<dl class="list">
				<dd class="dd-padding">
					<h6>评分</h6>
					<div class="score">
