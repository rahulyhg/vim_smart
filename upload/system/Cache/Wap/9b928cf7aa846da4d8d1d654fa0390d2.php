	...
	<body>
		...
		<div id="container">
			<div id="scroller" class="village_my">
				<nav class="me_pay">
					<?php if(is_array($pay_list)): $i = 0; $__LIST__ = $pay_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><section class="link-url" data-url="<?php echo ($vo["url"]); ?>"><img src="<?php echo ($static_path); ?>images/house/<?php echo ($vo["type"]); ?>.png"/><p><?php echo ($vo["name"]); ?></p><?php if($vo['money'] > 0): ?><em>(需缴费￥<?php echo ($vo["money"]); ?>)</em><?php endif; ?></section><?php endforeach; endif; else: echo "" ;endif; ?>
				</nav>
