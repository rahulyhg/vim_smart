<?php if (!defined('THINK_PATH')) exit();?><html>
       ...
       <?php if($zd['status'] == 1): echo ($zd['code']); endif; ?>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo ($static_path); ?>css/114/iscroll.css" media="all">
<!-- <link href="<?php echo ($static_path); ?>css/114/cate14_.css" rel="stylesheet" type="text/css"> -->
<link href="<?php echo ($static_path); ?>css/allcss/cate12_<?php echo ($tpl["color_id"]); ?>.css" rel="stylesheet" type="text/css" />
<style>

 
</style>
<script src="<?php echo ($static_path); ?>css/114/iscroll.js" type="text/javascript"></script>
...
<?php $tinvote_array = $invote_array; $invote_array=''; ?>
<script src="http://libs.baidu.com/jquery/2.0.0/jquery.min.js" type="text/javascript"></script>
...
<?php if($tinvote_array): ?><script>
	var html = '<div class="list" style="border-top: 1px solid #ddd8ce; border-bottom: 1px solid #ddd8ce; margin-top: .2rem; margin-bottom: 0; background-color: #fff;z-index:100000;"><a href="<?php echo ($tinvote_array["url"]); ?>" style="color:#666;display:block;padding:.2rem;padding-bottom: 9px;">';
	html += '<img src="<?php echo ($tinvote_array["avatar"]); ?>" style="width:40px;  vertical-align: middle;"/><?php echo ($tinvote_array["txt"]); ?>';
	html += '<button style="float:right;height:2.8rem;border:none;background-color:green;color:white;border-radius:5px;padding:0 1.2rem;">关注我们</button>';
	html += '</a></div>';
	$('body').prepend(html);
	if ($('body').attr('id')) {
