...
<script type="text/javascript" src="<?php echo ($static_path); ?>meal/js/main.js"></script>
<script type="text/javascript" src="<?php echo ($static_path); ?>meal/js/helper.js"></script>
<script type="text/javascript" src="<?php echo ($static_path); ?>meal/js/booklist.js"></script>
<script type="text/javascript" src="<?php echo ($static_path); ?>meal/js/showdialog.js"></script>
<title><?php echo ($config["meal_alias_name"]); ?>店铺列表</title>
...
<script>
	...
	function searchList(){
		...
		var url = "<?php echo U('Food/index', array('mer_id' => $mer_id));?>&searhkey="+encodeURIComponent(searchStr);
	...
	<footer data-role="footer">
		<nav class="nav">
			<ul class="box">
				...
				<li class="on">
					<a href="<?php echo U('Food/index', array('mer_id' => $mer_id, 'store_id' => $store_id));?>">
