...
function changeImage(){
	document.getElementById("imgflag").src="<?php echo ($static_path); ?>images/ttw3.png";
	window.location.href="<?php echo U('House/access_control_ask',array('village_id'=>$now_village['village_id'],'ac_id'=>$ac_id));?>";
}

function changeImagee(){
	document.getElementById("imgflag2").src="<?php echo ($static_path); ?>images/ttw4.png";
	window.location.href="<?php echo U('House/village_access_control',array('village_id'=>$now_village['village_id'],'ac_id'=>$ac_id));?>";
}


var user_long="<?php echo ($long_lat["long"]); ?>",user_lat="<?php echo ($long_lat["lat"]); ?>";
$(function(){	
...
var signa_arr="<?php echo ($signa_arr); ?>";
...
<div class="cw">
	<div class="cw2"><a href="#"><img id="imgflag" src="<?php echo ($static_path); ?>images/ttw1.png" onClick="changeImage()" style="width:85%;"></a></div>
	<div class="cw2"><a href="#"><img id="imgflag2" src="<?php echo ($static_path); ?>images/ttw2.png" onClick="changeImagee()" style="width:85%;"></a></div>
	<div style="clear:both"></div>
</div>
<div class="cw3"><span style="color:#fb4746; font-weight:bold;">访客登记:</span>提交访客资料后取得临时访问授权（24小时内有效，过期需重新扫码登记）。</div>
<div class="cw3"><span style="color:#7788f2; font-weight:bold;">业主认证:</span>提交业主相关信息后，需管理员进行审核，审核通过后可直接进行扫码开门。</div>
</body>
</html>