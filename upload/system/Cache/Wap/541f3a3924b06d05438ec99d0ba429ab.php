...
<body id="index" data-com="pagecommon">
        <div id="container">
			...
			<div id="login">
			    <form id="login_form" autocomplete="off" method="post" action="<?php echo U('Deliver/login');?>">
		...
		<script type="text/javascript">
			var static_public="<?php echo ($static_public); ?>",
				static_path="<?php echo ($merchantstatic_path); ?>",
				login_check="<?php echo U('Deliver/login');?>",
				store_index="<?php echo U('Deliver/grab');?>";
