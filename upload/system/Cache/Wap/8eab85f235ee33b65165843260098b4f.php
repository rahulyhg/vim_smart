    ...
    <script type="text/javascript">
		$(function(){
			$('.weui_btn_primary').click(function(){
				//window.close();   //关闭当前页面
				window.location.href="<?php echo ($config['site_url']); ?>/index.php?g=WapMerchant&c=Index&a=index";
			})
		})
    </script>
</head>
...
<div id="innerHtml">
	...
	<div class="skr">
		<div class="skr_1"><span class="sk">付款人</span><span class="xm"><?php echo ($view_content["title"]); ?></span></div>
	</div>
