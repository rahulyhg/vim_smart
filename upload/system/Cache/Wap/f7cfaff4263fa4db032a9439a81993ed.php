	...
	<body>
		...
		<div id="container">
			<div id="scroller" class="village_my">
				<?php if($order_list): ?><nav class="order_list">
						<?php if(is_array($order_list)): $i = 0; $__LIST__ = $order_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><section>
								<img src="<?php echo ($static_path); ?>images/house/<?php echo ($vo["order_type"]); ?>.png"/>
								<p><?php echo ($vo["order_name"]); ?></p>
								<p class="money">金额：<span>￥<?php echo (floatval($vo["money"])); ?></span><em><?php echo (date('Y-m-d H:i',$vo["time"])); ?></em></p>
							</section><?php endforeach; endif; else: echo "" ;endif; ?>
					</nav>
				<?php else: ?>
					<div class="noMoreDiv" style="margin-top:20px;background:#ebebeb;">您还没有使用缴费功能</div><?php endif; ?>
