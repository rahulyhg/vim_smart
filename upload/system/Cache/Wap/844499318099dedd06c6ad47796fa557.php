...
<html lang="zh-CN">
	...
	<head>
		...
		<script type="text/javascript">
			...
			var okUrl = "<?php echo U('House/village_my_utilitieslists',array('village_id'=>$now_village['village_id']));?>";

		</script>

		<script type="text/javascript" src="<?php echo ($static_path); ?>js/village_my.js?210" charset="utf-8"></script>

		<script type="text/javascript" src="<?php echo ($static_path); ?>js/exif.js?210" charset="utf-8"></script>

		<script type="text/javascript" src="<?php echo ($static_path); ?>js/imgUpload.js?210" charset="utf-8"></script>
	...
	<body>
		...
		<div id="container">
			...
			<div id="scroller" class="village_repair">
				...
				<div style="width:88%; margin: 30px auto 0;"><a href="javascript:;" class="weui_btn weui_btn_primary wdwe" id="submit_btn">上报</a></div>
