...
<html lang="zh-CN">
	<head>
		...
		<script type="text/javascript">
			var okUrl = "<?php echo U('House/village_my',array('village_id'=>$now_village['village_id']));?>";
		</script>
	...
	<body>
		...
		<div id="container">
			<div id="scroller" class="village_repair">
				...
				<div style="width:88%; margin: 30px auto 0;"><a href="javascript:;" class="weui_btn weui_btn_primary wdwe" id="submit_btn">提交</a></div>
