...
$.post('/wap.php?g=Wap&c=Card&a=addSign&token=<?php echo ($token); ?>&cardid=<?php echo ($thisCard["id"]); ?>', submitData,
function(data) {
	alert(data.success)
...
<div class="jifen-box">
<ul class="zongjifen">
<li><a href="/wap.php?g=Wap&c=Card&a=expense&token=<?php echo ($token); ?>&cardid=<?php echo ($thisCard["id"]); ?>">
<div class="fengexian">
<p>消费记录</p>
<span><?php echo ($userInfo['expensetotal']); ?>元</span></div>
</a></li>
<li><a href="/wap.php?g=Wap&c=Card&a=signscore&token=<?php echo ($token); ?>&cardid=<?php echo ($thisCard["id"]); ?>">
<div class="fengexian">
<p>剩余积分</p>
...
function dourl2(m){
	location.href= '/wap.php?g=Wap&c=Card&a=signscore&token=<?php echo ($token); ?>&cardid=<?php echo ($thisCard["id"]); ?>&month='+m;
}
</script>
