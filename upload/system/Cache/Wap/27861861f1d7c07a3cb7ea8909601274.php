			...
			<div id="scroller">
				<div id="address">
					<dl class="list">
						...
						<dd id="see_load">
							<?php echo ($now_store["area_name"]); echo ($now_store["adress"]); ?>
							<a class="btn right" href="<?php echo U('Group/get_route',array('store_id'=>$now_store['store_id']));?>">查看路线</a>
						</dd>
					</dl>
				</div>
				...
				<script type="text/javascript">
					$(function(){
						...
						map.centerAndZoom(new BMap.Point(<?php echo ($now_store["long"]); ?>,<?php echo ($now_store["lat"]); ?>), 16);
					
						map.addControl(new BMap.ZoomControl());  //添加地图缩放控件
						var marker1 = new BMap.Marker(new BMap.Point(<?php echo ($now_store["long"]); ?>,<?php echo ($now_store["lat"]); ?>));  //创建标注
						map.addOverlay(marker1);                 // 将标注添加到地图中
						//创建信息窗口
						var infoWindow1 = new BMap.InfoWindow("<?php echo ($now_store["name"]); ?>");
