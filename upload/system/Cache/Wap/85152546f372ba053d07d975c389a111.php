	...
	<body>
		...
		<div id="container">
			<div id="scroller" class="village_my">
				...
				<nav>
					<section class="link-url" data-url="<?php echo U('House/village_my_pay',array('village_id'=>$now_village['village_id']));?>"><span style="background-color:#0092DE;">费</span><p>社区缴费</p></section>
				...
				<nav>
					...
					<!--<section class="link-url" data-url="<?php echo U('House/village_control_check',array('village_id'=>$now_village['village_id']));?>"><span style="background-color:#0092DE;">审</span><p>用户资料审核</p></section>-->	
				</nav>
				<nav>
					...
					<!--<section class="link-url" data-url="<?php echo U('House/village_my_bind',array('village_id'=>$now_village['village_id']));?>"><span style="background-color:#0092DE;">绑</span><p>管理员后台</p></section>-->
				</nav>
