...
<head>
    ...
    <title>身边<?php echo ($config["group_alias_name"]); ?>-选择位置 | <?php echo ($config["site_name"]); ?></title>
    <!--[if IE 6]>
...
<link rel="stylesheet" type="text/css" href="<?php echo ($static_path); ?>css/around.v2be69a85.css" />
	<script type="text/javascript">
	 var group_alias_name = "<?php echo ($config["group_alias_name"]); ?>";
...
<script src="<?php echo ($static_path); ?>js/group_around_map.js"></script>
</head>
...
<header class="header cf">
	...
	<div id="doc" class="body">
		...
		<div id="bdw" class="bdw">
			<div id="bd" class="cf">
				<h2 style="font-size:18px;margin:20px 0;">身边<?php echo ($config["group_alias_name"]); ?></h2>
				<div class="pg-around-position">
					<div class="bd">
						<p class="location-label">我的位置：</p>
						<p class="mobile-link">
							<span class="F-glob F-glob-phone mobile-icon"></span>
							访问 <a href="<?php echo ($config["site_url"]); ?>/topic/weixin.html" target="_blank">微信版</a>，随时随地查看附近<?php echo ($config["group_alias_name"]); ?>
						</p>
