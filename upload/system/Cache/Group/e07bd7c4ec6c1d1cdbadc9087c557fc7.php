					...
					<div class="product_list cf">
						...
						<div class="product_list_bottom">
							...
							<?php if(isset($mpackages) AND !empty($mpackages)): ?><div class="input cf" id="mpackageslist">
								...
								<div class="but cf">
								<?php if($now_group['end_time'] > $_SERVER['REQUEST_TIME']): ?><button class="info_but" type="submit">立即购买</button><?php endif; ?>
							...
							<?php if($now_group['end_time'] < $_SERVER['REQUEST_TIME']): ?><div  style="color: red;font-size: 20px">真遗憾！这单<?php echo ($config["group_alias_name"]); ?>已经结束</div>
							<?php else: ?>
		...
		<div class="detail_content cf">
			<div class="content_left">
				<div class="content_navbar" id="J-content-navbar">
					...
					<?php if($now_group['end_time'] > $_SERVER['REQUEST_TIME']): ?><div id="J-nav-buy" class="buy-group J-hub">
				...
				<section class="shop_bottom">
					<ul>
						...
						<li style="float:right">
							<?php if($now_group['end_time'] > $_SERVER['REQUEST_TIME']): ?><a class="shop_bottom_but" href="<?php echo ($now_group["buy_url"]); ?>">抢购</a><?php endif; ?>
						</li>
					</ul>
				</section>
			</div>
