			...
			<div class="category cf" id="f1">
				<div class="category_list">
					<?php if($group_list): ?><ul>
							<?php if(is_array($group_list)): $i = 0; $__LIST__ = $group_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($i%3 == 0 || $i == count($group_list)): ?>class="last--even"<?php endif; ?>>
									<div class="category_list_img">
										...
										<div class="extra-inner cf">
											<?php if($vo['is_start'] > 0): ?><div class="sales">已售<strong class="num"><?php echo ($vo['sale_count']+$vo['virtual_num']); ?></strong></div >
											<div class="noreviews">
												<?php if($vo['reply_count']): ?><a href="<?php echo ($vo["url"]); ?>#anchor-reviews" target="_blank" style="display:block;">
											...
											<?php else: ?>
											<div class="sales">开团时间：<strong class="num"><?php echo ($vo['begin_time']); ?></strong></div ><?php endif; ?>
										</div>
									</div>
								</li><?php endforeach; endif; else: echo "" ;endif; ?>
						</ul>
