...
<html>
	...
	<body>
		...
		<script type="text/javascript">
			...
			//定位
			var point = new BMap.Point(<?php echo ($_GET['map_point']); ?>);
			...
			var content = "<b>地址：</b><?php echo ($_GET['store_adress']); ?><br/><b>电话：</b><?php echo ($_GET['store_phone']); ?><br/><b>线路：</b><a href='http://map.baidu.com/m?word=<?php echo (urlencode($_GET['store_adress'])); ?>' target='_blank'>公交/驾车路线查询»</a>";
			//创建检索信息窗口对象
			var searchInfoWindow = null;
			searchInfoWindow = new BMapLib.SearchInfoWindow(map, content, {
				title  : "<?php echo ($_GET['store_name']); ?>",      //标题
				width  : 290,             //宽度
				height : 60,              //高度
				panel  : "panel",         //检索结果面板
