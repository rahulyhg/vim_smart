...
<div class="main-content">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="<?php echo U('Access/visitorLog');?>">访客信息</a>
            </li>
    ...
    <div class="page-content">
        <div class="page-content-area">
            <div class="row">
                <div class="col-xs-12">
                    <form enctype="multipart/form-data" class="form-horizontal" method="post" id="edit_form" action="<?php echo U('Access/visitorLog_edit');?>">
                        <input  name="pigcms_id" type="hidden" value="<?php echo ($visitor_info['pigcms_id']); ?>"/>
                        <div class="tab-content">
                            <div id="basicinfo" class="tab-pane active">
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">微信名</label></label>
                                    <input class="col-sm-2" size="80" name="nickname" id="title" type="text" readonly="readonly" value="<?php echo ($visitor_info['nickname']); ?>"/>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">真实姓名</label></label>
                                    <input class="col-sm-2" size="80" name="name" id="title" type="text" readonly="readonly" value="<?php echo ($visitor_info['name']); ?>"/>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">手机号码</label></label>
                                    <input class="col-sm-2" size="80" name="phone" id="title" type="text" readonly="readonly" value="<?php echo ($visitor_info['phone']); ?>"/>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">身份证</label></label>
                                    <input class="col-sm-2" size="80" name="id_card" id="title" type="text" readonly="readonly" value="<?php echo ($visitor_info['id_card']); ?>"/>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">公司名称</label></label>
                                    <input class="col-sm-2" size="80" name="company" id="title" type="text" readonly="readonly" value="<?php echo ($visitor_info['company']); ?>"/>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">登记时间</label></label>
                                    <input class="col-sm-2" size="80" name="add_time" id="title" type="text" readonly="readonly" value="<?php echo (date('Y-m-d H:i:s',$visitor_info['add_time'])); ?>"/>
                                </div>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    <button class="btn btn-info" type="button" onclick="window.location.href='<?php echo U('Access/visitorLog');?>'">
...
<!--<form id="myform" method="post" action="" frame="true" refresh="true">
	<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
		<tr>
			<th width="100">工牌图</th>
			<td>
			<?php $workcard_img=explode('|',$visitor_info['workcard_img']) ?>
