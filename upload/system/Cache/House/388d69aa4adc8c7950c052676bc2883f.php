    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="<?php echo U('Access/userCheck');?>">智能系统审核</a>
            </li>
        </ul>
    </div>
    <!-- 内容头部 -->
                ...
                <div class="col-xs-12">
                    <div id="shopList" class="grid-view">
                        <table class="search_table" width="100%">
                            <tr>
                                <td>
                                    <form action="<?php echo U('Access/userCheck');?>" method="get">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if($userCheck_list['userCheck_list']): if(is_array($userCheck_list['userCheck_list'])): $i = 0; $__LIST__ = $userCheck_list['userCheck_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
                            ...
                            <td><div class="tagDiv"><?php if($vo["card_type"] == 1): ?>现场审核<?php endif; if($vo["card_type"] == 2): ?>门禁卡<?php endif; if($vo["card_type"] == 3): ?>身份证<?php endif; if($vo["card_type"] == 4): ?>工作牌<?php endif; ?></td>
                            ...
                            <td class="button-column">
                                <a style="width: 60px;" class="label label-sm label-info" title="审核" href="<?php echo U('Access/userCheck_edit',array('pigcms_id'=>$vo['pigcms_id']));?>">审核</a>
                                <a style="width: 60px;" class="label label-sm label-info" title="删除" href="<?php echo U('Access/userCheck_del',array('pigcms_id'=>$vo['pigcms_id']));?>">删除</a>
                            </td>
                            </tr><?php endforeach; endif; else: echo "" ;endif; ?>

                            <?php else: ?>
                            <tr class="odd"><td class="button-column" colspan="11">列表为空！</td></tr><?php endif; ?>
                            </tbody>
                        </table>
                        <tr class="odd"><td class="button-column" colspan="11"><?php echo ($userCheck_list['pagebar']); ?></td></tr>
                    </div>
                </div>
            </div>
        </div>
