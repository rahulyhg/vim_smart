        ...
        <div class="page-content-area">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <form  class="form-horizontal" method="post" id="edit_form" action="<?php echo U('Access/group_edit_do');?>">

                        <input type="hidden" value="<?php echo ($ag_id); ?>" name='ag_id'/>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="basicinfo" class="tab-pane active">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="col-sm-2" size="20" name="ag_name" id="ag_name" type="text" value="<?php echo ($group_info["ag_name"]); ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="ag_desc"  placeholder="描述内容"><?php echo (htmlspecialchars_decode($group_info["ag_desc"],ENT_QUOTES)); ?></textarea>
