...
<div class="main-content">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="<?php echo U('Access/userCheck');?>">智能审核</a>
            </li>
    ...
    <div class="page-content">
        <div class="page-content-area">
            <div class="row">
                <div class="col-xs-12">
                    <form enctype="multipart/form-data" class="form-horizontal" method="post" id="edit_form" action="<?php echo U('Access/userCheck_edit_do');?>">
                        ...
                        <div class="tab-content">
                            <div id="basicinfo" class="tab-pane active">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="col-sm-2" size="80" name="company" id="title" type="text" readonly="readonly" value="<?php echo ($userCheck_info['company_name']); ?>"/>
                                </div>
                                ...
                                <div class="form-group"><label class="col-sm-1"><label for="title">证件类型</label></label>
                                    <?php if($userCheck_info["card_type"] == 1): ?><input type="text" class="col-sm-2" size="80" value="现场审核" readonly="readonly"/><?php endif; ?>
                                    <?php if($userCheck_info["card_type"] == 2): ?><input type="text" class="col-sm-2" size="80" value="门禁卡" readonly="readonly"/><?php endif; ?>
                                    <?php if($userCheck_info["card_type"] == 3): ?><input type="text" class="col-sm-2" size="80" value="身份证" readonly="readonly"/><?php endif; ?>
                                    <?php if($userCheck_info["card_type"] == 4): ?><input type="text" class="col-sm-2" size="80" value="工作牌" readonly="readonly"/><?php endif; ?>
                                </div>

                                <?php if($userCheck_info["card_type"] != 1 and $userCheck_info["card_type"] != 4 ): ?><div class="form-group">
                                ...
                                <?php if($userCheck_info["card_type"] != 1): ?><div class="form-group">
								...
								<?php if($userCheck_info['check_name'] != '' && $userCheck_info['ac_status'] != 1): ?><div class="form-group">
                                    <label class="col-sm-1"><label for="title">审核人</label></label>
                                    <input class="col-sm-2" size="80" name="check_name" id="title" type="text" readonly="readonly"  value="<?php echo ($userCheck_info['check_name']); ?>"/>
                                </div><?php endif; ?>
                                <div class="form-group" id="d1" <?php if($userCheck_info['ac_status'] != 3): ?>style="display:none"<?php endif; ?>>
...
<!--<form id="myform" method="post" action="" frame="true" refresh="true">
	<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">       
		<tr>
			...
			<td>
			<?php $workcard_img=explode('|',$userCheck_info['workcard_img']) ?>						
			<?php if(is_array($workcard_img)): $k = 0; $__LIST__ = $workcard_img;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($k % 2 );++$k;?><img alt="" src="/upload/house/<?php echo ($img); ?>" class="view_msg" width="100" height="100" style="margin-left:20px;margin-top:10px;clear:both"/><?php endforeach; endif; else: echo "" ;endif; ?>
			</td>
		</tr>						  
	</table>
</form>-->
