...
<div class="main-content">
	...
	<div class="page-content">
		<div class="page-content-area">
			...
			<div class="row">
				<div class="col-xs-12">
					<form  class="form-horizontal" method="post" id="edit_form" action="<?php echo U('News/cate_edit_do');?>">
					<input type="hidden" value="<?php echo ($cate_id); ?>" name='c_id'/>
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								<div class="form-group">
									<label class="col-sm-1"><label for="cat_name">分类名称</label></label>
									<input class="col-sm-2" size="20" name="cat_name" id="cat_name" type="text" value="<?php echo ($cate_info["cat_name"]); ?>"/>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="phone">分类排序</label></label>
									<input class="col-sm-2" size="20" name="cat_sort" id="cat_sort" type="text" value="<?php echo ($cate_info["cat_sort"]); ?>" />
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="water_price">分类状态</label></label>
									<label><input name="cat_status"  type="radio" value="1" <?php if($cate_info["cat_status"] == 1): ?>checked<?php endif; ?> />&nbsp;&nbsp;正常</label>
									&nbsp;&nbsp;&nbsp;
									<label><input name="cat_status"  type="radio" value="0" <?php if($cate_info["cat_status"] == 0): ?>checked<?php endif; ?> />&nbsp;&nbsp;关闭</label>
								</div>
							</div>
						</div>
						<div class="space"></div>
