...
<div class="main-content">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="<?php echo U('CommonPhone/ct_index');?>">服务电话管理</a>
            </li>
    ...
    <div class="page-content">
        <div class="page-content-area">
            <div class="row">
                <div class="col-xs-12">
                    <form enctype="multipart/form-data" class="form-horizontal" method="post" id="edit_form" action="<?php echo U('CommonPhone/ct_edit');?>">
                        <input  name="ct_id" type="hidden" value="<?php echo ($news_info['ct_id']); ?>"/>
                        <div class="tab-content">
                            <div id="basicinfo" class="tab-pane active">
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">分类名称&nbsp;&nbsp;<span style="color:red;">*</span></label></label>
                                    <input class="col-sm-2" size="80" name="ct_name" id="ct_name" type="text" required="required" value="<?php echo ($news_info['ct_name']); ?>"/>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="sort">描述</label></label>
                                    <textarea id="description" name="description"  placeholder="写上一些描述"><?php echo (htmlspecialchars_decode($news_info['ct_description'],ENT_QUOTES)); ?></textarea>
                                </div>
                                <div class="space"></div>
