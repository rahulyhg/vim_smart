    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="<?php echo U('News/cate');?>">新闻分类管理</a>
            </li>
        </ul>
    </div>
    <!-- 内容头部 -->
                ...
                <div class="col-xs-12">
                    <div id="shopList" class="grid-view">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <?php if($news_category): if(is_array($news_category)): $i = 0; $__LIST__ = $news_category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
                                            <td><div class="tagDiv"><?php echo ($vo["cat_name"]); ?></div></td>
                                            <td><div class="tagDiv"><?php echo ($vo["cat_sort"]); ?></div></td>
                                            <td><div class="shopNameDiv"><?php if($vo["cat_status"] == '1' ): ?>正常<?php else: ?>关闭<?php endif; ?></div></td>
                                            <td class="button-column">
                                                <a style="width: 60px;" class="label label-sm label-info" title="编辑" href="<?php echo U('News/cate_edit',array('cat_id'=>$vo['cat_id']));?>">编辑</a>
                                            </td>
...
function CreateCategory(){
	window.location.href = "<?php echo U('News/cate_edit');?>";
}
</script>
