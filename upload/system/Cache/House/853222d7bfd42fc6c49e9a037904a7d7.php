                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <?php if($user_list): if(is_array($user_list['user_list'])): $i = 0; $__LIST__ = $user_list['user_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
                                            ...
                                            <td><div class="tagDiv"><?php echo ($vo["water_price"]); ?></div></td>
                                            <td><div class="tagDiv"><?php echo ($vo["electric_price"]); ?></div></td>
                                            <td><div class="tagDiv"><?php echo ($vo["gas_price"]); ?></div></td>
                                            <td><div class="tagDiv"><?php echo ($vo["park_price"]); ?></div></td>
                                            <td><div class="tagDiv"><?php echo ($vo["property_price"]); ?></div></td>
                                            <td><div class="shopNameDiv"><?php echo ($vo["ydate"]); ?>年<?php echo ($vo["mdate"]); ?>月</div></td>
                                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                                <?php else: ?>
                                    <tr class="odd"><td class="button-column" colspan="11" >没有任何欠费。</td></tr><?php endif; ?>
                            </tbody>
                        </table>
