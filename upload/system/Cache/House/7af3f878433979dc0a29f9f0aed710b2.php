                ...
                <div class="col-xs-12">
                    <div id="shopList" class="grid-view">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <?php if($order_list): if(is_array($order_list['order_list'])): $i = 0; $__LIST__ = $order_list['order_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
                                            <td><div class="tagDiv"><?php echo ($vo["order_name"]); ?></div></td>
                                            <td><div class="tagDiv"><?php echo ($vo["money"]); ?></div></td>
                                            <td><div class="shopNameDiv"><?php echo (date('Y-m-d H:i:s',$vo["time"])); ?></div></td>
                                            <td><div class="tagDiv"><?php echo ($vo["username"]); ?></div></td>
                                ...
                                <?php else: ?>
                                    <tr class="odd"><td class="button-column" colspan="11" >暂时没有任何缴费记录。</td></tr><?php endif; ?>
                            </tbody>
                        </table>
                        <?php echo ($order_list["pagebar"]); ?>
                    </div>
                </div>
            </div>
        </div>
