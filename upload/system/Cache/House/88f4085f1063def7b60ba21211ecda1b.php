...
<div class="main-content">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="<?php echo U('Access/index');?>">门禁管理</a>
            </li>
    ...
    <div class="page-content">
        <div class="page-content-area">
            <div class="row">
                <div class="col-xs-12">
                    <form enctype="multipart/form-data" class="form-horizontal" method="post" id="edit_form" action="<?php echo U('Access/access_edit_do');?>" >
                        <input  name="ac_id" type="hidden" value="<?php echo ($access_info['ac_id']); ?>"/>
                        <div class="tab-content">
                            <div id="basicinfo" class="tab-pane active">
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">名称</label></label>
                                    <input class="col-sm-2" size="80" name="ac_name" id="title" type="text" value="<?php echo ($access_info['ac_name']); ?>"/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="col-sm-2" size="80" name="apikey" id="title" type="text" value="<?php echo ($access_info['apikey']); ?>"/>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">节点ID</label></label>
                                    <input class="col-sm-2" size="80" name="nodeid" id="title" type="text" value="<?php echo ($access_info['nodeid']); ?>"/>
                                </div>
                                <div class="form-group" <?php if($access_info['ac_id'] == ''): ?>style="display:none;"<?php endif; ?> >
                                    <label class="col-sm-1"><label for="title">传感器ID</label></label>
                                    <input class="col-sm-2" size="80" name="sensorid" id="title" type="text" value="<?php echo ($access_info['sensorid']); ?>"/>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1">状态</label>
                                    <label><input value="1" name="ac_status" type="radio"  <?php if($access_info['ac_status'] == 1 || $access_info['ac_status'] == ''): ?>checked="checked"<?php endif; ?> />&nbsp;&nbsp;启用</label>
                                    &nbsp;&nbsp;&nbsp;
                                    <label><input value="2" name="ac_status" type="radio" <?php if($access_info['ac_status'] == 2): ?>checked="checked"<?php endif; ?> />&nbsp;&nbsp;停用</label>
                                </div>
