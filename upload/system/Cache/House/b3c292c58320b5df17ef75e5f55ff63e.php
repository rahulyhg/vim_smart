    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="<?php echo U('Access/examine');?>">智能系统审核</a>
            </li>
        </ul>
    </div>
    <!-- 内容头部 -->
                ...
                <div class="col-xs-12">
                    <div id="shopList" class="grid-view">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if($examine_list['examine_list']): if(is_array($examine_list['examine_list'])): $i = 0; $__LIST__ = $examine_list['examine_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
                            <td><div class="tagDiv"><?php echo ($vo["pigcms_id"]); ?></div></td>
                            <td><div class="tagDiv"><?php echo ($vo["nickname"]); ?></div></td>
                            <td><div class="tagDiv"><?php echo ($vo["name"]); ?></div></td>
                            <td><div class="tagDiv"><?php echo ($vo["company"]); ?></div></td>
                            <td><div class="tagDiv"><?php echo ($vo["department"]); ?></div></td>
                            <td><div class="tagDiv"><?php echo ($vo["usernum"]); ?></div></td>
                            <td><div class="tagDiv"><?php echo ($vo["address"]); ?></div></td>
                            <td><div class="tagDiv"><?php echo (date('Y-m-d H:i:s',$vo["add_time"])); ?></div></td>
                            <td><div class="shopNameDiv"><?php if($vo["ac_status"] == '1' ): ?>审核中<?php endif; if($vo["ac_status"] == '2' || $vo["ac_status"] == '4'): ?>通过<?php endif; if($vo["ac_status"] == '3' ): ?>未通过<?php endif; ?></div></td>
                            <td class="button-column">
                                <a style="width: 60px;" class="label label-sm label-info" title="审核" href="<?php echo U('Access/examine_edit',array('pigcms_id'=>$vo['pigcms_id']));?>">审核</a>
                                <a style="width: 60px;" class="label label-sm label-info" title="删除" href="<?php echo U('Access/examine_del',array('pigcms_id'=>$vo['pigcms_id']));?>">删除</a>
                            </td>
                        ...
                        <tr class="odd"><td class="button-column" colspan="9"><?php echo ($examine_list['pagebar']); ?></td></tr>
                    </div>
                </div>
            </div>
        </div>
