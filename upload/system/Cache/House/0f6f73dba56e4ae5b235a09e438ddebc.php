...
<body class="no-skin">
	...
	<ul class="nav nav-list" style="top: 0px;">
		...
		<li class="hsub <?php if(MODULE_NAME == 'Access' && in_array(ACTION_NAME,array('index','access_edit','group','group_edit','examine','examine_edit'))): ?>open active<?php endif; ?>">
		...
		<ul class="submenu">
			...
			<li <?php if(MODULE_NAME == 'Access' && in_array(ACTION_NAME,array('examine','examine_edit'))): ?>class="active"<?php endif; ?>>

			<a href="<?php echo U('Access/examine');?>">
...
<div class="main-content">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="<?php echo U('Access/examine');?>">智能审核</a>
            </li>
    ...
    <div class="page-content">
        <div class="page-content-area">
            <div class="row">
                <div class="col-xs-12">
                    <form enctype="multipart/form-data" class="form-horizontal" method="post" id="edit_form" action="<?php echo U('Access/examine_edit_do');?>">
                        <input  name="pigcms_id" type="hidden" value="<?php echo ($examine_info['pigcms_id']); ?>"/>
                        <div class="tab-content">
                            <div id="basicinfo" class="tab-pane active">
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">微信名</label></label>
                                    <!--<input class="col-sm-2" size="20" value="<?php echo ($examine_info["nickname"]); ?>" type="text" style="border:none;background:white!important;" readonly="readonly"/>-->
                                    <input class="col-sm-2" size="80" name="nickname" id="title" type="text" value="<?php echo ($examine_info['nickname']); ?>"/>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">真实姓名</label></label>
                                    <!--<input class="col-sm-2" size="20" value="<?php echo ($examine_info["truename"]); ?>" type="text" style="border:none;background:white!important;" readonly="readonly"/>-->
                                    <input class="col-sm-2" size="80" name="name" id="title" type="text" value="<?php echo ($examine_info['name']); ?>"/>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">公司</label></label>
                                    <!--<input class="col-sm-2" size="20" value="<?php echo ($examine_info["company"]); ?>" type="text" style="border:none;background:white!important;" readonly="readonly"/>-->
                                    <input class="col-sm-2" size="80" name="company" id="title" type="text" value="<?php echo ($examine_info['company']); ?>"/>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">部门</label></label>
                                    <!--<input class="col-sm-2" size="20" value="<?php echo ($examine_info["department"]); ?>" type="text" style="border:none;background:white!important;" readonly="readonly"/>-->
                                    <input class="col-sm-2" size="80" name="department" id="title" type="text" value="<?php echo ($examine_info['department']); ?>"/>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">工牌号</label></label>
                                    <!--<input class="col-sm-2" size="20" value="<?php echo ($examine_info["workcard"]); ?>" type="text" style="border:none;background:white!important;" readonly="readonly"/>-->
                                    <input class="col-sm-2" size="80" name="usernum" id="title" type="text" value="<?php echo ($examine_info['usernum']); ?>"/>
                                    <!--<span>&nbsp;&nbsp;&nbsp;&nbsp;工牌图:<img alt="" src="<?php echo ($examine_info["workcard_img"]); ?>" width="60" height="80" style="margin-left:20px;margin-top:-45px;clear:both"></span>-->
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">工牌图</label></label>
                                    <span>&nbsp;&nbsp;&nbsp;&nbsp;<img alt=""  src="./upload/house/<?php echo ($examine_info["workcard_img"]); ?>" width="70" height="110" style="margin-left:20px;margin-top:10px;clear:both"></span>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">地址</label></label>
                                    <!--	<input class="col-sm-2" size="20" value="<?php echo ($examine_info["address"]); ?>" type="text" style="border:none;background:white!important;" readonly="readonly"/>-->
                                    <input class="col-sm-2" size="80" name="address" id="title" type="text" value="<?php echo ($examine_info['address']); ?>"/>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1">审核结果</label>
                                    <label><input value="1" name="ac_status" type="radio" onclick='document.getElementById("d1").style.display="none" ;' <?php if($examine_info['ac_status'] == 1): ?>checked="checked"<?php endif; ?> />&nbsp;&nbsp;审核中</label>
                                    &nbsp;&nbsp;&nbsp;
                                    <label><input value="2" name="ac_status" type="radio"  onclick='document.getElementById("d1").style.display="none" ;' <?php if($examine_info['ac_status'] == 2 || $examine_info['ac_status'] == 4): ?>checked="checked"<?php endif; ?> />&nbsp;&nbsp;通过</label>
                                    &nbsp;&nbsp;&nbsp;
                                    <label><input value="3" name="ac_status" type="radio" onclick='document.getElementById("d1").style.display="block";' <?php if($examine_info['ac_status'] == 3): ?>checked="checked"<?php endif; ?> />&nbsp;&nbsp;未通过</label>
                                </div>
                                <div class="form-group" id="d1" style="display:none">
                                    <label class="col-sm-1"><label for="description">描述</label></label>
                                    <textarea id="description" name="ac_desc"  placeholder="描述内容"><?php echo (htmlspecialchars_decode($examine_info['ac_desc'],ENT_QUOTES)); ?></textarea>
                                </div>
                                <div class="space"></div>
