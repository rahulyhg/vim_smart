...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			<li>
				...
				<a href="<?php echo U('Index/index');?>">业主管理</a>
			</li>
	...
	<div class="page-content">
		<div class="page-content-area">
			...
			<div class="row">
				<div class="col-xs-12">
					<form  class="form-horizontal" method="post" id="edit_form" action="<?php echo U('User/edit');?>">
						<input  name="pigcms_id" type="hidden"  value="<?php echo ($info["pigcms_id"]); ?>"/>
						<input  name="usernum" type="hidden"  value="<?php echo ($info["usernum"]); ?>"/>
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								<div class="form-group">
									<label class="col-sm-1"><label for="usernum">用户编号</label></label>
									<input class="col-sm-2" size="20" value="<?php echo ($info["usernum"]); ?>" type="text" style="border:none;background:white!important;" readonly="readonly">
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="name">业主名称</label></label>
									<input class="col-sm-2" size="20" name="name" id="name" type="text" value="<?php echo ($info["name"]); ?>"/>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="phone">业主联系方式</label></label>
									<input class="col-sm-2" size="20" name="phone" id="phone" type="text" value="<?php echo ($info["phone"]); ?>" />
									<span class="form_tips">多个电话号码以空格分开</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="address">住址</label></label>
									<input class="col-sm-2" size="20" name="address" id="address" type="text" value="<?php echo ($info["address"]); ?>" />
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="water_price">水费总欠费</label></label>
									<input class="col-sm-2" size="10" name="water_price" id="water_price" type="text"  value="<?php echo (floatval($info["water_price"])); ?>"/>
									<span class="form_tips">元 （支持两位小数）</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="electric_price">电费总欠费</label></label>
									<input class="col-sm-2" size="10" name="electric_price" id="electric_price" type="text"  value="<?php echo (floatval($info["electric_price"])); ?>"/>
									<span class="form_tips">元 （支持两位小数）</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="gas_price">燃气费总欠费</label></label>
									<input class="col-sm-2" size="10" name="gas_price" id="gas_price" type="text"  value="<?php echo (floatval($info["gas_price"])); ?>"/>
									<span class="form_tips">元 （支持两位小数）</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="park_price">停车费总欠费</label></label>
									<input class="col-sm-2" size="10" name="park_price" id="park_price" type="text"  value="<?php echo (floatval($info["park_price"])); ?>"/>
									<span class="form_tips">元 （支持两位小数）</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="property_price">物业费总欠费</label></label>
									<input class="col-sm-2" size="10" name="property_price" id="property_price" type="text"  value="<?php echo (floatval($info["property_price"])); ?>"/>
									<span class="form_tips">元 （支持两位小数）</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="park_flag">停车位</label></label>
									<label><input name="park_flag"  type="radio" value="1" <?php if($info["park_flag"] == 1): ?>checked<?php endif; ?> />&nbsp;&nbsp;有</label>
									&nbsp;&nbsp;&nbsp;
									<label><input name="park_flag"  type="radio" value="0" <?php if($info["park_flag"] == 0): ?>checked<?php endif; ?> />&nbsp;&nbsp;无</label>
								</div>
							</div>
						</div>
						<div class="space"></div>
