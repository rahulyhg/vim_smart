    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="<?php echo U('Access/group');?>">区域分组管理</a>
            </li>
        </ul>
    </div>
    <!-- 内容头部 -->
                ...
                <div class="col-xs-12">
                    <div id="shopList" class="grid-view">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if($access_categorys): if(is_array($access_categorys)): $i = 0; $__LIST__ = $access_categorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
                            <td><div class="tagDiv"><?php echo ($vo["ag_id"]); ?></div></td>
                            <td><div class="tagDiv"><?php echo ($vo["ag_name"]); ?></div></td>
                            <td><div class="tagDiv"><?php echo ($vo["village_name"]); ?></div></td>
                            <td><div class="tagDiv"><?php echo ($vo["ag_desc"]); ?></div></td>
                            <td class="button-column">
                                <a style="width: 60px;" class="label label-sm label-info" title="编辑" href="<?php echo U('Access/group_edit',array('ag_id'=>$vo['ag_id']));?>">编辑</a>
                                <a style="width: 60px;" class="label label-sm label-info" title="删除" href="<?php echo U('Access/group_del',array('ag_id'=>$vo['ag_id']));?>">删除</a>
                            </td>
...
<script>
    function CreateCategory(){
        window.location.href = "<?php echo U('Access/group_edit');?>";
    }
</script>
