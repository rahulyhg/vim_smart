        ...
        <div class="page-content-area">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form id="myform" method="post" action="<?php echo U('User/user_import');?>" enctype="multipart/form-data">
						...
						<table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover" width="100%">
							<tr>
								<th width="80">示例表格</th>
								<td><a target="_blank" href="<?php echo ($static_public); ?>file/user_sample.xls" class="button" style="margin-left:0px;">点击下载</a></td>
							</tr>
							<tr>
