    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="<?php echo U('News/cate');?>">号码分类管理</a>
            </li>
        </ul>
    </div>
    <!-- 内容头部 -->
                ...
                <div class="col-xs-12">
                    <div id="shopList" class="grid-view">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <?php if($type_info): if(is_array($type_info)): $i = 0; $__LIST__ = $type_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
                            <td style="text-align: center;"><div class="tagDiv"><?php echo ($vo["ct_id"]); ?></div></td>
                            <td style="text-align: center;"><div class="tagDiv"><?php echo ($vo["ct_name"]); ?></div></td>
                            <td style="text-align: center;"><?php echo ($vo["ct_description"]); ?></td>
                            <td class="button-column" style="text-align: center;">
                                <a style="width: 60px;" class="label label-sm label-info" title="编辑" href="<?php echo U('CommonPhone/ct_edit',array('ct_id'=>$vo['ct_id']));?>">编辑</a>
                                <a style="width: 60px;" class="label label-sm label-info delete" id="delete" title="删除" href="<?php echo U('CommonPhone/ct_del',array('ct_id'=>$vo['ct_id']));?>">删除</a>
                            </td>
                            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                            <?php else: ?>
                            <tr class="odd"><td class="button-column" colspan="4" >您没有添加任何新闻分类。</td></tr><?php endif; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
...
<script>
    ...
    function CreateCategory(){
        window.location.href = "<?php echo U('CommonPhone/ct_edit');?>";
    }
    function Category(){
        window.location.href = "<?php echo U('CommonPhone/cp_index');?>";
    }
</script>
