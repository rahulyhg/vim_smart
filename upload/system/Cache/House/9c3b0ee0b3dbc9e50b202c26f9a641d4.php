                        ...
                        <div class="tab-content">
                            <div id="basicinfo" class="tab-pane active">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="col-sm-2" size="80" name="name" id="title" type="text" readonly="readonly" value="<?php echo ($log_info['name']); ?>"/>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">联系方式</label></label>
                                    <input class="col-sm-2" size="80" name="phone" id="title" type="text" readonly="readonly" value="<?php echo ($log_info['phone']); ?>"/>
                                </div>
                                
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">时间</label></label>
                                    <input class="col-sm-2" size="80" name="opdate" id="title" type="text"  readonly="readonly" value="<?php echo (date('Y-m-d H:i:s',$log_info['opdate'])); ?>"/>
                                </div>
                                
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">设备名称</label></label>
                                    <input class="col-sm-2" size="80" name="ac_name" id="title" type="text"  readonly="readonly" value="<?php echo ($log_info['ac_name']); ?>"/>
                                </div>
                                
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">所属区域</label></label>
                                    <input class="col-sm-2" size="80" name="village_name" id="title" type="text"  readonly="readonly" value="<?php echo ($log_info['ag_name']); ?>"/>
                                </div>
                                
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">所属公司</label></label>
                                    <input class="col-sm-2" size="80" name="company" id="title" type="text"  readonly="readonly" value="<?php echo ($log_info['company_name']); ?>"/>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">证件类型</label></label>
                                    <?php if($log_info["card_type"] == 1): ?><input type="text" class="col-sm-2" value="现场审核" readonly="readonly"/><?php endif; ?>
                                    <?php if($log_info["card_type"] == 2): ?><input type="text" class="col-sm-2" value="门禁卡" readonly="readonly"/><?php endif; ?>
                                    <?php if($log_info["card_type"] == 3): ?><input type="text" class="col-sm-2" value="身份证" readonly="readonly"/><?php endif; ?>
                                    <?php if($log_info["card_type"] == 4): ?><input type="text" class="col-sm-2" value="工作牌" readonly="readonly"/><?php endif; ?>
                                </div>

                                <?php if($log_info["card_type"] != 1 and $log_info["card_type"] != 4 ): ?><div class="form-group">
                                        <label class="col-sm-1"><label for="title">证件号</label></label>
                                        <input class="col-sm-2" size="80" name="usernum" id="title" type="text" readonly="readonly" value="<?php echo ($log_info['usernum']); ?>"/>
                                    </div><?php endif; ?>

                                <?php if($log_info["card_type"] != 1): ?><div class="form-group">
                                ...
                                onclick="window.location.href='http://www.hdhsmart.com/shequ.php?g=House&c=Access&a=operatLog'"
                                    ...
                                    <textarea id="description" name="ac_desc"  placeholder="描述内容"><?php echo (htmlspecialchars_decode($access_info['ac_desc'],ENT_QUOTES)); ?></textarea>
                                </div>-->
                            <div class="space"></div>
                             <div class="clearfix form-actions">
                                    <div class="col-md-offset-3 col-md-9">
                                        <button class="btn btn-info" type="button" onclick="window.location.href='<?php echo U('Access/operatLog');?>'">
