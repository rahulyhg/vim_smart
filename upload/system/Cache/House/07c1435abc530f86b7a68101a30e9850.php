...
<div class="main-content">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="<?php echo U('CommonPhone/cp_index');?>">新闻列表</a>
            </li>
    ...
    <div class="page-content">
        <div class="page-content-area">
            <div class="row">
                <div class="col-xs-12">
                    <form enctype="multipart/form-data" class="form-horizontal" method="post" id="edit_form" action="<?php echo U('CommonPhone/cp_edit');?>">
                        <input  name="cp_id" type="hidden" value="<?php echo ($news_info['cp_id']); ?>"/>
                        <div class="tab-content">
                            <div id="basicinfo" class="tab-pane active">
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">昵称&nbsp;&nbsp;<span style="color:red;">*</span></label></label>
                                    <input class="col-sm-2" size="80" maxlength="12" name="nickname" id="nickname" type="text" required="required" value="<?php echo ($news_info['nickname']); ?>"/>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">联系号码&nbsp;&nbsp;<span style="color:red;">*</span></label></label>
                                    <input class="col-sm-2" size="80" name="iphone" id="iphone" required="required" type="text" value="<?php echo ($news_info['iphone']); ?>"/>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-1"><label for="title">所选分类&nbsp;&nbsp;<span style="color:red;">*</span></label></label>
                                    <select name='ct_id' required="required">
                                        <?php if($ct): ?><option value="">--请选择--</option>
                                        <?php if(is_array($ct)): $i = 0; $__LIST__ = $ct;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><option  value='<?php echo ($cate["ct_id"]); ?>' <?php if($news_info['ct_id'] == $cate['ct_id']): ?>selected<?php endif; ?> ><?php echo ($cate["ct_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            <?php else: ?>
                                            <option value="">--暂无分类可选--</option><?php endif; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1">服务中心</label>
                                    <label><input  value="1" name="s_phone" type="radio" <?php if($news_info['s_phone'] == 1): ?>checked="checked"<?php endif; ?> />&nbsp;&nbsp;是</label>
                                    &nbsp;&nbsp;&nbsp;
                                    <label><input  value="0" name="s_phone" type="radio" <?php if($news_info['s_phone'] != 1): ?>checked="checked"<?php endif; ?> />&nbsp;&nbsp;否</label>
                                    &nbsp;&nbsp;（<span style="color:red;">服务中心电话只能有一个存在</span>）
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="sort">描述</label></label>
                                    <textarea id="description"  name="description"  placeholder="写上一些描述"><?php echo (htmlspecialchars_decode($news_info['description'],ENT_QUOTES)); ?></textarea>
                                </div>
                                <div class="space"></div>
