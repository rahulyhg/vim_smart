                ...
                <div class="col-xs-12">
                    <div id="shopList" class="grid-view">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if($get_log_list['access_list']): if(is_array($get_log_list['access_list'])): $i = 0; $__LIST__ = $get_log_list['access_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
                                    ...
                                    <td class="button-column">
                                        <a style="width:60px;" class="label label-sm label-info" title="详情" href="<?php echo U('Access/accessLog_edit',array('log_id'=>$vo['log_id']));?>">详情</a>
                                        <a style="width:60px;" class="label label-sm label-info" title="删除" href="<?php echo U('Access/accessLog_del',array('log_id'=>$vo['log_id']));?>">删除</a>
                                    </td>
                        ...
                        <tr class="odd"><td class="button-column" colspan="9"><?php echo ($get_log_list['pagebar']); ?></td></tr>
                    </div>
                </div>
            </div>
        </div>
