    ...
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                ...
                <a href="<?php echo U('Access/group');?>">设备类型管理</a>
        ...
        <div class="page-content-area">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <form  class="form-horizontal" method="post" id="edit_form" action="<?php echo U('Access/deviceType_edit_do');?>">

                        <input type="hidden" value="<?php echo ($actype_id); ?>" name='actype_id'/>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="basicinfo" class="tab-pane active">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="col-sm-2" size="20" name="actype_name" id="actype_name" type="text" value="<?php echo ($device_info["actype_name"]); ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="actype_value" name="actype_value"  placeholder="描述内容"><?php echo (htmlspecialchars_decode($device_info["actype_value"],ENT_QUOTES)); ?></textarea>
