    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="<?php echo U('CommonPhone/cp_index');?>">服务号码列表</a>
            </li>
        </ul>
    </div>
    <!-- 内容头部 -->
                ...
                <div class="col-xs-12">
                    <div id="shopList" class="grid-view">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if($news_list): if(is_array($news_list['news_list'])): $i = 0; $__LIST__ = $news_list['news_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
                            <td style="text-align: center;"><div class="tagDiv"><?php echo ($vo["cp_id"]); ?></div></td>
                            <td style="text-align: center;"><div class="tagDiv"><?php echo ($vo["nickname"]); ?></div></td>
                            <td style="text-align: center;"><div class="shopNameDiv"><?php echo ($vo["iphone"]); ?></div></td>
                            <td style="text-align: center;"><div class="tagDiv"><?php echo ($vo["ct_name"]); ?></div></td>
                            <td style="text-align: center;"><div class="tagDiv"><?php if($vo["s_phone"] == '1'): ?>是<?php else: ?>否<?php endif; ?></div></td>
                            <td style="text-align: center;"><div class="shopNameDiv"><?php echo ($vo["description"]); ?></div></td>
                            <td class="button-column" style="text-align: center;">
                                <a style="width: 60px;" class="label label-sm label-info" title="编辑" href="<?php echo U('CommonPhone/cp_edit',array('cp_id'=>$vo['cp_id']));?>">编辑</a>
                                <a style="width: 60px;" class="label label-sm label-info delete" title="删除" href="<?php echo U('CommonPhone/cp_del',array('cp_id'=>$vo['cp_id']));?>">删除</a>
                            </td>
                            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                            <?php else: ?>
                            <tr class="odd"><td class="button-column" colspan="7" >您没有添加任何号码。</td></tr><?php endif; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
...
<script>
    function CreateCategory(){
        window.location.href = "<?php echo U('CommonPhone/cp_edit');?>";
    }
    function Category(){
        window.location.href = "<?php echo U('CommonPhone/ct_index');?>";
    }
    $(function(){
