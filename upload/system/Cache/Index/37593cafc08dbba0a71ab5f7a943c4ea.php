...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo ($static_path); ?>css/login.v7e870f72.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo ($static_path); ?>css/login-section.vfa22738e.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo ($static_path); ?>css/qrcode.v74a11a81.css" />
...
<body id="login" class="theme--www" style="position: static;">
	...
	<div class="site-body pg-login cf">
	    <div class="promotion-banner">
	        <img src="<?php echo ($static_path); ?>css/img/web_login/<?php echo mt_rand(1,4);?>.jpg" width="480" height="370">    
	    </div>
