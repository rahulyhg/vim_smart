...
<html>
<head>
    <title>微信版介绍页 | <?php echo ($config["site_name"]); ?></title>
    <meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
    <link rel="stylesheet" href="<?php echo ($config["site_url"]); ?>/tpl/Static/default/weixin/weixin.css"/>
</head>
<body>
<div id="header">
    <a class="site-logo" href="<?php echo ($config["site_url"]); ?>"><img src="<?php echo ($config["site_logo"]); ?>" style="height:43px;"/></a>
    <div id="menu">
    ...
    <div id="web-tip" class="hide">
        <div id="arrow"></div>
        手机浏览器访问<?php echo ($_SERVER["SERVER_NAME"]); ?>，无需安装，立刻访问
    </div>
</div>
        ...
        <div class="fixed">
            <div class="top-1">
                ...
                <div id="qrcode-wrapper">
                    <div class="qrcode" style="background-image:url(<?php echo ($config["wechat_qrcode"]); ?>);background-size:100%;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='<?php echo ($config["wechat_qrcode"]); ?>',sizingMethod='scale');"></div>
                    <div id="btn">
...
<script src="<?php echo ($config["site_url"]); ?>/tpl/Static/default/weixin/jquery.js"></script>
<script src="<?php echo ($config["site_url"]); ?>/tpl/Static/default/weixin/rotate.js"></script>
<script src="<?php echo ($config["site_url"]); ?>/tpl/Static/default/weixin/weixin.js"></script>
</body>
</html>