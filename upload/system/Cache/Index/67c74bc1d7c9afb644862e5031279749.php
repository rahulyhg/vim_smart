...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="body"> 
									...
									<div id="scroll_box">
										...
										<div class="div">
											<ul class="scroll_list">
												...
												<?php else: ?>	
													<?php $index_today_fav = D("Adver")->get_adver_by_key("index_today_fav","6");if(is_array($index_today_fav)): $i = 0;if(count($index_today_fav)==0) : echo "<div class=\"index_today_fav_empty\">列表为空</div>" ;else: foreach($index_today_fav as $key=>$vo): ++$i;?><li>
															<div class="scroll_article_left_top">
																<a href="<?php echo ($vo["url"]); ?>" target="_blank">
																	<img src="<?php echo ($vo["pic"]); ?>" style="width:100%;height:100%;"/>
																</a>
															</div>
														</li><?php endforeach; endif; else: echo "<div class=\"index_today_fav_empty\">列表为空</div>" ;endif; endif; ?>
											</ul>
										</div>
									</div>
								</div>
			...
			<?php if($near_shop_list): ?><article class="nearby cf">
										...
										<div class="index-slider ui-slider log-mod-viewed">
											...
											<div class="head ccf">
												<ul class="trigger-container ui-slider__triggers mt-slider-trigger-container cf">
													<?php $near_shop_adver_list = D("Adver")->get_adver_by_key("index_near_shop","3");if(is_array($near_shop_adver_list)): $i = 0;if(count($near_shop_adver_list)==0) : echo "<div class=\"index_near_shop_empty\">列表为空</div>" ;else: foreach($near_shop_adver_list as $key=>$vo): ++$i;?><li class="mt-slider-trigger <?php if($i == 1): ?>mt-slider-current-trigger<?php endif; ?>"></li><?php endforeach; endif; else: echo "<div class=\"index_near_shop_empty\">列表为空</div>" ;endif; ?>
												</ul>
											</div>
											<ul class="content">
