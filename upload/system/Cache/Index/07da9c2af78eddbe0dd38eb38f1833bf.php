...
<div class="dcs"><h1><?php echo ($now_city_name); ?></h1><a href="/index.php?g=Index&c=Changecity&a=index">切换城市</a></div>
		...
		<div class="banner activity_banner" <?php if($now_activity['bg_color']): ?>style="background-color:<?php echo ($now_activity["bg_color"]); ?>"<?php endif; ?>>
			<div class="banner_img">
				...
				<div class="banner_list">
					...
					<div id="divdown1">
						<div class="banner_list_datad" id="time_d"><?php echo ($time_array['d']); ?></div><div class="banner_list_icon_txt">天</div>
