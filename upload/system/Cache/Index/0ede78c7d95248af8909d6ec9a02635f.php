	...
	<div class="content" style="margin:0px auto;border:none;padding:30px;overflow:hidden;width:270px;">
	    <div class="component-login-section component-login-section--page mt-component--booted" >
		    <div class="origin-part theme--www">
			    ...
			    <p class="signup-guide">还没有账号？<a href="<?php echo U('Login/reg',array('referer'=>$url_referer));?>" target="_top">免费注册</a></p>        
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#J-login-form").submit(function(){
				...
				$.post("<?php echo U('Index/Login/index');?>", {'phone':phone, 'pwd':pwd}, function(data){
					if (data.error_code) {
						...
						<?php else: ?>
							setTimeout("window.top.location.href=window.top.location.href", 1000);<?php endif; ?>
					}
				}, 'json');
				return false;
			});
			...
			$('.oauth__link--weixin').click(function(){
				art.dialog.open("<?php echo U('Index/Recognition/see_login_qrcode',array('scriptName'=>$_GET['scriptName']));?>",{
					init: function(){
