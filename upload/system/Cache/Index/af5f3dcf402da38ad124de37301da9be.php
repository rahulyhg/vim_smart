...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><?php echo ($now_activity["name"]); ?> - 一元夺宝 - <?php echo ($config["site_name"]); ?></title>
			...
			<div class="oneyuan cf">
				<div class="navBreadCrumb cf">
					<ul class="cf">
						...
						<li>
							<div class="navBreadCrumb_txt"><a href="<?php echo ($config["site_url"]); ?>/activity/1/all">一元夺宝&nbsp;&nbsp;&gt;</a></div>
						</li>
				...
				<div class="product_table cf">
					...
					<div class="product_list">
						<div class="product_list_top">
							...
							<div class="product_dec"><?php echo ($now_activity["title"]); ?></div>
							<div class="cf">
								<div class="product_number cf">
									<div class="product_number_top">总需人次<span><?php echo ($now_activity["all_count"]); ?></span></div>
