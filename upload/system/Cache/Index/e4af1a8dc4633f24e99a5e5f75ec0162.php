...
<div class="article">
  ...
  <div class="shop_shop_list">
	...
	<div class="tab">
		<div class="tab_title">
			<a href="/merreviews/<?php echo ($merid); ?>.html" class="on">全部</a>
			<a href="/merreviews/<?php echo ($merid); ?>.html?st=1">好评</a>
			<a href="/merreviews/<?php echo ($merid); ?>.html?st=2">中评</a>
			<a href="/merreviews/<?php echo ($merid); ?>.html?st=3">差评</a>
			<a href="/merreviews/<?php echo ($merid); ?>.html?st=4">有图</a>
		</div>
	</div>
	<div class="content">
