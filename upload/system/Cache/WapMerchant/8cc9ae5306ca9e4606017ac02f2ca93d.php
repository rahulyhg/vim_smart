...
<style style="text/css">
 ...
 p.staff-list-info{line-height: 25px;}
	...
	<header class="pigcms-header mm-slideout">
		...
		<a  href="<?php echo U('Index/staff_add');?>" id="pigcms-header-right">添加店员</a>
	</header>
...
<div id="slide_menu">
	...
	<div id="staff-list-wrapper" class='pigcms-main'>
		<div id="staff-list-scroller">
			<ul id="staff-list-ul" >
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><li class="staff-list-li">
					<p class="staff-list-info">
						<span class="staff-name" style='width:22px;'><span style='color:red'>(<?php echo ($i); ?>)</span></span>
						&nbsp;&nbsp;电话：<a href="tel:<?php echo ($list["tel"]); ?>" class="staff-phone"><?php echo ($list["tel"]); ?></a>
						<br/>
						&nbsp;店员账号：<span class="staff-type"><?php echo ($list["username"]); ?></span>
						<br/>
						&nbsp;店员姓名：<span class="staff-type"><?php echo ($list["name"]); ?></span>
						<br/>
						&nbsp;所属店铺：<span class="staff-type"><?php echo ($list["storename"]); ?></span>
					</p>
					<div class="staff-list-operation">
						<a href="<?php echo U('Index/staff_edit',array('staff_id'=>$list['id']));?>" class="staff-operation-remove" onclick="checkDel(this)">
							<i class="iconfont icon-edit"></i>
							<span> 编辑</span>
						</a><br/>
						<a href="<?php echo U('Index/loginStaff',array('id'=>$list['id'],'store_id'=>$list['store_id']));?>" class="staff-operation-remove">
							<i class="iconfont icon-loading"></i>
							<span> 登陆</span>
						</a><br/>
						<a href="<?php echo U('Index/staff_dell',array('staff_id'=>$list['id']));?>" class="staff-operation-remove" onclick="delcfm()">
