	...
	<div class="item-list-wrap">
		<div id="item-list-wrapper" class="pigcms-main" style="padding-top: 10px;">
			...
			<ul id="item-list-ul" style="margin-bottom: 70px;">
					...
					<?php if(!empty($sort_list)): if(is_array($sort_list)): $i = 0; $__LIST__ = $sort_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sbv): $mod = ($i % 2 );++$i;?><li class="item-list-container">
						<div class="item-detail" style="width: 95%;">
						<p class="item-name">分类名称：<?php echo ($sbv['sort_name']); ?></p>
						<?php if($sbv['week_str']): ?><p class="item-price-sell">
						<span class="item-price">星期几显示：<strong><?php echo ($sbv['week_str']); ?></strong></span>
						</p><?php endif; ?>
						...
						<a class="item-operation" data-itemid="<?php echo ($sbv['sort_id']); ?>" onclick="item_delete_St(this)"><i class="iconfont icon-shanchu" style="color:#cd0009"></i><span>删除</span></a>
						<a href="<?php echo U('Index/sort_add',array('store_id'=>$sbv['store_id'],'stid'=>$sbv['sort_id']));?>" class="item-operation"><i class="iconfont icon-edit" style="color:#449fc6"></i><span>编辑</span></a></div>
						<div class="clearfix"></div>
						</div>
						<div class="clearfix"></div>
		...
		<div class="item-list-footer">
			<a href="<?php echo U('Index/sort_add',array('store_id'=>$now_store['store_id']));?>" class="footer-operation">
