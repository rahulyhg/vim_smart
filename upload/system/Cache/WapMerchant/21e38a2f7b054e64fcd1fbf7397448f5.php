	...
	<div class="order-list-wrap">
		...
		<div class="pigcms-container">
				...
				<ul id="order-list-ul" class="mm-list">
			        ...
			        <li><a class="mm-subopen"></a><a href="<?php echo U('Index/gpro');?>" class="second"><?php echo ($config["group_alias_name"]); ?>商品</a></li>

					<li><a class="mm-subopen"></a><a href="<?php echo U('Index/mpro');?>" class="second"><?php echo ($config["meal_alias_name"]); ?>商品</a></li>
