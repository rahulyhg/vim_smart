...
<body>
	...
	<form class="pigcms-form" method="post" action="" onsubmit="return checkSubmit();return false">
		...
		<div class="pigcms-container">
			...
			<?php if(is_array($store)): $i = 0; $__LIST__ = $store;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$store): $mod = ($i % 2 );++$i;?><option value="<?php echo ($store["store_id"]); ?>"><?php echo ($store["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
