...
<body>
	...
	<div class="container container-fill" style='padding-top:50px'>
		...
		<form class="pigcms-form" method="post" enctype="multipart/form-data" class="form-horizontal" method="post" id="edit_form" action="<?php echo U('Index/mpackageadd');?>">
			<div class="pigcms-container">
				<p class='pigcms-form-title'>套餐标示<br/>名称：</p>
				<input type="text" class="pigcms-input-block" name="title" id="title" placeholder="填上套餐标示名称" value="<?php echo ($mpackage['title']); ?>">
				<div style="clear:both"></div>
			</div>
			<div class="pigcms-container">
				<p class='pigcms-form-title'>简短描述：</p>
				<textarea  id="description" name="description"  placeholder="写上一些此套餐的简短描述" rows="5" class="pigcms-textarea"><?php echo (htmlspecialchars_decode($mpackage['description'],ENT_QUOTES)); ?></textarea>
				<div style="clear:both"></div>
			</div>
