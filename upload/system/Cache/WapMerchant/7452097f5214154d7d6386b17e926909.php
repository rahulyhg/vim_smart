	...
	<div class="order-list-wrap">
		...
		<div class="pigcms-container">
				...
				<ul id="order-list-ul" class="mm-list">
			        ...
			        <li><a class="mm-subopen"></a><a href="<?php echo U('Index/gorder');?>" class="second"><?php echo ($config["group_alias_name"]); ?>订单</a></li>

					<li><a class="mm-subopen"></a><a href="<?php echo U('Index/morder');?>" class="second"><?php echo ($config["meal_alias_name"]); ?>订单</a></li>
					<li id="sorder"><a class="mm-subopen"></a><a href="<?php echo U('Index/sorder');?>" class="second">扫码订单</a></li>
				</ul>
