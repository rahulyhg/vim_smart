...
<html>
	...
	<body>
		...
		<script>var location_url = '<?php echo ($url); ?>';layer.open({title:['成功提示','background-color:#8DCE16;color:#fff;'],content:'<?php echo ($msg); ?>',btn: ['确定'],end:function(){location.href=location_url;}});</script>
	</body>
