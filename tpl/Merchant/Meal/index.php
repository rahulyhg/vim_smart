						...
						<table class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="button-column" width="140">餐台管理</th>
								</tr>
							</thead>
							<tbody>
								<if condition="$store_list">
									<volist name="store_list" id="vo">
										<tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
											...
											<td class="button-column">
												<if condition="$vo['store_type'] neq 2">
												<a style="width: 60px;" class="label label-sm label-info" title="编辑餐台" href="{pigcms{:U('Meal/table',array('store_id'=>$vo['store_id']))}">编辑餐台</a>
												</if>
											</td>
										</tr>
									</volist>
