						...
						<div class="grid-view">
							<form class="form" method="post" action="" target="_top" enctype="multipart/form-data">
								<div class="content">
									...
									颜色：
									<input type="text" name="vipnamecolor" id="vipnamecolor" value="{pigcms{$card.vipnamecolor}" class="px color" style="width: 80px; background:{pigcms{$card.vipnamecolor}; color: rgb(255, 255, 255);" onblur="document.getElementById('vipname').style.color=document.getElementById('vipnamecolor').value;">
									</td>
									</tr>
									<tr>
									<td colspan="2">最低积分要求：
									...
									<a href="###" onclick="upyunPicUpload('logo',1000,600,'member_card_set')" class="a_upload">上传</a> 
									...
									<td colspan="2">自己设计背景：
										...
										<a href="###" onclick="upyunPicUpload('bgs',1000,600,'member_card_set')" class="a_upload">上传</a> <a href="###" onclick="viewImg('bgs')">预览</a> 背景图
									</td>
									</tr>
									<tr>
									<td colspan="2">
									...
									<!--th width="303" rowspan="5" valign="top">
										<div class="vipcard">
											...
											<br />
											<a href="###" onclick="upyunPicUpload('qiandao2',700,420,'member_card_set')" class="a_upload">上传</a> 
								...
								<tr>
									<td align="center">
										...
										<a href="###" onclick="upyunPicUpload('news2',700,420,'member_card_set')" class="a_upload">上传</a> <a href="###" onclick="viewImg('news2')">预览</a>
									</td>
									<td align="center">
										...
										<a href="###" onclick="upyunPicUpload('vippower2',700,420,'member_card_set')" class="a_upload">上传</a> <a href="###" onclick="viewImg('vippower2')">预览</a>
									</td>
									<td align="center">
										...
										<a href="###" onclick="upyunPicUpload('payre2',700,420,'member_card_set')" class="a_upload">上传</a> <a href="###" onclick="viewImg('payre2')">预览</a>
									</td>
									<td align="center">
										...
										<a href="###" onclick="upyunPicUpload('shopping2',700,420,'member_card_set')" class="a_upload">上传</a> <a href="###" onclick="viewImg('shopping2')">预览</a>
									</td>
								 </tr>
								<tr>
								<td></td>
								...
								<td align="center">
									...
									<a href="###" onclick="upyunPicUpload('user2',700,420,'member_card_set')" class="a_upload">上传</a> <a href="###" onclick="viewImg('user2')">预览</a>
								</td>
								<td align="center">
									...
									<a href="###" onclick="upyunPicUpload('info2',700,420,'member_card_set')" class="a_upload">上传</a> <a href="###" onclick="viewImg('info2')">预览</a>
								</td>
								<td align="center">
									...
									<a href="###" onclick="upyunPicUpload('addr2',700,420,'member_card_set')" class="a_upload">上传</a> <a href="###" onclick="viewImg('addr2')">预览</a>
								</td>
								<td align="center">
									...
									<a href="###" onclick="upyunPicUpload('rech2',700,420,'member_card_set')" class="a_upload">上传</a> <a href="###" onclick="viewImg('rech2')">预览</a>
								</td>
								</tr>
								<tr>
