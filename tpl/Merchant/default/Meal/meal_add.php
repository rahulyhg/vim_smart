							...
							<form enctype="multipart/form-data" class="form-horizontal" method="post">
								...
								<div class="form-group">
									<label class="col-sm-1">
                                        <label for="unit">
                                           {pigcms{$now_store['store_type']===3 ? "logo":"商品图片"}
                                        </label>
                                    </label>
                                ...
                                <div id="image_preview_box"></div><!-- 图片容器-->
...
<!--                                    logo-->
                                    ...
                                    <div id="image_preview_box2"></div><!-- 图片容器-->

                                    <!--                                    联系方式-->
                                    <div class="form-group">
                                        <label class="col-sm-1"><label >咨询热线</label></label>
                                        <input class="col-sm-1" size="20" name="contact[]"  type="text" value="{pigcms{$now_meal.contact}"/>
                                        <span class="form_tips">必填。</span>
                                    </div>
                                    ...
                                    <div class="form-group title">
                                        <label class="col-sm-1"><label >预约标题</label></label>
...
<!--描述-->
								...
								<div class="form-group">
									<label class="col-sm-1"><label for="unit">描述</label></label>
...
$('input[name="is_service"]').click(function(){
