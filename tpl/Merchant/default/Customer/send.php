						...
						<div class="tab-content">
							...
							<div class="form-group js-show-score" >
								<label class="col-sm-2">
									<label for="phone">您当前需要扣除的积分为：<label id="js-deduct">10</label>分</label>
									<label for="phone">您当前的积分为：<label id="js-current-score">{pigcms{$now_merchant.plat_score}</label>分</label>
								</label>
							</div>
							<div class="form-group js-show-score" >
								...
								<a id="show_score_frame" class="btn btn-sm btn-success"  href="javascript:void(0);">兑换</a>（一个首页排序储存值可以兑换 {pigcms{$config.customer_one_score_exchange}积分）
