...
<div class="main-content">
	...
	<link href="{pigcms{$static_path}plugins/css/iCheck/custom.css" rel="stylesheet">
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-content">
								...
								<form action='{pigcms{:U("Cashier/employersDel")}' class="employersDelAll" method="post">
    	...
    	<div class="modal-dialog modal-lg">
        	<div class="modal-content">
                ...
                <div class="modal-body clearfix">
					<form id="employersForm" class="form" action='{pigcms{:U("Cashier/merchantOperat")}' method="post">
						<div class="col-lg-12">
							<div class="ibox">
...
<!-- FooTable -->
<script src="{pigcms{$static_path}plugins/js/footable/footable.all.min.js"></script>
<!-- iCheck -->
<script src="{pigcms{$static_path}plugins/js/iCheck/icheck.min.js"></script>
<!-- Jquery Validate -->
<script src="{pigcms{$static_path}plugins/js/validate/jquery.validate.min.js"></script>
<!-- Page-Level Scripts -->
<script>
	...
	!function(a,b){
		...
		employers.init = function(){
			...
			b('.formSubmit').click(function(){
				if(b('#account').val() != ''){
					$.post('{pigcms{:U("Cashier/merchant")}',{account:b('#account').val()},function(re){
						if(re.status == 0){
			...
			b('.status-checkbox').change(function(){
				...
				$.post('{pigcms{:U("Cashier/employersField")}',{eid:i,status:s},function(re){
					if(re.status == 0){
						swal("错误", re.msg+" :)", "error");
					}
				},'json');
			...
			b('.employersDel').click(function(){
				...
				swal({
					...
					$.post('{pigcms{:U("Cashier/employersDel")}',{eid:c.attr('data-id')},function(re){
						if(re.status == 0){
							swal("错误", re.msg+" :)", "error");
						}else{
