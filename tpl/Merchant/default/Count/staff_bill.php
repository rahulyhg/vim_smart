													...
													<if condition="$order_list">
														<volist name="order_list" id="vo">
															<tr>
																...
																<td><if condition="$vo['total_price'] gt 0">{pigcms{$vo.total_price|round=2}<else />{pigcms{$vo.price|round=2}</if></td>
																<td>{pigcms{$vo.balance_pay}</td>
																<td>{pigcms{$vo.payment_money}</td>
																<td>{pigcms{$vo.merchant_balance}</td>
																<td><strong style="color: green">{pigcms{$vo.cash|round=2}</strong></td>
														...
														<tr class="even">
															<td colspan="18">
																本页总金额：<strong style="color: green">{pigcms{$total|round=2}</strong>　本页已出账金额：<strong style="color: red">{pigcms{$finshtotal|round=2}</strong><br/> 
																总金额：<strong style="color: green">{pigcms{$alltotal+$alltotalfinsh|round=2}</strong>　总已出账金额：<strong style="color: red">{pigcms{$alltotalfinsh|round=2}</strong><br/>
															</td>
														</tr>
														<tr class="odd">
