...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
        ...
        <div id="nav" class="mainnav_title">
                <ul>
                        <a href="{pigcms{:U('Count/bill',array('mer_id'=>$mer_id, 'type' => 'meal'))}" <if condition="$type eq 'meal'">class="on"</if>>快店账单</a>
                        <a href="{pigcms{:U('Count/bill',array('mer_id'=>$mer_id, 'type' => 'group'))}" <if condition="$type eq 'group'">class="on"</if>>团购账单</a>
                        <a href="{pigcms{:U('Count/bill',array('mer_id'=>$mer_id, 'type' => 'weidian'))}" <if condition="$type eq 'weidian'">class="on"</if>>微店账单</a>
                        <a href="{pigcms{:U('Count/bill',array('mer_id'=>$mer_id, 'type' => 'appoint'))}" <if condition="$type eq 'appoint'">class="on"</if>>预约账单</a>
                        ...
                        <a href="{pigcms{:U('Count/bill',array('mer_id'=>$mer_id, 'type' => 'store'))}" <if condition="$type eq 'store'">class="on"</if>>收银账单</a>
                </ul>
        </div>
