						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								...
								<div class="form-group">
									...
									<if condition=" $goodInfo['gcat_id'] eq $vo['gcat_id'] || !$goodInfo['gcat_id']">
									<input type='radio' value="{pigcms{$vo['gcat_id']}" name="gcat_id" 
										<if condition=" $goodInfo['gcat_id'] eq $vo['gcat_id'] || !$goodInfo['gcat_id']">checked</if> jstips='请添加商品分类'> {pigcms{$vo['gcat_name']} &nbsp;
										</if>
									</volist>
								</div>
								<div class="form-group">
