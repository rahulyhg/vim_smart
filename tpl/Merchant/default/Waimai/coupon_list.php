                    ...
                    <div class="tab-content col-xs-12">               
                        <div id="basicinfo" class="tab-pane active">
                            ...
                            <thead>
                                <tr>
                                    <th width="5%">编号</th>
                                    <th width="10%">店铺名称</th>
                                    <th width="10%">优惠卷名称</th>
                                    <th width="10%">优惠卷描述</th>
                                    <th width="8%">优惠卷金额</th>
                                    <th width="8%">订单金额</th>
                                    <th width="8%">开始时间</th>
                                    <th width="8%">结束时间</th>
                        ...
                        <div id="txtstore" class="tab-pane">
                                ...
                                <div style="margin: 0;padding: 0;border: 0;font: inherit;font-size: 100%;vertical-align: baseline;display: block;cursor: pointer;-webkit-user-select: none;">
                                    <div style="margin: 0;padding: 0;border: 0;font: inherit;font-size: 100%;vertical-align: baseline;display: block;cursor: pointer;-webkit-user-select: none;">
                                        <div style="margin-top:-5px;-webkit-tap-highlight-color: transparent;position: relative;height: 60px;color: #fff;">
                                            <h2 style="font-size: 18px;line-height: 60px;padding-left: 10px;float: left;display: block;margin: 0;padding: 0;border: 0;vertical-align: baseline;margin-left: 10px;font-weight:bold;" id="_title">优惠卷标题</h2>
                                        </div>
                            ...
                            <div class="col-xs-8">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2">优惠卷金额:</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="form_tips">优惠卷使用最低消费！</span>
                                </div>
                                <div class="form-group">
                                    ...
                                    <span class="form_tips">优惠卷开始使用时间！</span>
                                </div>
                                <div class="form-group">
                                    ...
                                    <span class="form_tips">优惠卷结束使用时间！</span>
                                </div>
