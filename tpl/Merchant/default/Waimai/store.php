                                ...
                                <div class="tab-content">
                                    <div id="basicinfo" class="tab-pane active">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <span><label><input id='deliver_type' name="deliver_type" <if condition="$store['deliver_type'] eq 0 ">checked="checked"</if> value="0" type="radio"></label>&nbsp;<span>系统配送</span>&nbsp;</span>
