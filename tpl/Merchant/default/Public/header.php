...
<link rel="stylesheet" href="{pigcms{$static_path}layer/skin/layer.css" type="text/css">
<link rel="stylesheet" href="{pigcms{$static_path}layer/skin/layer.ext.css" type="text/css">
<script type="text/javascript" charset="utf-8" src="{pigcms{$static_path}layer/layer.js"></script>
