                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio" style="margin-left: 20px;margin-top: -10px;">
                                        ...
                                        <span>当前余额<input type="text" name="money" value="{pigcms{$money}元" style="border:none;background:white!important;" readonly="readonly"/>&nbsp;<a href="{pigcms{:U('Promote/recharge')}" class="weui_btn weui_btn_mini weui_btn_primary" id="Recharge">账户充值</a> </span>
                                    </div>
                                </div>
                                <div class="form-group">
