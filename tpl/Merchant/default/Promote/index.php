			...
			<div class="row">
				<div class="form-group">
					...
					<div style="padding-top:4px;line-height:24px;">
						<a href="{pigcms{$config.site_url}/index.php?g=Index&c=Recognition&a=see_qrcode&type=merchant&id={pigcms{$now_merchant.mer_id}&img=1" class="see_qrcode">查看二维码</a>&nbsp;&nbsp;&nbsp;
						<a href="{pigcms{$config.site_url}/index.php?g=Index&c=Recognition&a=get_merchant_qrcode&mer_id={pigcms{$now_merchant.mer_id}&name={pigcms{$now_merchant.name}&img_info={pigcms{$now_merchant.img_info}" class="see_qrcode">商户转账二维码</a>
					</div>
				</div>
				<div class="col-xs-12">
