					...
					<form enctype="multipart/form-data" class="form-horizontal" method="post" id="edit_form">
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								...
								<if condition="$pay_offline_open eq 1 AND $now_merchant.is_close_offline eq 1">
									<div class="form-group">
								...
								<div class="form-group">
									...
									<if condition="$now_merchant['money']">
									<input value="{pigcms{$now_merchant.money}" type="text" style="border:none;background:white!important;color:red;max-width:150px" readonly="readonly"/>元
									<else/>
									<input value="0.01" type="text" style="border:none;background:white!important;color:red;max-width:150px" readonly="readonly"/>元
									</if>		
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div id="upload_pic_box">
										<ul id="upload_img_ul">
											<if condition="$now_merchant['img']">
											<li class="upload_img_li" style="list-style:none"><img src="{pigcms{$now_merchant.img.url}"/><input type="hidden" name="img" value="{pigcms{$now_merchant.img.title}"/><br/><a href="#" onclick="deleteImg('{pigcms{$now_merchant.img.title}',this);return false;">[ 删除 ]</a></li>
											</if>
										</ul>
									</div>
								</div>
