						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								...
								<div class="form-group">
									...
									<if condition="$bind['alias']">
									<img width="158" height="158" src="http://open.weixin.qq.com/qr/code/?username={pigcms{$bind['alias']}"/>
									<else />
									<img width="158" height="158" src="{pigcms{$bind['qrcode_url']}"/>
									</if>
									</div>
								</div>
							</div>
