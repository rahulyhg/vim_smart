...
<div class="content">
	...
	<div class="alert alert-success alert-dismissable">
		...
		<if condition="$_SESSION['is_syn'] neq 1">		温馨提示：本功能使用了模板消息中的"订单发货提醒"模板消息和"中奖结果通知"模板消息,模板消息编号为OPENTM200565259和TM00695。<br/>		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		开通微信支付功能的公众号在使用此功能的时候可以在"基本设置——微信模板消息"中配置对应的模板消息。<br/><br/>
		</if>
		</if>		活动算法：活动开始以后，当商品的最后一元被购买，此时活动就会开奖。中奖号码的计算是取最后一元的购买者前100条全站记录（这个全站记录是指所有购买一元购的人的记录，并不是单独一个活动的记录）的时间转化成数字（例如21:45:32.123转化后就是214532123）的总和，用这个总和与设置的价钱取余数，这余数加上100000组成最终的幸运号码，（当全站记录没有100条时，则有几条取几条）。
	</div>
	<div class="msgWrap">
...
(function() {
  ...
  hm.src = "//hm.baidu.com/hm.js?0836792a1d362ac816fb4a3745ab2f92";
