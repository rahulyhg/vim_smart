...
.pigcms-form-titlex{
	...
	<form class="pigcms-form" method="post" action="{pigcms{:U('Index/storemeal',array('store_id'=>$now_store['store_id']))}">
		...
		<div class="pigcms-container">
			...
			<input class="pigcms-input-block" size="10" maxlength="10" name="deposit" id="Config_deposit" type="text" value="{pigcms{$store_meal.deposit}" style="float:left; width:55%;"/><span style="line-height:3;">元</span>
		</div><div style="clear:both"></div>
		<div class="pigcms-container">
			<p class='pigcms-form-title'>人均消费</p>
			<input class="pigcms-input-block" size="10" maxlength="10" name="mean_money" id="Config_mean_money" type="text" value="{pigcms{$store_meal.mean_money}" style="float:left; width:55%;"/><span style="line-height:3;">元</span><span class="required">*</span>
		</div><div style="clear:both"></div>
		...
		<div class="pigcms-container">
			...
			<input class="pigcms-input-block" size="10" maxlength="10" name="basic_price" id="Config_basicprice" type="text" value="{pigcms{$store_meal.basic_price}" style="float:left; width:55%;"/><span style="line-height:3;">元</span><span class="required">*</span>
		...
		<div class="pigcms-container">
			...
			<input class="pigcms-input-block" size="10" maxlength="10" name="delivery_fee" id="Config_delivery_fee" type="text" value="{pigcms{$store_meal.delivery_fee}" style="float:left; width:55%;"/><span style="line-height:3;">元</span><span class="required">*</span>
		...
		<div class="pigcms-container">
			...
			<input class="pigcms-input-block" size="10" maxlength="10" name="send_time" id="Config_send_time" type="text" value="{pigcms{$store_meal.send_time}" style="float:left; width:55%;"/><span style="line-height:3;">分钟</span>
		...
		<div class="pigcms-container">
			...
			<input class="pigcms-input-block" size="10" maxlength="10" name="delivery_radius" id="Config_delivery_radius" type="text" value="{pigcms{$store_meal.delivery_radius}" style="float:left; width:50%;"/><span style="line-height:3;">公里</span>
		</div><div style="clear:both"></div>
		<div class="pigcms-container">

			<p class='pigcms-form-title'>配送区域</p>

			<textarea class="pigcms-textarea" rows="4" name="delivery_area" id="Config_area" style="float:left; width:55%;">{pigcms{$store_meal.delivery_area}</textarea>
		</div><div style="clear:both"></div>
		...
		<div class="pigcms-container" style="width:85%; float:right;">
		...
		<p class='pigcms-form-title'>会员优惠</p>
			...
			<volist name="levelarr" id="vv">
			  ...
			  <div class="pigcms-container">
				...
				<p class="pigcms-form-title">{pigcms{$vv['lname']}：<br/>优惠类型：&nbsp;</p>

				<select name="leveloff[{pigcms{$vv['level']}][type]" style="margin-left: 10px;width: 25%; float:left; height:40px;">
				...
				<input name="leveloff[{pigcms{$vv['level']}][vv]" type="text" value="{pigcms{$vv['vv']}" placeholder="请填写一个优惠值数字" onKeyUp="value=value.replace(/[^1234567890]+/g,'')" style="width: 30%;padding-left:7px; float:left; margin-left:5px; height:31px;"/>
