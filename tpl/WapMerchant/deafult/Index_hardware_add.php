...
<body>
	...
	<form class="pigcms-form" method="post" action="" onSubmit="return checkSubmit2();return false">
		...
		<div class="pigcms-container">
			...
			<input type="text" class="pigcms-input-block3" placeholder="请输入终端号" name="mcode" value="{pigcms{$Orderprinter['mcode']}" >
			<div style="clear:both"></div>
		</div>
		<div class="pigcms-container">
			<p class='pigcms-form-title2'>绑定账号<span class="pigcms-help-text">(绑定手机号和绑定账号只能填写一个)</span></p>
			<input type="text" class="pigcms-input-block3" placeholder="请输入绑定账号" name="username" value="{pigcms{$Orderprinter['username']}" >
			<div style="clear:both"></div>
		</div>
		<div class="pigcms-container">
			<p class='pigcms-form-title2'>密钥</p>
			<input type="text" class="pigcms-input-block3" placeholder="请输入密钥" name="mkey" value="{pigcms{$Orderprinter['mkey']}" >
			<div style="clear:both"></div>
		</div>
		<div class="pigcms-container">
			<p class='pigcms-form-title2'>终端手机号</p>
			<input type="text" class="pigcms-input-block3" placeholder="请输入终端手机号" name="mp" value="{pigcms{$Orderprinter['mp']}" >
			<div style="clear:both"></div>
		</div>
		<div class="pigcms-container">
			<p class='pigcms-form-title2'>打印份数</p>
			<input type="text" class="pigcms-input-block3" placeholder="请输入打印份数" name="count" value="{pigcms{$Orderprinter['count']}" >
			<div style="clear:both"></div>
		</div>
		<div class="pigcms-container">
