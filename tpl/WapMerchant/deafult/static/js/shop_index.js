...
// 	setTimeout(function(){
// 		$("#slide_menu").find('.shao').parent().trigger('click');
// 	},700);
// })
...
$("#income-count-container").click(function() {
	$("#canvas-title").html("交易总金额趋势图 <span>(单位: 元)</span>");
})
$("#member-count-container").click(function() {
	$("#canvas-title").html("优惠金额趋势图 <span>(单位: 元)</span>");
})
$("#view-count-container").click(function() {
	$("#canvas-title").html("实际收入金额趋势图 <span>(单位: 元)</span>");
})
