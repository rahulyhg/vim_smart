	...
	<form class="pigcms-form" method="post" action="" onsubmit="return checkSubmit();return false;">
	  ...
	  <div class="pigcms-container">
			...
			<span class="verify_box" style="float:left;">
				<img src="{pigcms{:U('Index/verify',array('type'=>'reg'))}" id="reg_verifyImg" onclick="reg_fleshVerify('{pigcms{:U('Index/verify',array('type'=>'reg'))}')" title="刷新验证码" alt="刷新验证码" style="margin-top:8px; float:left;"/>&nbsp;
				<a href="javascript:reg_fleshVerify('{pigcms{:U('Index/verify',array('type'=>'reg'))}')" style="margin-top:15px; margin-left:5px; float:left;">刷新验证码</a>
				<div style="clear:both"></div>
			</span>
