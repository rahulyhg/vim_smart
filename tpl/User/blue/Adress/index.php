	...
	<form id="address-form" class="form" method="post" style="display:none;">
		...
		<div class="address-field-list">
			...
			<div class="form-field">
				...
				<input type="text" maxlength="60" size="60" name="adress" id="address-adress" class="f-text address-adress" value="" showWindow=1 placeholder="请输入小区、大厦或学校"/>
				<div class="address-suggestlist" style="display: none;" id='addressShow'>
