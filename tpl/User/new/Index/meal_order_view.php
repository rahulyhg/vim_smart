							...
							<dd class="bunch-section__content">
								<ul class="flow-list">
									...
									<if condition="$now_order['third_id'] eq '0' AND $now_order['pay_type'] eq 'offline'">
										...
										<li></li>
										<li></li>
										<li style="margin:30px 0;width:auto;"><b>线下需向商家付金额：</b>总金额 ￥{pigcms{$now_order['total_price']} - 商家会员卡余额支付 ￥{pigcms{:floatval($now_order['merchant_balance'])} - 平台余额支付 ￥{pigcms{:floatval($now_order['balance_pay'])} = <font color="red">￥{pigcms{$now_order['total_price']-$now_order['merchant_balance']-$now_order['balance_pay']}元</font></li>
									...
									<br><li style="margin:30px 0;width:auto;"><b>支付详情：</b>在线支付金额 ￥{pigcms{$now_order['payment_money']}  商家会员卡余额支付 ￥{pigcms{:floatval($now_order['merchant_balance'])}  平台余额支付 ￥{pigcms{:floatval($now_order['balance_pay'])} 
										</li>
								</ul>
