...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="page-content-area">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <form  class="form-horizontal" method="post" id="edit_form" enctype="multipart/form-data" action="{pigcms{:U('Index/contract_edit')}">
                        <div class="tab-content">
                            <div id="basicinfo" class="tab-pane active">
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="property_address">合同名称</label></label>
                                    <input class="col-sm-2" size="20" name="contract_name" id="contract_name" type="text" value="{pigcms{$shequArr.contract_name}"/>
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    function deleteImage(path,obj){
        $.post("{pigcms{:U('Index/store_ajax_del_pic')}",{path:path});
