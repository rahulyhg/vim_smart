    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="{pigcms{:U('Index/active_group_list')}">推荐{pigcms{$config.meal_alias_name}管理</a>
            </li>
                                ...
                                <if condition="$meal">
                                    <volist name="meal['store_list']" id="vo">
                                        <tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
                                            ...
                                            <td><div class="tagDiv"><a title="看详情" target='_blank' href="{pigcms{$config.site_url}/meal/{pigcms{$vo['store_id']}.html">访问</a></div></td>
