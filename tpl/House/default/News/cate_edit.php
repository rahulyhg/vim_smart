						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								<div class="form-group">
									...
									<input class="col-sm-2" size="20" name="cat_name" id="cat_name" type="text" value="{pigcms{$cate_info.cat_name}"/>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="phone">分类排序</label></label>
									<input class="col-sm-2" size="20" name="cat_sort" id="cat_sort" type="text" value="{pigcms{$cate_info.cat_sort}" />
								</div>
								<div class="form-group">
