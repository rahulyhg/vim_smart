...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">设备编辑</span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
        <!-- BEGIN PAGE BASE CONTENT -->
        <div class="row" id="app" v-cloak>
            <form action="{pigcms{:U('edit_meter_act')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">编辑设备</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="meter_code" disabled="disabled" value="{pigcms{$meter_info.meter_code}">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="meter_floor" value="{pigcms{$meter_info.meter_floor}">
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <select name="meter_type_id" id="" class="form-control" v-model="selected_meter_type" >
                                            ...
                                            <foreach name="meter_type_list" item="meter_type_desc" key="meter_type_id">
                                                <option value="{pigcms{$meter_type_id}"  {pigcms{$meter_type_id==$meter_info['meter_type_id']?"selected='selected'":""}>{pigcms{$meter_type_desc}</option>
                                            </foreach>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <select name="price_type_id" id="" class="form-control" v-model="selected_meter_type" >
                                            <option value="">请选择</option>
                                            <foreach name="price_type_list" item="price_type_desc" key="price_type_id">
                                                <option value="{pigcms{$price_type_id}" {pigcms{$price_type_id==$meter_info['price_type_id']?"selected='selected'":""}>{pigcms{$price_type_desc}</option>
                                            </foreach>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" placeholder="" value="{pigcms{:explode(',',$meter_info['be_cousume'])[1]}" name="last_cousume" id="cat_url">
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" placeholder="" value="{pigcms{$meter_info.rate}" name="rate"><div class="form-control-focus"></div>
                                    </div>
                                </div>
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-2 col-md-9">
                                            <input type="hidden" value="{pigcms{:I('get.meter_hash')}" name="meter_hash">
                                            <button type="submit" class="btn green">确认提交</button>
                                            <php>$list_url = U('meter_lists_news')</php>
