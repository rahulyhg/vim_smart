...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
			...
			<li>
                <span class="active">导入业主每月账单明细</span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">导入业主每月账单明细</span>
                            </div>
                            <div class="actions">
                                        ...
                                        <div id="shopList" class="grid-view">
                                            ...
                                            <form id="myform" method="post" action="__SELF__" enctype="multipart/form-data">
                                                ...
                                                <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover" width="100%">
                                                    <input class="col-sm-2 Wdate" type="text" name="paytime" style="height:30px; margin-bottom:20px;" onfocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyy年MM月',vel:'start_time'})" value="{pigcms{:date('Y年m月',$_SERVER['REQUEST_TIME'])}"/>
                                                    <if condition="$Think.session.system.account eq 'admin'">
                                                        <tr>
                                                            <th width="180">选择社区</th>
                                                            <td>
