                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="meter_code" value="{pigcms{$meter_info.meter_code}">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-bind:value="concat_desc" name="meter_desc"  value="{pigcms{$meter_info.meter_desc}"  class="form-control" placeholder=""  id="cat_url">
                                        <div class="form-control-focus"></div>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" placeholder="" value="{pigcms{$meter_info.last_cousume}" name="last_cousume" id="cat_url">
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
