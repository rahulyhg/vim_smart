                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input"  >
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="property_endtime"  id="property_endtime" value="<if condition="$thisRoomArray['property_endtime']">{pigcms{$thisRoomArray['property_endtime']}</if>"  class="form-control" <if condition="$thisRoomArray['property_endtime']">readonly="readonly"</if>>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input"  >
                                ...
                                <div id="pay" style="display: none;">
                                    ...
                                    <div class="form-group form-md-line-input"  >
                                        ...
                                        <div class="col-md-9" >
                                            <input type="text"   id="pay_true" value="" name="property_true" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group form-md-line-input"  >
...
<script type='text/javascript'>
    ...
    $('#property_endtime').datetimepicker({
        ...
        startDate:'{pigcms{$thisRoomArray['property_endtime']}',//设置开始时间
        yearStart:2000,     //设置最小年份
        yearEnd:2050,        //设置最大年份
        todayButton:false    //关闭选择今天按钮
    });
    var property_unit={pigcms{$thisRoomArray['property_unit']};
    var roomsize={pigcms{$thisRoomArray['roomsize']};
