...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            <li>
                <a href="{pigcms{:U('Off/off_list_news')}">巡检管理</a>
                        ...
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="btn-group">
                                        <a onclick="comeback()">
                                            <button id="sample_editable_1_new" class="btn sbold green">返回到上一页
                        ...
                        <if condition="$hello eq 1" >
                            ...
                            <else />
                                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                    <thead>
                                    <tr>
                                        <th style="width: 60px; text-align: center;line-height: 40px;">
                                            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                <input type="checkbox" class="group-checkable" data-set="#sample_1 .checkboxes" />
                                                <span></span>
                                            </label>
                                        </th>
                                        <th  style="width: 100px; text-align: center;line-height: 40px;">姓名</th>
                                        <th  style="width: 250px; text-align: center;line-height: 40px;">开始时间</th>
                                        <th  style="text-align: center;line-height: 40px;">结束时间</th>
                                        <th  style="text-align: center;line-height: 40px;">使用时长</th>
                                    </tr>
                                    </thead>
                                    <foreach name="transmitArr" item="vo" key="k">
                                        <tr>
                                            ...
                                            <td style="line-height: 40px;">{pigcms{$vo.tt_name}</td>
                                            <td style="line-height: 40px;">{pigcms{$vo.s_date}</td>
                                            <td style="line-height: 40px;">{pigcms{$vo.e_date}</td>
                                            <td style="line-height: 40px;">{pigcms{$vo.xx_time}</td>
                                        </tr>
                                    </foreach>
                                    <tr>
                                        <td style="line-height: 40px;">
                                        ...
                                        <td style="line-height: 40px;">{pigcms{$new_name}</td>
                                        <td style="line-height: 40px;">{pigcms{$new_date}</td>
...
<script type="text/javascript">
    ...
    function comeback()
    {
        var url1 = "{pigcms{:U('PropertyService/products_operate')}";
        var url2 = "{pigcms{:U('PropertyService/products_qrcode_list')}";
        var id = "{pigcms{$id}";
        var cid = "{pigcms{$cid}";
        if (id) {
            window.location.href = url2+'&pro_id='+id+'&cid='+cid;
        } else {
            window.location.href = url2+'&cid='+cid;
        }
