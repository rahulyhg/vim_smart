...
<div id="shopList" class="grid-view">
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <td><div class="tagDiv">{pigcms{$vo.st}<if condition="$vo['more'] eq 1"><a href="{pigcms{:U('list_for_more',array('usernum'=>$vo['usernum']))}"><br/>>>>>>更多</a></if></div></td>
        ...
        <tfoot>
            ...
            <tr>
                ...
                <td colspan="9" align="center">{pigcms{$user_list.pagebar}</td>
