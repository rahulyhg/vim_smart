...
<div class="table-toolbar">
    <div class="btn-group">
        <div class="col-md-6">
            <div class="btn-group">
                <a href="{pigcms{:U('PropertyService/point_safety_add')}">
        ...
        <volist name="pointArray" id="vo">
            ...
            <td><div class="tagDiv"><if condition="$vo['name'] neq ''">{pigcms{$vo.name}<else />{pigcms{$vo.orientation}</if></div></td>
                ...
                <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                    <li>
                        <a href="{pigcms{:U('point_safety_update',array('id'=>$vo['id']))}">
                            <i class="icon-tag"></i> 编辑 </a>
                    </li>
                    <li>
                        <a href="{pigcms{:U('qrcode_safety_point',array('rid'=>$vo['rid']))}"
                           data-toggle="modal"
