                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">添加报修项目</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="project_name"/>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="is_cost">
                                            <option value="0">无偿维修项目</option>
                                            <option value="1">有偿维修项目</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="可以不填" name="unit"/>
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group form-md-line-input" id="cost" style="display: none">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="cost"/>
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <div class="md-radio-inline">
                                            <div class="md-radio">
                                                <input type="radio" id="show_no" name="status"  value="0" class="md-radiobtn">
                                                <label for="show_no">
                                                    <span></span>
                                            ...
                                            <div class="md-radio">
                                                <input type="radio" id="show" name="status"  value="1" class="md-radiobtn">
                                                <label for="show">
                                                    <span></span>
                                                    <span class="check"></span>
