                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="form-control-focus"> </div>
                                        <span class="required">*方位不能超过8个字符</span>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-2 col-md-9">
                                            ...
                                            <button type="reset" class="btn default" onclick="window.location.href='http://www.hdhsmart.com/admin.php?g=System&c=PropertyService&a=point_list&is_del='+0">返 回</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
