        ...
        <volist name="list" id="vo">
            <tr class="odd gradeX" style="background-color: #F3F4F6">
                ...
                <td class="button-column">
                    <div class="btn-group">
                        <if condition="$vo['is_enter'] eq 1 && $vo['is_enter_list'] eq 0">
                            <a  data-toggle="modal" data-target="#modal_other"
                                href="{pigcms{:U('edit_other',array('usernum'=>$vo['usernum'],'tid'=>$vo['ub_id']))}" style="text-align: center">
                                出账
                            </a>
                        <elseif condition="$vo['is_enter'] eq 0"/>
                                统计未完成
                        <elseif condition="$vo['is_enter_list'] eq 1"/>

                            <a  data-toggle="modal" data-target="#modal_look"
                                href="{pigcms{:U('look_list',array('usernum'=>$vo['usernum']))}" style="text-align: center">
                                已出账
                            </a>
...
<div class="modal fade" id="modal_look" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" style="width:1200px" role="document">
        <div class="modal-content">
