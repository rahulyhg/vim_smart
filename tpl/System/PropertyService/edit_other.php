...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary" style="display: none;" id="save" data-usernum = "{pigcms{$Think.get.usernum}">保存</button>
    <button type="button" class="btn btn-success"   data-usernum = "{pigcms{$Think.get.usernum}" id="enter_list">出账</button>
