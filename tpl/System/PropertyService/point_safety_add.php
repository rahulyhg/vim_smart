                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">添加消防点</span>
                            </div>
                            <div class="actions">
                            ...
                            <div class="form-body">
                                ...
                                <!--<div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <input name="orientation[]" type="checkbox" value="东" class="mt-checkbox"/>东
                                        <input name="orientation[]" type="checkbox" value="南" class="mt-checkbox"/>南
                                        <input name="orientation[]" type="checkbox" value="西" class="mt-checkbox"/>西
                                        <input name="orientation[]" type="checkbox" value="北" class="mt-checkbox"/>北
                                    </div>
                                </div>-->
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <!-- <input type="text" maxlength="8"  name="pointname"/> -->
                                        头部：<select name="head" style="width: 40px; padding: 3px; text-align: center;">
                                        ...
                                        数量: <select name="number" style="width: 40px; padding: 3px; text-align: center;">
                                        ...
                                        <div class="form-control-focus"> </div>
                                        <span class="required">*请选择编号生成的头部和生成的数量</span>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
