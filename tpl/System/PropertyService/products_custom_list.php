...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            <li>
                <a href="{pigcms{:U('PropertyService/point_safety_list')}">物业服务</a>
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <foreach name="cusArr" item="vo" key="k">
                                <tr>
                                    ...
                                    <td style="line-height: 40px;"><a href="{pigcms{:U('PropertyService/products_qrcode_list',array('cid'=>$vo['cid']))}">查看详情</a></td>
                            </foreach>
                        </table>
...
<script type="text/javascript">
    ...
    function go() {
        ...
        if (num == null || num < 1) {
            ...
            var url = "{pigcms{:U('PropertyService/products_create_qrcode')}";
            $.ajax({
                url:url,
                type:'post',
                ...
                success:function(delmsg){
                    if(delmsg==null){
                        ...
                        location.href="{pigcms{:U('PropertyService/products_create_qrcode')}&log_id="+delmsg;
                    }
                    /*if (delmsg == null) {
                        layer.msg('创建失败！', {icon: 6});
                    } else if (delmsg === '1') {
