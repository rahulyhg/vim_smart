                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">导入业主</span>
                            </div>
                            <div class="actions">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div id="shopList" class="grid-view">
                                            ...
                                            <form id="myform" method="post" action="{pigcms{:U('User/import_tenant')}" enctype="multipart/form-data">
                                                ...
                                                <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover" width="100%">
                                                    <if condition="$Think.session.system.account eq 'admin'">
                                                        <tr>
                                                            <th width="180" height="50" valign="middle">选择社区</th>
                                                    ...
                                                    <tr>
                                                        <th width="80" height="50" valign="middle">示例表格</th>
                                                        <td height="50" valign="middle"><a target="_blank" href="{pigcms{$static_public}file/example_proprietor_import.xls" class="button" style="margin-left:0px;">点击下载</a></td>
                                                    </tr>
                                                    <tr>
                                                        <th width="80" height="50" valign="middle">Excel导入</th>
                                                      <td height="50" valign="middle"><input type="file" class="input fl" name="file" style="width:200px;" placeholder="请上传excel表格" validate="required:true"/></td>
                                                    </tr>
                                              </table>
                                                <div class="clearfix form-actions">
                                                    <div class="col-md-offset-1 col-md-9" style="margin-left:150px;">
                                                        <button class="btn btn-info" type="submit">
                                                            <i class="ace-icon fa fa-check bigger-110"></i>
                                                            保存
                                                        </button>
														<button type="reset" class="btn default" onclick="window.location.href='http://www.hdhsmart.com/admin.php?g=System&c=User&a=tenant_list_news'">返 回</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
