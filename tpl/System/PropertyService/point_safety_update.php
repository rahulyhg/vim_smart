                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">更新巡检点</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <input type="text" name="id" value="{pigcms{$room_name['id']}" style="display: none"/>
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="rid">
                                            <foreach name="roomArray" item="sv">
                                                <option value="{pigcms{$sv.id}"<if condition="$sv['id'] eq $room_name['rid']">selected</if>>{pigcms{$sv.room_name}</option>
                                            </foreach>
                                        </select>
                                    </div>
                                </div>
                                <!--
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-2 control-label" for="form_control_1">方位
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                        <input name="all_orientation" type="checkbox" value="" class="mt-checkbox"/>全选
                                        <input name="orientation[]" type="checkbox" value="东" class="mt-checkbox"<if condition="in_array('东',$orientationArray)">checked</if>/>东
                                        <input name="orientation[]" type="checkbox" value="南" class="mt-checkbox"<if condition="in_array('南',$orientationArray)">checked</if>/>南
                                        <input name="orientation[]" type="checkbox" value="西" class="mt-checkbox"<if condition="in_array('西',$orientationArray)">checked</if>/>西
                                        <input name="orientation[]" type="checkbox" value="北" class="mt-checkbox"<if condition="in_array('北',$orientationArray)">checked</if>/>北
                                    </div>
                                </div>-->
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-2 control-label" for="form_control_1">编号
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                        <input type="text" maxlength="8"  name="pointname" value="<if condition="$room_name['name'] neq ''">{pigcms{$room_name.name}<else />{pigcms{$room_name.orientation}</if>"/>
                                        <div class="form-control-focus"> </div>
                                        <span class="required">*编号最多支持8个字符</span>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-2 col-md-9">
                                            ...
                                            <button type="reset" class="btn default" onclick="window.location.href='http://www.hdhsmart.com/admin.php?g=System&c=PropertyService&a=point_safety_list&is_del=0'">返 回</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
