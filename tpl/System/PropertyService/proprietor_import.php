                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div id="shopList" class="grid-view">
                                            ...
                                            <form id="myform" method="post" action="{pigcms{:U('User/proprietor_import')}" enctype="multipart/form-data">
                                                ...
                                                <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover" width="100%">
                                                    ...
                                                    <tr>
                                                        <th width="80">示例表格</th>
                                                        <td><a target="_blank" href="{pigcms{$static_public}file/example_proprietor_import.xls" class="button" style="margin-left:0px;">点击下载</a></td>
                                                    </tr>
                                                    <tr>
