...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">巡检楼层二维码-{pigcms{$thisPointArray.0.room_name}</h4>
</div>
            ...
            <table class="table table-bordered table-hover">
                ...
                <foreach name="thisPointArray" item="vo">
                    <tr>
                        ...
                        <if condition="$vo['adress']">
                            <td><img src="{pigcms{$vo['adress']}" width="150px" height="150px"/></td>
                        <else/>
