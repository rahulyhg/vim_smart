                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">更新巡更点</span>
                            </div>
                            <div class="actions">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <span class="required">*方位最支持8个字符</span>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-2 col-md-9">
                                            ...
                                            <button type="reset" class="btn default" onclick="window.location.href='http://www.hdhsmart.com/admin.php?g=System&c=PropertyService&a=point_list'">返 回</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
