                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('add_group',array('company_id'=>$company_id,'mid'=>$mid))}">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('group_recharge',array('company_id'=>$vo['company_id'],'group_id'=>$vo['group_id'],'mid'=>$mid))}">
                                                        <i class="icon-docs"></i> 充值 </a>
                                                </li>
                                                <li>
                                                    <a href="{pigcms{:U('group_edit',array('company_id'=>$vo['company_id'],'group_id'=>$vo['group_id'],'mid'=>$mid))}">
                                                        <i class="icon-docs"></i> 编辑 </a>
                                                </li>
                                                <li>
                                                    <a href="{pigcms{:U('group_del',array('company_id'=>$vo['company_id'],'group_id'=>$vo['group_id'],'mid'=>$mid))}">
