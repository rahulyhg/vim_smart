...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            <li>
                <if condition="$mid"><a href="{pigcms{:U('group',array('company_id'=>$company_id,'mid'=>$mid))}">分组管理</a>
                    <i class="fa fa-circle"></i>
                <else/>
                    <a href="{pigcms{:U('left_group_news',array('company_id'=>$company_id))}">分组管理</a>
                    <i class="fa fa-circle"></i>
                </if>
            </li>
            <li>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <if condition="$mid">
                                                <a href="{pigcms{:U('add_user',array('company_id'=>$company_id,'group_id'=>$group_id,'mid'=>$mid))}">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th>用户名</th>
                                <if condition="$mid"><th>账户余额</th></if>
                                <th>联系电话</th>
                                <th>证件类型</th>
                                <th>证件号</th>
                                <th>注册时间</th>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('user_del',array('company_id'=>$company_id,'group_id'=>$group_id,'mid'=>$mid,'uid'=>$vo['uid']))}">
       ...
       $('.del').click(function () {
           ...
           if(uid_arr=="" || uid_arr=="null"){
               ...
               $.ajax({
                   ...
                   'data':{'uid_arr':uid_arr,'group_id':group_id,'company_id':company_id,'mid':mid},
                   'type':'POST',
                   'dataType':'JSON',
