                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <foreach name="result" item="vo">
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                        <a href="{pigcms{:U('user_list',array('company_id'=>$vo['company_id'],'mid'=>$vo['mer_id']))}">{pigcms{$vo.name}</a>
                                    </td>
                                    <td class="center">
                                        {pigcms{$vo.R_money}
                                    </td>
                                    <td class="center">
                                        <a href="{pigcms{:U('chinaPay',array('company_id'=>$vo['company_id'],'mid'=>$vo['mer_id']))}">充值</a>
                                    </td>
                                    <td class="center">
                                        <a href="{pigcms{:U('user_list',array('company_id'=>$vo['company_id'],'mid'=>$vo['mer_id']))}">访问</a>
                                    </td>
<!--                                    <td>-->
<!--                                        <div class="btn-group">-->
...
<!--                                                <li>-->
<!--                                                    <a href="{pigcms{:U('user_list',array('company_id'=>$vo['company_id'],'mid'=>$vo['mer_id']))}">-->
<!--                                                        <i class="icon-docs"></i> 访问 </a>-->
<!--                                                </li>-->
<!--                                                <li>-->
<!--                                                    <a href="{pigcms{:U('chinaPay',array('company_id'=>$vo['company_id'],'mid'=>$vo['mer_id']))}">-->
