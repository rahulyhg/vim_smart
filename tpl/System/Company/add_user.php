...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            <li>
                <span class="active">{pigcms{$group_name}</span>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <a href="{pigcms{:U('user_manage',array('company_id'=>$company_id,'mid'=>$mid,'group_id'=>$group_id))}">成员管理</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span class="active">添加组员</span>
            </li>
        </ul>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        <form action="{pigcms{:U('au_submit')}" method="post">
