...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 var  meal_alias_name = "{pigcms{$config.meal_alias_name}";
		...
		<link rel="stylesheet" type="text/css" href="{pigcms{$static_path}css/employeeStyle.css" />
	    ...
	    <script type="text/javascript" src="{pigcms{$static_public}js/jquery.validate.js"></script><!--控制图片放大-->
		...
		<!--引用图表插件-->
		<script type="text/javascript" src="{pigcms{$static_path}js/echarts.js"></script>
