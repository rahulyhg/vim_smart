        ...
        <table class="table table-striped table-bordered table-hover" id="sample_1" >
            ...
            <volist name="money_list" id="vo" key="ke">
                ...
                <tr>
                    ...
                    <td><div ondblclick="open_url({pigcms{$vo2['type_id']})" title="双击修改详细"   style="width: 100%;"><div class="tagDiv">{pigcms{:number_format($vo2['data']['money_sum'],2)}</div></div></td>
                    <td><div ondblclick="open_url({pigcms{$vo2['type_id']})" title="双击修改详细"   style="width: 100%;"><div class="tagDiv">{pigcms{:number_format($vo2['data']['sum'],2)}</div></div></td>
                    <td><div ondblclick="open_url({pigcms{$vo2['type_id']})" title="双击修改详细"   style="width: 100%;"><div class="tagDiv">{pigcms{:number_format(($vo2['data']['money_sum']-$vo2['data']['sum']),2)}</div></div></td>
            </volist>
...
<block name="script">
    <script>
        ...
        function change_url(type,val) {
            console.log(val);
            window.location.href='{pigcms{:U('Budget/check_money_list_change')}&'+type+'='+val;
        }
        function open_url(type_id) {
            var url='{pigcms{:U('Budget/ajax_change_money',array('project_id_change'=>$project_id_change,'year'=>$year))}';
