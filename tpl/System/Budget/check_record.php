            ...
            <div class="tab-content" id="app">
                <div  class="tab-pane active">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input  class="form-control number" type="text" size="20" name="record_money" value="{pigcms{$record_info['record_money']}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9" >
                            <input class="form-control" value="{pigcms{$record_info['record_time']}" name="record_time" id="record_time" type="text" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <!--<span>{pigcms{$record_info['record_remark']}</span>-->
                            <textarea name="record_remark" class="form-control" value="{pigcms{$record_info['record_remark']}" rows="2" ></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2 control-label">所属项目</div>
                        <div class="col-sm-9" style="padding-top: 7px">
                        <span>{pigcms{$record_info['village_name']}</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2 control-label">所属公司</div>
                        <div class="col-sm-9" style="padding-top: 7px">
                        <span>{pigcms{$record_info['company_name']}</span>
                        </div>
                    </div>
...
-->                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9" >
                            <input placeholder="不填写则默认为审核时间，请注意" class="form-control" size="20" name="record_check_time" id="record_check_time" type="text" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9" >
                        <textarea name="record_check_remark" class="form-control" rows="10" ></textarea>
                        </div>
                    </div>
                </div>
