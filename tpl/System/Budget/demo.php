                                ...
                                <div class="portlet-body">
                                    <div class="row">
                                        <foreach name="quick_list['list']" item="vo1">
                                            <a href="{pigcms{:U($vo1['controller'].'/'.$vo1['action'])}"><div class=" col-md-6 col-sm-4" style="margin-bottom:15px; height:20px; overflow:hidden;">
                                ...
                                <div class="tq2">
                                    <div class="tq3" style="width: 80%">
                                        <div class="cw1">
                                            ...
                                            <div class="wz2" style="width: 100px;margin-left: 20%">
