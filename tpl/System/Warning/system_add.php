					...
					<div class="portlet light portlet-fit portlet-form bordered">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green sbold uppercase">添加新系统</span>
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							...
							<div class="form-body">
								...
								<div class="form-group form-md-line-input">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" placeholder="" name="system_name"/>
								...
								<div class="form-group form-md-line-input">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" placeholder="" name="system_con"/>
										<div class="form-control-focus"> </div>
								...
								<div class="form-group form-md-line-input">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" placeholder="" name="system_act"/>
										<div class="form-control-focus"> </div>
								...
								<div class="form-group form-md-line-input">
									...
									<div class="col-md-9">
										<select  class="form-control" name='system_type'>
											<option value="0">接口错误</option>
											<option value="1">本地系统错误</option>
								...
								<div class="form-group form-md-line-input" name='add_tr'>
									...
									<div class="col-md-9">
										<input type="text" class="form-control"  name="user_wx_opid[]"/>
										<br/>
										<br/>
										<br/>
										<br/>
...
<script type='text/javascript'>
	...
	$(function(){
		...
		$("#mybutton").click(function(){
			var tr="<div class='form-group form-md-line-input' name='add_tr'><label class='col-md-2 control-label' for='form_control_1'>指定接受警告推送人员 <span class='required'>*</span></label><div class='col-md-9'><input type='text' class='form-control'  name='user_wx_opid[]'/><br/><br/><br/><br/><div class='form-control-focus'></div></div></div>";
