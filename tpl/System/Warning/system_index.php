                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="{pigcms{:U('Warning/system_add')}">
                                                        <button id="sample_editable_1_new" class="btn sbold green"> 添加新系统
                                                            <i class="fa fa-plus"></i>
                                                        </button>
                                                    </a>
                                                </div>
                                                <div class="btn-group">
                                                    <a href="{pigcms{:U('Warning/showlist')}">
                                                        <button id="sample_editable_1_new" class="btn sbold green"> 警告信息列表
                                                            <i class="fa fa-plus"></i>
                                                        </button>
                                                    </a>
                                                </div>
                                                <div class="btn-group">
                                                    <a href="{pigcms{$Think.config.web_domain}/unify.php?g=Unify&c=Index&a=show_now">
                                                        <button id="sample_editable_1_new" class="btn sbold green"> 计划任务管理
                                                            <i class="fa fa-plus"></i>
                                                        </button>
                                                    </a>
                                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <foreach name="system_array" item="v">
                                                <tr class="odd gradeX">
                                                    <td> {pigcms{$v.pigcms_id} </td>
													<td> {pigcms{$v.system_name} </td>
                                                    <td> {pigcms{$v.system_con} </td>
                                                    <td> {pigcms{$v.system_act} </td>
                                                    <td class="center"><if condition="$v['system_type'] eq 0">接口错误</if><if condition="$v['system_type'] eq 1">本地系统错误</if><if condition="$v['system_type'] eq 2">状态异常</if></td>
													<td class="center"><if condition="$v['system_state'] eq 0">正常</if><if condition="$v['system_state'] eq 1">停用</if></td>
                                                    <td class="center">
                                                          <a href="{pigcms{:U('showlist',array('system_id'=>$v['pigcms_id']))}" target="_blank">点击查看</a>
                                                    </td>
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                                <li>
                                                                    <a href="{pigcms{:U('system_edit',array('system_id'=>$v['pigcms_id']))}">
