            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="http://www.hdhsmart.com/admin.php?g=System&c=Warning&a=system_index">警告信息管理</a>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                            <span class="active">警告信息列表</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="col-md-6">
                                            <div class="btn-group">
                                                <a href="{pigcms{:U('Warning/deal_all')}">
                                                    <button id="sample_editable_1_new" class="btn sbold green"> 全部处理
                                                    </button>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <foreach name="warnings_array" item="v">
                                                <tr class="odd gradeX">
                                                    <td> {pigcms{$v.pigcms_id} </td>
													<td> {pigcms{$v.system_name} </td>
                                                    <td> {pigcms{$v.warning_name} </td>
                                                    <td> {pigcms{$v.system_con} </td>
                                                    <td> {pigcms{$v.system_act} </td>
													<td class="center"><if condition="$v['is_check'] eq 0">未查看<elseif condition="$v['is_check'] eq 1 and $v['is_deal'] eq 0"/>未处理<else/>已处理</if></td>
                                                    <td> {pigcms{$v.warning_info} </td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                                <li>
                                                                    <a href="{pigcms{:U('warning_detail',array('pigcms_id'=>$v['pigcms_id']))}">
