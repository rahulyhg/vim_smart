...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="index.html">团购回复设置</a>
                <i class="fa fa-circle"></i>
            </li>
        </ul>
        <div class="row">
            <form action="{pigcms{:U('Home/group_news')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" readonly="readonly" name="village_name" id="cat_url" value="{pigcms{$config.group_alias_name}  —— 当用户输入该关键词时，将会触发此回复。"/>
