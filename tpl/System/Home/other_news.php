                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> 关键词回复</span>
                        </div>
                        <div class="actions">
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Home/other_add_new')}">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <foreach name="list" item="vo">
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="{pigcms{$vo.url}" target="_blank" title="{pigcms{$vo.url}" style="color:blue;">链接预览(鼠标悬浮可显示)</a></td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('Home/other_edit_new',array('id'=>$vo['id']))}">
    ...
    function delete_pr_info(obj) {
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"{pigcms{:U('Home/other_del_new')}",
                    data:{'id':id},
                    type:'post',
