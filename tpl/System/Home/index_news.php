...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">首页回复设置</span>
            </li>
        </ul>
        <div class="row">
            <form action="{pigcms{:U('Home/index_news')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <div class="col-md-12" style="float: left">
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class=" icon-layers font-green"></i>
                                <span class="caption-subject font-green sbold uppercase">首页回复设置</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="village_name" readonly="readonly" id="cat_url" value="首页 —— 当用户输入该关键词时，将会触发此回复。"/>
                                ...
                                <if condition="$info['pic']">
									...
									<div style="margin-left:17%; margin-bottom:30px;"><img src="{pigcms{$info.pic}" width="280" height="180"></div>
