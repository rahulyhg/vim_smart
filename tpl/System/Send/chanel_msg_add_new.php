...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="index.html">智慧助手</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <a href="index.html">添加关键词回复</a>
                <i class="fa fa-circle"></i>
            </li>
        </ul>
        <div class="m-heading-1 border-green m-bordered">
            <h3>使用提示</h3>
            <p> 本操针对商家使用，在使用时如有不详之处请及时与管理员进行沟通，以免造成一些不必要的误操作！
                <a class="btn red btn-outline" href="http://jqueryvalidation.org" target="_blank">不会使用请点此联系相关服务人员指导</a>
            </p>
        </div>
        <div class="row">
            <form action="{pigcms{:U('Send/chanel_msg_add')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-3 control-label" for="form_control_1">标题
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="Full_title" id="cat_url" value="{pigcms{$info.key}"/>
                                        <div class="form-control-focus"> </div>
                                        <span class="help-block">使用相同的关键词可以实现多图文</span>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-3 control-label" for="form_control_1">回复标题
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-3 control-label" for="form_control_1">文章简介
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                        <textarea rows="6" cols="52" name="info">{pigcms{$info.info}</textarea>
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-3 control-label" for="form_control_1">回复内容
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                        <textarea rows="6" cols="52" name="content" id="content">{pigcms{$info.content}</textarea>
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-3 control-label" for="form_control_1">外链接url
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-3 control-label" for="form_control_1">回复图片
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-3 control-label" for="form_control_1">第三方接口url
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
