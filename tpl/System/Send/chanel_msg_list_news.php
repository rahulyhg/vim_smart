...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">平台渠道二维码列表</span>
            </li>
        </ul>
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('Send/chanel_msg_add')}','添加渠道消息',1000,640,true,false,false,addbtn,'edit',true);">
                                            <button id="sample_editable_1_new" class="btn sbold green">添加渠道消息
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <foreach name="chanel_list" item="vo">
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="{pigcms{$config.site_url}/index.php?g=Index&c=Recognition&a=see_qrcode&type=chanel&id={pigcms{$vo.chanel_id}" class="see_qrcode">查看二维码</a></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('Send/chanel_msg_edit_new',array('chanel_id'=>$vo['chanel_id']))}">
                                                        <i class="icon-docs"></i> 更新 </a>
                                                </li>
                                                <li onclick="delete_pr_info(this)" id="{pigcms{$vo.chanel_id}">
                                                    <a href="javascript:;">
