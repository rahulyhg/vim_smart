					...
					<td>
						<table style="width:100%;border:#d5dfe8 1px solid;padding:2px;">
							...
							<tr>
								...
								<td width="60">链接：</td>
								<td><input type="text"  style="width:200px;" class="input" name="url[]" id="url" value="{pigcms{$vo.url}" /><a href="#modal-table" id="addLink" class="btn btn-sm btn-success" onclick="addLink('url',0)" data-toggle="modal">从功能库选择</a></td>
							</tr>
						</table>
					</td>
				</tr>
