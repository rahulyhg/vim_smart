					...
					<div class="portlet-body">
						<div class="table-toolbar">
							<div class="row">
								<div class="col-md-6">
									<div class="btn-group">
										<a href="{pigcms{:U('Hickey/hickey_add_news')}">
											<button id="sample_editable_1_new" class="btn sbold green"> 手动添加接口
						...
						<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
							...
							<tbody>
							<foreach name="Hickey_array" item="vo">
								<tr class="odd gradeX">
									<td> {pigcms{$vo.pigcms_id} </td>
									<td class="center">
										<a href="#" target="_blank">{pigcms{$vo.terrace_name}</a>
									</td>
									<td class="center">
										<a href="#" target="_blank">{pigcms{$vo.hickey_control}</a>
									</td>
									<td class="center">
										<a href="#" target="_blank">{pigcms{$vo.hick_action}</a>
									</td>
									<td class="center">
										<a href="#" target="_blank">{pigcms{$vo.url}</a>
									</td>
									<td name="change_state"><if condition="$vo['is_use'] eq 1"><font color="green">启用</font><elseif condition="$vo['is_use'] eq 2"/><font color="red">待审核</font><else/><font color="red">关闭</font></if></td>
									<td>
										<div class="btn-group">
											...
											<ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
												<if condition="$v.check_state eq 0">
													<li>
														<a href="{pigcms{:U('hickey_update_news',array('pigcms_id'=>$vo['pigcms_id']))}">
															<i class="icon-tag"></i> 编辑 </a>
													</li>
												</if>
												<li class="divider"> </li>
												<li>
													<a href="{pigcms{:U('Hickey/hickey_del',array('pigcms_id'=>$vo['pigcms_id']))}">
