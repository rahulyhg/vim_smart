...
<div class="page-content-wrapper">
	...
	<div class="page-content">
		...
		<ul class="page-breadcrumb breadcrumb">
			...
			<li>
				<span class="active">编辑接口信息</span>
			</li>
		</ul>
		<!-- END PAGE BREADCRUMB -->
		<!-- BEGIN PAGE BASE CONTENT -->
		<div class="row">
			<form action="{pigcms{:U('Hickey/hickey_edit_news')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
					...
					<div class="portlet light portlet-fit portlet-form bordered">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green sbold uppercase">编辑接口信息</span>
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							...
							<div class="form-body">
								...
								<div class="form-group form-md-line-input">
									<label class="col-md-2 control-label" for="form_control_1">接口名称
										<span class="required">*</span>
									</label>
									<div class="col-md-9">
										<input type="text" class="form-control" placeholder="" name="hickey_name" id="cat_name" value="{pigcms{$hickey_array.hickey_name}"/>
										<div class="form-control-focus"> </div>
										<span class="help-block">接口名称必填</span>
									</div>
								</div>
								<div class="form-group form-md-line-input">
									<label class="col-md-2 control-label" for="form_control_1">施行动作名称
										<span class="required">*</span>
									</label>
									<div class="col-md-9">
										<input type="text" class="form-control" placeholder="" name="hick_action" id="cat_name" value="{pigcms{$hickey_array.hick_action}"/>
										<div class="form-control-focus"> </div>
									</div>
								</div>
								<div class="form-group form-md-line-input">
									...
									<div class="col-md-9">
										<select id="terrace_name" name="terrace_id" class="form-control">
								...
								<div class="form-group form-md-line-input">
									<label class="col-md-2 control-label" for="form_control_1">接口基类名称
										<span class="required">*</span>
									</label>
									<div class="col-md-9">
										<span id="terrace_class"></span>
										<div class="form-control-focus"> </div>
									</div>
								</div>
								<div class="form-group form-md-line-input">
									<label class="col-md-2 control-label" for="form_control_1">本地调用方法
										<span class="required">*</span>
									</label>
									<div class="col-md-9">
										<input type="text" class="form-control" placeholder="" id="hickey_control" name="hickey_control" value="{pigcms{$hickey_array.hickey_control}"/>
										<div class="form-control-focus"> </div>
										<span class="help-block">请输入名额数，纯整数输入</span>
									</div>
								</div>
								<div class="form-group form-md-line-input">
									<label class="col-md-2 control-label" for="form_control_1">请求方式
										<span class="required">*</span>
									</label>
									<div class="col-md-9">
										<select name="curl_type" class="form-control">
								...
								<div class="form-group form-md-line-input" name="add_tr">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" placeholder="" name="arguments[]" value="{pigcms{$sv.arguments}"/>
										<input type="text" class="form-control" placeholder="" name="arguments_value[]" value="{pigcms{$sv.arguments_value}"/>
										<select name="arguments_type[]" class="form-control">
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-2 col-md-9">
											...
											<button type="reset" class="btn default" onclick="window.location.href='http://www.hdhsmart.com/admin.php?g=System&c=Hickey&a=index_news'">返 回</button>
										</div>
									</div>
								</div>
...
<script type='text/javascript'>
	...
	$(function(){
		$("#mybutton").click(function(){
			var tr="<div class='form-group form-md-line-input' name='add_tr'><label class='col-md-2 control-label' for='form_control_1'>其他参数<span class='required'>*</span></label><div class='col-md-9'><input type='text' class='form-control' placeholder='' name='arguments[]'/><input type='text' class='form-control' placeholder='' name='arguments_value[]'/><div class='form-control-focus'></div><select name='arguments_type[]' class='form-control'><option value='0'>参数类型</option><option value='1'>常量</option><option value='2'>变量</option></select></div></div></div>";
