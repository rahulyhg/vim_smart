...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">员工编辑</span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
        <!-- BEGIN PAGE BASE CONTENT -->
        <div class="row">
            <form action="{pigcms{:U('ue_submit')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="name" value="{pigcms{$user['name']}"/>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="phone" value="{pigcms{$user['phone']}" />
                                        <div class="form-control-focus"> </div>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-9">
                                        <select name="group_id" class="form-control">
                                            ...
                                            <foreach name="group" item="value">
                                                <option value="{pigcms{$value['group_id']}"<if condition="$value['group_id'] eq $user['group_id']">selected="selected"</if>>{pigcms{$value['group_name']}</option>
                                            </foreach>
                                        </select>
                                        <div class="form-control-focus"> </div>
                                    </div>
