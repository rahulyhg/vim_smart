                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-2 control-label" for="form_control_1">充值金额
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-2 col-md-9">
                                            <button type="button" class="btn green" id="tijiao">确认提交</button>
...
<script type='text/javascript'>
    $(function () {
        $('#tijiao').click(function () {
            ...
            if(result==true){
                $.ajax({
                    'url':"{pigcms{:U('user_recharge_submit')}",
                    'data':{'uid':uid,'company_id':company_id,'money':money},
                    'type':'POST',
                    'dataType':'JSON',
                    'success':function(ret){
                        if(ret.error==0){
                            alert(ret.msg);
                            window.location.href="{pigcms{:U('user_list',array('company_id'=>$company_id))}";
                        }else{
                            alert(ret.msg);
                        }
                    },
