                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">添加商品信息</span>
                            </div>
                            <div class="actions">
                            ...
                            <div class="form-body">
                                ...
                                <if condition="$now_store['store_type'] eq 3 or $now_store['store_type'] eq 4">
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" size="20" name="contact[]"  type="text" value="{pigcms{$now_meal.contact}"/>
