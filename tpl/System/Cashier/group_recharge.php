                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="name" value="{pigcms{$result}"/>
    ...
    $(function () {
        $('#tijiao').click(function () {
            ...
            if(result==true){
                //alert(2);
                $.ajax({
                    'url':"{pigcms{:U('gr_submit')}",
                    'data':{'group_id':group_id,'company_id':company_id,'money':money},
                    'type':'POST',
                    'dataType':'JSON',
                    'success':function(ret){
                        if(ret.error==0){
                            ...
                            window.location.href="{pigcms{:U('group',array('company_id'=>$company_id))}";
                        }else{
                            alert(ret.msg);
                        }
                    },
