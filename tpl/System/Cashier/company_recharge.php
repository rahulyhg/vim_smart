                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="name" value="{pigcms{$company_name}"/>
...
<script type='text/javascript'>
    $(function () {
        $('#tijiao').click(function () {
            ...
            if(result==true){
                $.ajax({
                    'url':"{pigcms{:U('company_recharge_submit')}",
                    ...
                    'success':function(ret){
                        if(ret.error==0){
                            alert(ret.msg);
                            window.location.href="{pigcms{:U('recharge_news')}";
                        }else{
                            alert(ret.msg);
                        }
                    },
