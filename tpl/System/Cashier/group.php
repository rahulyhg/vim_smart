...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{pigcms{:U('user_list',array('company_id'=>$company_id))}">员工列表</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span class="active">分组管理</span>
            </li>
        </ul>
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('add_group',array('company_id'=>$company_id))}">
                                            <button id="sample_editable_1_new" class="btn sbold green">添加分组
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <foreach name="list" item="vo">
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                        <a href="{pigcms{:U('user_manage',array('company_id'=>$vo['company_id'],'group_id'=>$vo['group_id'],'mid'=>$mid))}">成员管理</a>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('group_recharge',array('company_id'=>$vo['company_id'],'group_id'=>$vo['group_id']))}">
                                                        <i class="icon-docs"></i> 充值 </a>
                                                </li>
                                                <li>
                                                    <a href="{pigcms{:U('group_edit',array('company_id'=>$vo['company_id'],'group_id'=>$vo['group_id']))}">
                                                        <i class="icon-docs"></i> 编辑 </a>
                                                </li>
                                                <li>
                                                    <a href="{pigcms{:U('group_del',array('company_id'=>$vo['company_id'],'group_id'=>$vo['group_id']))}">
