    ...
    <div class="page-content">
        ...
        <div class="page-head">
            ...
            <div class="page-title">
                <h1>
                    <h1>{pigcms{$company_name}</h1><span id="leftmoney">余额：<if condition="$company_money">{pigcms{$company_money}元<else/>0.00元</if></span>
                </h1>
            </div>
        </div>
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{pigcms{:U('recharge_news')}">公司列表</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('record',array('company_id'=>$company_id))}">
                                            <button id="sample_editable_1_new" class="btn sbold green">充值记录
                                                <i class="fa fa-plus"></i>
                                            </button>
                                        </a>
                                        <a href="{pigcms{:U('group',array('company_id'=>$company_id))}">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('recharge',array('company_id'=>$vo['company_id'],'uid'=>$vo['uid']))}">
