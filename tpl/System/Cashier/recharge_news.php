                        ...
                        <else/>
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="{pigcms{:U('Cashier/all_record')}">
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                ...
                                <foreach name="list" item="vo">
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                            <a href="{pigcms{:U('user_list',array('company_id'=>$vo['company_id']))}">{pigcms{$vo.name}</a>
                                        </td>
                                        <td class="center">{pigcms{$vo.count}</td>
                                        <td class="center">
                                            <if condition="$vo.money neq ''">
                                                {pigcms{$vo.money}
                                                <else/>0.00
                                            </if>
                                        </td>
                                        <td><a href="{pigcms{:U('user_list',array('company_id'=>$vo['company_id']))}">访问</a></td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                    <li>
                                                        <a href="{pigcms{:U('company_recharge',array('company_id'=>$vo['company_id']))}">
                                                            <i class="icon-docs"></i> 充值 </a>
                                                    </li>
                                                    <li>
                                                        <a href="{pigcms{:U('chinaPay',array('company_id'=>$vo['company_id']))}">
