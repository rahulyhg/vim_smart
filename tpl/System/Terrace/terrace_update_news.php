...
<div class="page-content-wrapper">
	...
	<div class="page-content">
		...
		<ul class="page-breadcrumb breadcrumb">
			...
			<li>
				<span class="active">编辑平台信息</span>
			</li>
		</ul>
		<!-- END PAGE BREADCRUMB -->
		<!-- BEGIN PAGE BASE CONTENT -->
		<div class="row">
			<form action="{pigcms{:U('Terrace/terrace_edit_news')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
					...
					<div class="portlet light portlet-fit portlet-form bordered">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green sbold uppercase">编辑平台信息</span>
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							...
							<div class="form-body">
								...
								<div class="form-group form-md-line-input">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" placeholder="" name="terrace_name" id="cat_name" value="{pigcms{$terrace_array.terrace_name}"/>
								...
								<div class="form-group form-md-line-input">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" placeholder="" name="url" id="cat_url" value="{pigcms{$terrace_array.url}"/>
										<div class="form-control-focus"> </div>
									</div>
								</div>
								<div class="form-group form-md-line-input">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" placeholder="" name="terrace_class" id="cat_url" value="{pigcms{$terrace_array.terrace_class}"/>
										<div class="form-control-focus"> </div>
									</div>
								</div>
								<div class="form-group form-md-line-input">
									...
									<div class="col-md-9">
										<select name="data_type" class="form-control">
											<option value="0"<if condition="$terrace_array['data_type'] eq 0">selected='selected'<else/></if>>请选择</option>
											<option value="1"<if condition="$terrace_array['data_type'] eq 1">selected='selected'<else/></if>>JSON</option>
											<option value="2"<if condition="$terrace_array['data_type'] eq 2">selected='selected'<else/></if>>XML</option>
										</select>
										<div class="form-control-focus"> </div>
									</div>
								</div>
								<div class="form-group form-md-line-input">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" placeholder="" name="key" value="{pigcms{$terrace_array.key}"/>
										<div class="form-control-focus"> </div>
