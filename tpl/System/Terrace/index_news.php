                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="{pigcms{:U('Terrace/terrace_add_news')}">
                                                        <button id="sample_editable_1_new" class="btn sbold green"> 手动添加平台
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <foreach name="terrace_array" item="v">
                                                <tr class="odd gradeX">
                                                    <td> {pigcms{$v.pigcms_id} </td>
                                                    <td class="center">
                                                          <a href="#" target="_blank">{pigcms{$v.terrace_name}</a>
                                                    </td>
                                                    <td class="center">
                                                        <a href="#" target="_blank">{pigcms{$v.url}</a>
                                                    </td>
                                                    <td class="center"><if condition="$v['data_type'] eq 1">JSON</if><if condition="$v['data_type'] eq 2">XML</if></td>
                                                    <td name="change_state"><if condition="$v['is_use'] eq 1"><font color="green">启用</font><elseif condition="$v['is_use'] eq 2"/><font color="red">待审核</font><else/><font color="red">关闭</font></if></td>
                                                    <td class="center" >{pigcms{$v.key}</td>
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                                ...
                                                                <li>
                                                                    <a href="{pigcms{:U('terrace_update_news',array('pigcms_id'=>$v['pigcms_id']))}">
                                                                        <i class="icon-tag"></i> 编辑 </a>
                                                                </li>
                                                                </if>
                                                                <li class="divider"> </li>
                                                                <li>
                                                                    <a href="{pigcms{:U('Terrace/terrace_del',array('pigcms_id'=>$v['pigcms_id']))}">
