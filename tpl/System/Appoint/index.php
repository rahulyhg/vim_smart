			...
			<div id="nav" class="mainnav_title">
				<ul>
					<if condition="empty($now_category)">
						...
						<a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('Appoint/cat_add',array('cat_fid'=>intval($_GET['cat_fid'])))}','添加主分类',480,260,true,false,false,addbtn,'add',true);">添加主分类</a>
					<else/>
						...
						<a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('Appoint/cat_add',array('cat_fid'=>intval($_GET['cat_fid'])))}','添加子分类',520,370,true,false,false,addbtn,'add',true);">添加子分类</a>
					</if>
				</ul>
			</div>
