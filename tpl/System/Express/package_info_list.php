...
<block name="table-toolbar-right">
    <!--    筛选-->
    <span>筛选：</span>
    <select style="width: 10%" name="status">
        <option value=" ">全部</option>
        <option value="已到站">待出库</option>
        <option value="已提货">已出库</option>
    </select>
    <input type="date" name="date" value="<php>echo date('Y-m-d')</php>"/>
    ...
    <br>
<!--    <div id="com_a" >-->
        <foreach name="company_count" item="vo" key="ko">
...
<!--自定义js代码区结束-->
<include file="Public_news:footer_server"/>