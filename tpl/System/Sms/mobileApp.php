...
<div class="mainbox">
    <div id="nav" class="mainnav_title"><ul><a class="on">APP版本配置</a><a href="{pigcms{:U('Appintro/index')}">编辑关于我们</a></ul></div>
    <form method="post" action="{pigcms{:U('System/Sms/mobileApp')}">
        <table cellpadding="0" cellspacing="0" class="table_form" width="100%" style="" >
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="input-text" name="ios_version" id="ios_version" value="{pigcms{$ios_version}" size="60" validate="required:true" tips="请填写当前Ios版本名称">
                </td>
            </tr>
            <tr>
