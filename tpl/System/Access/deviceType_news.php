                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                                ...
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Access/deviceType_edit_news')}">
                                            <button id="sample_editable_1_new" class="btn sbold green"> 添加设备类型
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tbody>
                            <foreach name="deviceType_info" item="vo">
                                <tr class="odd gradeX">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <if condition="$v.check_state eq 0">
                                                    <li>
                                                        <a href="{pigcms{:U('Access/deviceType_edit_news',array('actype_id'=>$vo['actype_id']))}">
                                                            <i class="icon-tag"></i> 编辑 </a>
                                                    </li>
                                                </if>
                                                <li class="divider"> </li>
                                                <li>
                                                    <a href="{pigcms{:U('Access/deviceType_del',array('actype_id'=>$vo['actype_id']))}">
