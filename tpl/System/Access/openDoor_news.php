...
<style type="text/css">
	<!--
	.dropdown-menu {margin: 0 0 0 -20px;}
	-->
</style>
<!-- BEGIN CONTENT -->
					...
					<div class="portlet-body">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="btn-group">
										...
										<button class="btn sbold green dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> 开启条件搜索
												<i class="fa fa-angle-down"></i>
										</button>
												<ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
													<li>
														<a href="{pigcms{:U('Access/openDoor_news',array('searchtype'=>'name','searchtime'=>'zday'))}">
															<i class="icon-tag"></i> 按用户 </a>
													</li>
													<li>
														<a href="{pigcms{:U('Access/openDoor_news',array('searchtype'=>'company','searchtime'=>'zday'))}">
															<i class="icon-tag"></i> 按公司 </a>
													</li>
													<li>
														<a href="{pigcms{:U('Access/openDoor_news',array('searchtype'=>'','searchtime'=>'zday'))}">
															<i class="icon-tag"></i> 使用一览 </a>
													</li>
												</ul>
						...
						<if condition="$state eq 1">
							<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
								...
								<tbody>
								<foreach name="log_list['access_list']" item="vo">
									<tr class="odd gradeX">
										<td>
											<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
