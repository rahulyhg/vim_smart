...
<div class="page-content-wrapper">
	...
	<div class="page-content">
		...
		<ul class="page-breadcrumb breadcrumb">
			...
			<li>
				<span class="active">用户开门记录列表</span>
			</li>
		</ul>
		<!-- END PAGE BREADCRUMB -->
						...
						<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
							...
							<foreach name="log_list['access_list']" item="vo">
								<tr class="odd gradeX">
                                    ...
                                    <td><if condition="$vo.type eq 0">扫码</if><if condition="$vo.type eq 1">扫码</if><if condition="$vo.type eq 2">开关</if></td>
									<td class="center">
									...
									<td class="center">
										{pigcms{$vo.opdate|date='Y-m-d H:i:s',###}
									</td>
									<td>
										<div class="btn-group">
											...
											<ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
												<if condition="$v.check_state eq 0">
													<li>
														<a href="{pigcms{:U('Access/operatLog_edit_news',array('log_id'=>$vo['log_id']))}">
															<i class="icon-tag"></i> 详细 </a>
													</li>
												</if>
												<li class="divider"> </li>
												<li>
													<a href="{pigcms{:U('Access/operatLog_del',array('pigcms_id'=>$vo['pigcms_id']))}">
