...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">访客信息管理列表</span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                                ...
                                <div class="col-md-6">
                                   <!-- <div class="btn-group">
                                        <a href="{pigcms{:U('Access/deviceType_edit_news')}">
                                            <button id="sample_editable_1_new" class="btn sbold green"> 访客登记
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tbody>
                            <foreach name="visitor_list['visitor_list']" item="vo">
                                <tr class="odd gradeX">
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <if condition="$v.check_state eq 0">
                                                    <li>
                                                        <a href="{pigcms{:U('Access/visitorLog_edit_news',array('pigcms_id'=>$vo['pigcms_id']))}">
                                                            <i class="icon-tag"></i> 详细 </a>
                                                    </li>
                                                </if>
                                                <li class="divider"> </li>
                                                <li>
                                                    <a href="{pigcms{:U('Access/visitorLog_del',array('pigcms_id'=>$vo['pigcms_id']))}">
