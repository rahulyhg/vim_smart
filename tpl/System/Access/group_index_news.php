                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Access/group_edit_news')}">
                                            <button id="sample_editable_1_new" class="btn sbold green"> 添加区域
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tbody>
                            <foreach name="group_info" item="vo">
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                        <a href="#" target="_blank">{pigcms{$vo.ag_desc}</a>
                                    </td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <if condition="$v.check_state eq 0">
                                                    <li>
                                                        <a href="{pigcms{:U('Access/group_edit_news',array('ag_id'=>$vo['ag_id']))}">
                                                            <i class="icon-tag"></i> 编辑 </a>
                                                    </li>
                                                </if>
                                                <li class="divider"> </li>
                                                <li>
                                                    <a href="{pigcms{:U('Access/group_del',array('ag_id'=>$vo['ag_id']))}">
