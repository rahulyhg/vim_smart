...
<!--                                    </if>-->
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tbody>
                            <foreach name="userCheck_list['userCheck_list']" item="vo">
                                <tr class="odd gradeX">
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                    ...
                                    <td class="center">
                                        {pigcms{$vo.company_name}
                                    </td>
                                    <td class="center">
                                        <if condition="$vo.card_type eq 1">现场审核</if><if condition="$vo.card_type eq 2">门禁卡</if><if condition="$vo.card_type eq 3">身份证</if><if condition="$vo.card_type eq 4">工作牌</if>
                                    </td>
                                    <td class="center">
                                        {pigcms{$vo.usernum}
                                    </td>
                                    <td><if condition="$vo.workcard_img eq ''"><img src="http://www.hdhsmart.com/upload/system/image/default.jpg" style="width:90px; height: 80px;">
                                            <else/> <img src="./upload/house/{pigcms{$vo.workcard_img}" style="width:90px; height: 80px;"></if>、
                                    </td>
                                    <td class="center">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <if condition="$v.check_state eq 0">
                                                    <li>
                                                        <a href="{pigcms{:U('Access/userCheck_edit_news',array('pigcms_id'=>$vo['pigcms_id']))}">
                                                            <i class="icon-tag"></i> 审核 </a>
                                                    </li>
                                                </if>
                                                <li class="divider"> </li>
                                                <li>
                                                    <a href="{pigcms{:U('Access/userCheck_del',array('pigcms_id'=>$vo['pigcms_id']))}">
