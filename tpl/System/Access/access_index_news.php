                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Access/access_edit_news')}">
                                            <button id="sample_editable_1_new" class="btn sbold green"> 添加设备
                                                <i class="fa fa-plus"></i>
                                            </button>
                                        </a>

                                        <a href="javascript:void(0);" onclick="change_state();" id="open">
                                            <button  class="btn sbold green"> 异常开关--现在状态：关
                                                <i class="fa fa-check"></i>
                                            </button>
                                        </a>

                                        <a href="javascript:void(0);" onclick="change_state();" id="close">
                                            <button  class="btn sbold red"> 异常开关--现在状态：开
...
<!--                                    </if>-->
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tbody>
                            <foreach name="access_list['access_list']" item="vo">
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                        {pigcms{$vo.actype_name}
                                    </td>
                                    <td class="center">
                                        <a href="#" target="_blank">{pigcms{$vo.terrace_id}</a>
                                    </td>
                                    <td class="center">
                                        {pigcms{$vo.ag_name}
                                    </td>
                                    ...
                                    <td class="center">
                                        <if condition="$vo['ac_status'] eq '1' ">开启<else />关闭</if>
                                    </td>
                                    <td class="center">
                                        {pigcms{$vo.ac_desc}
                                    </td>
                                    <td class="center">
                                        <a href="#" target="_blank">{pigcms{$vo.ac_time|date='Y-m-d H:i:s',###}</a>
                                    </td>
                                    <td>
                                        <a style="width:30px;" class="label label-info handle_btn" href="./index.php?g=Index&c=Recognition&a=control_qrcode&village_id={pigcms{$vo.village_id}&ac_id={pigcms{$vo.ac_id}">设备二维码</a>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <if condition="$v.check_state eq 0">
                                                    <li>
                                                        <a href="{pigcms{:U('Access/access_edit_news',array('ac_id'=>$vo['ac_id']))}">
                                                            <i class="icon-tag"></i> 编辑 </a>
                                                    </li>
                                                </if>
                                                <li class="divider"> </li>
                                                <li>
                                                    <a href="{pigcms{:U('Access/access_del',array('ac_id'=>$vo['ac_id']))}">
