...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        <!-- BEGIN LOGO -->
        <!-- <div class="page-logo">
            <a href="{pigcms{:U('Index/index_new')}" class="ggt" id="logo_a">
        ...
        <div class="page-actions">
            <div class="btn-group">
                <!--<div class="btn-group index_left_nav" data-toggle="buttons" style="float:left; margin-top:22px; margin-right:10px;">
                    <label class="btn red-haze active" onClick="window.location.href='{pigcms{$Think.config.WEB_DOMAIN}/admin.php?g=System&c=Index&a=index_new';"> 智能门禁 </label>
					<label class="btn" onClick="window.location.href='{pigcms{$Think.config.WEB_DOMAIN}/Car/index.php?s=/Admin/Index/index/state/1';" style="color:#FFFFFF;"> 智慧停车场 </label>
                 </div>-->
...
<!--                <option value="" <if condition="$auth_village_id neq null" >style="display:none;"</if> >全部显示</option>-->
        ...
        <if condition="!empty($project)">
            <div class="col-md-4" style="margin-top:22px; width:10%; float:left;">
        ...
        <div class="page-top">
            ...
            <div class="top-menu">
				<ul class="nav navbar-nav pull-right">
                    ...
                    <present name="warning_count">
                        <li class="dropdown dropdown-extended dropdown-notification dropdown-dark" id="header_notification_bar">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" aria-expanded="false">
                                <i class="icon-bell"></i>
                                <span style="width:25px; height:25px; overflow:hidden; text-align:center; line-height:25px; background-color: #ed6b75; border-radius:50%!important; color:#FFFFFF; font-size: 12px; color: #FFFFFF; padding:4px 5px;"> {pigcms{$warning_count} </span>
                            </a>
                    ...
                    <present name="noDealThingArray">
                        <!--<li class="dropdown dropdown-extended dropdown-notification dropdown-dark" id="header_notification_bar" style="width:75px;">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" aria-expanded="false">
                                <i class="fa fa-flag"></i>
                                <span class="badge badge-success"> {pigcms{$noDealThingCount} </span>
                            </a>
                            <ul class="dropdown-menu" style="width: 120px; margin-left: -35px; margin-top: 10px;">
                                <li class="external">
                                    <h3>
                                        <span class="bold">{pigcms{$noDealThingCount} 条</span> 未处理反馈 </h3>
                                    <a href="{pigcms{:U('PropertyService/repair_list_news')}">更多</a>
                                </li>
                                <li>
                                    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 250px;">
                                        <ul class="dropdown-menu-list scroller" style="height: 250px; overflow: hidden; width: auto;" data-handle-color="#637283" data-initialized="1">
                                            <foreach name="noDealThingArray" item="vo">
                                                <if condition="$vo['type'] eq 1">
                                                    <li>
                                                        <a href="{pigcms{:U('PropertyService/repair_list_news')}">
                                                            <span class="time">{pigcms{$vo.time|date="Y-m-d",###}</span>
                                                            <span class="details">
                                                        <span class="label label-sm label-icon label-warning">
                                                            <i class="fa fa-bell-o"></i>
                                                        </span> 报修信息 </span>
                                                ...
                                                <elseif condition="$vo['type'] eq 3"/>
                                                    <li>
                                                        <a href="{pigcms{:U('PropertyService/suggess_list_news')}">
                                                            <span class="time">{pigcms{$vo.time|date="Y-m-d",###}</span>
                                                            <span class="details">
                                                        <span class="label label-sm label-icon label-warning">
                                                            <i class="fa fa-bell-o"></i>
                                                ...
                                                <elseif condition="$vo['type'] eq 4"/>
                                                    <li>
                                                        <a href="{pigcms{:U('PropertyService/appointment_list_news')}">
                                                            <span class="time">{pigcms{$vo.time|date="Y-m-d",###}</span>
                                                            <span class="details">
                                                        <span class="label label-sm label-icon label-warning">
                                                            <i class="fa fa-bell-o"></i>
                    ...
                    <!--<present name="unread_message_count">
                        <li class="dropdown dropdown-extended dropdown-notification dropdown-dark" id="header_notification_bar" style="width:75px;">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" aria-expanded="false">
                                <i class="icon-envelope-open"></i>
                                <span class="badge badge-success"> {pigcms{$unread_message_count} </span>
                            </a>
                            <ul class="dropdown-menu" style="width: 120px; margin-left: -35px; margin-top: -70px;">
                                <li class="external">
                                    <h3>
                                        <span class="bold">{pigcms{$unread_message_count} 条</span> 未读信息 </h3>
                                    <a href="{pigcms{:U('Warning/showlist',array('system_id'=>10))}">更多</a>
                                </li>
                                <li>
                                    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 250px;">
                                        <ul class="dropdown-menu-list scroller" style="height: 250px; overflow: hidden; width: auto;" data-handle-color="#637283" data-initialized="1">
                                            <foreach name="unread_message_array" item="vo">
                                                <li>
                                                    <a href="http://www.hdhsmart.com/Car/index.php?s=/Admin/Payrecord/chat_windows/user_id/{pigcms{$vo.warning_result}/pigcms_id/{pigcms{$vo.pigcms_id}">
                                                        <span class="time">{pigcms{$vo.create_time|date="Y-m-d",###}</span>
                                                        <span class="time">{pigcms{$vo.create_time|date="H:i:s",###}</span>
                                                    <span class="details">
                                                        <span class="label label-sm label-icon label-warning">
					...
					<li class="dropdown dropdown-user dropdown-dark">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
							...
							<if condition="$_SESSION['system']['headimgurl'] eq ''">
                            <img alt="" class="img-circle" src="http://www.hdhsmart.com/static/images/5a55d063878ed2.png" /> 
							<else/> 
							<img alt="" class="img-circle" src="http://www.hdhsmart.com/upload/cardfocus/headimage/<php>echo date('Y').'/'.$_SESSION['system']['headimgurl'];</php>" />
							</if></a>
                            ...
                            <ul class="sub-menu">
                                <volist name="sv['child_list']" id="voo">
                                    <li class="nav-item  ">
                                        ...
                                        <elseif condition="$voo['auth_type'] eq 3" />
                                            <a href="{pigcms{$voo.w_url}" class="nav-link " target="_blank">
                                                <span class="title">{pigcms{$voo.name}</span>
                                            </a>
                                            <else/>
                                            <a <if condition="$_SESSION['system_id'] neq ''">href="<?php echo $voo['url'].'_news'.'&system='.$_SESSION['system_id'];?>"<else/>href="<?php echo $voo['url'].'_news';?>"</if>  class="nav-link " id="child_a">
                                                <span class="title">{pigcms{$voo.name}</span>
                                            </a>
                                        </if>
                                    </li>
...
-->                 <script src="/Car/Admin/Public/assets/global/plugins/jquery.min.js" type="text/javascript"></script>
                ...
                <script>
                    ...
                    app.root             = "__ROOT__";
                    app.app              = "__APP__";
                    app.app_dir         = "{pigcms{:APP_PATH}"
                    app.group_name      = "{pigcms{:GROUP_NAME}";
                    app.controller_name      = "{pigcms{:MODULE_NAME}";
                    app.action_name      = "{pigcms{:ACTION_NAME}";
                    app.url_model        = {pigcms{:C('URL_MODEL')};
                </script>
