...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Wap内容管理</span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
        ...
        <div class="row">
            <form action="__SELF__" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <input type="hidden" name="id" value="{pigcms{$adver_array.id}"/>
                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">修改记录</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <select name="village_id" id="village_id" class="form-control">
                                            <option selected="selected" value="1"<if condition="$adver_array['village_id'] eq 1"> selected="selected" </if>>通用全社区</option>
                                            <volist name="village_array" id="v">
                                                <if condition="$adver_array['village_id'] eq $v['village_id']">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <select name="type_id" id="type_id" class="form-control">
                                            <volist name="group_type_array" id="v">
                                                <if condition="$adver_array['type_id'] eq $v['type_id']">
                                                    <option value="{pigcms{$v.type_id}" selected="selected">{pigcms{$v.type_name}</option>
                                                <else/>
                                                    <option value="{pigcms{$v.type_id}">{pigcms{$v.type_name}</option>
                                                </if>
                                            </volist>
                                        </select>
                                        <div class="form-control-focus"> </div>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="name" value="{pigcms{$adver_array.name}"/>
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <div class="md-radio-inline">
                                            <div class="md-radio">
                                                <input type="radio" id="show_no" name="status"  value="1" class="md-radiobtn" <if condition="$adver_array['status'] eq 1">checked='checked'</if>>
                                                <label for="show_no">
                                                    <span></span>
                                            ...
                                            <div class="md-radio">
                                                <input type="radio" id="show" name="status"  value="0" class="md-radiobtn" <if condition="$adver_array['status'] eq 0">checked='checked'</if>>
                                                <label for="show">
                                                    <span></span>
                                                    <span class="check"></span>
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-2 col-md-9">
                                            ...
                                            <button type="reset" class="btn default" onclick="window.location.href='http://www.hdhsmart.com/admin.php?g=System&c=Wapindex&a=wap_control_list_news'">返 回</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
