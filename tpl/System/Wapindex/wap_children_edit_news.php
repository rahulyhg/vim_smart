    ...
    <div class="page-content">
        ...
        <div class="row">
            <form action="__SELF__" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <input type="hidden" name="id" value="{pigcms{$Think.get.id}"/>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="可不填写" name="bg_color" value="{pigcms{$adver_array.bg_color}"/>
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="checkbox" class="make-switch" data-on-color="success" data-off-color="danger"  id="is_online"/>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="url" value="{pigcms{$adver_array.url}"/>
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
...
<script src="{$Think.config.ADMIN_JS_URL}uploadPlugjs/script2.js" type="text/javascript"></script>
...
<script type='text/javascript'>
    ...
    $(function(){
        //异常状态开关
        var is_online = "{pigcms{$adver_array.is_online}";
        if(is_online == 1){
            $('#is_online').bootstrapSwitch('state', true);
        }else{
            $('#is_online').bootstrapSwitch('state', false);
        }
    ...
    $("#is_online").bootstrapSwitch({
        onText:"上线",
        offText:"下线",
        onSwitchChange:function(event,state){
            var not_online_url = "{pigcms{$not_online_url}";
            var online_url = "{pigcms{$adver_array.url}";
            if(state==true){
                $("input[name='is_online']").val("1");
                if(not_online_url == online_url){
                    $("input[name='url']").val('');
                }else{
                    $("input[name='url']").val(online_url);
                }

            }else{
                $("input[name='is_online']").val("0");
