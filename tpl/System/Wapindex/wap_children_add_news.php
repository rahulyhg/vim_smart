    ...
    <div class="page-content">
        ...
        <div class="row">
            <form action="__SELF__" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <input type="hidden" name="fid" value="{pigcms{$Think.get.fid}"/>
                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">添加子内容</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-2 control-label" for="form_control_1">子内容图片
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                        <input type="file" class="form-control" placeholder="" name="upload"/>
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>

                                <div class="form-group form-md-line-input">
                                    <label class="col-md-2 control-label" for="form_control_1">背景颜色
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="可不填写" name="bg_color"/>
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>

                                <div class="form-group form-md-line-input">
                                    <label class="col-md-2 control-label" for="form_control_1">是否上线
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                        <select id="is_online" class="form-control">
                                ...
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-2 control-label" for="form_control_1">链接地址
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <div class="md-radio-inline">
                                            <div class="md-radio">
                                                <input type="radio" id="show_no" name="status"  value="1" class="md-radiobtn">
                                                <label for="show_no">
                                                    <span></span>
                                            ...
                                            <div class="md-radio">
                                                <input type="radio" id="show" name="status"  value="0" class="md-radiobtn">
                                                <label for="show">
                                                    <span></span>
                                                    <span class="check"></span>
...
<script type='text/javascript'>
    ...
    $("#is_online").change(function () {
        var not_online_url = "{pigcms{$not_online_url}";
        var is_online = $("#is_online").val();
        if(is_online==0){
            $("input[name='url']").val(not_online_url);
        }
    });
