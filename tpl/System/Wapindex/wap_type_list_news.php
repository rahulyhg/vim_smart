                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Wapindex/wap_type_add_news')}">
                                            <button id="sample_editable_1_new" class="btn sbold green">添加类型
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <foreach name="type_array" item="vo">
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center" style="color: #9a9afb">
                                        {pigcms{$vo.type_desc}
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('Wapindex/wap_type_edit_news',array('type_id'=>$vo['type_id']))}">
                                                        <i class="icon-docs"></i> 更新 </a>
                                                </li>
                                                <li>
                                                    <a href="{pigcms{:U('Wapindex/wap_type_delete_news',array('type_id'=>$vo['type_id']))}">
