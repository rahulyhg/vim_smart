...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
			...
			<li>
                <span class="active">Wap内容配置</span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">Wap内容配置</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <foreach name="wap_content_config" item="vo">
                                    <div class="form-group form-md-line-input">
                                        <label class="col-md-2 control-label" for="form_control_1">{pigcms{$vo.desc}
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder="" name="{pigcms{$vo.name}" value="{pigcms{$vo.value}"/>
