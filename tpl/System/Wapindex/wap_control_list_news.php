                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Wapindex/wap_content_add_news')}">
                                            <button id="sample_editable_1_new" class="btn sbold green">添加内容
                                                <i class="fa fa-plus"></i>
                                            </button>
                                        </a>
                                    </div>
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Wapindex/wap_type_list_news')}">
                                            <button id="sample_editable_1_new" class="btn sbold green">内容类型
                                                <i class="fa fa-plus"></i>
                                            </button>
                                        </a>
                                    </div>
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Wapindex/wap_config_news')}">
                                            <button id="sample_editable_1_new" class="btn sbold green">Wap内容配置
                                                <i class="fa fa-plus"></i>
                                            </button>
                                        </a>
                                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tbody>
                            <foreach name="wap_content_array" item="vo">
                                <tr class="odd gradeX">
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                    ...
                                    <if condition="$vo.village_id eq 1">
                                        <td class="center">
                                            全社区通用
                                        </td>
                                    <else/>
                                    ...
                                    <td class="center">
                                        <a href="__APP__?g=System&c=Wapindex&a=wap_children_list_news&fid={pigcms{$vo.id}">子内容列表</a>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('Wapindex/wap_content_edit_news',array('id'=>$vo['id']))}">
                                                        <i class="icon-docs"></i> 更新 </a>
                                                </li>
                                                <li>
                                                    <a href="{pigcms{:U('Wapindex/wap_content_delete_news',array('id'=>$vo['id']))}">
