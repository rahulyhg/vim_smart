                    ...
                    <div class="portlet-body">
                                ...
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Exam/question_add_news')}">
                                            <button id="sample_editable_1_new" class="btn sbold green">新建试题
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th  style="width: 100px; text-align: center;">题号</th>
                                <th  style="width: 300px; text-align: center;">所属题库</th>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('Exam/question_edit_news',array('id'=>$vo['id']))}">
