                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Exam/subject_add_news')}">
                                            <button id="sample_editable_1_new" class="btn sbold green">新建题库
                                                <i class="fa fa-plus"></i>
                                            </button>
                                        </a>
                                    </div>
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Exam/paper_news')}">
                                            <button id="sample_editable_1_new" class="btn sbold green">试题管理
                                            </button>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            <thead>
                            <tr>
                                <th  style="width: 150px; text-align: center;">题库编号</th>
                                <th  style="width: 350px; text-align: center;">题库名称</th>
                                <th  style="text-align: center;">题库说明</th>
                                <th  style="width: 150px; text-align: center;">操作</th>
                            </tr>
                            </thead>
                            <foreach name="subjectArr" item="vo">
                                <tr>
                                    <td>{pigcms{$vo.id}</td>
                                    <td>{pigcms{$vo.subject_name}</td>
                                    <td>{pigcms{$vo.explain}</td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('Exam/subject_edit_news',array('id'=>$vo['id']))}">
    ...
    function delete_pr_info(obj) {
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"{pigcms{:U('Exam/subject_del_news')}",
                    data:{'id':id},
                    type:'post',
