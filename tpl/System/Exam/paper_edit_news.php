...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <form action="{pigcms{:U('Exam/paper_edit_save_news')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <div class="col-md-12" style="float: left">
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class=" icon-layers font-green"></i>
                                <span class="caption-subject font-green sbold uppercase">更新试卷</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <select name="subject_id" id="pid">
                                        ...
                                        <volist name="subjectArr" id="vo" >
                                            <option  value="{pigcms{$vo.id}" <if condition="$vo['id'] eq $paper_OneArr['id']">selected="selected"</if> >{pigcms{$vo.subject_name}</option>
                                        </volist>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" value="{pigcms{$paper_OneArr.title}" name="title" id="cat_url" required />
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-2 control-label" for="form_control_1">总分
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" disabled="true" value="{pigcms{$paper_OneArr.totalper}" name="totalper" id="cat_url" required />
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-2 control-label" for="form_control_1">考试时长
                                        <span class="required"></span>
                                    </label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="testtime"  value="{pigcms{$paper_OneArr.testtime}" placeholder="单位/分钟" />
                                        <input type="hidden" class="form-control" name="id" value="{pigcms{$paper_OneArr.id}" />
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-2 col-md-9">
                                        <button type="submit" class="btn green">确认更新</button>
