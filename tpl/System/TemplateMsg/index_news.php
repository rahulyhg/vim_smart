                    ...
                    <div class="portlet-body" style="overflow-x: auto;">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th style="width:5%;">模板编号</th>
                                <th style="width:3%;">模板名</th>
                                <th style="width:50%;">回复内容</th>
                                <th style="width:10%;">头部颜色</th>
                                <th style="width:10%;">文字颜色</th>
                                <th style="width:10%;">状态</th>
                                <th style="width:10%;">模板ID</th>
                            </tr>
                            </thead>
                            <tbody>
                            <foreach name="list" item="t">
                                <tr class="odd gradeX">
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                            ...
                            <tr>
                                <td colspan="7" align="center"><input type="submit" name="dosubmit" value="保存" class="button"/ style="margin-left:-910px;"></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
