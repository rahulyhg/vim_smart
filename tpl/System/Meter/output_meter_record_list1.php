...
<block name="body">
    ...
    <div class="tabbable-custom nav-justified" style="overflow-x: scroll;overflow-y: hidden;">
        <table class="table table-striped table-bordered table-hover"  id="sample_2" >
            <thead>
            <tr>
                <td colspan="41" align="center" style="font-size: 25px" class="center">(地下一层主配) 广发项目配电房运行记录表 ({pigcms{$year}) {pigcms{$meter['meter_cate']}------ {pigcms{$year} 年 {pigcms{$month} 月</td>
            </tr>
            <tr>
                <th  rowspan="3" class="center">日期</th>
                <th  rowspan="3" class="center">检查时间</th>                
                <th  colspan="7" class="center">1号变压器</th>
                <th  colspan="7" class="center">2号变压器</th>
                <th  colspan="7" class="center">3号变压器</th>
                <th  rowspan="3" class="center">抄表人签字</th>
                <!-- <for start="1" end="13">
                    <th  colspan="3" class="center">{pigcms{$i}月</th>
                </for> -->
            </tr>
            <tr>
                <th colspan="3">输出电流(A)</th>
...
<block name="script">
    ...
    <script>
        ...
        function change_url(type,val) {
            console.log(val);
            window.location.href='{pigcms{:U('Meter/output_meter_record_list1')}&'+type+'='+val;
        }
    </script>
</block>
