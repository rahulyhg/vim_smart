                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th>操作IP</th>
                                <th>通过的模块</th>
                                <th class="textcenter">通过的方法</th>
                                <th>操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            <foreach name="log_arr" item="vo">
                                <tr class="odd gradeX">
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                    ...
                                    <td>{pigcms{$vo.adminuser}</td>
                                    <td>{pigcms{$vo.table_name}</td>
                                    <td>{pigcms{$vo.opera_name}</td>
                                    <td>{pigcms{$vo.do_time|date='Y-m-d H:i',###}</td>
                                    <td>{pigcms{$vo.do_ip}</td>
                                    <td>{pigcms{$vo.module_name}</td>
                                    <td class="textcenter">{pigcms{$vo.action_name}</td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li onclick="delete_pr_info(this)" id="{pigcms{$vo['pigcms_id']}">
                                                    <a href="javascript:;">
