				...
				<div class="portlet light bordered">
					<div class="portlet-title">
						<div class="caption font-dark">
							...
							<span class="caption-subject bold uppercase"> 置顶信息列表</span>
						</div>
						<div class="actions">
					...
					<div class="portlet-body">
						<div class="table-toolbar">
							<div class="row">
								<div class="col-md-6">
									<div class="btn-group">
										<a href="{pigcms{:U('Access/deviceType_edit_news')}">
											<button id="sample_editable_1_new" class="btn sbold green"> 开启条件搜索
						...
						<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
							...
							<tbody>
							<foreach name="listdatas" item="vo">
								<tr class="odd gradeX">
									<td>
										<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
									...
									<td class="center">
										{pigcms{$ClassifyArr[$vo['fcid']]}
									</td>
									<td class="center">
										{pigcms{$ClassifyArr[$vo['cid']]}
									</td>
									<td class="center">
										<if condition="!empty($title)"> {pigcms{$vo['title']|str_replace=$title,'<b style="color: red;">'.$title.'</b>',###}<else/>{pigcms{$vo.title}</if>
									</td>
									<td class="center">
										{pigcms{$vo.endtoptime|date='Y-m-d H:i:s',###}
									</td>
									<td class="center">
										已审核/已置顶&nbsp;&nbsp;<input type="button" value="取消置顶" style="" class="button" onclick="CancelTop({pigcms{$vo.id})">
									</td>
									<td>
										<div class="btn-group">
											...
											<ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
												<li>
													<a href="{pigcms{:U('Classify/infodetail',array('vid'=>$vo['id']))} ">
														<i class="icon-tag"></i> 查看详细 </a>
												</li>
												<li>
													<a href="{pigcms{:U('Classify/attrSet',array('vid'=>$vo['id']))}">
														<i class="icon-tag"></i> 设置操作 </a>
												</li>
												<li>
													<a href="javascript:void(0);" onclick="toDelItem({pigcms{$vo.id});">
