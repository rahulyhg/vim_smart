                ...
                <div class="row">
                    <div class="tabbable-custom nav-justified">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
                            ...
                            <tbody>
                            <volist name="otherfee_list" id="row">
                                <tr>
    ...
    <script>
        ...
        $('#sample_2').dataTable( {
            "footerCallback": function( tfoot, data, start, end, display ) {
                $(tfoot).find('th').eq(2).html( '{pigcms{$sum.sum_last}' );
                $(tfoot).find('th').eq(3).html( '{pigcms{$sum.sum_nowrecive}' );
                $(tfoot).find('th').eq(4).html( '{pigcms{$sum.sum_nowtrue}' );
                $(tfoot).find('th').eq(5).html( '{pigcms{$sum.sum_nowend}' );
                <for start="1" end="$month_number1" >
                var ab1=4+{pigcms{$i}*2;
                var ab2=5+{pigcms{$i}*2;
