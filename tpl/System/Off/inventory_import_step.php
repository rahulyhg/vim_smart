...
<block name="body">
    <div>
        <form action="{pigcms{:U('inventory_import_step1')}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-2 col-md-9">
                        ...
                        <button type="button" class="btn default" onclick="app.redirect('inventory_list_news')">返 回</button>
                    </div>
                </div>
            </div>
        </form>
