...
<!--                                                <i class="fa fa-plus"></i>-->
                                    ...
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('goods_import_step')}">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr>
                                ...
                                <if condition="$villageId neq ''">
                                    <th style="text-align: center;">物品区域</th>
                                </if>
                                <th style="text-align: center;">单价</th>
                                <th style="text-align: center;">数量</th>
                                <if condition="$villageId neq ''">
                                    <th style="text-align: center;">占比率</th>
                                </if>                                
                            ...
                            <foreach name="offArr" item="vo" id="change_data">
                                <tr>
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                    ...
                                    <!-- <td>{pigcms{$vo.pro_code}</td> -->
                                    <td>
<!--                                        <a data-toggle="modal" data-target="#common_modal"  href="{pigcms{:U('Off/products_qr_code',array('pro_id'=>$vo['pro_id']))}">-->
<!--                                             {pigcms{$vo.pro_name}-->
<!--                                        </a>-->
                                        {pigcms{$vo.pro_name}
                                    </td>
                                    <td>{pigcms{$vo.type_name}</td>
                                    <td>{pigcms{$vo.band}</td>
                                    <if condition="$villageId neq ''">
                                        <td>{pigcms{$vo.zone_name}</td>
                                        <td>{pigcms{$vo.pro_price}</td>
                                        <td>{pigcms{$vo.r_num_v}/{pigcms{$vo.r_num}</td>
                                        <td>{pigcms{$vo.rate}%</td>
                                    <else/>
                                        <td>{pigcms{$vo.pro_price}</td>
                                        <td>{pigcms{$vo.r_num}</td>
                                    </if>
                                    <!-- <td>{pigcms{$vo.r_num}</td> -->
                                    <!-- <td>{pigcms{$vo.r_num}/{pigcms{$vo.pro_stock}</td> -->
                                    <td>{pigcms{$vo.pro_creator}</td>
                                    <td>{pigcms{$vo.create_time|date="Y-m-d H:i:s",###}</td>
                                    <td>
                                        <if condition="$villageId neq ''">
                                            <a href="{pigcms{:U('Off/products_operate',array('pro_id'=>$vo['pro_id'],'villageId'=>$villageId))}">物品管理</a>
                                        <else/>
                                            <a href="{pigcms{:U('Off/products_operate',array('pro_id'=>$vo['pro_id']))}">物品管理</a>
                                        </if>                                   
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('Off/products_edit',array('pro_id'=>$vo['pro_id']))}">
