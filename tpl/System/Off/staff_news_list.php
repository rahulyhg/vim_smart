                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Off/staff_house_add')}">
                                    ...
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Off/staff_list')}">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="company_list_count" style="margin-top:25px;">
                                            ...
                                            <foreach name="village" item="vo">
                                                <tr>
                                                    ...
                                                    <td align="center">{pigcms{$vo.room}</td>
                                                    <td align="center">{pigcms{$vo.bed_count}</td>
                                                    <td align="center">{pigcms{$vo.bed_number}</td>
                                                    <td align="center">
                                                        <a href="{pigcms{:U('Off/staff_house_village_edit',array('id'=>$vo['village_id']))}">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <foreach name="staff" item="vo" id="change_data">
                                <tr>
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                    ...
                                    <td>{pigcms{$vo.room}</td>
                                    <td>{pigcms{$vo.bed_number}</td>
                                    <td>{pigcms{$vo.name}</td>
                                    <td>{pigcms{$vo.department}</td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('Off/staff_house_edit',array('id'=>$vo['staff_id']))}">
                                                        <i class="icon-docs"></i> 更新 </a>
                                                </li>
                                                <li onclick="delete_pr_info(this)" id="{pigcms{$vo.staff_id}">
                                                    <a href="javascript:;">
    ...
    function delete_pr_info(obj) {
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"{pigcms{:U('Off/staff_house_delete')}",
                    data:{'id':id},
                    type:'post',
