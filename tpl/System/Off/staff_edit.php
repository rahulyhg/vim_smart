...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <form action="{pigcms{:U('Off/staff_edit')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <div class="col-md-12" style="float: left">
                    <div class="portlet light portlet-fit portlet-form bordered">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control select2" name="village_id" id="type" onchange="staff_room(this)">
                                            <volist name="vallage" id="v">
                                                <option value="{pigcms{$v.village_id}" <if condition="$v['village_id'] eq $staff['village_id']">selected="selected"</if>>{pigcms{$v.village_name}</option>
                                            </volist>
                                        </select>
                            ...
                            <div class="col-md-9" >
                                <select class="form-control select2" name="room" id="type1" onchange="room_change(this)" >
                                    <volist name="room" id="v">
                                        <option value="{pigcms{$v.room}" <if condition="$v['room'] eq $staff['room']">selected="selected"</if>>{pigcms{$v.room}</option>
                                    </volist>
                                </select>
                                <div class="form-control-focus"> </div>
                            </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="bed_number" id="phone" value="{pigcms{$staff['bed_number']}" placeholder="请输入床位数" required  readonly="readonly"/>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="department" id="location" value="{pigcms{$staff['department']}" placeholder="请输入部门" required readonly="readonly"/>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="comment" id="tax_rate" value="{pigcms{$staff['comment']}" placeholder="请输入备注" readonly="readonly"/>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" placeholder="" name="name" id="operator" value="{pigcms{$staff_name['name']}"/>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                ...
                                <input type="hidden" name="name_id" value="{pigcms{$staff_name['id']}" class="staff">
...
<script>
    ...
    function room_change(obj) {
        ...
        $.ajax({
            url:"{pigcms{:U('Off/staff_house_info')}",
