...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <form action="{pigcms{:U('Off/supplier_edit')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <div class="col-md-12" style="float: left">
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class=" icon-layers font-green"></i>
                                <span class="caption-subject font-green sbold uppercase">更新供应商</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="sup_unit" id="sup_unit" value="{pigcms{$supplier['sup_unit']}" placeholder="请输入单位信息"  required />
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="sup_name" id="sup_name" value="{pigcms{$supplier['sup_name']}" placeholder="请输入供应商姓名"  required />
                                <div class="form-control-focus"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="phone" id="phone" value="{pigcms{$supplier['phone']}" placeholder="请输入联系电话" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="location" id="location" value="{pigcms{$supplier['location']}" placeholder="请输入联系地址" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9">
                                <select class="form-control select2" name="business_scope[]" id="business_scope" multiple="multiple">
                                    <volist name="type_array" id="v">
                                        <option value="{pigcms{$v.id}" <if condition="in_array($v['id'],$supplier['scope_list'])">selected="selected"</if>>{pigcms{$v.info}</option> 
                                    </volist>
                                </select>
                                <div class="form-control-focus"> </div>
                            </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="tax_rate" id="tax_rate" value="{pigcms{$supplier['tax_rate']}" placeholder="请输入供应商商品税率" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="input-group input-large date-picker input-daterange">
                                <input type="text" class="form-control" name="supplier_start" id="supplier_start" <if condition="$supplier['supplier_start']">value="{pigcms{$supplier['supplier_start']}"<else/>value="<php>echo $_GET['d_time']?:date('Y-m-d')</php>"</if> onchange="" style="width: 140px;"> 
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="input-group input-large date-picker input-daterange">
                                <input type="text" class="form-control" name="supplier_end" id="supplier_end" <if condition="$supplier['supplier_end']">value="{pigcms{$supplier['supplier_end']}"<else/>value="<php>echo $_GET['d_time']?:date('Y-m-d')</php>"</if> onchange="" style="width: 140px;"> 
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" placeholder="" name="operator" id="operator" value="{pigcms{$supplier['operator']}"/>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>                    
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <span class="cb-enable"><label class="cb-enable"><span>正常</span><input type="radio" name="status" value="1" <if condition="$supplier['status'] eq 1">checked</if> /></label></span>

                                <span class="cb-disable"><label class="cb-disable"><span>已停止</span><input type="radio" name="status" value="0" <if condition="$supplier['status'] eq 0">checked</if> /></label></span>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div id="upload_pic_box">
                                <ul id="upload_pic_ul">
                                    <volist name="supplier['pic_arr']" id="vo">
                                        <li class="upload_pic_li"><img src="./upload/contract/{pigcms{$vo}"/><input type="hidden" name="pic[]" value="{pigcms{$vo.title}"/><br/><a href="#" onclick="deleteImage('{pigcms{$vo.title}',this);return false;">[ 删除 ]</a></li>
                                    </volist>
                                </ul>
                            </div>
                        </div>
                       	...
                       	<div class="form-actions">
                            <div class="row">
                                <input type="hidden" name="id" value="{pigcms{$supplier['id']}"/>
