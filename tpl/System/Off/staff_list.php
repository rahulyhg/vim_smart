                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Off/staff_add')}">
                                            <button id="sample_editable_1_new" class="btn sbold green">添加员工
                                                <i class="fa fa-plus"></i>
                                            </button>
                                        </a>
                                    </div>
                                    <div class="btn-group">
                                        <button class="btn btn-danger btn-sm" onclick="delete_pr_infos()">批量删除</button>
                                    </div>
                                    <!-- <div class="btn-group">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr>
                                <th>
                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                        <input type="checkbox" class="group-checkable" data-set="#sample_1 .checkboxes" onclick="staff_checked()"/>
                                        <span></span>
                                    </label>
                                </th>
                            ...
                            <foreach name="data" item="vo" id="change_data">
                                <tr>
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                            <input type="checkbox" class="checkboxes" value="{pigcms{$vo.id}"  id="checks" name="ids[]" />
                                            <span></span>
                                        </label>
                                    </td>
                                    <td>{pigcms{$vo.name}</td>
                                    <td>{pigcms{$vo.info.village_name}</td>
                                    <td>{pigcms{$vo.info.room}</td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('Off/staff_detail',array('id'=>$vo['id']))}" data-toggle="modal" data-target="#modal_{pigcms{$vo.id}">
                                                        <i class="icon-docs"></i> 详情 </a>
                                                </li>
                                                <li>
                                                    <a href="{pigcms{:U('Off/staff_edit',array('id'=>$vo['id']))}">
    ...
    function delete_pr_infos(){
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"{pigcms{:U('Off/staff_deletes')}",
                    data:{'ids':ids},
                    type:'post',
                    success:function(delmsg){
                        if(delmsg==='1'){
