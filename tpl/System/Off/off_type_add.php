...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">添加分类</span>
            </li>
        </ul>
        <div class="row">
            <form action="{pigcms{:U('Off/off_type_save')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">添加分类</span>
                            </div>
                            <div class="actions">
...
<!--                                                        </if>-->
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="type_name"  size="20" validate="maxlength:30,required:true" value="" required />
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                            </div>
