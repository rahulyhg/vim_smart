                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Off/off_zone_add')}">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <foreach name="typeArr" item="vo">
                                <tr>
                                    ...
                                    <td>{pigcms{$vo.id}</td>
                                    <td><a href="{pigcms{:U('Off/off_list_news',array('zone_id'=>$vo['id']))}">{pigcms{$vo.zone_name}</a></td>
                                    <td>顶级分类</td>
                                    <td>{pigcms{$vo.check_name}</td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('Off/off_zone_update',array('id'=>$vo['id']))}">
                                ...
                                <if condition="isset($vo['son'])">
                                    <foreach name="vo['son']" item="v">
                                        <tr>
                                            ...
                                            <td>{pigcms{$v.id}</td>
                                            <td><a href="{pigcms{:U('Off/off_list_news',array('zone_id'=>$v['id']))}">|---{pigcms{$v.zone_name}</a></td>
                                            <td>{pigcms{$vo.zone_name}</td>
                                            <td>{pigcms{$v.check_name}</td>
                                            <td>{pigcms{$v.create_time|date="Y-m-d H:i:s",###}</td>
                                            <td>
                                                <div class="btn-group">
                                                    <button class="btn btn-xs green dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> 操作
                                                        <i class="fa fa-angle-down"></i>
                                                    ...
                                                    <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                        <li>
                                                            <a href="{pigcms{:U('Off/off_zone_update',array('id'=>$v['id']))}">
                                                                <i class="icon-docs"></i> 更新 </a>
                                                        </li>
                                                        <li onclick="delete_pr_info(this)" id="{pigcms{$v.id}">
                                                            <a href="javascript:;">
                                                                <i class="icon-tag"></i> 删除 </a>
                                                        </li>
                                                    </ul>
                                        ...
                                        <if condition="isset($v['g_son'])">
                                            <foreach name="v['g_son']" item="sv">
                                                <tr>
                                                    ...
                                                    <td>{pigcms{$sv.id}</td>
                                                    <td><a href="{pigcms{:U('Off/off_list_news',array('zone_id'=>$sv['id']))}">|---|---{pigcms{$sv.zone_name}</a></td>
                                                    <td>{pigcms{$v.zone_name}</td>
                                                    <td>{pigcms{$sv.check_name}</td>
                                                    <td>{pigcms{$sv.create_time|date="Y-m-d H:i:s",###}</td>
                                                    <td>
                                                        <div class="btn-group">
                                                            <button class="btn btn-xs green dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> 操作
                                                                <i class="fa fa-angle-down"></i>
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                                <li>
                                                                    <a href="{pigcms{:U('Off/off_zone_update',array('id'=>$sv['id']))}">
                                                                        <i class="icon-docs"></i> 更新 </a>
                                                                </li>
                                                                <li onclick="delete_pr_info(this)" id="{pigcms{$sv.id}">
                                                                    <a href="javascript:;">
                                                                        <i class="icon-tag"></i> 删除 </a>
                                                                </li>
                                                            </ul>
    ...
    function delete_pr_info(obj) {
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"{pigcms{:U('Off/off_zone_delete')}",
                    data:{'id':id},
                    type:'post',
