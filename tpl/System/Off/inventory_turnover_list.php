                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> 商品进/出库信息列表 </span>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Off/inventory_list_news')}">
                                    ...
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Off/inventory_turnover_add')}">
                                            <button id="sample_editable_1_new" class="btn sbold green">新建商品进/出库信息
                                                <i class="fa fa-plus"></i>
                                            </button>
                                        </a>
                                    </div>
                                    ...
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('inventory_turnover_import_step')}">
                                            <button id="sample_editable_1_new" class="btn sbold green">批量导入商品进/出库信息
                                                <!-- <i class="fa fa-plus"></i> -->
                                            </button>
                                        </a>
                                    </div>
                                    <!-- <div class="btn-group">
                                        <a href="{pigcms{:U('Off/inventory_in_list')}" data-toggle="modal">
                                            <button id="sample_editable_1_new" class="btn sbold green">商品入库信息总表
                                                <i class="fa fa-plus"></i>
                                            </button>
                                        </a>
                                    </div>
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Off/inventory_out_list')}" data-toggle="modal">
                                            <button id="sample_editable_1_new" class="btn sbold green">商品出库信息总表
                                                <i class="fa fa-plus"></i>
                                            </button>
                                        </a>
                                    </div> -->
                    ...
                    <!-- 模态框结束     -->
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th style="text-align: center;">进/出库</th>
                                <th style="text-align: center;">进/出库时间</th>
                                <th style="text-align: center;">进/出库数量</th>
                                <th style="text-align: center;">操作人</th>
                                <th style="text-align: center;">备注</th>
                                <th style="width: 150px; text-align: center;">操作</th>
                            </tr>
                            </thead>
                            <foreach name="inventory_list" item="vo" id="change_data">
                                <tr>
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                    ...
                                    <if condition="$vo['info'] eq 1">
                                        <td>入库</td>
                                    <else/>
                                        <td>出库</td>
                                    </if>
                                    <td>{pigcms{$vo.info_time}</td>
                                    <!-- <td>{pigcms{$vo.brand}</td> -->
                                    <td>{pigcms{$vo.info_count}</td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('Off/inventory_turnover_edit',array('id'=>$vo['id']))}">
    ...
    function delete_pr_info(obj) {
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"{pigcms{:U('Off/inventory_turnover_delete')}",
                    data:{'id':id},
                    type:'post',
