...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <form action="{pigcms{:U('Off/staff_house_village_edit')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <div class="col-md-12" style="float: left">
                    <div class="portlet light portlet-fit portlet-form bordered">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="vallage_name" id="sup_name" value="{pigcms{$village['village_name']}" placeholder="请输入项目名称"  required readonly="readonly"/>
                            ...
                            <div class="col-md-9" >
                                <select class="form-control select2" name="room" id="type1" onchange="room_change(this)" >
                                    ...
                                    <volist name="room" id="v">
                                        <option value="{pigcms{$v.room}">{pigcms{$v.room}</option>
                                    </volist>
                                </select>
                                <div class="form-control-focus"> </div>
                            </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <input type="hidden" name="village_id" value="{pigcms{$village['village_id']}" class="staff" id="type">
...
<script>
    ...
    function room_change(obj) {
        ...
        $.ajax({
            url:"{pigcms{:U('Off/staff_house_village_room')}",
