                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> 人员住宿历史记录 </span>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <foreach name="info" item="vo" id="change_data">
                                <tr>
                                    ...
                                    <td onclick="delete_pr_info(this)" id="{pigcms{$vo.id}">
    ...
    function delete_pr_info(obj) {
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"{pigcms{:U('Off/staff_record_delete')}",
                    data:{'id':id},
                    type:'post',
    ...
    function delete_pr_infos(){
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"{pigcms{:U('Off/staff_record_deletes')}",
                    data:{'ids':ids},
                    type:'post',
                    success:function(delmsg){
                        if(delmsg==='1'){
