...
<!--                        </select>-->
    ...
    <div class="shtx_xm">
        ...
        <div class="shtx_kek"><input name="borrower" id="borrower" value="{pigcms{$proArr.borrower}" type="text" <if condition="$isOpen neq 1">disabled</if> style="width:95%; border:1px #d4d4d4 solid; height:28px; line-height:28px; border-radius:0px; font-size:14px; padding-left:5px;">
        </div>
        <div class="both"></div>
    </div>
