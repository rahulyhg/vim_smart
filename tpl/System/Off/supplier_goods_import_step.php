...
<block name="body">
    <div>
        <form action="{pigcms{:U('supplier_goods_import_step1')}" method="post" enctype="multipart/form-data">
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-9">
                    <a href="http://www.hdhsmart.com/upload/example/供应商商品数据导入格式表.xls" download="supplier_goods_example.xls">
                        下载
                    </a>
                </div>
            </div>
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-2 col-md-9">
                        ...
                        <button type="button" class="btn default" onclick="app.redirect('supplier_goods_list')">返 回</button>
                    </div>
                </div>
            </div>
        </form>
