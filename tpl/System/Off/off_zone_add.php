...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            <li>
                <a href="{pigcms{:U('Off/off_zone_news')}">分类区域</a>
        ...
        <div class="row">
            <form action="{pigcms{:U('Off/off_zone_save')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input" id="village">
                                    <label class="col-md-2 control-label" for="form_control_1">父级区域
...
<!--                                                        </if>-->
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="zone_name"  size="20" validate="maxlength:30,required:true" value="" required />
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                            </div>
