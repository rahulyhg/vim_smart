...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <form action="{pigcms{:U('Off/inventory_turnover_edit')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <div class="col-md-12" style="float: left">
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class=" icon-layers font-green"></i>
                                <span class="caption-subject font-green sbold uppercase">更新商品进/出库信息</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <span class="cb-enable"><label class="cb-enable"><span>进库</span><input type="radio" name="info" value="1" <if condition="$inventory['info'] eq 1">checked</if>/></label></span>

                                <span class="cb-disable"><label class="cb-disable <if condition="$inventory['info'] eq 2">selected</if>"><span>出库</span><input type="radio" name="info" value="2" <if condition="$inventory['info'] eq 2">checked</if> /></label></span>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="input-group input-large date-picker input-daterange">
                                <input type="text" class="form-control" name="info_time" id="info_time" <if condition="$inventory['info_time']">value="{pigcms{$inventory['info_time']}"<else/>value="<php>echo $_GET['d_time']?:date('Y-m-d')</php>"</if> onchange="" style="width: 140px;"> 
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="info_count" id="info_count" value="{pigcms{$inventory['info_count']}" placeholder="请输入商品单位" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="operator" id="operator" value="{pigcms{$inventory['operator']}" placeholder="请输入操作人" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>                       
