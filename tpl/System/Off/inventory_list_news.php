                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Off/inventory_add')}">
                                    ...
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('inventory_import_step')}">
                                    ...
                                    <div class="btn-group">
                                        <a href="{pigcms{:U('Off/inventory_turnover_list')}" data-toggle="modal">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('Off/inventory_edit',array('id'=>$vo['id']))}">
    ...
    function delete_pr_info(obj) {
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"{pigcms{:U('Off/inventory_delete')}",
                    data:{'id':id},
                    type:'post',
