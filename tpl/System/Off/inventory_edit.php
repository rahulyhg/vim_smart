...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{pigcms{:U('Off/inventory_list_news')}">库存信息列表</a>
                <i class="fa fa-circle"></i>
            </li>            
        </ul>
        <div class="row">
            <form action="{pigcms{:U('Off/inventory_edit')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <div class="col-md-12" style="float: left">
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class=" icon-layers font-green"></i>
                                <span class="caption-subject font-green sbold uppercase">更新库存商品信息</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="goods_name" id="goods_name" value="{pigcms{$inventory['goods_name']}" placeholder="请输入商品名称"  required />
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="specification" id="specification" value="{pigcms{$inventory['specification']}" placeholder="请输入商品规格参数"  required />
                                <div class="form-control-focus"></div>
                            </div>
                        </div>
                        ...
                        <!-- <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="unit" id="unit" placeholder="请输入商品单位" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div> -->
                        ...
                        <!-- <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="price" id="price" placeholder="请输入商品单价" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div> -->

                        <div class="form-group form-md-line-input">
                            <label class="col-md-2 control-label" for="form_control_1">库存数量
                                <span class="required">*</span>
                            </label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="count" id="count" value="{pigcms{$inventory['count']}" placeholder="请输入商品数量" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <!-- <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="brand" id="brand" placeholder="请输入商品品牌" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div> -->
                            ...
                            <div class="col-md-9">
                                <select class="form-control select2" name="type" id="type">
                                    <volist name="type_array" id="v">
                                        <option value="{pigcms{$v.id}" <if condition="$v['id'] eq $inventory['type']">selected="selected"</if>>{pigcms{$v.info}</option>
                                    </volist>
                                </select>
                                <div class="form-control-focus"> </div>
                            </div>
                            ...
                            <div class="col-md-9">
                                <select class="form-control select2" name="sup_id" id="sup_id">
                                    <volist name="sup_array" id="v">
                                        <option value="{pigcms{$v.id}" <if condition="$v['id'] eq $inventory['sup_id']">selected="selected"</if>>{pigcms{$v.sup_unit}</option>
                                    </volist>
                                </select>
                                <div class="form-control-focus"> </div>
                            </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="remark" id="remark" value="{pigcms{$inventory['remark']}" placeholder="请输入商品备注" />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>                    
                       	...
                       	<div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-2 col-md-9">
                                    <input type="hidden" name="id" value="{pigcms{$inventory['id']}"/>
                                    <button type="submit" class="btn green">确认提交</button>
                                    <button type="reset" class="btn default" onclick="window.location.href='http://www.hdhsmart.com/admin.php?g=System&c=Off&a=inventory_list_news'">返 回</button>
                                </div>
                            </div>
                        </div>
				    </div>
