...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            <li>
                <a href="{pigcms{:U('Off/off_type_news')}">分类管理</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span class="active">更新分类</span>
            </li>
        </ul>
        <div class="row">
            <form action="{pigcms{:U('Off/off_type_update')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="pid"  required>
                                            ...
                                            <foreach name="typeArr" item="vo">
                                                <option value="{pigcms{$vo.id}" <if condition="$tArr['pid'] eq $vo['id']">selected</if>>{pigcms{$vo.type_name}</option>
                                                <if condition="isset($vo['son'])">
                                                    <foreach name="vo['son']" item="v">
                                                        <option value="{pigcms{$v.id}" <if condition="$tArr['pid'] eq $v['id']">selected</if> >|--{pigcms{$v.type_name}</option>
<!--                                                        <if condition="isset($v['g_son'])">-->
<!--                                                            <foreach name="v['g_son']" item="sv">-->
<!--                                                                <option value="{pigcms{$sv.id}" <if condition="$tArr['pid'] eq $sv['id']">selected</if> >|--|--{pigcms{$sv.type_name}</option>-->
<!--                                                            </foreach>-->
<!--                                                        </if>-->
                                                    </foreach>
                                                </if>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="type_name"  size="20" validate="maxlength:30,required:true" value="{pigcms{$tArr.type_name}" required />
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
					...
					<div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-9">
                                ...
                                <button type="reset" class="btn default" onclick="window.location.href='http://www.hdhsmart.com/admin.php?g=System&c=Off&a=off_type_news'">返 回</button>
                            </div>
                        </div>
                    </div>
