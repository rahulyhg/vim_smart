...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">更新物品</span>
            </li>
        </ul>
        <div class="row">
            <form action="{pigcms{:U('Off/products_edit')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <input type="hidden" name="pro_id" value="{pigcms{$proArr['pro_id']}"/>
                <div class="col-md-12" style="float: left">
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class=" icon-layers font-green"></i>
                                <span class="caption-subject font-green sbold uppercase">更新物品</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="pro_name" id="pro_name" value="{pigcms{$proArr.pro_name}"  required />
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="off_pro_type"  required>
                                            ...
                                            <foreach name="typeArr" item="vo">
                                                <option value="{pigcms{$vo.id}" <if condition="$proArr['off_pro_type'] eq $vo['id'] " >selected</if> >{pigcms{$vo.type_name}</option>
                                                <if condition="isset($vo['son'])">
                                                    <foreach name="vo['son']" item="v">
                                                        <option value="{pigcms{$v.id}" <if condition="$proArr['off_pro_type'] eq $v['id'] " >selected</if> >|--{pigcms{$v.type_name}</option>
                                                        <if condition="isset($v['g_son'])">
                                                            <foreach name="v['g_son']" item="sv">
                                                                <option value="{pigcms{$sv.id}" <if condition="$proArr['off_pro_type'] eq $sv['id'] " >selected</if> >|--|--{pigcms{$sv.type_name}</option>
                                                            </foreach>
                                                        </if>
                                                    </foreach>
                                                </if>
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="zone_id"  required>
                                            ...
                                            <foreach name="zone_list" item="vo">
                                                <option value="{pigcms{$vo.id}" <if condition="$proArr['zone_id'] eq $vo['id'] " >selected</if> >{pigcms{$vo.zone_name}</option>
                                                <if condition="isset($vo['son'])">
                                                    <foreach name="vo['son']" item="v">
                                                        <option value="{pigcms{$v.id}" <if condition="$proArr['zone_id'] eq $v['id'] " >selected</if> >|--{pigcms{$v.zone_name}</option>
                                                        <if condition="isset($v['g_son'])">
                                                            <foreach name="v['g_son']" item="sv">
                                                                <option value="{pigcms{$sv.id}" <if condition="$proArr['zone_id'] eq $sv['id'] " >selected</if> >|--|--{pigcms{$sv.zone_name}</option>
                                                            </foreach>
                                                        </if>
                                                    </foreach>
                                                </if>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="pro_unit" size="20" value="{pigcms{$proArr.pro_unit}"  required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="pro_stock" size="20" value="{pigcms{$proArr.pro_stock}" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="date" class="form-control" name="purch_time" id="purch_time" size="20"   value="{pigcms{$proArr.purch_time|date='Y-m-d',###}" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="band" id="band" size="20" value="{pigcms{$proArr.band}" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="pro_price"  value="{pigcms{$proArr.pro_price}" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="pro_supplier" value="{pigcms{$proArr.pro_supplier}" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="pro_desc" size="20" value="{pigcms{$proArr.pro_desc}" />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="pro_specification" size="20" value="{pigcms{$proArr.pro_specification}" />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <span class="cb-enable"><label class="cb-enable <if condition="$proArr['product_status'] eq 1">selected</if>"><span>领用</span><input type="radio" name="product_status" value="1" <if condition="$proArr['product_status'] eq 1">checked="checked"</if> /></label></span>

                                <span class="cb-disable"><label class="cb-disable  <if condition="$proArr['product_status'] eq 2">selected</if>"><span>借用</span><input type="radio" name="product_status" value="2" <if condition="$proArr['product_status'] eq 2">checked="checked"</if> /></label></span>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
