                ...
                <div class="profile-sidebar">
                    ...
                    <div class="portlet light profile-sidebar-portlet bordered">
                        ...
                        <div class="profile-userbuttons">
                            ...
                            <a  class="btn btn-circle red btn-sm" href="javascript:;" style="text-align: center" onclick="go_add_personnel()">
                                员工添加
                            </a>
                        </div>
                        <!-- END SIDEBAR BUTTONS -->
                                ...
                                <div class="portlet-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="btn-group">
                                                    ...
                                                    <div style="margin-left:10px; float:left;">
                                                        <a  class="btn green " href="javascript:;" style="text-align: center" onclick="go_add_personnel()">
                                                            员工添加
                                                        </a>
                                                    </div>
                                                    <div style="margin-left:10px; float:left;">
                                                        <a  class="btn red " href="{pigcms{:U('Personnel/add_personnel_excel')}" style="text-align: center" >
                                                            员工导入
                                                        </a>
                                                    </div>
                                                    <div style="margin-left:10px; float:left;">
                                                        <a  class="btn blue" href="{pigcms{:U('Personnel/personnel_check_list')}" style="text-align: center" >
                                                            待办事项人员查看
                                                        </a>
                                                    </div>
                                    ...
                                    <!--<div class="btn-group" style="margin-top: 10px;margin-bottom: 10px">
                                        ...
                                        <span id="filter">
                                            <span>
                    <div class="btn-group">
                        <select id="search_type"  class="form-control search" onchange="search_change('search_type',this.options[this.options.selectedIndex].value)">
                            <option value="0">条件搜索</option>
                            <option value="1">本月社保缴纳</option>
                            <option value="2">本月公积金缴纳</option>
                            <option value="3">本月推荐奖励</option>
                        </select>
                    </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="simple_2">
                                        ...
                                        <tr>
                                            ...
                                            <th> 公积金缴纳时间 </th>
                                            <th> 公积金缴纳时间 </th>
                                            <th style="text-align:center;"> 是否有后台账号 </th>
...
<script type="text/javascript">
    ...
    table.dataTable({
        ...
        'processing':true,// 加载
        ajax: {
            url: '{pigcms{:U("Personnel/ajax_personnel_list")}&department_id='+localStorage.getItem('department_id'),
            type: 'POST'
        },
        ordering:  false,
        ...
        "aoColumns": [
            ...
            {
                "sTitle" : "参保时间",
                "mDataProp": "social_addtime",
                "sDefaultContent" : "",
                "sClass" : "center"
            },
            {
                "sTitle" : "参保情况",
                "mDataProp": "social_condition",
                "sDefaultContent" : "",
                "sClass" : "center"
            },
            {
                "sTitle" : "公积金缴纳时间",
                "mDataProp": "accumulation_addtime",
                "sDefaultContent" : "",
                "sClass" : "center"
            },
            {
            ...
            {
                "sTitle" : "转正时间",
                "mDataProp": "positivetime",
                "sDefaultContent" : "",
                "sClass" : "center"
            },
            {
                "sTitle" : "合同结束时间",
                "mDataProp": "contract_end",
                "sDefaultContent" : "",
                "sClass" : "center"
            },
            {
                "sTitle" : "年假剩余",
                "mDataProp": "annual_residue",
                "sDefaultContent" : "",
                "sClass" : "center"
            },
            {
                "sTitle" : "是否有后台账号",
                "mDataProp": "admin_type",
                "sDefaultContent" : "",
                "sClass" : "center"
            },
            {
    ...
    function search_change(key,value){
        ...
        var url='{pigcms{:U("Personnel/ajax_personnel_list")}&department_id='+localStorage.getItem('department_id')+'&search_type='+sessionStorage.getItem('search_type');
...
<script type="text/javascript">
    ...
    function dept_click(obj){
        ...
        var dept_idVal=localStorage.getItem('department_id');
        //alert(dept_idVal);
        ...
        /*$('#displaynone').attr('href','{pigcms{:U('House/department_edit')}&id='+dept_idVal);
        $('#displaynone').trigger('click');*/
    }
...
<script type="text/javascript">
    ...
    function go_add_personnel() {
        var department_id=localStorage.getItem('department_id');
        window.location.href='{pigcms{:U('Personnel/personnel_edit')}&department_id='+department_id;
    }
