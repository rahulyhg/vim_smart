...
<form action="__SELF__" METHOD="post">
    <input name="idVal" value="{pigcms{$Think.get.id}" type="hidden">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <table width="95%" border="0" cellspacing="0" cellpadding="0" style="margin-top:20px;">
                ...
                <tr>
                    <td height="50" align="left">
                        <input type="text" class="input condition" name="nickname" value="{pigcms{$user_info.nickname}" style="border:1px #e3e7ea solid;border-radius:6px;line-height:32px;height:32px;width:90%;outline:none;padding-left:10px;padding-right:10px;font-family:'微软雅黑';color:#919191; font-size:14px;" placeholder="请输入微信昵称"/>
                    </td>
                    <td height="50" align="left">
                        ...
                        <td height="50" align="left">
                            <select name="tid" style="width:95%;border:1px #e3e7ea solid;border-radius:6px;height:32px;line-height:32px;outline:none;color:#919191; font-size:14px;padding-left:10px;font-family:'微软雅黑';">
                                ...
                                <volist name="tenant_array" id="row">
                                    <if condition="$row['pigcms_id'] eq $user_info['tid']">
                                        <option value="{pigcms{$row.pigcms_id}" selected="selected">{pigcms{$row.tenantname}</option>
                                        <else />
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-9">
                    <volist name="role_list" id="v">
                        <div style="margin: 5px;width: 10px;font-size: 14px;display: inline-block;">
                            <input type="checkbox"  name="role_id[]" id="role_id_{pigcms{$v.role_id}"  value="{pigcms{$v.role_id}" <if condition="in_array($v['role_id'],$user_info['role_id'])">checked</if> />
