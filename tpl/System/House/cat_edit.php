...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <form action="{pigcms{:U('cat_edit')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <input type="hidden" name="cat_id" value="{pigcms{$info['cat_id']}">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="cat_name" id="cat_name" value="{pigcms{$info.cat_name}"/>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="cat_sort" id="cat_sort" value="{pigcms{$info.cat_sort}"/>
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group form-md-radios">
                                    ...
                                    <div class="col-md-9">
                                        <div class="md-radio-inline">
                                            <div class="md-radio">
                                                <input type="radio" id="checkbox1_11" name="cat_status" value="1" class="md-radiobtn" <if condition="$info['cat_status'] eq 1"> checked="checked" </if>>
                                            ...
                                            <div class="md-radio">
                                                <input type="radio" id="checkbox1_12" name="cat_status" value="0" class="md-radiobtn" <if condition="$info['cat_status'] eq 0"> checked="checked" </if>>
