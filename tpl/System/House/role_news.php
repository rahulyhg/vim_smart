                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <foreach name="role_list" item="v">
                                <tr class="odd gradeX">
                                    ...
                                    <td>{pigcms{$v.role_id} </td>
                                    <td>{pigcms{$v.role_name}</td>
                                    <td>{pigcms{$v.role_desc}</td>
                                    <if condition="$v['belong_user'] neq ''">
                                        <td style="color: blue;">{pigcms{$v.belong_user}<a class="btn green btn-xs" href="{pigcms{:U('Admin/index_news',array('role_id'=>$v['role_id']))}" style="float: right">更多</a></td>
                                    <else/>
                                        <td style="color: red;">该角色未分配人员</td>
                                    </if>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="{pigcms{:U('House/role_edit_new',array('role_id'=>$v['role_id']))}">
