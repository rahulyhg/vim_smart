...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">添加新闻</span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
        <!-- BEGIN PAGE BASE CONTENT -->
        <div class="row">
            <form action="{pigcms{:U('news_add')}" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <select name="village_id" id="village_id">
                                            <option selected="selected" value="1">全社区通用</option>
                                    ...
                                    <div class="form-group form-md-line-input" id="cat">
                                        <if condition="$admin['system']['account'] neq 'admin'">
                                    ...
                                    <div class="col-md-9">
                                        <select name="cat_id" id="cat_id">
                                            <volist name="cate" id="v">
                                                <option value="{pigcms{$v.cat_id}">{pigcms{$v.cat_name}</option>
                                            </volist>
                                        </select>
                                        <div class="form-control-focus"> </div>
                                    </div>
...
<!--                                    <div class="col-md-9">-->
<!--                                        <input type="text" class="form-control" placeholder="" name="content" id="content"/>-->
<!--                                        <div class="form-control-focus"> </div>-->
<!--                                    </div>-->
                                ...
                                <div class="form-group form-md-radios">
                                    ...
                                    <div class="col-md-9">
                                        <div class="md-radio-inline">
                                            <div class="md-radio">
                                                <input type="radio" id="checkbox1_9" name="is_hot" value="1" class="md-radiobtn">
                                            ...
                                            <div class="md-radio">
                                                <input type="radio" id="checkbox1_10" name="is_hot" value="0" class="md-radiobtn">
                                ...
                                <div class="form-group form-md-radios">
                                    ...
                                    <div class="col-md-9">
                                        <div class="md-radio-inline">
                                            <div class="md-radio">
                                                <input type="radio" id="checkbox1_11" name="status" value="1" class="md-radiobtn">
                                            ...
                                            <div class="md-radio">
                                                <input type="radio" id="checkbox1_12" name="status" value="0" class="md-radiobtn">
