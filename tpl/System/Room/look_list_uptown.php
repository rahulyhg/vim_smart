...
<div class="modal-body" style="height: 40rem;overflow-y: scroll">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-hover" id="myTable">
                ...
                <tr class="main_price">
                    <td>燃气费</td>
                    <td data-field="electric_price">{pigcms{:sprintf("%.2f", $payListInfo['use_gas'])}元</td>
                </tr>
                <tr class="main_price">
                    <td>泊位费</td>
                    <td data-field="electric_price">{pigcms{:sprintf("%.2f", $payListInfo['use_park'])}元
                        <if condition="$payListInfo['park_price'] eq 0 and $payListInfo['use_park'] neq 0">
                            <span style="color: green;">已缴费</span>
                        </if>
                        <if condition="$payListInfo['park_price'] neq 0 and $payListInfo['use_park'] neq 0">
                            <span style="color: red;">待缴费</span>
                        </if></td>

                </tr>
                <tr class="main_price">
                    <td>物业费</td>
                    <td data-field="property_price">{pigcms{:sprintf("%.2f", $payListInfo['use_property'])}元
                        <if condition="$payListInfo['property_price'] eq 0 and $payListInfo['use_property'] neq 0">
                            <span style="color: green;">已缴费</span>
                        </if>
                        <if condition="$payListInfo['property_price'] neq 0 and $payListInfo['use_property'] neq 0">
                            <span style="color: red;">待缴费</span>
                        </if>
                    </td>
                ...
                <if condition="$otherList">
                    <tr>
                        ...
                        <if condition="$payListInfo['other_price'] eq 0 and $payListInfo['use_other'] neq ''">
                            <span style="color: green;">已缴费</span>
                        </if>
                        <if condition="$payListInfo['other_price'] neq 0 and $payListInfo['use_other'] neq ''">
                            <span style="color: red;">待缴费</span>
                        </if>
    ...
    <!--<div style="width: 50%;float: left">
        ...
        <a data-toggle="modal" data-target="#third_modal" href="{pigcms{:U('PropertyService/show_this_template',array('usernum'=>$payListInfo['usernum'],'ym'=>$_GET['ym']?:date('Y-m'),'type'=>1))}">
    ...
    <div style="width: 50%;float: left;">
        ...
        <a data-toggle="modal" data-target="#third_modal" href="{pigcms{:U('PropertyService/show_this_template',array('usernum'=>$payListInfo['usernum'],'ym'=>$_GET['ym']?:date('Y-m'),'type'=>0))}">
