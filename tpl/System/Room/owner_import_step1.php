...
<block name="body">
    <div>
        <form action="{pigcms{:U('owner_import_step2')}" method="post" enctype="multipart/form-data">
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-9">
                    <a href="http://www.hdhsmart.com/upload/example/owner.xlsx" download="owner_example.xlsx">
                        下载
                    </a>
                </div>
            </div>
