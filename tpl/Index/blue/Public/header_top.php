    ...
    <div class="hot cf">
        <div class="loginbar cf">
			<if condition="empty($user_session)">
				<div class="login"><a href="{pigcms{:UU('Index/Login/index')}" style="color:red;"> 登陆 </a></div>
...
<header class="header cf">
    ...
    <div class="nav cf">
		<div class="logo">
<span><a href="{pigcms{$config.site_url}" title="{pigcms{$config.site_name}"><img  src="{pigcms{$config.site_logo}" /></a></span>
<div class="dcs"><h1>{pigcms{$now_city_name}</h1><a href="/index.php?g=Index&c=Changecity&a=index">切换城市</a></div>
			<div></div>
