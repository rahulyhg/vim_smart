			                    ...
			                    <table cellspacing="0" class="buy-table">
			                    	...
			                    	<notempty name="score_count">
                                                <tr>
                                                    ...
                                                    <td colspan="3" class="extra-fee total-fee rightpadding">
                                                        使用积分抵扣:<input type="checkbox" id ="use_score" name="use_score" value="1" <if condition="$score_checkbox eq 1 "> checked="checked" </if><if condition="$score_can_use_count eq 0 "> disabled="disabled" </if>>
                                                    </td>
                                                </tr>
                                            </notempty>
			                	</table>
