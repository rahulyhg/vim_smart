...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="http://www.hdhsmart.com/admin.php?g=System&c=Warning&a=system_index">计划任务管理</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <if condition="$is_work eq 1 and $is_not_deal eq 0">
                                                    <span class="btn green-jungle btn-lg" id="search">监控进行中....</span>
                                                <else/>
                                                    <span class="btn red btn-lg">监控关闭中</span>
                                                </if>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <if condition="$is_work eq 1 and $is_not_deal eq 0">
                                                    <a href="javascript:;" class="btn green-jungle btn-lg" id="end_work" > 停止监控 </a>
                                                <else/>
                                                    <a href="javascript:;" class="btn green-jungle btn-lg" id="start_work"> 开启监控 </a>
                                                </if>
                                                <a href="javascript:;" class="btn green-jungle btn-lg" id="end_work" style="display: none"> 停止监控 </a>
                                                <a href="javascript:;" class="btn green-jungle btn-lg" id="start_work" style="display: none"> 开启监控 </a>
                                            </div>
                                        </div>
                                    </div>
                                    </form>
