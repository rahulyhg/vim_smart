...
<style type="text/css">
	...
	.few {width:100%; height:40px; overflow:hidden; text-align:center; line-height:40px; background-color:#18b4ed; color:#FFFFFF; border-radius:4px; font-size:16px;}
	.few:active {background-color:#119fd3;}
	#menuList .menudesc .addmark {
	margin-top:5px;
    width: 60px;
    height: 27px;
    text-align: center;
    ...
    background: #ffffff;
    color: #00adcf;
	border:1px #00adcf solid;
}
</style>
<body onselectstart="return true;" ondragstart="return false;" style="background-color:#e5e5e5;" ontouchstart="">
<script type="text/javascript">
	var islock=false;
	function next() {
...
<section data-role="body">
	<div class="main" >
		...
		<form name="myorderform" method="POST" action="{pigcms{$action_url}">
			...
			<!--<div class="mark">
				<a href="javascript:history.go(-1)"><div class="few">返 回</div></a>
...
<footer data-role="footer">			
	<nav class="g_nav">
		<div>
			<span style="width:5%; padding-top:3px; padding-right:3px;"><img src="http://www.hdhsmart.com/tpl/Wap/default/static/meal/image/car.png" style="width:100%; height:auto;"></span>
			<if condition="isset($level_off) AND !empty($level_off)">
			<span><span class="money"><del>￥<label id="allmoney">0</label></del>&nbsp;￥<label id="levelallmoney">0</label></span>/<label id="menucount">0</label>份</span><span style="margin-left: 60px;color: #FD7008;">{pigcms{$level_off['offstr']}</span>
			<else />
			<span> <span class="money">￥<label id="allmoney">0</label> </span> <span style="color:#a2a2a3; margin-left:3px;"> / <label id="menucount">0</label> 份</span></span>
			</if>
			<a href="javascript:next();" class="btn orange show" id="nextstep">下一步</a>
			<a href="javascript::" onClick="javascript:history.back(-1);" class="btn orange show">上一步</a>
		</div>
	</nav>
</footer>
