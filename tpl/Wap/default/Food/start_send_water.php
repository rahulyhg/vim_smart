...
<div class="weui-form-preview">
    ...
    <div class="weui-form-preview__bd">
        ...
        <div class="weui-form-preview__item">
            <label class="weui-form-preview__label">送货人</label>
            <span class="weui-form-preview__value">{pigcms{$data[0]['admin_user_info']['nickname']}</span>
        </div>
        <div class="weui-form-preview__item">
            <label class="weui-form-preview__label">联系方式</label>
            <span class="weui-form-preview__value"><a href="tel:{pigcms{$data[0]['phone']}">{pigcms{$data[0]['admin_user_info']['phone']}</a></span>
        </div>
        <div class="weui-form-preview__item">
...
<script>
  var status = parseInt("{pigcms{$data[0]['status']}");
  if(status===1){
      $('#audit_1').text("已通知用户");
      $('#audit_1').hidden();
