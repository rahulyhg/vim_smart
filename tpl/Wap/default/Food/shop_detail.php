...
<body onselectstart="return true;" ondragstart="return false;">
	...
	<section data-role="body" class="section_scroll_content">
		...
		<ul class="pay">
			...
			<li class="title"><a><span class="icon mark"></span>服务简介</a></li>
		...
		<ul class="pay">
			...
			<li class="title"><a><span class="icon gr"></span>服务特色</a></li>
		...
		<ul class="pay">
			...
			<li class="title"><a><span class="icon call"></span>电话</a></li>
		...
		<ul class="pay">
			...
			<li class="title"><a><span class="icon add"></span>地址</a></li>

			<li style="color:#000000;font-family:&#39;sans serif&#39;, tahoma, verdana, helvetica;font-size:12px;font-style:normal;font-weight:normal;line-height:18px;">

			湖北省武汉市江汉区建设大道737号广发银行大厦32F
						...
						<dl>
							...
							<dt>评价
                                <span class="pull-right">
                                    <span class="stars">
                                        <for start="0" end="5">
                                            <if condition="$store['score_mean'] gt $i">
                                                <i class="text-icon icon-star"></i>
                                            <elseif condition="$store['score_mean'] gt $i-1"/>
                                                <i class="text-icon icon-star-gray">
                                                    <i class="text-icon icon-star-half">
