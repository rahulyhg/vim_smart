				...
				<dd style="overflow:visible;">
					...
					<dl>
					    ...
					    <if condition="$now_order['third_id'] eq '0' AND $now_order['pay_type'] eq 'offline'"> 
							 ...
							 <dd class="dd-padding coupons-code">线下需向商家付金额：<font color="red">￥{pigcms{$now_order['total_money']-$now_order['wx_cheap']-$now_order['merchant_balance']-$now_order['balance_pay']}元</font>
