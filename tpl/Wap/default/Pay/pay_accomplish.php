...
<div id="innerHtml">
    ...
    <div class="skr">
        <div class="skr_1" id="skr_1_1"><span class="sk" >退款金额</span><span class="xm" style="color: #000000;font-size: 50px;font-family:Helvetica;">￥{pigcms{$info.money}</span></div>
    </div>
    <div class="skr" id="skr_1_2" > 
        <div class="skr_1" ><span class="sk" style="letter-spacing:60px">商品</span><span class="xm">线下扫码支付</span></div>
    </div>
    <div class="skr" id="skr_1_2">
        <div class="skr_1" ><span class="sk">商户名称</span><span class="xm">{pigcms{$info.name}</span></div>
    </div>
    <div class="skr" id="skr_1_2">
        <div class="skr_1" ><span class="sk" style="letter-spacing:60px">时间</span><span class="xm" style="font-family:font-family:Helvetica;">{pigcms{$info.time|date="Y-m-d H:i:s",###}</span></div>
    </div>
    <div class="skr" id="skr_1_2">
        <div class="skr_1" ><span class="sk">支付方式</span><span class="xm">扫码支付</span></div>
    </div>
     <div class="skr" id="skr_1_2">
        <div class="skr_1" ><span class="sk">商户单号</span><span class="xm" style="font-family:Helvetica;">{pigcms{$info.outid}</span></div>
    </div>
