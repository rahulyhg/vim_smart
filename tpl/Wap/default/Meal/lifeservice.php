...
<head>
    ...
    <style>
		...
		.dealcard-block-right div{line-height: 26px;}
	</style>
</head>
<body id="index">
						...
						<if condition="$order_list">
							<volist name="order_list['order_list']" id="vo">
								...
								<dd class="dealcard dd-padding">
									<div class="dealcard-block-right" style="padding: 10px 8px 10px 0px;">
										<img src="http://you.huidehang.cn/tpl/Wap/pure/static/images/house/{pigcms{$vo.order_type}.png"/ style="width: 50px;height: 50px;float: left;margin-top:-9px;">
										<!--<div class="dealcard-brand single-line">户名：{pigcms{$vo.infoArr.accountName} </div>-->
										<!--<div class="dealcard-brand single-line">户名：{pigcms{$vo.username} </div>-->
										<div class="dealcard-brand single-line" style="padding-left: 60px;">{pigcms{$vo.order_name} </div>
										<div class="dealcard-brand single-line" style="padding-left: 60px;font-size: 12px;">金额：{pigcms{$vo.money} 元</div>
										<div class="dealcard-brand single-line" style="float: right;margin-top: -32px;">状态：<font color="green">缴费成功</font></div>
										<div class="dealcard-brand single-line" style="float: right;margin-top: -2px;font-size: 12px;">{pigcms{$vo.time|date='Y-m-d H:i:s',###}</div>
