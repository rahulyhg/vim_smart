...
<html lang="zh-CN">
 ...
 <body> 
  <div class="body_div"> 
  	<div>
		<a class="my-account" href="{pigcms{:U('My/myinfo')}">
			...
			<div class="user-info more more-weak">
				...
				<p class="umoney">余额：<strong style="color:#FFFFFF;">{pigcms{$now_user.now_money}</strong> 元</p>
				<p style="color:#FFFFFF;">积分：<strong style="color:#FFFFFF;">{pigcms{$now_user.score_count}</strong> 分</p>
				<else/>
   ...
   <div class="dl_nav"> 
    <span> <a href="/wap.php?g=Wap&c=Classify&a=index">分类信息首页</a> &gt; <a href="{pigcms{:U('Classify/myCenter',array('uid'=>$uid))}" rel="nofollow">个人中心</a> &gt; <a href="javascript:;" rel="nofollow" style="color: #fb4746;">我的收藏</a> </span> 
   </div> 
   <div class="ucenter"> 
