...
<head>
    ...
    <script src="{pigcms{$static_path}js/weui.min.js"></script>
...
<body>
<div style="width:100%;height:46px; line-height:46px; text-align:center; font-size:18px; color:#FFFFFF; background-color:#ff586c;">{pigcms{$msg_info['title']}</div>
