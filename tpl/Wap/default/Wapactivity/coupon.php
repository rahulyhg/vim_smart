			...
			<div class="list">
			    ...
			    <dl class="list list-in">
					...
					<dd class="dd-padding buy-price" id="buy_box">
			            <div class="price">
			                <strong class="J_pricetag strong-color"><if condition="$now_activity['money']">{pigcms{$now_activity.money}<else/>{pigcms{$now_activity.mer_score}</if></strong>&nbsp;<span class="strong-color"><if condition="$now_activity['money']">元<else/>商家积分</if></span>
			                <space></space>
							<if condition="!$now_activity['money']"><del style="text-decoration:none;">或 {pigcms{$now_activity['mer_score']/$config['activity_score_scale']} 平台积分</del></if>
			            </div>
			        </dd>
