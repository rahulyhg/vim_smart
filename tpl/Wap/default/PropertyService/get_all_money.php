...
<div class="zk">
    <div class="zk2" >
        <div class="sm">
            ...
            <div class="kk2"><span >全部记录({pigcms{$count})</span></div>
        ...
        <div style="width:100%;" id="henfan">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="hehe">
                <tr>
                    ...
                    <td height="40" align="center" style="border-bottom:1px #e1e1e1 solid; font-size:16px; color:#909090;width: 35%;">支付时间<br />
                </tr>
...
<script>
    ...
    function sea() {
        var time = "{pigcms{$time}";
        var search = $("#searchInput").val();
        window.location.href = "{pigcms{:U('get_all_money')}"+"&search="+search+"&ym="+time+"&village_id="+village_id;
    }
    ...
    $(document.body).infinite().on("infinite", function() {
        ...
        setTimeout(function() {
            ...
            gt = parseInt(lt)-1;
            $.ajax({
                url:"{pigcms{:U('get_all_money_ajax')}",
                type:"get",
