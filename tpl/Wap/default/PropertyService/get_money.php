...
<div class="zk">
    <div class="zk2" >
        <div class="sm">
            ...
            <div class="kk2"><span >订单记录({pigcms{$count})</span></div>
        ...
        <div style="width:100%;" id="henfan">
            <table width="100%" border="0" cellspacing="0" cellpadding="0"  id="hehe">
                <tr>
                    <td height="40" align="center" style="border-bottom:1px #e1e1e1 solid; font-size:16px; color:#909090;width: 25%;">商家</td>
                    <td height="40" align="center" style="border-bottom:1px #e1e1e1 solid; font-size:16px; color:#909090;width: 18%;">价格</td>
                    <td height="40" align="center" style="border-bottom:1px #e1e1e1 solid; font-size:16px; color:#909090;width: 30%;">支付方式</td>
                    <td height="40" align="center" style="border-bottom:1px #e1e1e1 solid; font-size:16px; color:#909090;width: 35%;">支付时间<br /><span style="font-size: 12px;"></span></td>
                </tr>
                <foreach name="list" item="vo">
                    <tr style="font-size: 12px;">
                        <td height="40" align="center" style="color:#515455; border-bottom:1px #efefef solid;"><span style="font-size: 12px;">{pigcms{$vo.wxname|substr=###,0,15}</span></td>
                        <td height="40" align="center" style="font-size:14px; color:#515455; border-bottom:1px #efefef solid;">{pigcms{$vo.goods_price}</td>
                        <td height="40" align="center" style="font-size:14px; color:#515455; border-bottom:1px #efefef solid;">{pigcms{$vo.goods_describe}</td>
                        <td height="40" align="center" style="font-size:12px; color:#515455; border-bottom:1px #efefef solid;">{pigcms{$vo.paytime|date='Y-m-d H:i:s',###}</td>
                    </tr>
                </foreach>
            </table>
        </div>
...
<script>
    ...
    function sea() {
        var search = $("#searchInput").val();
        window.location.href = "{pigcms{:U('get_money')}"+"&search="+search+"&ym="+time+"&village_id="+village_id;
    }
