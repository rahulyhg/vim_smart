        ...
        <div class="weui-tab">
            ...
            <div class="weui-tab__bd">
                <div id="tab1" class="weui-tab__bd-item weui-tab__bd-item--active">
                    <div class="weui-panel__hd">正常编号：{pigcms{$safetyPoint} , 异常编号：{pigcms{$warningPoint}</div>

                    <volist name="nowPointList" id="vo">
                        <div class="weui-panel weui-panel_access">
                            <div class="weui-panel__bd">
                                <a href="{pigcms{:U('record_safety_detail',array('id'=>$vo['pigcms_id']))}" class="weui-media-box weui-media-box_appmsg">
                                    <div class="weui-media-box__bd" style="float:left;">
                                        <h4 class="weui-media-box__title">
                                            巡检楼层：{pigcms{$vo.room_name}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            巡检编号：{pigcms{$vo.orientation}
                                        </h4>
                                        <p class="weui-media-box__desc">由
                                            <if condition="isset($vo['truename'])">{pigcms{$vo.truename}<else />{pigcms{$vo.name}</if>
                                            于{pigcms{$vo.check_time|date='Y-m-d H:i:s',###}上报
                                         </p>
                                    </div>
                            ...
                            <div class="weui-panel__ft">
                                <a href="{pigcms{:U('record_safety_detail',array('id'=>$vo['pigcms_id']))}" class="weui-cell weui-cell_access weui-cell_link">
                        ...
                        <div class="weui-cells">
                            <div class="weui-cell">
                                <div class="weui-cell__bd">
                                    <p>巡检楼层：{pigcms{$sv.room_name}&nbsp;&nbsp;&nbsp;&nbsp;
                                        巡检编号：{pigcms{$sv.oname}</p>
                                </div>
                                <div class="weui-cell__ft">未巡检</div>
                            </div>
                        </div>
                    </foreach>
                </div>
