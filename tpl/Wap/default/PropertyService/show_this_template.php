    ...
    <tr>
        <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <if condition="count($billTemplateArray['water']) gt count($billTemplateArray['electric'])">
                    <foreach name="billTemplateArray['water']" item="wv" key="wk">
                        <tr>
                            ...
                            <td height="34" align="center" style="border:1px #000000 solid; border-left:none; border-top:none;"><php>echo $billTemplateArray['electric'][$wk]['last_total_consume']?:'/'</php></td>
                            <td height="34" align="center" style="border:1px #000000 solid; border-left:none; border-top:none;"><php>echo $billTemplateArray['electric'][$wk]['total_consume']?:'/'</php></td>
                            <td height="34" align="center" style="border:1px #000000 solid; border-left:none; border-top:none;"><php>echo $billTemplateArray['electric'][$wk]['now_consume']?:'/'</php></td>
                        </tr>
                    </foreach>
                <else/>
                    <foreach name="billTemplateArray['electric']" item="ev" key="ek">
                        <tr>
                            <td height="34" align="center" style="border:1px #000000 solid; border-top:none;"><php>echo $billTemplateArray['water'][$ek]['last_total_consume']?:'/'</php></td>
                            <td height="34" align="center" style="border:1px #000000 solid; border-left:none; border-top:none;"><php>echo $billTemplateArray['water'][$ek]['total_consume']?:'/'</php></td>
                            <td height="34" align="center" style="border:1px #000000 solid; border-left:none; border-top:none;"><php>echo $billTemplateArray['water'][$ek]['now_consume']?:'/'</php></td>
                ...
                <tr>
                    ...
                    <td height="34" colspan="2" align="center" style="border:1px #000000 solid; border-left:none; border-top:none;">{pigcms{$billTemplateArray.total_money}</td>
                </tr>
