    ...
    <div class="kk">
        <div class="zw">
            <div class="width p20">
                <div class="dkk">
                    <div class="width">
                        <div class="nu"><a href="{pigcms{:U('PropertyService/check_safety_record')}" class="dsz">{pigcms{$nowPointCount}</a></div>
                ...
                <div class="dkk2">
                    <div class="width">
                        <div class="nu"><a href="{pigcms{:U('PropertyService/check_safety_record')}" class="dsz">{pigcms{$lowPoint}</a></div>
                        <div class="nu2">本月未巡检设备数</div>
                        <div class="nu3">
                            <div class="re3">
                                <div class="width">
                                    <div class="jk3">巡检日期</div>
                                    <div class="jk4">{pigcms{$date[0]}-{pigcms{$date[1]}</div>
                                </div>
                            </div>
                        </div>
                    </div>
