...
<head>
    ...
    <style>
		...
		.weui-cells {background-color:none;}
    </style>
</head>
            ...
            <ol class="list-unstyled">
                    ...
                    <div class="zk">
                        <div id="biaoji1">
                            <foreach name="listTwo" item="vo">
                                ...
                                <div class="zk2 i1">
                                    <div class="sm">
                                        <div class="f1"><img src="{pigcms{$vo.logo}" style="height:33px;"></div>
                        ...
                        <div onclick="ii1(0)" id="ccc1" style='font-size: 16px;text-align: center;'>更多</div>
                ...
                <li v-show="show_sub_pag===2">
                        <div class="zk">
                            ...
                            <div onclick="ii2()" id="ccc2" style='font-size: 16px;text-align: center;'>更多</div>
							<div style="height:100px; overflow:hidden; width:100%;"></div>
                        </div>
                </li>
                <li v-show="show_sub_pag===3">
                    ...
                    <div class="zk">
                        ...
                        <div onclick="ii3(1)" id="ccc3" style='font-size: 16px;text-align: center;'>更多</div>
						<div style="height:100px; overflow:hidden; width:100%;"></div>
                    </div>
...
<script>
    ...
    function ii3(status) {
        ...
        gt = parseInt(lt);
        $.ajax({
            url:"{pigcms{:U('getExpressList_ajax')}",
            type:"get",
            data:"&more="+gt+"&phone="+phone+"&status="+status,
            // dataType:'json',
            success:function (res) {
                if (res) {
                    $("#biaoji3").append(res);
                    ...
                    $("#ccc3").hide();
                    $("#biaoji3").append("<p style='font-size: 12px;text-align: center;'> 已经到底啦 </p>");
                }
            }
        });
    }
    ...
    function ii1(status) {
        ...
        gt = parseInt(lt);
        $.ajax({
            url:"{pigcms{:U('getExpressList_two_ajax')}",
            type:"get",
            data:"&more="+gt+"&phone="+phone+"&status="+status,
            // dataType:'json',
            success:function (res) {
                if (res) {
                    ...
                    $("#ccc1").hide();
                    $("#biaoji1").append("<p style='font-size: 12px;text-align: center;'> 已经到底啦 </p>");
                }
            }
        });
    }
    ...
    function ii2() {
        ...
        gt = parseInt(lt);
        $.ajax({
            url:"{pigcms{:U('express_getBadList_ajax')}",
            type:"get",
            data:"&more="+gt+"&phone="+phone,
            // dataType:'json',
            success:function (res) {
                ...
                if (res) {
                    ...
                    $("#ccc2").hide();
                    $("#biaoji2").append("<p style='font-size: 12px;text-align: center;'> 已经到底啦 </p>");
                }
            }
        });
    }
