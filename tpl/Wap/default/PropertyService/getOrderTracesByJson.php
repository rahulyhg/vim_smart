...
<div class="wz">
    <div class="ls">订单详情</div>
        <div class="zk2">
            <div class="kw">
                <div class="kw2">
                    <div class="wzw">寄件人姓名</div>
                    <div class="wz2"><span style="padding-left:5px;">{pigcms{$exs_list.bad_name}</span></div>
                    <div style="clear:both"></div>
                </div>
                <div class="kw2">
                    <div class="wzw">快递公司</div>
                    <div class="wz2"><span style="padding-left:5px;">{pigcms{$exs_list.exp_name}</span></div>
                    <div style="clear:both"></div>
                </div>
                <div class="kw2">
                    <div class="wzw">单号</div>
                    <div class="wz2"><span style="padding-left:5px;">{pigcms{$exs_list.ems_order_id}</span></div>
                    <div style="clear:both"></div>
                </div>
            </div>
            <div style="clear:both"></div>
...
<div class="dd"  id="close_window">关闭</div>
