...
<form method="post" action="{pigcms{:U('Hotactivity/addPhone')}" id="form1">
    ...
    <div style="width:79%; margin:15px auto;">
        <div style="float:left; width:70%;">
            <div style="float:left; margin-left:5px; width:100%;"><span style='background-color: #824b9a;width:100%;padding: 5px;height:28px;border-radius: 4px;color: #ffffff;line-height:28px;'>{pigcms{$phone}</span><span style="padding-left: 3px; border-radius: 4px; color: #824b9a;">领取成功！</span></div>
            <div style="float:left; width:20%; margin-left:5px;">
                <button type="button" class="btn btn-success mt-sweetalert " id="myform" style="display: none">已领取</button>
