		    			...
		    			<volist name="order_list" id="order">
							<dd class="dealcard dd-padding">
			                    ...
			                    <div class="dealcard-block-right">
			                        ...
			                        <br/>
			                        <small>总&nbsp;&nbsp;&nbsp;&nbsp;价：{pigcms{$order['total_price']}元</small> <small style="color: red">优&nbsp;&nbsp;&nbsp;&nbsp;惠：{pigcms{$order['discount_price']}元</small><br/>
			                        <small style="color: green">实&nbsp;&nbsp;&nbsp;&nbsp;收：{pigcms{$order['price']}元</small><br/>
