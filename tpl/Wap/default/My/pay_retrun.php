...
<body>
<div id="innerHtml">
	<form action="{pigcms{:U('My/pay_retrun')}" method="post" id="submit" onsubmit="return checkForm(this);">
	<input type="hidden" name="cmsData" value="{pigcms{$cmsData}">
	...
	<div class="skr">
		<div class="skr_1"><span class="sk">收款人</span><span class="xm">{pigcms{$view_content.title}</span></div>
	</div>
