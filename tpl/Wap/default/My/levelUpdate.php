		    	...
		    	<dd>
		    		...
		    		<dl>
						...
						<dd>
				        	...
				        	<div class="react  more-weak">等级优惠：<span><if condition="$levelarr[$nextlevel]['type'] eq 1">购买商品优惠{pigcms{$levelarr[$nextlevel]['boon']}%<elseif condition="$levelarr[$nextlevel]['type'] eq 2" />商品价格立减{pigcms{$levelarr[$nextlevel]['boon']}元<else />无</if></span></div>
