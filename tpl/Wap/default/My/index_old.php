...
<body>
	...
	<dl class="list">
		...
		<!--<ddx>-->
			<div class="kid">
				<div class="xwc"><a href="{pigcms{:U('My/user_qrcode')}" style="display:inline-block"><img class="vww" src="{pigcms{$static_path}images/ccw1.jpg"></a></div>
				<div class="xwce">付 款</div>				
			</div>
			<div class="kid">
				<div class="xwc"><a href="{pigcms{:U('My/account_recharge')}" ><img class="vww" src="{pigcms{$static_path}images/ccw2.jpg"></div>
				<div class="xwce" style="color:#333;">零 钱</div>
				<div class="xwce2">￥<strong>{pigcms{$now_user.now_money}</strong></div>
			</div>
			<div class="kid">
				<div class="xwc"><a href="{pigcms{:U('My/mx_money')}" style="display:inline-block"><img class="vww" src="{pigcms{$static_path}images/ccw3.jpg"></a></div>
	...
	<dl class="list">
		<dd>
			<a class="react" href="{pigcms{:U('Login/logout')}">
				<div class="more-weak" style="color:#fb4746;">
