...
<div class="container">
	<section>
		...
		<ul class="box">
			...
			<li>支付状态：<if condition="$order['status'] eq 3"><span style="color:red">已退款</span><elseif condition="$order['paid']"/><if condition="$order['pay_type'] eq 'offline' AND empty($order['third_id'])"><span style="color:red">线下未支付</span><else /><span style="color:green">已付款</span></if><else /><span style="color:red">未支付</span></if></li>
