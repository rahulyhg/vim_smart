		    ...
		    <dl class="list">
		    	<dd>
		    		<dl>
						...
						<dd>
				        	<div class="react  more-weak">
							<if condition="$config['level_onoff'] gt 0">
							<a href="javascript:void(0);" class="btn" onclick="levelToupdate({pigcms{$now_user.score_count},{pigcms{$levelarr[$nextlevel]['integral']},$(this))" style="color:#FFF;">升 级</a>
							<else />
							会员等级已关闭
							</if>
							</div>
