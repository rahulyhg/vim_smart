...
<div class="container">
	<section>
		...
		<ul class="box">
			...
			<li>我的地址：{pigcms{$order['address']}</li>
			<li>送达时间：{pigcms{$order['arrive_time']}</li>
			<li>外送费用：￥{pigcms{$order['delivery_fee']}</li>
			...
			<li>消费码：{pigcms{$order['meal_pass']}</li>
	...
	<footer class="order_fixed">
		<div class="fixed">
			...
			<div style="float: right">
				<if condition="$order['paid'] eq 0 AND $order['is_confirm'] eq 0">
