...
<script type="text/javascript" src="{pigcms{$static_path}takeout/js/index.js?ver=<php>echo time();</php>"></script>
	...
	<div class="container">
		<header class="search">
			<form action="javascript:searchList()">
				<input type="search" placeholder="搜索店名" id="searchTxt" value="{pigcms{$searhkey}">
			</form>
		</header>
		<section>
