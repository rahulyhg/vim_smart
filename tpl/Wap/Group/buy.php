			...
			<dd>
				<dl>
					<dd class="dd-padding kv-line-r">
						...
						<else/>
						 <p>{pigcms{$now_group['price']}元</p>
						</if>
					</dd>
					<if condition="!empty($leveloff) AND $finalprice gt 0">
					<dd class="dd-padding kv-line-r">
						<h6>会员等级：</h6>
						<span class="kv-v"><strong style="font-size:16px;color:#FF4907">{pigcms{$leveloff['lname']}</strong></span>
					</dd>
					<dd class="dd-padding kv-line-r">
						<h6>优惠：</h6>
						<span class="kv-v">{pigcms{$leveloff['offstr']}&nbsp;&nbsp;惠后单价 <strong style="font-size:16px;color:#FF4907">{pigcms{$leveloff['price']}</strong>元
						</span>
					</dd>
					</if>
