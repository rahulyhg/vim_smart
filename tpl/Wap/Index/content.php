...
<div class="list" style="border-top: 1px solid #ddd8ce; border-bottom: 1px solid #ddd8ce; margin-bottom: 0; background-color: #fff;z-index:100000;margin-top: 46px;  width: 100%;position: absolute;left:-10px;">
...
<button style="float:right;height:2.8rem;border:none;background-color:green;color:white;border-radius:5px;padding:0 1.2rem;  margin-right: 2px;">关注我们</button>
</a>
</div>
</if>
<php>$invote_array = '';</php>
	...
	<div class="Listpage">
		...
		<div class="page-bizinfo">
			...
			<a id="biz-link" class="btn" href="{pigcms{:U('Index/index',array('token'=>$tpl['token']))}" data-transition="slide">
				<div class="arrow">
