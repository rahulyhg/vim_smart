  ...
  <div class="body_div"  style="margin-bottom: 30px;"> 
   ...
   <div class="detail_w detail_w_new"> 
    ...
    <div class="connection_con"> 
     <p class="connection"><a data-click-from="telephone_ico" href="tel:{pigcms{$detail['lxtel']}" class="fangico dianhua "><i></i>电话联系</a><a href="sms:{pigcms{$detail['lxtel']}" class="fangico duanxin online" data-click-from="shortmessage" id="contact_sms"><i></i>装修咨询</a></p>
    </div> 
	</if>
