						...
						<volist name="group_list" id="vo">
							<dd class="link-url" data-url="{pigcms{$vo.url}">
								...
								<div class="dealcard-block-right">									
									...
									<div class="price">
										<strong>{pigcms{$vo.price}</strong><span class="strong-color">元</span><if condition="$vo['wx_cheap']"><span class="tag">微信再减{pigcms{$vo.wx_cheap}元</span><else/><del>{pigcms{$vo.old_price}</del></if> <span class="line-right">已售{pigcms{$vo.sale_count}</span>
									</div>
								</div>
							</dd>
						</volist>
