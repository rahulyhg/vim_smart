...
<head>
    ...
    <link rel="stylesheet" href="{pigcms{$static_path}css/visitorLog.css">
...
<body>
<header class="pageSliderHide"><div id="backBtn"></div>访客登记<div style="position: absolute; top:0; right:3%; height:100%; margin-top:7px;"><a href="javascript:;" onClick="history.go(0)"> <img src="{pigcms{$static_path}images/ny.png" width="36" height="36"/></a></div></header>
...
<script>
    ...
    var url = "{pigcms{:U('House/village_visitorLog')}";
...
<script src="{pigcms{$static_path}js/visitorLog.js"></script>
</html>