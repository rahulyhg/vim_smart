...
<div class="rich_media container">
    ...
    <div class="rich_media_inner content" style="min-height: 831px;">
        ...
        <h2 class="rich_media_title" id="activity-name">{pigcms{$msg_info['title']}</h2>

        <div class="rich_media_meta_list">

            <em id="post-date" class="rich_media_meta text">{pigcms{$msg_info.create_time|date="Y-m-d H:i",###}</em>
        ...
        <div id="page-content" class="content">
            ...
            <div id="img-content">
                ...
                <div class="rich_media_content" id="js_content">{pigcms{$msg_info['content']|htmlspecialchars_decode=ENT_QUOTES}</div>
