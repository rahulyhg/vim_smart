...
<body>
<header class="pageSliderHide"><div id="backBtn"></div>访客记录<div style="position: absolute; top:0; right:3%; height:100%; margin-top:7px;"><a href="javascript:;" onClick="history.go(0)"> <img src="{pigcms{$static_path}images/ny.png" width="36" height="36"/></a></div></header>
...
var url = "{pigcms{:U('House/village_user_openLog')}";
...
<script src="{pigcms{$static_path}js/openLog.js"></script>
</html>