...
<div style="width:100%; margin:0px auto;">
	...
	<div style="width:100%; margin:0px auto; margin-bottom:0; background:url({pigcms{$static_path}images/137/hd2.png) #febe39 no-repeat; max-width:100%; background-size:100% 100%;">
		<div style="margin:0px auto; width:95%; font-size:16px; text-align:left; border-bottom:2px #e70000 solid; color:#969696; padding:15px 0 10px 13px; font-family:'微软雅黑'; font-weight:600; color:#e70000;">新年快乐</div>
		<div style="margin:0px auto; width:85%;">
			<div style="width:94%; line-height:2.1; font-size:17px; color:firebrick; margin-top:18px; margin-left:3%; text-align:center; font-family:'微软雅黑'; font-weight:500;" id="div_txt">汇得行祝您新年快乐，新年新气象！</div>
			<div style="padding-top:10px;" id="mybotton"><div class="mt-sweetalert"><button class="btn red btn-block">你好,2017!</button></div>
...
<div style="margin:30px auto; width:98%; border-radius:8px; border:3px #c21c08 solid; background-color:#ffffff;">
	<div style="width:90%; margin:0px auto; padding-top:10px; padding-bottom:10px;">
		<div style="line-height:1.5; font-size:16px; color:#4b4b4b; font-family:'微软雅黑'; font-weight:800;">新年祝福</div>
		<div style="line-height:2; font-size:14px; color:#7e7e7e; font-family:'微软雅黑'; padding-top:5px;">圣诞狂欢，元旦小憩。挥手过往，尘埃落定。迎接新年，快乐无敌。放松心情，能量积蓄。共盼美好。闪亮人生，精彩同行。祝元旦愉快!
	</div>
</div>
...
<script type="text/javascript">
	...
	$(function(){
		$("#mybotton").click(function(){
			swal({
				title: "新年将至，汇得行和您一起跨年！",
				text: "2017年的钟声即将响起，汇得行将和您一起迎接2017的到来",
				imageUrl: "{pigcms{$static_path}images/137/03.jpg",
				closeOnConfirm: false,
				animation: "slide-from-top",
				confirmButtonText: "新年快乐"
			});
