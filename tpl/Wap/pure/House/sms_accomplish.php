...
<div id="innerHtml"> 
    ...
    <div class="action" id="action_content">
		<div class="skr">
			<div class="skr_1" id="skr_1_1"><span class="sk" >提交审核</span><span class="xm" style="color: #000000;font-size: 50px;font-family:Helvetica;"></span></div>
		</div>
		<div class="skr" id="skr_1_2">
			<div class="skr_1" ><span class="sk">社区名称</span><span class="xm">{pigcms{$info.village}</span></div>
		</div>
		<div class="skr" id="skr_1_2">
			<div class="skr_1" ><span class="sk">提交人</span><span class="xm" style="font-family:Helvetica;">{pigcms{$info.name}</span></div>
		</div>
		<div class="skr" id="skr_1_2">
