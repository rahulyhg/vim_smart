...
<head>
	...
	<style type="text/css">
		...
		.btn.red:not(.btn-outline) {color: #fff;background-color: #3fb636;border-color: #3fb636;}
...
<div style="width:100%; margin:0px auto;">
	...
	<div style="margin:0px auto; width:95%; font-size:16px; text-align:left; border-bottom:2px #e70000 solid; color:#969696; padding:15px 0 10px 13px; font-family:'微软雅黑'; font-weight:600; color:#e70000;">新年活动</div>
	<div style="margin:0px auto; width:85%;">
			<div style="width:94%; line-height:2.1; font-size:17px; color:firebrick; margin-top:18px; margin-left:3%; text-align:center; font-family:'微软雅黑'; font-weight:500;" id="div_txt">汇得行给您准备了一份圣诞礼物！</div>
			<div style="padding-top:10px;"><div class="mt-sweetalert" id="mybotton"><img style="max-width:100%;" src="{pigcms{$static_path}images/137/bt.png" onClick="this.src=='{pigcms{$static_path}images/137/bt.png'?this.src='{pigcms{$static_path}images/137/bt2.png':this.src='{pigcms{$static_path}images/137/bt.png'"  /></div></div>
			...
			<div id="mytable"></div>
			<div style="padding-top:15px;display: none;"><button class="btn btn-success mt-sweetalert" data-title="恭喜您！获得{pigcms{$gift}！" data-message="{pigcms{$message}" data-type="success" data-allow-outside-click="true" data-confirm-button-text="{pigcms{$note}"  data-confirm-button-class="btn-success" id="success">点击领取</button></div>
		</div>
...
</div><!--<div style="width:100%; margin:-3px auto;"><img style="max-width:100%;" src="{pigcms{$static_path}images/137/gr.jpg"></div>-->
...
<script type="text/javascript">
	...
	$(function(){
		$("#mybotton").click(function(){
			$("#cate2").show();
			$.ajax({
				url: "{pigcms{:U('House/get_gift_port')}",
				type: "get",
				data:{'gift_name':gift,'rc_result':rc_result},
			...
			swal({
				...
				$.ajax({
					url: "{pigcms{:U('House/pastgift')}",
					type: "get",
					success:function(resl){
						$("#mybotton").hide();
						$("#mytable").show();
						$("#div_txt").html("您已经获取了"+gift);
						$("#mytable").html(resl);
					}
				});
			});
