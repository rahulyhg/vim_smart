...
function changeImage(){
	document.getElementById("imgflag").src="{pigcms{$static_path}images/ttw3.png";
	window.location.href="{pigcms{:U('House/access_control_ask',array('village_id'=>$now_village['village_id'],'ac_id'=>$ac_id))}";
}
...
<div class="cw">
	<a href="#"><div class="cw2"><img id="imgflag" src="{pigcms{$static_path}images/ttw1.png" onClick="changeImage()" style="width:85%;"></div></a>
