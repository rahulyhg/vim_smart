...
<html lang="zh-CN">
	<head>
		...
		<script type="text/javascript" src="{pigcms{$static_path}js/village_my.js" charset="utf-8"></script>-->
	...
	<body>
		...
		<div id="container">
			<div id="scroller" class="village_repair">
				...
				<div style="width:88%; margin: 30px auto 0;"><a href="javascript:;" class="weui_btn weui_btn_primary_blue wdwe" id="submit_btn">报修</a></div>
