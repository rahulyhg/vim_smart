...
$(function(){
	...
	$('.myKey').click(function(){
		$.ajax({
			'url':"{pigcms{:U('House/village_access_finish',array('village_id'=>$now_village['village_id']))}",
			'data':{'ac_status':'4'},
			'type':'POST',
			'dataType':'JSON',
...
<div class="sfrz_zkd"><img src="{pigcms{$static_path}images/qtt.jpg" style="width:100%;" /></div>
<div class="att">
	<div class="kt"><img src="{pigcms{$static_path}images/gg.jpg" style="width:120%;" /></div>
	<div class="kt2"><span style="color:#fb4746;">恭喜您，审核成功！</span><br/>点击下方的钥匙进入门禁管理</div>
	<div class="both"></div>
</div>
<div class="att2"></div>
    <if condition="$now_village['village_type'] eq 0">
	<div class="fr"><a href="javascript:;" class="weui_btn weui_btn_warn myKey">我的钥匙</a></div>
    <else />
    <div class="fr"><a href="{pigcms{:U('House/village_my_pay',array('village_id'=>$now_village['village_id']))}" class="weui_btn weui_btn_warn">我的房屋信息</a></div>
    </if>
