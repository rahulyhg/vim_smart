...
<form id="access_form" onSubmit="return false;">
    <div class="shtx_dkx">
        <div class="shtx_xm">
            ...
            <div class="shtx_kk"><!--刘德华-->{pigcms{$repair_info.name}</div>
            <div class="both"></div>
        </div>
        <div class="shtx_xm">
            ...
            <div class="shtx_kk"><!--18086681360-->{pigcms{$repair_info.usernum}</div>
            <div class="both"></div>
        </div>
    </div>
    <div class="shtx_dk2">
        <div class="shtx_xm">
            ...
            <div class="shtx_kk"><!--武汉邻钱科技有限公司-->{pigcms{$repair_info.phone}
            </div>
            <div class="both"></div>
        </div>
        <div class="shtx_xm">
            ...
            <div class="shtx_kk"><!--技术部-->{pigcms{$repair_info.time|date='Y-m-d H:i:s',###}</div>
            <div class="both"></div>
        </div>
        <div class="shtx_xm">
            ...
            <div class="shtx_kk"><!--广发银行大厦2008-->{pigcms{$repair_info.address}</div>
            <div class="both"></div>
        </div>
    </div>
                ...
                <div class="weui_uploader">
                    ...
                    <div class="upload_box">
                        <ul class="upload_list clearfix" id="upload_list">
                            <if condition="$repair_info['pic']">
                                <php>$pic=explode('|',$repair_info['pic'])</php>
    ...
    <div style="width:92%; margin:10px auto; margin-bottom:0px; background-color:#FFFFFF;border-radius: 10px;" id="desc_show"><textarea id="description" name="content" readonly="readonly"  placeholder="报修内容" style="width:97%;height:50px; border:none; font-size:14px; line-height:25px; padding-left:5px;">{pigcms{$repair_info.content}</textarea></div>
    <!--<div class="zkd">
        <div style="float:left;width:48%;"><a href="javascript:;" class="weui_btn weui_btn_warn btn_check" data_status="2" data_idVal="{pigcms{$repair_info.pigcms_id}" data_uid="{pigcms{$repair_info.uid}">通过</a></div>
        <div style="float:right;width:48%;"><a href="javascript:;" class="weui_btn weui_btn_warn btn_check" data_status="3" data_idVal="{pigcms{$repair_info.pigcms_id}" data_uid="{pigcms{$repair_info.uid}">不通过</a></div>
