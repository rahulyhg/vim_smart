...
<div style="width:100%; margin:0px auto;">
	...
	<div style="width:100%; margin:0px auto; margin-bottom:0; background:url({pigcms{$static_path}images/137/hd2.png) #febe39 no-repeat; max-width:100%; background-size:100% 100%;">
		...
		<div style="margin:0px auto; width:85%;">
			...
			<div id="mytable">{pigcms{$listTd}</div>
...
<div style="margin:30px auto; width:98%; border-radius:8px; border:3px #c21c08 solid; background-color:#ffffff;">
	<div style="width:90%; margin:0px auto; padding-top:10px; padding-bottom:10px;">
		<div style="line-height:1.5; font-size:16px; color:#fb4746; font-family:'微软雅黑'; font-weight:800;">新年祝福</div>
		<div style="line-height:2; font-size:14px; color:#292929; font-family:'微软雅黑'; padding-top:5px;">新年到，好事全来到！汇得行祝您及全家生鸡盎然，神采奕奕！身体健康！工作顺利！鸡年大吉！</div>
		<div style="text-align:right;line-height:2.5; color:#7e7e7e; font-family:'微软雅黑'; font-weight:500;">汇得行控股（中国）有限公司</div>
		<div style="text-align:right;line-height:1.2; color:#7e7e7e; font-family:'微软雅黑'; font-weight:500;">2017年1月1日</div>
	</div>
</div>
	</div>
</div>
<!--<div style="width:100%; margin:-3px auto;"><img style="max-width:100%;" src="{pigcms{$static_path}images/137/gr.jpg"></div>-->
<div class="cwx">主办方：汇得行控股（中国）有限公司</div>
	...
	$(function(){
		...
		$("#mytable").on("click","#mybutton2",function(){
			swal({
				...
				if (inputValue === "") {
					swal.showInputError("提示：您还没有输入车牌");
					return false
				}
