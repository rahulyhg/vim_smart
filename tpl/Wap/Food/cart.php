...
<include file="Food:header"/><body onselectstart="return true;" ondragstart="return false;" style="background-color:#e5e5e5;">
...
<footer data-role="footer">			
	...
	<nav class="g_nav">
		...
		<div>
			...
			<a href="javascript:next();" class="btn orange show" id="nextstep">上一步</a>
