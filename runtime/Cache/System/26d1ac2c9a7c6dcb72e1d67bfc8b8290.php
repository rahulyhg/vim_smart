                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="<?php echo U('Off/off_type_add');?>">
                                            <button id="sample_editable_1_new" class="btn sbold green">新建分类
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th  style="width: 150px; text-align: center;">分类编号</th>
                                <th>分类名称</th>
                                <th  style="width: 350px; text-align: center;">父级分类</th>
                                <th  style="text-align: center;">创建人</th>
                                <th  style="text-align: center;">创建时间</th>
                                <th  style="width: 150px; text-align: center;">操作</th>
                            </tr>
                            </thead>
                            <?php if(is_array($typeArr)): foreach($typeArr as $key=>$vo): ?><tr>
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                    ...
                                    <td><a href="<?php echo U('Off/off_list_news',array('type_id'=>$vo['id']));?>"><?php echo ($vo["type_name"]); ?></a></td>
                                    <td>顶级分类</td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="<?php echo U('Off/off_type_update',array('id'=>$vo['id']));?>">
                                ...
                                <?php if(isset($vo['son'])): if(is_array($vo['son'])): foreach($vo['son'] as $key=>$v): ?><tr>
                                            <td>
                                                <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                    <input type="checkbox" class="checkboxes" value="<?php echo ($vo["id"]); ?>" />
                                                    <span></span>
                                            ...
                                            <td><?php echo ($v["id"]); ?></td>
                                            <td><a href="<?php echo U('Off/off_list_news',array('type_id'=>$v['id']));?>">|---<?php echo ($v["type_name"]); ?></a></td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                        <li>
                                                            <a href="<?php echo U('Off/off_type_update',array('id'=>$v['id']));?>">
                                                                <i class="icon-docs"></i> 更新 </a>
                                                        </li>
                                                        <li onclick="delete_pr_info(this)" id="<?php echo ($v["id"]); ?>">
                                                            <a href="javascript:;">
                                                                <i class="icon-tag"></i> 删除 </a>
                                                        </li>
                                                    </ul>
                                        ...
                                        <?php if(isset($v['g_son'])): if(is_array($v['g_son'])): foreach($v['g_son'] as $key=>$sv): ?><tr>
                                                    <td>
                                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                            <input type="checkbox" class="checkboxes" value="<?php echo ($vo["id"]); ?>" />
                                                            <span></span>
                                                    ...
                                                    <td><a href="<?php echo U('Off/off_list_news',array('type_id'=>$sv['id']));?>">|---|---<?php echo ($sv["type_name"]); ?></a></td>
                                                    <td><?php echo ($v["type_name"]); ?></td>
                                                    <td><?php echo ($sv["check_name"]); ?></td>
                                                    <td><?php echo (date("Y-m-d H:i:s",$sv["create_time"])); ?></td>
                                                    <td>
                                                        <div class="btn-group">
                                                            <button class="btn btn-xs green dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> 操作
                                                                <i class="fa fa-angle-down"></i>
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                                <li>
                                                                    <a href="<?php echo U('Off/off_type_update',array('id'=>$sv['id']));?>">
                                                                        <i class="icon-docs"></i> 更新 </a>
                                                                </li>
                                                                <li onclick="delete_pr_info(this)" id="<?php echo ($sv["id"]); ?>">
                                                                    <a href="javascript:;">
                                                                        <i class="icon-tag"></i> 删除 </a>
                                                                </li>
                                                            </ul>
    ...
    function delete_pr_info(obj) {
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"<?php echo U('Off/off_type_delete');?>",
                    data:{'id':id},
                    type:'post',
