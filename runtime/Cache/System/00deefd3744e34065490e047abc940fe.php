            ...
            <style>
                .ace-file-input a {display:none;}
                    ...
                    <div class="btn-group" style="float: left; margin-left: 5px;">
                        <a href="<?php echo U('contract_import_step');?>">
                        ...
                        <span>
                            <div class="btn-group">
                               <select name="contract_time_id" id="contract_time_id" class="form-control">
                                    ...
                                    <option value="1" <?php if($contract_time_id == 1): ?>selected="selected"<?php endif; ?>>全部合同</option>
                                    <option value="2" <?php if($contract_time_id == 2): ?>selected="selected"<?php endif; ?>>正常合同</option>
                                    <option value="3" <?php if($contract_time_id == 3): ?>selected="selected"<?php endif; ?>>即将到期合同</option>
                                    <option value="4" <?php if($contract_time_id == 4): ?>selected="selected"<?php endif; ?>>已过期合同</option>
                                    <option value="5" <?php if($contract_time_id == 5): ?>selected="selected"<?php endif; ?>>特殊合同</option>
                                </select>
                            </div>
                        </span>
                        <span>
                            <div class="btn-group">
                               <select name="contract_type" id="contract_type" class="form-control">
                                    ...
                                    <option value="1" <?php if($type == 1): ?>selected="selected"<?php endif; ?>>收入合同</option>
                                    <option value="2" <?php if($type == 2): ?>selected="selected"<?php endif; ?>>支出合同</option>
                                    <option value="3" <?php if($type == 3): ?>selected="selected"<?php endif; ?>>其他合同</option>
                                </select>
                            </div>
                        </span>
                    </div>
                    <div id="shopList" class="grid-view">
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            <tbody>
                            <?php if($shequArr): if(is_array($shequArr)): $i = 0; $__LIST__ = $shequArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr />
                                    <!-- <td><?php echo ($vo["id"]); ?></td>
                                    <td><?php echo ($vo["village_name"]); ?></td> -->
                                    <td><?php echo ($vo["company"]); ?></td>
                                    <td><?php echo ($vo["contract_name"]); ?></td>
                                    <td><?php echo ($vo["contract_number"]); ?></td>
                                    <td><?php echo ($vo["first_party"]); ?></td>
                                    <td><?php echo ($vo["second_party"]); ?></td>
                                    <td><?php echo ($vo["third_party"]); ?></td>
                                    <td><?php echo ($vo["contract_start"]); ?></td>
                                    <td><?php echo ($vo["contract_end"]); ?></td>
                                    <!-- <td><?php echo ($vo["contract_time"]); ?></td> -->
                                    <!-- <td>
                                        <div class="progress">
                                            <?php if($vo['rate'] < 60): ?><div class="progress-bar progress-bar-success" style="width: <?php echo ($vo["rate"]); ?>%"><?php echo ($vo["rate"]); ?>%</div>
                                            <?php elseif($vo['rate'] >= 60 and $vo['rate'] < 90): ?>
                                                <div class="progress-bar progress-bar-warning" style="width: <?php echo ($vo["rate"]); ?>%"><?php echo ($vo["rate"]); ?>%</div>
                                            <?php elseif($vo['rate'] >= 90 and $vo['rate'] < 100): ?>
                                                <div class="progress-bar progress-bar-danger" style="width: <?php echo ($vo["rate"]); ?>%"><?php echo ($vo["rate"]); ?>%</div>
                                            <?php else: ?>
                                                <div class="progress-bar progress-bar-info" style="width: <?php echo ($vo["rate"]); ?>%"><?php echo ($vo["rate"]); ?>%</div><?php endif; ?>
                                        </div>
                                    </td> -->
                                    <td>
                                        <div>
                                            <?php if($vo['rate'] == 1): if($vo['status'] == 1): ?><button class="btn btn-sm green btn-outline filter-submit margin-bottom" id="contract_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["status"]); ?>" onclick="changeType(this)">正常合同</button>
                                                    <input type="hidden" id="contract_<?php echo ($vo["id"]); ?>_id" value="<?php echo ($vo['id']); ?>">
                                                <?php else: ?>
                                                    <button class="btn btn-sm red btn-outline filter-submit margin-bottom" id="contract_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["status"]); ?>" onclick="changeType(this)">终止合同</button>
                                                    <input type="hidden" id="contract_<?php echo ($vo["id"]); ?>_id" value="<?php echo ($vo['id']); ?>"><?php endif; ?>                                               
                                            <?php elseif($vo['rate'] == 2): ?>
                                                <button class="btn btn-sm yellow btn-outline filter-submit margin-bottom">即将到期合同</button>
                                            <?php elseif($vo['rate'] == 3): ?>
                                                <button class="btn btn-sm red btn-outline filter-submit margin-bottom">终止合同</button>
                                            <?php else: ?>
                                                <?php if($vo['status'] == 1): ?><button class="btn btn-sm blue btn-outline filter-submit margin-bottom" id="contract_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["status"]); ?>" onclick="changeType1(this)">特殊合同</button>
                                                    <input type="hidden" id="contract_<?php echo ($vo["id"]); ?>_id" value="<?php echo ($vo['id']); ?>">
                                                <?php else: ?>
                                                    <button class="btn btn-sm red btn-outline filter-submit margin-bottom" id="contract_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["status"]); ?>" onclick="changeType1(this)">终止合同</button>
                                                    <input type="hidden" id="contract_<?php echo ($vo["id"]); ?>_id" value="<?php echo ($vo['id']); ?>"><?php endif; endif; ?>
                                            <!-- <div class="progress-bar bg-success" style="width: 70%">70%</div> -->
                                        </div>
                                    </td>                                    
                                    <td><?php echo ($vo["operator"]); ?></td>
                                    <!-- <?php if($vo['classify'] == 1): ?><td>收入</td>
                                    ...
                                    <!-- <?php if($vo['duration'] == 1): ?><td>
                                        <button class="btn btn-sm green btn-outline filter-submit margin-bottom" id="time_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["duration"]); ?>" onclick="changeTime(this)">长期合同</button>
                                        <input type="hidden" id="time_<?php echo ($vo["id"]); ?>_id" value="<?php echo ($vo['id']); ?>">                  
                                        </td>
                                    <?php else: ?>
                                        <td>
                                        <button class="btn btn-sm red btn-outline filter-submit margin-bottom" id="time_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["duration"]); ?>" onclick="changeTime(this)">短期合同</button>
                                        <input type="hidden" id="time_<?php echo ($vo["id"]); ?>_id" value="<?php echo ($vo['id']); ?>">
                                        </td><?php endif; ?> -->
                                    <!-- <?php if($vo['status'] == 1): ?><td>
                                        <button class="btn btn-sm green btn-outline filter-submit margin-bottom" id="contract_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["status"]); ?>" onclick="changeType(this)">正常合同</button>
                                        <input type="hidden" id="contract_<?php echo ($vo["id"]); ?>_id" value="<?php echo ($vo['id']); ?>">                  
                                        </td>
                                    <?php else: ?>
                                        <td>
                                    ...
                                    <td class="button-column" nowrap="nowrap">
                                        <a title="详情" class="green" style="padding-right:8px;" href="<?php echo U('contract_detail',array('id'=>$vo['id']));?>" data-toggle="modal" data-target="#modal_<?php echo ($vo["id"]); ?>">
                                            <i class="ace-icon fa fa-file bigger-130"></i>
                                        </a>
                                        <a title="修改" class="green" style="padding-right:8px;" href="<?php echo U('Contract/contract_edit',array('id'=>$vo['id']));?>">
                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                        </a>
                                        <a title="删除" class="red" style="padding-right:8px;" onclick="deleteContract('<?php echo ($vo['id']); ?>')" href="javascript:;">
...
<script type="text/javascript">
    ...
    function deleteContract(id) {
        swal({
            ...
            if(iscom){
                window.location.href='<?php echo U('Contract/contract_del');?>&id='+id;
            }else{
                swal.close();
            }
    ...
    function CreateContract(){
        window.location.href = "<?php echo U('Contract/contract_add');?>";
    }
    ...
    $("select#contract_time_id").change(function(){
        ...
        //     url = str;
        // }
        location.href='http://www.hdhsmart.com/admin.php?g=System&c=Contract&a=contract_news'+'&contract_time_id='+u;
    });
    ...
    $("select#contract_type").change(function(){
        ...
        $.ajax({
             url:'<?php echo U("contract_news");?>',
             type:'get',
             data:{'type':type},
             success:function (res) {
                 if (res) {                 
                    location.href='http://www.hdhsmart.com/admin.php?g=System&c=Contract&a=contract_news'+'&contract_time_id='+u+'&contract_type='+type;
                 }
             }
         });
    });
    ...
    function changeType(id) {
        ...
        $.ajax({
            url:'<?php echo U("contract_status");?>',
            type:'post',
    ...
    //     $.ajax({
    //         url:'<?php echo U("contract_duration");?>',
    //         type:'post',
