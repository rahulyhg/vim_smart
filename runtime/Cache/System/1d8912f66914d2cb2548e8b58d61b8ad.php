                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="<?php echo U('add_group',array('company_id'=>$company_id));?>">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                        <a href="<?php echo U('user_manage',array('company_id'=>$vo['company_id'],'group_id'=>$vo['group_id']));?>">成员管理</a>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="<?php echo U('group_edit',array('company_id'=>$vo['company_id'],'group_id'=>$vo['group_id']));?>">
                                                        <i class="icon-docs"></i> 编辑 </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo U('group_del',array('company_id'=>$vo['company_id'],'group_id'=>$vo['group_id']));?>">
...
<script>
    $(document).ready(function () {
        ...
        if(mid){
            var url = "<?php echo U('index_news');?>";
            menu_select(url);
        }else{
            var url = "<?php echo U('left_group_news');?>";
            menu_select(url);
        }
