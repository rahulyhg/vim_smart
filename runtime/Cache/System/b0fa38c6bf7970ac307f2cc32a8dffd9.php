...
<!--<div class="page-container">-->
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="button-column">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-left" role="menu" style="position: absolute;">
                            <li>
                                <a data-toggle="modal" data-target="#common_modal"  href="<?php echo U('modal_edit_config',array('config_id'=>$row['id']));?>">
                                    <i class="icon-docs"></i> 参数配置
                                </a>
                            </li>
                            <li>
                                <?php if($is_admin): ?><a  href="<?php echo U('del_config',array('config_id'=>$row['id']));?>" onclick="return window.confirm('确认删除？')">
            ...
            <?php if(is_array($row['cate'])): $i = 0; $__LIST__ = $row['cate'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rr): $mod = ($i % 2 );++$i;?><tr>
                    <td class="tab"><?php echo ($rr["desc"]); ?></td>
                    <td></td>
                    <td><?php echo ($rr["village_name"]); ?></td>
                    <td class="button-column">
                        <div class="btn-group">
                            <button class="btn btn-xs green dropdown-toggle" type="button" data-toggle="dropdown"
                                    aria-expanded="false"> 操作
                            ...
                            <ul class="dropdown-menu pull-left" role="menu" style="position: absolute;">
                                <li>
                                    <a data-toggle="modal" data-target="#common_modal"  href="<?php echo U('modal_edit_cate',array('cate_id'=>$rr['id']));?>">
                                        <i class="icon-docs"></i> 参数配置
                                    </a>
                                </li>
                                <li>
                                    <a data-toggle="modal" data-target="#common_modal"  href="<?php echo U('modal_cate_meters',array('cate_id'=>$rr['id']));?>">
                                        <i class="icon-docs"></i> 设备管理
                                    </a>
                                </li>
                                <li>
                                    <a  href="<?php echo U('del_cate',array('cate_id'=>$rr['id']));?>">
                                        <i class="icon-docs"></i> 删除
                                    </a>
                                </li>
                            </ul>
