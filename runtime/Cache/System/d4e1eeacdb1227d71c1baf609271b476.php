    ...
    <div class="page-content">
        ...
        <div class="row">
            <form action="#" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo ($menu_array["id"]); ?>">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="auth_type" id="cont_type">
                                            ...
                                            <option value="0"<?php if($menu_array['auth_type'] == 0): ?>selected="selected"<?php endif; ?>>菜单</option>
                                            <option value="1"<?php if($menu_array['auth_type'] == 1): ?>selected="selected"<?php endif; ?>>逻辑业务</option>
                                            <option value="2"<?php if($menu_array['auth_type'] == 2): ?>selected="selected"<?php endif; ?>>显示权限</option>
                                            <option value="3"<?php if($menu_array['auth_type'] == 3): ?>selected="selected"<?php endif; ?>>外部链接</option>
                                            <option value="4"<?php if($menu_array['auth_type'] == 4): ?>selected="selected"<?php endif; ?>>模块显示</option>
                                            <option value="5"<?php if($menu_array['auth_type'] == 5): ?>selected="selected"<?php endif; ?>>后台管理</option>
                                        </select>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="auth_area" id="auth_area">
                                            <option selected="selected">--请选择--</option>
                                            <option value="0"<?php if($menu_array['auth_area'] == 0): ?>selected="selected"<?php endif; ?>>后台cms</option>
                                            <option value="1"<?php if($menu_array['auth_area'] == 1): ?>selected="selected"<?php endif; ?>>Wap端权限</option>
                                            <option value="2"<?php if($menu_array['auth_area'] == 2): ?>selected="selected"<?php endif; ?>>项目权限</option>
                                        </select>
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="name" value="<?php echo ($menu_array["name"]); ?>" >
                                        <div class="form-control-focus"> </div>
                                        <span class="help-block">请输入权限名称</span>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input" <?php if($menu_array["auth_type"] != 4 ): ?>style="display:none;"<?php endif; ?>>
                                    <label class="col-md-2 control-label" for="form_control_1" id="cont_name">单位
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="unit" value="<?php echo ($menu_array["unit"]); ?>" >
                                        <div class="form-control-focus"> </div>
                                ...
                                <div class="form-group form-md-line-input" id="fid_select">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="fid" id="fid">
                                            <?php if($menu_array['fid'] != 0): if(is_array($show_father_menu)): foreach($show_father_menu as $key=>$v): if($menu_array['fid'] == $v['id']): ?><option value="<?php echo ($v["id"]); ?>" selected="selected"><?php echo ($v["name"]); ?></option>
                                                <?php else: ?>
                                                    <option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endif; endforeach; endif; ?>
                                            <?php else: ?>
                                                <option value="0" selected="selected">顶级菜单</option>
                                                <?php if(is_array($show_father_menu)): foreach($show_father_menu as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; endif; ?>
                                        </select>
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <?php if($menu_array['fid'] == 0): ?><select class="form-control" name="group_id" id="group_id">
                                                <?php if($menu_array['group_id'] != 0): if(is_array($group_array)): foreach($group_array as $key=>$v): if($menu_array['group_id'] == $v['id']): ?><option value="<?php echo ($v["id"]); ?>" selected="selected"><?php echo ($v["name"]); ?></option>
                                                            <?php else: ?>
                                                            <option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endif; endforeach; endif; ?>
                                                    <?php else: ?>
                                                    <option value="0" selected="selected">顶级菜单</option>
                                                    <?php if(is_array($group_array)): foreach($group_array as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; endif; ?>
                                            </select>
                                        <?php else: ?>
                                            <?php if(is_array($group_array)): foreach($group_array as $key=>$v): if($menu_array['group_id'] == $v['id']): ?><span class="form-control"><?php echo ($v["name"]); ?></span>
                                                    <input name="group_id" value="0" type="hidden"/><?php endif; endforeach; endif; endif; ?>
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                <?php if($menu_array['fid'] != 0): ?><div class="form-group form-md-line-input" id="model">
                                    ...
                                    <div class="col-md-9">
                                        <select name="module" class="form-control" id="model_select">
                                            <option>请选择</option>
                                            <?php if(is_array($module_array)): foreach($module_array as $key=>$re): if($re == $menu_array['module']): ?><option value="<?php echo ($re); ?>" selected="selected"><?php echo ($re); ?></option>
                                                <?php else: ?>
                                                    <option value="<?php echo ($re); ?>"><?php echo ($re); ?></option><?php endif; endforeach; endif; ?>
                                        </select>
                                        <div class="form-control-focus"> </div>
                                ...
                                <div class="form-group form-md-line-input" id="module">
                                    ...
                                    <div class="col-md-9">
                                        <select name="controller" class="form-control" id="module_select">
                                            <?php if(is_array($control_array)): foreach($control_array as $key=>$voo): if($menu_array['controller'] == $voo): ?><option value="<?php echo ($voo); ?>" selected="selected"><?php echo ($voo); ?></option>
                                                    <?php else: ?>
                                                    <option value="<?php echo ($voo); ?>"><?php echo ($voo); ?></option><?php endif; endforeach; endif; ?>
                                        </select>
                                        <div class="form-control-focus"> </div>
                                ...
                                <div class="form-group form-md-line-input" id="action">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="action" value="<?php echo ($menu_array["action"]); ?>">
                                ...
                                <?php if($menu_array['auth_type'] == 3): ?><input name="auth_type" type="hidden" value="3"/>
                                    <div class="form-group form-md-line-input" id="url">
                                        <label class="col-md-2 control-label" for="form_control_1">外部链接
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder="" name="w_url" value="<?php echo ($menu_array["w_url"]); ?>">
                                            <div class="form-control-focus"> </div>
                                ...
                                <?php if($menu_array['auth_type'] == 4): ?><div class="form-group form-md-line-input" id="class">
                                        <label class="col-md-2 control-label" for="form_control_1">样式ClassName
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder="" name="class" value="<?php echo ($menu_array["class"]); ?>">
                                            <div class="form-control-focus"> </div>
                                    ...
                                    <div class="form-group mt-repeater" style="padding-left: 9%;" id="arguments">
                                        ...
                                        <div data-repeater-list="group-c">
                                            <?php if(is_array($menu_array['argArray'])): foreach($menu_array['argArray'] as $ke=>$vo): ?><div data-repeater-item class="mt-repeater-item">

                                                    <div class="row mt-repeater-row">

                                                        <div class="col-md-8">
                                                            <label class="control-label">参数名</label>
                                                            <input type="text" placeholder="参数名称" class="form-control" name="a_key" value="<?php echo ($vo["a_key"]); ?>"/> </div>
                                                        <div class="col-md-2">
                                                            <label class="control-label">参数值</label>
                                                            <input type="text" placeholder="动态值可不填" class="form-control" name="a_value" value="<?php echo ($vo["a_value"]); ?>"/> </div>
                                                        <div class="col-md-1">
                                ...
                                <?php if($menu_array['fid'] == 0 and $menu_array['auth_type'] != 4): ?><div class="form-group form-md-line-input" id="icon">
                                    <label class="col-md-2 control-label" for="form_control_1">选择图标
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="icon" value="<?php echo ($menu_array["icon"]); ?>">
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div><?php endif; ?>
                                ...
                                <input type="hidden" class="form-control"  name="custom_icon" value="<?php echo ($menu_array["custom_icon"]); ?>">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <div class="md-radio-inline">
                                            <div class="md-radio">
                                                <input type="radio" id="show_no" name="is_show"  value="1" class="md-radiobtn"<?php if($menu_array['is_show'] == 1): ?>checked<?php endif; ?>>
                                                <label for="show_no">
                                                    <span></span>
                                            ...
                                            <div class="md-radio">
                                                <input type="radio" id="show" name="is_show"  value="0" class="md-radiobtn"<?php if($menu_array['is_show'] == 0): ?>checked<?php endif; ?>>
                                                <label for="show">
                                                    <span></span>
                                                    <span class="check"></span>
...
<script type='text/javascript'>
    ...
    $('#cont_type').change(function(){
        ...
        if(cont_type =='0'){
            ...
            $.ajax({
                url:"<?php echo U('Index/make_child_option');?>",
    ...
    $("#model_select").change(function(){
        ...
        $.ajax({
            url:"<?php echo U('make_control_option');?>",
            type:'post',
