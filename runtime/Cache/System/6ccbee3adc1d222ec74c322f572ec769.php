...
<!--头部设置-->
<?php
$title = array( 'title'=>'在线报修', 'describe'=>'', ); $breadcrumb = array( array('物业服务','#'), array('在线报修','#'), ); ?>
<!--头部设置结束-->
...
<div class="table-toolbar">
    <div class="row">
        <div class="col-md-6">
            <div class="btn-group">
                <a href="<?php echo U('PropertyService/repair_control_list');?>">
...
<div id="shopList" class="grid-view">
    <table class="table table-striped table-bordered table-hover" id="sample_1" >
        ...
        <tbody>
            ...
            <?php if(is_array($repair_list['repair_list'])): $i = 0; $__LIST__ = $repair_list['repair_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
        ...
        <td><div class="tagDiv"><?php echo ($vo["contact"]); ?></div></td>
        <td>
            <div class="tagDiv">
                <?php if($vo['is_read'] == 0): ?><span style="color: red">未处理</span>
                    <?php else: ?>
        ...
        <td class="button-column">
			...
			<ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
				<li>
					<?php if($vo['is_read'] == 0): ?><a href="javascript:;" onclick="read(this)" bindid='<?php echo ($vo["bind_id"]); ?>' pid="<?php echo ($vo["pid"]); ?>">
						<i class="icon-docs"></i> 标记为已处理 </a><?php endif; ?>
				</li>
				<li>
					<a href="<?php echo U('info',array('bindid'=>$vo['bind_id'],'pid'=>$vo['pid']));?>">
