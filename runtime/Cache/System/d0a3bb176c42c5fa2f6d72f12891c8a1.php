...
<!--<div class="page-container">-->
    ...
    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
        ...
        <tbody>
        <?php if(is_array($news_list)): foreach($news_list as $key=>$v): ?><tr class="odd gradeX">
                <td>
                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                ...
                <td><?php if($v["village_name"] == ''): ?>全社区通用<?php else: echo ($v["village_name"]); endif; ?></td>
                <td><?php if($v["is_notice"] == '1'): ?>是<?php else: ?>否<?php endif; ?></td>
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-left" role="menu" style="position:relative; margin-left:-90px;">
                            <li>
                                <a href="<?php echo U('news_edit',array('news_id'=>$v['news_id']));?>">
                                    <i class="icon-docs"></i> 编辑 </a>
                            </li>
                            <li>
                                <?php if($v["status"] == '1'): if($v["is_notice"] == '0'): ?><a href="<?php echo U('send',array('news_id'=>$v['news_id']));?>">
                                            <i class="icon-docs"></i> 微信群发业主 </a><?php endif; ?>
                                    <?php else: ?>
                                    <a href="#">
                                        <i class="icon-docs"></i>新闻已被关闭 </a><?php endif; ?>
                            </li>
                        </ul>
                    </div>
                </td>
