...
<!--<div class="page-container">-->
    ...
    <div class="btn-group">
            <button id="sample_editable_1_new" class="btn sbold green">当前房间门牌号: <?php echo ($room_info['room_name']); ?>
            </button>
    </div>
    <div class="btn-group">
        <a href="<?php echo U('add_otherfee',array('rid'=>$room_info['id']));?>">
    ...
    <table class="table table-striped table-bordered table-hover" id="sample_1" >
        ...
        <tbody>
        <?php if(is_array($otherfee_list)): $i = 0; $__LIST__ = $otherfee_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td><div class="tagDiv"><?php echo ($vo["otherfee_type_name"]); ?></div></td>
            <td><div class="tagDiv"><?php echo ($vo["fee_time"]); ?></div></td>
            <td><div class="tagDiv"><?php if($vo['otherfee_type'] == 1): ?>缴费<?php else: ?>押金<?php endif; ?></div></td>
            <td><div class="tagDiv"><?php if($vo['type'] == 1): ?>线上支付<?php elseif($vo['type'] == 2): ?>现金<?php elseif($vo['type'] == 3): ?>转账<?php elseif($vo['type'] == 4): ?>POS单<?php elseif($vo['type'] == 5): ?>现金缴款单<?php endif; ?></div></td>
            <td><div class="tagDiv"><?php if($vo['otherfee_type'] == 1): echo ($vo["fee_receive"]); endif; ?></div></td>
            <td><div class="tagDiv"><?php if($vo['otherfee_type'] == 1): echo ($vo["fee_true"]); else: echo ($vo["fee_receive"]); endif; ?></div></td>
            <td><div class="tagDiv"><?php if($vo['otherfee_type'] != 1): echo ($vo["fee_true"]); endif; ?></div></td>
            <td><div class="tagDiv"><?php echo ($vo["remark"]); ?></div></td>
            <td><div class="tagDiv"><?php echo ($vo["fee_mouth"]); ?></div></td>
            <td class="button-column">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                            <li>
                                <a href="<?php echo U('delete_otherfee',array('rid'=>$room_info['id'],'otherfee_id'=>$vo['otherfee_id']));?>" >
