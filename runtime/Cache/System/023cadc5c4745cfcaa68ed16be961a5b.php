                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> 库存信息列表 </span>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="btn-group">
                                        <a href="<?php echo U('Off/inventory_add');?>">
                                            <button id="sample_editable_1_new" class="btn sbold green">新建库存信息
                                    ...
                                    <div class="btn-group">
                                        <a href="<?php echo U('inventory_import_step');?>">
                                            <button id="sample_editable_1_new" class="btn sbold green">批量导入库存信息
                                                <!-- <i class="fa fa-plus"></i> -->
                                            </button>
                                        </a>
                                    </div>
                                    <div class="btn-group">
                                        <a href="<?php echo U('Off/inventory_turnover_list');?>" data-toggle="modal">
                                            <button id="sample_editable_1_new" class="btn sbold green">商品进/出库信息总表
                                                <!-- <i class="fa fa-plus"></i> -->
                                            </button>
                                        </a>
                                    </div>
                                    <!-- <div class="btn-group">
                                        <a href="<?php echo U('Off/inventory_out_list');?>" data-toggle="modal">
                    ...
                    <!-- 模态框结束     -->
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <?php if(is_array($inventory_list)): foreach($inventory_list as $key=>$vo): ?><tr>
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="<?php echo U('Off/inventory_edit',array('id'=>$vo['id']));?>">
    ...
    function delete_pr_info(obj) {
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"<?php echo U('Off/inventory_delete');?>",
                    data:{'id':id},
                    type:'post',
