...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <form action="<?php echo U('House/role_edit_new');?>" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="role_name" id="cat_url" value="<?php echo ($role["role_name"]); ?>"/>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="" name="role_desc" id="cat_url" value="<?php echo ($role["role_desc"]); ?>"/>
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                <div class="form-group form-md-checkboxes">
                                    ...
                                    <div class="col-md-9"><table border='1' style="border:1px  #c2cad8 solid;">
                                            ...
                                            <?php if(is_array($menus_model)): $i = 0; $__LIST__ = $menus_model;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rowset): $mod = ($i % 2 );++$i;?><tr>
                                                    <th width="20%">
                                                        <div class="md-checkbox" style="float: left; padding:15px 15px 15px 20px;">
                                                            <input type="checkbox" class="md-check" id="checkbox1_<?php echo ($rowset["id"]); ?>" name="menus[]" value="<?php echo ($rowset['id']); ?>" onclick="parent_controller(this)"<?php if(in_array($rowset['id'], $role['menus'])): ?>checked="checked"<?php endif; ?>/>
                                                            <label for="checkbox1_<?php echo ($rowset["id"]); ?>"><span></span>
                                                                <span class="check"></span>
                                                                <span class="box"></span><?php echo ($rowset['name']); ?></label>
                                                        </div>
                                                    </th>
                                                    <td>

                                                        <?php if(is_array($rowset['lists'])): $i = 0; $__LIST__ = $rowset['lists'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><div class="md-checkbox" style="float: left; padding:15px 15px 15px 20px;">
                                                                <input type="checkbox" class="md-check" id="checkbox1_<?php echo ($row["id"]); ?>" name="menus[]" value="<?php echo ($row['id']); ?>" onclick="check_parent(this)" <?php if(in_array($row['id'], $role['menus'])): ?>checked="checked"<?php endif; ?> />
                                                                <label for="checkbox1_<?php echo ($row["id"]); ?>"><span></span>
                                                                    <span class="check"></span>
                                                                    <span class="box"></span><?php echo ($row['name']); ?></label>　
                                        ...
                                        <?php if(is_array($menus_O2O)): $i = 0; $__LIST__ = $menus_O2O;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rowset): $mod = ($i % 2 );++$i;?><tr>
                                                <th width="20%">
                                                    <div class="md-checkbox" style="float: left; padding:15px 15px 15px 20px;">
                                                    <input type="checkbox" class="md-check" id="checkbox1_<?php echo ($rowset["id"]); ?>" name="menus[]" value="<?php echo ($rowset['id']); ?>" onclick="parent_controller(this)"<?php if(in_array($rowset['id'], $role['menus'])): ?>checked="checked"<?php endif; ?>/>
                                                        <label for="checkbox1_<?php echo ($rowset["id"]); ?>"><span></span>
                                            ...
                                            <?php if(is_array($menus_guanli)): $i = 0; $__LIST__ = $menus_guanli;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rowset): $mod = ($i % 2 );++$i;?><tr>
                                                    <th width="20%" colspan="2">
                                                        <div class="md-checkbox" style="float: left; padding:15px 15px 15px 20px;">
                                                            <input type="checkbox" class="md-check" id="checkbox1_<?php echo ($rowset["id"]); ?>" name="menus[]" value="<?php echo ($rowset['id']); ?>" onclick="parent_controller(this)"<?php if(in_array($rowset['id'], $role['menus'])): ?>checked="checked"<?php endif; ?>/>
                                                            <label for="checkbox1_<?php echo ($rowset["id"]); ?>" style="text-align: center"><span></span>
                                                                <span class="check"></span>
                                                                <span class="box"></span><?php echo ($rowset['name']); ?></label>
                                                        </div>
                                                    </th>
                                            ...
                                            <?php if(is_array($menus_yulan)): $i = 0; $__LIST__ = $menus_yulan;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rowset): $mod = ($i % 2 );++$i;?><tr>
                                                    <th width="20%">
                                                        <div class="md-checkbox" style="float: left; padding:15px 15px 15px 20px;">
                                                            <input type="checkbox" class="md-check" id="checkbox1_<?php echo ($rowset["id"]); ?>" name="menus[]" value="<?php echo ($rowset['id']); ?>" onclick="parent_controller(this)"<?php if(in_array($rowset['id'], $role['menus'])): ?>checked="checked"<?php endif; ?>/>
                                                            <label for="checkbox1_<?php echo ($rowset["id"]); ?>"><span></span>
                                                    ...
                                                    <td>
                                                        <?php if(is_array($rowset['son'])): $i = 0; $__LIST__ = $rowset['son'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><div class="md-checkbox" style="float: left; padding:15px 15px 15px 20px;">
                                                                <input type="checkbox" class="md-check" id="checkbox1_<?php echo ($row["id"]); ?>" name="menus[]" value="<?php echo ($row['id']); ?>" onclick="check_parent(this)" <?php if(in_array($row['id'], $role['menus'])): ?>checked="checked"<?php endif; ?> />
                                                                <label for="checkbox1_<?php echo ($row["id"]); ?>"><span></span>
                                                                    <span class="check"></span>
                                                                    <span class="box"></span><?php echo ($row['name']); ?></label>　
                                            ...
                                            <?php if(is_array($menus_phone)): $i = 0; $__LIST__ = $menus_phone;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rowset): $mod = ($i % 2 );++$i;?><tr>
                                                    <th width="20%" colspan="2">
                                                        <div class="md-checkbox" style="float: left; padding:15px 15px 15px 20px;">
                                                            <input type="checkbox" class="md-check" id="checkbox1_<?php echo ($rowset["id"]); ?>" name="menus[]" value="<?php echo ($rowset['id']); ?>" onclick="parent_controller(this)"<?php if(in_array($rowset['id'], $role['menus'])): ?>checked="checked"<?php endif; ?>/>
                                                            <label for="checkbox1_<?php echo ($rowset["id"]); ?>" style="text-align: center"><span></span>
                                            ...
                                            <?php if(is_array($menus_shequ)): $i = 0; $__LIST__ = $menus_shequ;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rowset): $mod = ($i % 2 );++$i;?><tr>
                                                    <th width="20%">
                                                        <div class="md-checkbox" style="float: left; padding:15px 15px 15px 20px;">
                                                            <input type="checkbox" class="md-check" id="checkbox1_<?php echo ($rowset["id"]); ?>" name="menus[]" value="<?php echo ($rowset['id']); ?>" onclick="parent_controller(this)"<?php if(in_array($rowset['id'], $role['menus'])): ?>checked="checked"<?php endif; ?>/>
                                                            <label for="checkbox1_<?php echo ($rowset["id"]); ?>"><span></span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if(is_array($car_role_array)): $i = 0; $__LIST__ = $car_role_array;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="md-radio">
                                                            <input type="radio" id="radio_<?php echo ($vo['role_id']); ?>" name="car_role_id"  value="<?php echo ($vo['role_id']); ?>" class="md-radiobtn" <?php if($vo['role_id'] == $role['car_role_id']): ?>checked="checked"<?php endif; ?>>
                                                            <label for="radio_<?php echo ($vo['role_id']); ?>">
                                                                <span></span>
                                                                <span class="check"></span>
                                                                <span class="box"></span> <?php echo ($vo['role_name']); ?> </label>
                                                        </div><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </div>
                                                    </div>
                                                </td>
