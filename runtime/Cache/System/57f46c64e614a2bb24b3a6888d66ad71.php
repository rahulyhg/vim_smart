                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="btn-group">
                                        <a href="<?php echo U('Off/supplier_add');?>">
                                    ...
                                    <div class="btn-group">
                                        <a href="<?php echo U('supplier_import_step');?>">
                                    ...
                                    <div class="btn-group">
                                        <a href="<?php echo U('Off/supplier_goods_list');?>" data-toggle="modal">
                    ...
                    <!-- 模态框结束     -->
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <?php if(is_array($supplier_list)): foreach($supplier_list as $key=>$vo): ?><tr>
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button class="btn btn-xs green" type="button">
                                                <a href="<?php echo U('Off/supplier_goods_list',array('id'=>$vo['id']));?>" style="color: #FFF;">商品清单</a>
                                            </button>                                           
                                        </div>
                                    </td>
                                    ...
                                    <?php else: ?>
                                        <td>已停止</td><?php endif; ?> -->
                                    <td>
                                        <?php if($vo['status'] == 1): ?><button class="btn btn-sm green btn-outline filter-submit margin-bottom" id="supplier_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["status"]); ?>" onclick="changeType(this)">正常</button>
                                            <input type="hidden" id="supplier_<?php echo ($vo["id"]); ?>_id" value="<?php echo ($vo['id']); ?>">
                                        <?php else: ?>
                                            <button class="btn btn-sm red btn-outline filter-submit margin-bottom" id="supplier_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["status"]); ?>" onclick="changeType(this)">已终止</button>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="<?php echo U('Off/supplier_detail',array('id'=>$vo['id']));?>" data-toggle="modal" data-target="#modal_<?php echo ($vo["id"]); ?>">
                                                        <i class="icon-docs"></i> 详情 </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo U('Off/supplier_edit',array('id'=>$vo['id']));?>">
    ...
    function delete_pr_info(obj) {
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"<?php echo U('Off/supplier_delete');?>",
                    data:{'id':id},
                    type:'post',
