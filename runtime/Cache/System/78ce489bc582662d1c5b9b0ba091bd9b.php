...
<!--<div class="page-container">-->
    ...
    <div class="btn-group">
        <a href="<?php echo U('add_owner',array('village_id'=>$_GET['village_id']));?>">
    ...
    <div class="btn-group">
        <a href="<?php echo U('owner_import_step1');?>">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr  class="odd gradeX">
                ...
                <td>
                    ...
                    <span style="color:#FBFCFD;text-overflow:ellipsis;display:block;width:0px;height:0">
                            <?php echo sprintf("%04d",$vo['room_names']?:9999);?>
                        </span>
                    <!--/排序需要-->
                  <?php echo ($vo["room_names"]); ?>
                </td>
                <td>
                    <?php echo ($vo["ownername"]); ?>
                </td>
                <td>
                    <?php echo ($vo["name"]); ?> | <?php echo ($vo["phone"]); ?>
                </td>
                ...
                <td class="button-column">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-left" role="menu" style="position: absolute; margin-left:-90px;">
                            <li>
                                <a data-toggle="modal" data-target="#common_modal"  href="<?php echo U('modal_owner_bind_room',array('oid'=>$vo['id']));?>">
                                    <i class="icon-docs"></i> 绑定房间
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo U('edit_owner',array('oid'=>$vo['id']));?>">
                                    <i class="icon-docs"></i> 编辑
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo U('del_owner_act',array('oid'=>$vo['id']));?>" onclick="return window.confirm('删除后不可恢复！确认删除？')">
