                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <?php if(is_array($user_list)): foreach($user_list as $key=>$vo): ?><tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                        <?php if($vo['card_type'] == 1): ?>现场审核<?php endif; ?>
                                        <?php if($vo['card_type'] == 2): ?>门禁卡<?php endif; ?>
                                        <?php if($vo['card_type'] == 3): ?>身份证<?php endif; ?>
                                        <?php if($vo['card_type'] == 4): ?>工作牌<?php endif; ?>
                                    </td>
                                    <td class="center">
                                        <?php echo ($vo['usernum']); ?>
                                    </td>
                                    <td class="center">
                                        <?php if($vo['group_name']): echo ($vo['group_name']); else: ?>无<?php endif; ?>
                                    </td>
                                    <td class="center">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="<?php echo U('user_edit',array('company_id'=>$vo['company_id'],'uid'=>$vo['uid']));?>">
                                                        <i class="icon-docs"></i> 编辑 </a>
                                                </li>
                                                <li>
                                                    <a class="del_user" data_user=<?php echo ($vo['uid']); ?> href="">
...
<script type="text/javascript">
    $('.del_user').click(function(){
        ...
        if(result==true){
            $.post("<?php echo U('uid_del');?>",'uid='+uid,function(ret){
                //alert(ret);
                if(ret.error==0){
                    alert(ret.msg);
                    window.reload();
