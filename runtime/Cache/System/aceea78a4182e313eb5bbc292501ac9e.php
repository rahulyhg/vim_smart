...
<!--<div class="page-container">-->
    ...
    <div class="page-content-wrapper" id="main">
        ...
        <div class="btn-group">
            <a href="<?php echo U('room_carspace_uptown_updata',array('id'=>$thisRoom['id']));?>">
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody>
        <?php if(is_array($carspace_list)): $i = 0; $__LIST__ = $carspace_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                <td><?php echo ($row["carspace_number"]); ?></td>
                <td><?php echo ($row["car_number"]); ?></td>
                <td><?php echo ($row["carspace_price"]); ?></td>
                <td><?php echo date('Y年m月d日',strtotime($row['carspace_start']));?></td>
                <td><?php echo date('Y年m月d日',strtotime($row['carspace_end']));?></td>
                <td>
                    <div class="btn-group">
                        <a href="<?php echo U('room_carspace_uptown_updata',array('id'=>$thisRoom['id'],'carspace_id'=>$row['pigcms_id'],'edit'=>1));?>">
                            <button id="sample_editable_1_new" class="btn sbold green">车位信息修改
                            </button>
                        </a>
                        <!--<a href="<?php echo U('room_carspace_uptown_updata',array('id'=>$thisRoom['id'],'carspace_id'=>$row['pigcms_id']));?>">
                            <button id="sample_editable_1_new" class="btn sbold green">线下缴纳泊位费
                                <i class="fa fa-plus"></i>
                            </button>
                        </a>-->
                        <a href="javascript:;">
                            <button id="sample_editable_1_new" class="btn sbold green" onclick="delete_one(<?php echo ($row['pigcms_id']); ?>)">删除该车位
                            </button>
                        </a>
    ...
    <script>
        function delete_one(id) {
            ...
            swal({
                ...
                function(){
                    $.ajax({
                        url:'<?php echo U("PropertyService/ajax_delete_carspace");?>',
