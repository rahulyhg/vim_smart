...
<!--<div class="page-container">-->
    ...
    <!--<div class="btn-group">
        <a href="<?php echo U('add_owner_uptown',array('village_id'=>$_GET['village_id']));?>">
    ...
    <div class="btn-group">
        <a href="<?php echo U('owner_uptown_import_step1');?>">
                ...
                <td class="button-column">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-left" role="menu" style="position: absolute; margin-left:-90px;">
                            <!--<li>
                                <a data-toggle="modal" data-target="#common_modal"  href="<?php echo U('modal_owner_bind_room_sq',array('oid'=>$vo['pigcms_id']));?>">
                                    <i class="icon-docs"></i> 绑定房间
                                </a>
                            </li>-->
                            <?php if($role_id == 1): ?><li>
                                    <a href="<?php echo U('edit_owner_uptown',array('id'=>$vo['pigcms_id']));?>">
                                        <i class="icon-docs"></i> 编辑
                                    </a>
                                </li><?php endif; ?>                          
                            <li>
                                <a href="<?php echo U('del_owner_uptown',array('id'=>$vo['pigcms_id']));?>" onclick="return window.confirm('删除后不可恢复！确认删除？')">
...
<!--/底部文件-->
    ...
    <script>
        ...
        table.dataTable({
            ...
            'processing':true,// 加载
            ajax: {
                url: '<?php echo U("ajax_ownerlist_updown");?>',
                type: 'POST'
            },
            ordering:  false,
            "bStateSave": true, // save datatable state(pagination, sort, etc) in cookie.
