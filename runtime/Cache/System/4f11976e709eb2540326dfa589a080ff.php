...
<!--头部设置-->
<?php
$title = array( 'title'=>'巡更管理', 'describe'=>'', ); $breadcrumb = array( array('物业服务','#'), array('巡更管理','#'), ); ?>
<!--头部设置结束-->
...
<!--            <i class="fa fa-building"></i> 当前:<?php echo ($presentVillage); ?>-->
...
<!--            </li>-->
<!--            <?php if(is_array($villageArray)): foreach($villageArray as $key=>$vo): ?>-->
<!--                <li>-->
<!--                    <a href="__SELF__&village_id=<?php echo ($vo["village_id"]); ?>">-->
<!--                        <i class="fa fa-building-o"></i> <?php echo ($vo["village_name"]); ?> </a>-->
<!--                </li>-->
...
<div class="table-toolbar">
    <div class="row">
        <div class="col-md-6">
            <!--<div class="btn-group">
                <a href="<?php echo U('PropertyService/room_list');?>">
            ...
            <div class="btn-group">
                <a href="<?php echo U('PropertyService/point_list',array('is_del'=>0));?>">
    ...
    <div class="row">
        <div class="col-md-6">
            <!-- <div class="btn-group">
                <input type="date" name="choose_time" value="<?php echo $_GET['d_time']?:date('Y-m-d') ?>"/>
            </div> -->

            <div class="input-group input-large date-picker input-daterange">
                <input type="text" class="form-control" name="choose_time" id="choose_time" value="<?php echo $_GET['d_time']?:date('Y-m-d') ?>" onchange="" style="width: 140px;"> 
            </div>
        ...
        <div class="col-md-6">
            <?php if($setArr != ''): ?><div class="btn-group btn-group btn-group-justified">
                    <?php if($setArr['morning_shift'] == 1): ?><a href="<?php echo U('point_record',array('work_time'=>1,'d_time'=>$_GET['d_time']?:date('Y-m-d')));?>" class="btn <?php if(empty($_GET['work_time'])){if($w_time==1){echo 'green';}else{echo 'default';}}else{if($_GET['work_time']==1){echo 'green';}else{echo 'default';}} ?>"> 早班 </a><?php endif; ?>
                    <?php if($setArr['middle_shift'] == 1): ?><a href="<?php echo U('point_record',array('work_time'=>2,'d_time'=>$_GET['d_time']?:date('Y-m-d')));?>" class="btn <?php if(empty($_GET['work_time'])){if($w_time==2){echo 'green';}else{echo 'default';}}else{if($_GET['work_time']==2){echo 'green';}else{echo 'default';}} ?>"> 中班 </a><?php endif; ?>
                    <?php if($setArr['night_shift'] == 1): ?><a href="<?php echo U('point_record',array('work_time'=>3,'d_time'=>$_GET['d_time']?:date('Y-m-d')));?>" class="btn <?php if(empty($_GET['work_time'])){if($w_time==3){echo 'green';}else{echo 'default';}}else{if($_GET['work_time']==3){echo 'green';}else{echo 'default';}} ?>"> 晚班 </a><?php endif; ?>
                </div>
            <?php else: ?>
                <div class="btn-group btn-group btn-group-justified">
                    <a href="<?php echo U('point_record',array('work_time'=>1,'d_time'=>$_GET['d_time']?:date('Y-m-d')));?>" class="btn <?php if(empty($_GET['work_time'])){if($w_time==1){echo 'green';}else{echo 'default';}}else{if($_GET['work_time']==1){echo 'green';}else{echo 'default';}} ?>"> 早班 </a>
                    <a href="<?php echo U('point_record',array('work_time'=>2,'d_time'=>$_GET['d_time']?:date('Y-m-d')));?>" class="btn <?php if(empty($_GET['work_time'])){if($w_time==2){echo 'green';}else{echo 'default';}}else{if($_GET['work_time']==2){echo 'green';}else{echo 'default';}} ?>"> 中班 </a>
                    <a href="<?php echo U('point_record',array('work_time'=>3,'d_time'=>$_GET['d_time']?:date('Y-m-d')));?>" class="btn <?php if(empty($_GET['work_time'])){if($w_time==3){echo 'green';}else{echo 'default';}}else{if($_GET['work_time']==3){echo 'green';}else{echo 'default';}} ?>"> 晚班 </a>
                </div><?php endif; ?>                    
        </div>
    </div>
                        ...
                        <div class="form-group" style="width: 500px; margin-left: 100px; margin-top: 40px;">
                            <div class="input-group select2-bootstrap-prepend" style="width: 400px; margin-bottom: 5px;">
                                <span class="input-group-addon">
                                    <input type="checkbox" id="morning_shift" name="morning_shift" value="<?php echo ($setArr['morning_shift']); ?>" onchange="changeval()" <?php if($setArr['morning_shift'] == 1): ?>checked<?php endif; ?>> 早班 </span>
                                <input type="text" class="form-control" name="morning_time_from" id="morning_time_from" value="<?php echo ($setArr['morning_time_from']); ?>" <?php if($setArr['morning_shift'] == 0): ?>disabled<?php endif; ?>>
                                <span class="input-group-addon"> to </span>
                                <input type="text" class="form-control" name="morning_time_to" id="morning_time_to" value="<?php echo ($setArr['morning_time_to']); ?>" <?php if($setArr['morning_shift'] == 0): ?>disabled<?php endif; ?>>
                            </div>
                            <div class="input-group select2-bootstrap-prepend" style="width: 400px; margin-bottom: 5px;">
                                <span class="input-group-addon">
                                    <input type="checkbox" id="middle_shift" name="middle_shift" value="<?php echo ($setArr['middle_shift']); ?>" onchange="changeval()" <?php if($setArr['middle_shift'] == 1): ?>checked<?php endif; ?>> 中班 </span>
                                <input type="text" class="form-control" name="middle_time_from" id="middle_time_from" value="<?php echo ($setArr['middle_time_from']); ?>" <?php if($setArr['middle_shift'] == 0): ?>disabled<?php endif; ?>>
                                <span class="input-group-addon"> to </span>
                                <input type="text" class="form-control" name="middle_time_to" id="middle_time_to" value="<?php echo ($setArr['middle_time_to']); ?>" <?php if($setArr['middle_shift'] == 0): ?>disabled<?php endif; ?>>
                            </div>
                            <div class="input-group select2-bootstrap-prepend" style="width: 400px;">
                                <span class="input-group-addon">
                                    <input type="checkbox" id="night_shift" name="night_shift" value="<?php echo ($setArr['night_shift']); ?>" onchange="changeval()" <?php if($setArr['night_shift'] == 1): ?>checked<?php endif; ?>> 晚班 </span>
                                <input type="text" class="form-control" name="night_time_from" id="night_time_from" value="<?php echo ($setArr['night_time_from']); ?>" <?php if($setArr['night_shift'] == 0): ?>disabled<?php endif; ?>>
                                <span class="input-group-addon"> to </span>
                                <input type="text" class="form-control" name="night_time_to" id="night_time_to" value="<?php echo ($setArr['night_time_to']); ?>" <?php if($setArr['night_shift'] == 0): ?>disabled<?php endif; ?>>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <br/>
    <?php if($_GET['point_status'] == '' and $_GET['work_time'] != ''): ?><div class="row">
            <div class="col-md-12">
                <div class="btn-group">
                    巡更点一共  <span style="color: blue"><?php echo ($pointCount); ?></span> ，已经巡检  <span style="color: green"><?php echo ($nowPointCount); ?></span> 个, 未巡更点数：<a href="<?php echo U('no_check_point',array('work_time'=>$_GET['work_time']?:'','d_time'=>$_GET['d_time']?:''));?>"><?php echo ($lowPointCount); ?></a>
                </div>
            </div>
        </div><?php endif; ?>
</div>
...
<div id="shopList" class="grid-view">
    <table class="table table-striped table-bordered table-hover" id="sample_1" >
        ...
        <tbody>
        <?php if(is_array($pointRecord)): $i = 0; $__LIST__ = $pointRecord;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
                <td><div class="tagDiv"><?php echo ($vo["pigcms_id"]); ?></div></td>
                <td><div class="tagDiv"><?php echo ($vo["room_name"]); ?></div></td>
                <td><div class="tagDiv"><?php echo ($vo["orientation"]); ?></div></td>
                <td><div class="tagDiv"><?php echo ($vo["village_name"]); ?></div></td>
                <td><div class="tagDiv"><?php echo ($vo["name"]); ?></div></td>
                <td><div class="tagDiv"><?php echo (date('Y-m-d H:i:s',$vo["check_time"])); ?></div></td>
                <?php if($vo['point_status'] == 0): ?><td><div class="tagDiv" style="color: green">正常</div></td>
                <?php else: ?>
                    <td><div class="tagDiv" style="color: red">异常</div></td><?php endif; ?>
                <td class="button-column">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                            <li>
                                <a href="<?php echo U('point_detail',array('id'=>$vo['pigcms_id']));?>"
                                   data-toggle="modal"
                                   data-target="#modal_<?php echo ($vo["pigcms_id"]); ?>">
            ...
            <!--弹出层容器-->
            <div class="modal fade" tabindex="-1" role="dialog" id="modal_<?php echo ($vo["pigcms_id"]); ?>">
            ...
            <!--        弹出层容器--><?php endforeach; endif; else: echo "" ;endif; ?>
        </tbody>
    </table>
...
<div id="didida" style="margin-top:10px;">
    <table class="table table-striped table-bordered table-hover">
        ...
        <?php if(is_array($month_pointRecord)): foreach($month_pointRecord as $key=>$vo): ?><tr>
                <td><?php echo ($vo["date"]); ?></td>
                <td><?php echo ($vo["pointNum"]); ?></td>
                <td><?php echo ($vo["yes_Count"]); ?></td>
                <td><?php echo ($vo["no_Count"]); ?></td>
...
<script type="text/javascript">
    ...
    function go() {//模态框提交
        ...
        var url = "<?php echo U('PropertyService/village_shift_setting');?>";
        $.ajax({
            url:url,
            type:'post',
            data:{
...
<script type="text/javascript">
    $("input[name='to']").change(function(){
        ...
        // console.log(time_to);
        $.ajax({
             url:'<?php echo U("get_record_rate");?>',
             type:'post',
             dataType:'json',
...
<script>
    ...
    function read(obj){
        if(confirm('您确定要标记为已处理？')){
            ...
            $.post("<?php echo U('do_repair');?>",{bind_id:bindid,cid:cid},function(result){
                if(result.error == 0){
