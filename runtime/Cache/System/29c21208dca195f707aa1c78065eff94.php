...
<!--<div class="page-container">-->
    ...
    <div class="btn-group">
        <a href="<?php echo U('PropertyService/room_add');?>">
    ...
    <table class="table table-striped table-bordered table-hover" id="sample_1" >
        ...
        <tbody>
        <?php if(is_array($roomsArray)): $i = 0; $__LIST__ = $roomsArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
            <td><div class="tagDiv"><?php echo ($vo["id"]); ?></div></td>
            <td>
                 <span style="color:#FBFCFD;text-overflow:ellipsis;display:block;width:0px;height:0">
                            <?php echo sprintf("%04d",$vo['room_name']?:9999);?>
                </span>
                <?php echo ($vo["room_name"]); ?>

            </td>
            <td><div class="tagDiv"><?php echo ($vo["room_number"]); ?></div></td>
            ...
            <td class="button-column">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-left" role="menu" style="position:relative; margin-left:-90px;">
                        ...
                        <li>
                            <a href="<?php echo U('room_update',array('id'=>$vo['id']));?>">
