...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <form action="<?php echo U('Off/staff_add');?>" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <div class="col-md-12" style="float: left">
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class=" icon-layers font-green"></i>
                                <span class="caption-subject font-green sbold uppercase">添加员工</span>
                            </div>
                            <div class="actions">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control select2" name="village_id" id="type" onchange="staff_room(this)">
                                            ...
                                            <?php if(is_array($village)): $i = 0; $__LIST__ = $village;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["village_id"]); ?>"><?php echo ($v["village_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9" >
                                <select class="form-control select2" name="room" id="type1" onchange="room_change(this)" required>
                                    <option value="-1">请选择</option>
                                </select>
                                <div class="form-control-focus"> </div>
                            </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="bed_number" id="phone" value="" placeholder="请输入床位数" required="required"  readonly="readonly"/>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            <label class="col-md-2 control-label" for="form_control_1">员工姓名
                            </label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" placeholder="" name="name" id="operator" value=""/>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
