...
<!--<div class="page-container">-->
    ...
    <div class="btn-group">
        <a href="<?php echo U('meterlist_news');?>">
    ...
    <div class="btn-group">
        <a href="<?php echo U('meters_record_lists');?>">
            <button id="sample_editable_1_new" class="btn sbold green">工程设备记录表
            </button>
        </a>
    </div>
    <!-- <div class="btn-group">
        <a href="<?php echo U('Meter/output_meter_record_list1');?>">
...
<!--<?php endif; ?>-->
    ...
    <table class="table table-striped table-bordered table-hover" id="sample_1">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo ($row["meter_cate_name"]); ?></td>
                ...
                <td class="button-column">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-left" role="menu" style="position: absolute; margin-left:-90px;">
                            <li>
                                <?php if($village_type == 0): ?><a data-toggle="modal" data-target="#common_modal"  href="<?php echo U('modal_cate_meters',array('cate_id'=>$row['cate_id']));?>">
                                        <i class="icon-docs"></i> 绑定设备分类
                                    </a>
                                    <?php else: ?>
                                    <a data-toggle="modal" data-target="#common_modal"  href="<?php echo U('modal_cate_meters',array('cate_id'=>$row['cate_id']));?>">
                                        <i class="icon-docs"></i> 绑定设备分类
                                    </a><?php endif; ?>
                            </li>
                            <li>
