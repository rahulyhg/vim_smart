...
<!--<div class="page-container">-->
    ...
    <div class="btn-group">
        <button id="sample_editable_1_new" class="btn sbold green">当前房间门牌号: <?php echo ($data['room_name']); ?>
        </button>
    </div>
    ...
    <table class="table table-striped table-bordered table-hover" id="sample_1" >
        ...
        <tbody>
        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td><div class="tagDiv"><?php echo ($vo["owner_name"]); ?></div></td>
            <td><div class="tagDiv"><?php echo ($vo["start_code"]); ?></div></td>
            <td><div class="tagDiv"><?php echo ($vo["end_code"]); ?></div></td>
            <td><div class="tagDiv"><?php echo ($vo["price"]); ?></div></td>
            <td><div class="tagDiv"><?php echo ($vo["start_time"]); ?></div></td>
            <td><div class="tagDiv"><?php echo ($vo["end_time"]); ?></div></td>
            <td><div class="tagDiv"><?php echo ($vo["type"]); ?></div></td>
            <td><div class="tagDiv"><?php if($vo['result'] == 0): ?>未缴费<?php else: ?>已缴费<?php endif; ?></div></td>
            <td class="button-column">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                        <li>
                            <a href="<?php echo U('delete_water',array('id'=>$vo['id']));?>" >
