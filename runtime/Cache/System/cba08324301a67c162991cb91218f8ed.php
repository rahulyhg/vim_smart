                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="<?php echo U('House/company_edit_new');?>">
...
<!--<?php endif; ?>-->
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tbody>
                            <?php if(is_array($company_list)): foreach($company_list as $key=>$v): ?><tr class="odd gradeX">
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                    ...
                                    <td style="text-align: center;color: red"><?php echo ($v["floor"]); ?></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative; margin-left:-90px;">
                                                <li>
                                                    <a href="<?php echo U('House/company_edit_new',array('company_id'=>$v['company_id']));?>">
                                                        <i class="icon-docs"></i> 更新 </a>
                                                </li>
                                                <li onclick="delete_pr_info(this)" id="<?php echo ($v["company_id"]); ?>">
                                                    <a href="javascript:;">
    ...
    function delete_pr_info(obj) {
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"<?php echo U('House/company_del_new');?>",
