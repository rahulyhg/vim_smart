                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="btn-group">
                                        <a href="<?php echo U('Off/supplier_list_news');?>">
                        ...
                        <div id="form_modal" class="modal fade" role="dialog" aria-hidden="true">
                            ...
                            <form id="modal_order">
                            <!-- action="<?php echo U('Off/save_order');?>" method="post" -->
                    ...
                    <!-- 模态框结束     -->
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <?php if(is_array($commodity_list)): foreach($commodity_list as $key=>$vo): ?><tr>
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
