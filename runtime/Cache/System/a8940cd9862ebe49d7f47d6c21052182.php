                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> 资产申请管理列表 </span>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="btn-group">
                                        <a href="<?php echo U('Off/supplier_goods_add');?>">
                                            <button id="sample_editable_1_new" class="btn sbold green">新建资产申请信息
                                                <i class="fa fa-plus"></i>
                                            </button>
                                        </a>
                                    </div>
                                    <!-- <div class="btn-group">
                                        <a href="<?php echo U('supplier_goods_import_step',array('id'=>$id));?>">
                                    ...
                                    <div style="float: right; width:250px; margin-right: 15px;">
                                        <span style="float: left; margin-top: 6px;">筛选申请状态：</span>
                                        <select style="width:150px; height:34px; float: right; padding:6px 12px; background-color:#FFFFFF; border: 1px solid #c2cad8;" id="select_status_id">
                                            <option value="0">全部显示</option>
                                            <option value="1" <?php if($status == 1): ?>selected<?php endif; ?>>新申请</option>
                                            <option value="2" <?php if($status == 2): ?>selected<?php endif; ?>>已通过</option>
                                            <option value="3" <?php if($status == 3): ?>selected<?php endif; ?>>库存不足</option>
                                            <option value="4" <?php if($status == 4): ?>selected<?php endif; ?>>已驳回</option>
                                            <!-- <?php if(is_array($supplier_list)): foreach($supplier_list as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if($id == $vo['id']): ?>selected="selected"<?php endif; ?> ><?php echo ($vo["sup_unit"]); ?></option><?php endforeach; endif; ?> -->
                                        </select>
                                    </div>                                    
                        ...
                        <div id="form_modal" class="modal fade" role="dialog" aria-hidden="true">
                            ...
                            <!-- <form action="<?php echo U('Off/save_order');?>" method="post" class="form-horizontal" id="modal_order" enctype="multipart/form-data"> -->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                        <h4 class="modal-title">物品申请详情表</h4>
                                    </div>
                                    <div class="modal-body">
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="create_order" style="margin-top:25px;">
                                            ...
                                            <!-- <?php if(is_array($villageArray)): foreach($villageArray as $key=>$vo): ?><tr>
                                                    <td align="center"><?php echo ($vo["village_name"]); ?></td>
                                                    <td align="center"><?php echo ($vo["village_name"]); ?></td>
                                                    <?php if($vo["count"] != ''): ?><td align="center"><?php echo ($vo["count"]); ?>/<?php echo ($Count); ?></td>
                                                    <?php else: ?>
                                                        <td align="center">0/<?php echo ($Count); ?></td><?php endif; ?>                                                   
                                    ...
                                    <div class="modal-footer">
                                        <!-- <button type="submit" class="btn green">提交订单</button> -->
                                        <!-- <button class="btn green" class=""  onclick="goods_apply()">提交订单</button> -->
                                        <div class="btn-group">
                                            <button class="btn green dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> 操作
                                                <i class="fa fa-angle-down"></i>
                                            </button>
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative; margin-top: 35px;margin-left: -138px;">
                                                <li style="margin-bottom: 2px;">
                                                    <button style="width: 138px;" class="btn green" type="button" value="2" onclick="update_apply_status(this)">申请通过</button>
                                                    <!-- <a href="<?php echo U('Off/update_apply_status',array('status'=>2));?>">
                                                        <i class="icon-docs"></i> 申请通过 </a> -->
                                                </li>
                                                <li style="margin-bottom: 2px;">
                                                    <button style="width: 138px;" class="btn green" type="button" value="3" onclick="update_apply_status(this)">库存不足</button>
                                                    <!-- <a href="<?php echo U('Off/update_apply_status',array('status'=>3));?>">
                                                        <i class="icon-docs"></i> 库存不足 </a> -->
                                                </li>
                                                <li>
                                                    <button style="width: 138px;" class="btn green" type="button" value="4" onclick="update_apply_status(this)">驳回</button>
                                                    <!-- <a href="<?php echo U('Off/update_apply_status',array('status'=>4));?>">
                                                        <i class="icon-docs"></i> 驳回 </a> -->
                                                </li>
                                            </ul>
                                        </div>
                    ...
                    <!-- 模态框结束     -->
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr>
                                ...
                                <!-- <th style="width: 350px; text-align: center;">申请项目</th> -->
                                <!-- <th style="width: 350px; text-align: center;">申请部门</th> -->
                                <th style="width: 350px; text-align: center;">申请单位</th>
                                <th style="text-align: center;">申请人</th>
                                <th style="text-align: center;">申请物品</th>
                                <th style="text-align: center;">申请时间</th>
                                <th style="text-align: center;">申请状态</th>
                                <th style="text-align: center;">出库状态</th>
                            ...
                            <?php if(is_array($apply_list)): foreach($apply_list as $key=>$vo): ?><tr>
                                    ...
                                    <td><?php echo ($vo["village_name"]); ?> - <?php echo ($vo["company_name"]); ?> - <?php echo ($vo["deptname"]); ?></td>
                                    <td><?php echo ($vo["add_name"]); ?></td>
                                    <td>
                                        <a href="#form_modal" data-toggle="modal">
                                            <button id="sample_editable_1_new" value="<?php echo ($vo["id"]); ?>" class="btn sbold green" onclick="getGoodsContent(this);">查看物品详情
                                                <!-- <i class="fa fa-plus"></i> -->
                                            </button>
                                        </a>
                                    </td>
                                    <!-- <td>
                                        <?php if(is_array($vo['goods'])): foreach($vo['goods'] as $key=>$voi): ?><ol type="1">
                                                <li>
                                                物品名称:<?php echo ($voi["goods_name"]); ?>,规格:<?php echo ($voi["specification"]); ?>,数量:<?php echo ($voi["count"]); ?>,单价:<?php echo ($voi["price"]); ?></li>
                                            </ol><?php endforeach; endif; ?>
                                    </td> -->
                                    <td><?php echo (date("Y-m-d",$vo["add_time"])); ?></td>
                                    <td>
                                        <?php if($vo['status'] == 1): ?><button class="btn btn-sm blue btn-outline filter-submit margin-bottom" id="supplier_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["status"]); ?>">新申请</button>
                                            <!-- <input type="hidden" id="supplier_<?php echo ($vo["id"]); ?>_id" value="<?php echo ($vo['id']); ?>"> -->
                                        <?php elseif($vo['status'] == 2): ?>
                                            <button class="btn btn-sm green btn-outline filter-submit margin-bottom" id="supplier_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["status"]); ?>">已通过</button>
                                            <!-- <input type="hidden" id="supplier_<?php echo ($vo["id"]); ?>_id" value="<?php echo ($vo['id']); ?>"> -->
                                        <?php elseif($vo['status'] == 3): ?>
                                            <button class="btn btn-sm gray btn-outline filter-submit margin-bottom" id="supplier_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["status"]); ?>">库存不足</button>
                                            <!-- <input type="hidden" id="supplier_<?php echo ($vo["id"]); ?>_id" value="<?php echo ($vo['id']); ?>"> -->
                                        <?php else: ?>
                                            <button class="btn btn-sm red btn-outline filter-submit margin-bottom" id="supplier_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["status"]); ?>">已驳回</button>
                                            <!-- <input type="hidden" id="supplier_<?php echo ($vo["id"]); ?>_id" value="<?php echo ($vo['id']); ?>"> --><?php endif; ?>
                                    </td>
                                    <td>
                                        <?php if($vo['storage'] == 1): ?><button class="btn btn-sm green btn-outline filter-submit margin-bottom" id="good_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["storage"]); ?>" onclick="changeType(this)">已出库</button>
                                            <input type="hidden" id="good_<?php echo ($vo["id"]); ?>_id" value="<?php echo ($vo['id']); ?>">
                                        <?php else: ?>
                                            <button class="btn btn-sm red btn-outline filter-submit margin-bottom" id="good_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["storage"]); ?>" onclick="changeType(this)">未出库</button>
                                            <input type="hidden" id="good_<?php echo ($vo["id"]); ?>_id" value="<?php echo ($vo['id']); ?>"><?php endif; ?>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="<?php echo U('Off/supplier_goods_edit',array('id'=>$vo['id']));?>">
                                                        <i class="icon-docs"></i> 更新 </a>
                                                </li>
                                                <li onclick="delete_pr_info(this)" id="<?php echo ($vo["id"]); ?>">
                                                    <a href="javascript:;">
    ...
    function delete_pr_info(obj) {
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"<?php echo U('Off/supplier_goods_delete');?>",
                    data:{'id':id},                    
                    type:'post',
...
<script>
    ...
    $("select#select_status_id").change(function(){
        var u = $(this).val();
        var str = window.location.href;
        var length = str.substr(str.lastIndexOf('status=')-1,).length; //获取url中&villageId=u的长度
        var url = '';
...
<script>
    function getGoodsContent(obj){
        ...
        $.ajax({
            url:"<?php echo U('Off/get_goods_detail');?>",
            data:{'id':id},
            // dataType: "json",
            type:'post',
...
//订单状态处理
function update_apply_status(obj) {

    layer.msg('你确定要执行此操作么？', {
        time: 0 //不自动关闭
        ,btn: ['确定', '取消']
        ,yes: function(index){
            layer.close(index);
            ...
            //通过ajax异步删除
            $.ajax({
                url:"<?php echo U('Off/update_apply_status');?>",
                data:{'status':status},                    
                type:'post',
                success:function(delmsg){
                    if(delmsg==='1'){
...
function changeType(id) {
    var storage_id = $(id).attr('id');
    // var point_id_id = is_del+'_id';
    // console.log(status_id);

    var storage = $("#"+storage_id).val();
    var order_id = $("#"+storage_id+"_id").val();

    console.log(storage);
    console.log(order_id);

    $.ajax({
        url:'<?php echo U("order_storage");?>',
        type:'post',
        data:{'storage':storage, 'order_id':order_id},
        success:function (re) {
            if (status == 1) {
                if (re) {
                    $('#'+storage_id).html('已出库');
                    $('#'+storage_id).css("background-color","red");
                    // alert('该点位已停用');
                }
            } else {
                if (re) {
                    $('#'+storage_id).html('未出库');
                    $('#'+storage_id).css("background-color","green");
                    // alert('该点位已启用');
                }
            }
            location.href = window.location.href;
