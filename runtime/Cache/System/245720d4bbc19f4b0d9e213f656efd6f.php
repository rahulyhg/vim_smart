...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            <li>
                <span class="active">预算管理</span>
            </li>

        </ul>
        <div class="row">
            <form action="<?php echo U('Budget/execute');?>" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <div class="col-md-12" style="float: left">
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class=" icon-layers font-green"></i>
                                <span class="caption-subject font-green sbold uppercase">批量更新执行记录</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control select2" name="village_id" id="type" onchange="staff_room(this)">
                                            ...
                                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["village_id"]); ?>" ><?php echo ($v["village_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                ...
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-2 control-label" for="type_id">小区
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9" id="type1">
...
<script>
    ...
    function staff_room(obj) {
        ...
        $.ajax({
            url:"<?php echo U('Budget_project_info');?>",
            ...
            success:function(delmsg){
                ...
                if(data !== null){
                    console.log(data);
                    var html = '';
                    html+='<select class="form-control select2" name="project_id" id="type1"  id="room_info">';
                    $.each(data,function(i,item){
                        html+='<option value="'+item.pigcms_id+'">'+item.desc+'</option>';
                    });
                    html+='</select>';
                    console.log(html);
                    $("#type1").html(html);
