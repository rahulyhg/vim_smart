...
<div class="page-container">
        ...
        <div class="portlet-body">
            ...
            <div class="form-body">
                <div class="form-group form-md-line-input"  >
                    ...
                    <div class="col-md-9">
                        <input type="text"  value="<?php echo ($room_info['room_name']); ?>"  class="form-control" readonly="readonly">
                    </div>
                </div>
                <div class="form-group form-md-line-input"  >
                ...
                <div class="form-group form-md-line-input"  >
                    ...
                    <div class="col-md-9" >
                        <textarea    value="" name="otherfee[remark]" class="form-control"><?php echo ($otherfee_type_info['remark']); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-2 col-md-9">
                        ...
                        <button type="reset" class="btn default" onclick="window.location.href='<?php echo U('getotherfee_list');?>'">返 回</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type='text/javascript'>
        ...
        $('#fee_mouth').datetimepicker({
            ...
            startDate:'<?php echo date('Y-n');?>',//设置开始时间
            theme:'form-control',
        ...
        $('#fee_time').datetimepicker({
            ...
            format:"Y-n-j",      //格式化日期
            timepicker:false,    //关闭时间选项
            startDate:'<?php echo date('Y-n-j');?>',//设置开始时间
            theme:'form-control',
            yearStart:2000,     //设置最小年份
            yearEnd:2050,        //设置最大年份
            todayButton:false,    //关闭选择今天按钮
        ...
        $('#otherfee_type_id').change(function(){
            ...
            $.ajax({
                url:"<?php echo U('ajax_otherfee_type');?>",
