...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <form action="<?php echo U('Contract/contract_add');?>" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input" id="village">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control select2" name="village_id" id="village_id" required>
                                            ...
                                            <?php if(is_array($village_array)): $i = 0; $__LIST__ = $village_array;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["village_id"]); ?>"><?php echo ($v["village_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="input-group input-large date-picker input-daterange">
                                        <input type="text" class="form-control" name="contract_start" id="contract_start" value="<?php echo $_GET['d_time']?:date('Y-m-d') ?>" onchange="" style="width: 140px;"> 
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="input-group input-large date-picker input-daterange">
                                        <input type="text" class="form-control" name="contract_end" id="contract_end" value="<?php echo $_GET['d_time']?:date('Y-m-d') ?>" onchange="" style="width: 140px;"> 
                                    </div>
                                </div>
                                <div class="form-group form-md-line-input">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="input-group input-large date-picker input-daterange">
                                        <select class="form-control select2" name="relevance_contract_id" id="relevance_contract_id" required>
                                            <option value="0">请选择</option>
                                            <!-- <option value="1">全项目</option> -->
                                            <?php if(is_array($contract_array)): $i = 0; $__LIST__ = $contract_array;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["contract_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select> 
                                    </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-2 col-md-9">
                                            ...
                                            <button type="reset" class="btn default" onclick="window.location.href='<?php echo U('Contract/contract_news');?>'">返 回</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type='text/javascript'>
    KindEditor.ready(function(K) {
        ...
        K('#J_selectImage').click(function () {
            ...
            editor.uploadJson = "<?php echo U('Contract/store_ajax_upload_pic');?>";
