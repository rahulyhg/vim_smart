	...
	<div class="row bs-reset">
		<div class="col-md-6 login-container bs-reset">
			...
			<div class="login-content">
				...
				<form class="login-form" method="post" action="<?php echo U('Login/check_new');?>">
					...
					<div class="row">
						<div class="col-xs-6">
							<input class="form-control form-control-solid placeholder-no-fix form-group" type="text" autocomplete="off" placeholder="用户名"  id="account" value="<?php echo ($_GET["account"]); ?>" name="account" required/> </div>
						<div class="col-xs-6">
							<input class="form-control form-control-solid placeholder-no-fix form-group" type="password" autocomplete="off" placeholder="密码" name="pwd" id="pwd" value="<?php echo ($_GET["pwd"]); ?>" required/> </div>
					</div>
