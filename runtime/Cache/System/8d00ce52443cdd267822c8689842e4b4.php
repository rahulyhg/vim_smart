...
<!--<div class="page-container">-->
    ...
    <div class="btn-group">
        <a href="<?php echo U('add_otherfee_type');?>">
    ...
    <table class="table table-striped table-bordered table-hover" id="sample_1" >
        ...
        <tbody>
        <?php if(is_array($type_list)): $i = 0; $__LIST__ = $type_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td><div class="shopNameDiv"><?php echo ($vo["rank"]); ?></div></td>
            <td><div class="tagDiv"><?php echo ($vo["otherfee_type_name"]); ?></div></td>
            <td><div class="tagDiv"><?php if($vo['type'] == 1): ?>缴费<?php else: ?>押金<?php endif; ?></div></td>
            <td><div class="tagDiv"><?php if($vo['status'] == 1): ?><span style="color: green">显示</span><?php else: ?><span style="color: red">隐藏</span><?php endif; ?></div></td>
            <td><div class="tagDiv"><?php echo ($vo["remark"]); ?></div></td>
            <td><div class="tagDiv"><?php echo date('Y年m月d日 h时i分s秒',$vo['updatetime']);?></div></td>
            <td><div class="tagDiv"><?php echo date('Y年m月d日 h时i分s秒',$vo['createtime']);?></div></td>
            <td class="button-column">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                        ...
                        <li>
                            <a href="<?php echo U('add_otherfee_type',array('otherfee_type_id'=>$vo['otherfee_type_id']));?>" >
                                <i class="icon-tag"></i> 编辑 </a>
                        </li>
                        <?php if($vo['status'] == 0): ?><li>
                                <a href="<?php echo U('delete_otherfee_type',array('otherfee_type_id'=>$vo['otherfee_type_id'],'status'=>1));?>" >
                                    <i class="icon-tag"></i><span style="color: green"> 显示 </span></a>
                            </li>
                            <?php else: ?>
                            <li>
                                <a href="<?php echo U('delete_otherfee_type',array('otherfee_type_id'=>$vo['otherfee_type_id'],'status'=>0));?>" >
