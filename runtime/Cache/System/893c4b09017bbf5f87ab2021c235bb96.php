                    ...
                    <div class="portlet light profile-sidebar-portlet bordered">
                        ...
                        <div class="profile-userbuttons">
                            <a  data-toggle="modal" data-target="#modal_department" class="btn btn-circle green btn-sm"
                                href="<?php echo U('House/department_edit');?>" style="text-align: center">
                                部门添加
                            </a>
<!--                            <a  data-toggle="modal" data-target="#modal_add" class="btn btn-circle red btn-sm"-->
<!--                                href="<?php echo U('House/employee_add');?>" style="text-align: center">-->
<!--                                员工添加-->
<!--                            </a>-->
                            <!--<a  class="btn btn-circle red btn-sm" href="<?php echo U('Admin/admin_add_news');?>" style="text-align: center">-->
                            <a  class="btn btn-circle red btn-sm" href="<?php echo U('House/employee_add');?>" style="text-align: center">
                                员工添加
                            </a>
                        </div>
                        <!-- END SIDEBAR BUTTONS -->
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title tabbable-line">
                                    <div class="caption caption-md">
                                        ...
                                        <span class="caption-subject font-blue-madison bold uppercase" id="uppercase"><?php echo ($department_info["deptname"]); ?></span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button id="sample_editable_1_new" class="btn sbold blue" depart_arr="<?php echo ($department_info["id"]); ?>" onclick="dept_click(this)"> 编辑部门 </button>
                                                    <div style="margin-left:10px; float:left;">
                                                    <button id="sample_editable_1_new" depart_arr="<?php echo ($department_info["id"]); ?>" onclick="del_click(this)" class="btn sbold red"> 删除部门 </button>
                                                </div>
                                                    <div style="margin-left:10px; float:left;">
                                                        <a  class="btn green " href="<?php echo U('Admin/admin_add_news');?>" style="text-align: center"> 员工添加 </a>
                                                    </div>
...
<script type="text/javascript">
    ...
    table.dataTable({
        ...
        'processing':true,// 加载
        ajax: {
            url: '<?php echo U("House/ajax_employee_list");?>&department_id='+localStorage.getItem('department_id'),
            type: 'POST'
        },
        ordering:  false,
    ...
    function search_change(key,value){
        ...
        var url='<?php echo U("House/ajax_employee_list");?>&department_id='+localStorage.getItem('department_id')+'&search_type='+sessionStorage.getItem('search_type');
        // console.log(url);
    ...
    //批量启用或禁用
        ...
        //$('.status_click').on('click',function(){
            ...
            if(ids_arr=="" || ids_arr=="null"){
                ...
                $.ajax({
                    'url':"<?php echo U('House/employee_status_new');?>",
  ...
  function delete_pr_info(obj){
			layer.msg('你确定要删除么？', {
				...
				,yes: function(index){
					...
					//通过ajax异步删除
					$.ajax({
						url:"<?php echo U('House/employee_del');?>",
						data:{'id':id},
						dataType:'json',
						type:'post',
