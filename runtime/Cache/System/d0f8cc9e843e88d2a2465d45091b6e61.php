...
<!--<div class="page-container">-->
    ...
    <?php if(empty($_GET['type_id'])): if($is_cashier == 0 || $isLeader): ?><div class="btn-group">
                <a href="<?php echo U('Budget/type_list');?>">
            ...
            <div class="btn-group">
                <a href="<?php echo U('Budget/check_add_record');?>">
            ...
            <div class="btn-group">
                <a href="<?php echo U('Budget/check_import_record');?>">
            ...
            <div class="btn-group">
                <a href="<?php echo U('Budget/check_cashier_list');?>">
            ...
            <div class="btn-group">
                <a href="<?php echo U('Budget/check_money_list');?>">
            ...
            <div class="btn-group">
                <a href="<?php echo U('Budget/check_excel_print_type_select');?>">
            ...
            <div class="btn-group">
                <a href="<?php echo U('Budget/execute');?>">
        ...
        <div class="btn-group" style="margin-top:10px;">
            <form action="__SELF__" method="get">
                ...
                <span>
                    ...
                    <div class="btn-group">
                        <input type="text" id="datetimepicker"  class="form-inline" placeholder="" name="starttime" value="<?php echo date('Y-m-d',$starttime);?>" style="line-height:34px; height:34px; border:1px #CCCCCC solid; margin-right:7px; padding-left:5px;" autocomplete="off">
                         至&nbsp;
                        <input type="text" id="datetimepicker1"  class="form-inline" placeholder="" name="endtime" value="<?php echo date('Y-m-d',$endtime-24*3600);?>" style="line-height:34px; height:34px; border:1px #CCCCCC solid; margin-right:7px; padding-left:5px;" autocomplete="off">
                    </div>
                </span>
    ...
    <table class="table table-striped table-bordered table-hover" id="sample_1" >
        ...
        <?php if(is_array($record_list)): $i = 0; $__LIST__ = $record_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td>
                <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                    <input type="checkbox" class="checkboxes" value="<?php echo ($vo["record_id"]); ?>" />
                    <span></span>
                </label>
            </td>
            <td><div class="shopNameDiv"><?php echo ($vo["record_name"]); ?></div></td>
            <td><div class="tagDiv" id="<?php echo ($vo["record_id"]); ?>-money"><?php echo ($vo["record_money"]); ?></div></td>
...
-->            <td><div class="tagDiv"><?php echo ($vo["type_name"]); ?></div></td>
            <td><div class="tagDiv"><?php echo ($vo["record_status_name"]); ?></div></td>
<!--            <td><div class="tagDiv"><?php if($vo['record_status'] == 2): echo date('Y-m-d H:i:s',$vo['record_check_time']); endif; ?></div></td>
-->         <td><div class="tagDiv"><?php if($vo['record_status'] == 2): ?><input value="<?php echo date('Y-m-d',$vo['record_check_time']);?>" type="text" style="border: none;text-align: center;height: 30px;" class="record_check_time" onchange="change_check_time(this,<?php echo ($vo["record_id"]); ?>)"/><?php endif; ?></div></td>
            <td>
                <div class="tagDiv">
...
<!--/底部文件-->
    ...
    <script>
        ...
        $('#datetimepicker1').datetimepicker({
            ...
            format:"Y-m-d",      //格式化日期
            timepicker:false,    //关闭时间选项
            startDate:'<?php echo date('Y-m-d',$endtime-24*3600);?>',
            /*datepicker: false,//关闭日期选项*/
            yearStart:2000,     //设置最小年份
            yearEnd:2050,        //设置最大年份
            todayButton:false,    //关闭选择今天按钮
        ...
        $('#record_status').val('<?php echo ($record_status); ?>');

        function change_url(type,val) {
            console.log(val);
            window.location.href='<?php echo U('Budget/check_record_list');?>&'+type+'='+val;
        }

        function change_check_time(name,id) {
            var record_check_time=$(name).val();
            var url="<?php echo U('Budget/ajax_change_check_time');?>";
            $.ajax({
                url:url,
                type:'post',
        ...
        function sub() {
            ...
            if (ids.length == 0) {
                swal({
                    ...
                    var url = "<?php echo U('Budget/check_record_batch');?>";
                    //用post方式传递
                    var project_id='';
