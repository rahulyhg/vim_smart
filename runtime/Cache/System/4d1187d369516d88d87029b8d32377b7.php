...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="<?php echo U('Off/supplier_list_news');?>">供应商管理</a>
                <i class="fa fa-circle"></i>
            </li>            
        </ul>
        <div class="row">
            <form action="<?php echo U('Off/supplier_save');?>" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <select class="form-control select2" name="business_scope[]" id="business_scope" multiple="multiple">
                                    <?php if(is_array($type_array)): $i = 0; $__LIST__ = $type_array;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["info"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="input-group input-large date-picker input-daterange">
                                <input type="text" class="form-control" name="supplier_start" id="supplier_start" value="<?php echo $_GET['d_time']?:date('Y-m-d') ?>" onchange="" style="width: 140px;"> 
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="input-group input-large date-picker input-daterange">
                                <input type="text" class="form-control" name="supplier_end" id="supplier_end" value="<?php echo $_GET['d_time']?:date('Y-m-d') ?>" onchange="" style="width: 140px;"> 
                            </div>
                        </div>
