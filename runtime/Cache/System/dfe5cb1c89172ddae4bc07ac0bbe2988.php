					...
					<div class="portlet-body">
						<div class="table-toolbar">
							<div class="row">
								<div class="col-md-6">
									<div class="btn-group">
										<a href="<?php echo U('House/village_add_new');?>">
...
<!--									</div>-->
						...
						<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
							...
							<tbody>
							<?php if(is_array($village_list)): foreach($village_list as $key=>$v): ?><tr class="odd gradeX">
									<td>
										<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
									...
									<td><?php echo ($v["property_name"]); ?></td>
									<td><?php echo ($v["property_phone"]); ?></td>
									<td><?php if($v['last_time']): echo (date('Y-m-d H:i:s',$v["last_time"])); else: ?>从未登录<?php endif; ?></td>
									<td><a href="<?php echo U('House/village_login',array('village_id'=>$v['village_id']));?>" target="_blank">访问</a></td>
									<td><a href="<?php echo U('House/pay_order_new',array('village_id'=>$v['village_id']));?>">查看账单</a></td>
									<td class="textcenter"><?php if($v["status"] == 1): ?><font color="green">正常</font><?php elseif($v["status"] == 0): ?><font color="red" title="等待小区管理员登录社区后台完善信息">待完善信息</font><?php else: ?><font color="red">禁止</font><?php endif; ?></td>
									<td>
										<div class="btn-group">
											...
											<ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
												<li>
													<a href="<?php echo U('House/village_edit_new',array('village_id'=>$v['village_id']));?>">
