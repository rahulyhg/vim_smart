                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <?php if(is_array($info)): foreach($info as $key=>$vo): ?><tr>
                                    ...
                                    <?php if($vo["end_time"] != 0): ?><td><?php echo (date("Y-m-d H:i:s",$vo["end_time"])); ?></td>
                                        <?php else: ?>
                                        <td></td><?php endif; ?>

                                    <!-- <td><?php echo ($vo["add_name"]); ?></td> -->
                                    <td onclick="delete_pr_info(this)" id="<?php echo ($vo["id"]); ?>">
    ...
    function delete_pr_info(obj) {
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"<?php echo U('Off/staff_record_delete');?>",
                    data:{'id':id},
                    type:'post',
    ...
    function delete_pr_infos(){
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"<?php echo U('Off/staff_record_deletes');?>",
                    data:{'ids':ids},
                    type:'post',
                    success:function(delmsg){
                        if(delmsg==='1'){
