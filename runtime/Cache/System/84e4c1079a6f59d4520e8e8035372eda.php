                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="btn-group">
                                        <a href="<?php echo U('Off/staff_add');?>">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <?php if(is_array($info)): foreach($info as $key=>$vo): ?><tr>
                                    ...
                                    <td><?php echo ($vo["info"]["village_name"]); ?></td>
                                    <td><?php echo ($vo["info"]["room"]); ?></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="<?php echo U('Off/staff_detail',array('id'=>$vo['id']));?>" data-toggle="modal" data-target="#modal_<?php echo ($vo["id"]); ?>">
                                                        <i class="icon-docs"></i> 详情 </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo U('Off/staff_edit',array('id'=>$vo['id']));?>">
    ...
    function delete_pr_info(obj) {
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"<?php echo U('Off/staff_delete');?>",
                    data:{'id':id},
                    type:'post',
    ...
    function delete_pr_infos(){
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"<?php echo U('Off/staff_deletes');?>",
                    data:{'ids':ids},
                    type:'post',
                    success:function(delmsg){
                        if(delmsg==='1'){
