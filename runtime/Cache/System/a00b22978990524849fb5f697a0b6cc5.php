 ...
 <div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">用户资料审核列表</span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
...
<!--<?php endif; ?>-->
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tbody>
                            <?php if(is_array($userCheck_list['userCheck_list'])): foreach($userCheck_list['userCheck_list'] as $key=>$vo): ?><tr class="odd gradeX">
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                    ...
                                    <td class="center">
                                        <?php if($vo["card_type"] == 1): ?>现场审核<?php endif; if($vo["card_type"] == 2): ?>门禁卡<?php endif; if($vo["card_type"] == 3): ?>身份证<?php endif; if($vo["card_type"] == 4): ?>工作牌<?php endif; ?>
                                    </td>
                                    <td class="center">
                                        <?php echo ($vo["usernum"]); ?>
                                    </td>
                                    <td><?php if($vo["workcard_img"] == ''): ?><img src="http://www.hdhsmart.com/upload/system/image/default.jpg" style="width:90px; height: 80px;">
                                            <?php else: ?> <img src="./upload/house/<?php echo ($vo["workcard_img"]); ?>" style="width:90px; height: 80px;"><?php endif; ?>、
                                    </td>
                                    <td class="center">
                                        <?php echo ($vo["village_name"]); ?>
                                    </td>
                                    <td class="center">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <?php if($v["check_state"] == 0): ?><li>
                                                        <a href="<?php echo U('Access/userCheck_edit_news',array('pigcms_id'=>$vo['pigcms_id']));?>">
                                                            <i class="icon-tag"></i> 审核 </a>
                                                    </li><?php endif; ?>
                                                <li class="divider"> </li>
                                                <li>
                                                    <a href="<?php echo U('Access/userCheck_del',array('pigcms_id'=>$vo['pigcms_id']));?>">
