...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <form action="<?php echo U('Off/staff_house_edit');?>" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <div class="col-md-12" style="float: left">
                    <div class="portlet light portlet-fit portlet-form bordered">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="vallage" id="sup_name" value="<?php echo ($staff['village_name']); ?>" placeholder="请输入项目名称"  required readonly="readonly"/>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="room" id="sup_name" value="<?php echo ($staff['room']); ?>" placeholder="请输入房间号"  required readonly="readonly"/>
                                <div class="form-control-focus"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="bed_number" id="phone" value="<?php echo ($staff['bed_number']); ?>" placeholder="请输入床位数" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="department" id="location" value="<?php echo ($staff['department']); ?>" placeholder="请输入部门" required />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="comment" id="tax_rate" value="<?php echo ($staff['comment']); ?>" placeholder="请输入备注" />
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <select class="form-control select2" name="name_id[]" id="business_scope" multiple="multiple">
                                    <?php if(is_array($staff_name)): $i = 0; $__LIST__ = $staff_name;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if(in_array($v['id'],$staff['name_id'])): ?>selected="selected"<?php endif; ?>><?php echo ($v["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                ...
                                <input type="hidden" name="village_id" value="<?php echo ($staff['village_id']); ?>"/>
