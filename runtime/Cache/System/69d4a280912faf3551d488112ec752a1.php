...
<link rel="stylesheet" type="text/css" href="<?php echo ($static_path); ?>css/datatables.min.css" />
<link rel="stylesheet" type="text/css" href="<?php echo ($static_path); ?>css/datatables.bootstrap.css" />
<link rel="stylesheet" type="text/css" href="<?php echo ($static_path); ?>css/sweetalert.css" />
<link rel="stylesheet" type="text/css" href="<?php echo ($static_path); ?>css/font-awesome.min.css" />
...
<!--									<div class="btn-group">-->
<!--										<a href="#">-->
<!--											<button id="update" class="btn sbold green"> 更新用户信息-->
...
<!--						</div>-->
						<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
							...
							<tbody>
							<?php if(is_array($user_list)): foreach($user_list as $key=>$vo): ?><tr class="odd gradeX">
									<td>
										<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
									...
									<td class="center">
										<?php echo ($vo["last_ip_txt"]); ?>
									</td>
									<td class="center">
										￥<?php echo (floatval($vo["now_money"])); ?>
									</td>
									<td class="center">
										<?php echo ($vo["score_count"]); ?>
									</td>
									<td class="center">
									...
									<td>
										<div class="btn-group">
											...
											<ul class="dropdown-menu pull-left" role="menu" style="position:relative; margin-left:-90px;">
												<?php if($v["check_state"] == 0): ?><li>
														<a href="<?php echo U('User/edit_news',array('uid'=>$vo['uid']));?>">
...
<script type="text/javascript" src="<?php echo ($static_path); ?>js/sweetalert.min.js"></script>
<script type="text/javascript" src="<?php echo ($static_path); ?>js/ui-sweetalert.min.js"></script>
<script type="text/javascript" src="<?php echo ($static_path); ?>js/layer.js"></script>
...
<!--                function(){-->
<!--                    $.ajax({-->
<!--                        url:"<?php echo U('User/update_info');?>",-->
<!--                        type:'post',-->
<!--                        dataType:'json',-->
...
<script>
	$(function(){
		$("[name='change_state']").click(function(){
			...
			$.ajax({
				url: "<?php echo U('Hickey/change_state');?>",
				type: "GET",
