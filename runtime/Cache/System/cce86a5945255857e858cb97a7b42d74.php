...
<!--<div class="page-container">-->
    ...
    <!--<div class="btn-group">
        <a href="<?php echo U('Budget/village_add_record');?>">
    ...
    <div class="btn-group" style="margin-left: 10px">
        <a href="<?php echo U('Budget/village_excel_print');?>">
    ...
    <table class="table table-striped table-bordered table-hover" id="sample_1" >
        ...
        <?php if(is_array($record_list)): $i = 0; $__LIST__ = $record_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td>
            ...
            <td><div class="tagDiv"><?php if($vo['record_audit_time']): echo date('Y年n月j日 H:i:s',$vo['record_audit_time']); endif; ?></div></td>
            <td><div class="tagDiv"><?php echo ($vo["record_check_remark"]); ?></div></td>
            <td class="button-column">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-left" role="menu" style="position:relative; margin-left:-90px;">
                        <li>
                            <a href="<?php echo U('Budget/village_add_record',array('id'=>$vo['record_id']));?>" >
...
<!--/底部文件-->
    ...
    <script>
        ...
        function change_url(type,val) {
            console.log(val);
            window.location.href='<?php echo U('Budget/village_record_list');?>&'+type+'='+val;
        }
    </script>
