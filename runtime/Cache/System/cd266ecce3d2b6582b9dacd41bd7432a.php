            ...
            <td class="button-column noExl">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-left" role="menu" style="position:relative; margin-left:-90px;">
                        ...
                        <?php if($vo['status'] == 1 or $vo['status'] == 6): ?><li>
                                <a href="<?php echo U('Budget_predict/edit_predict_one',array('id'=>$vo['predict_id']));?>" >
...
<!--/底部文件-->
    ...
    <script>
        ...
        //添加新的清单条目
        function sub() {
            var url='<?php echo U("Budget_predict/edit_predict_one");?>&year='+$('#year').val();
