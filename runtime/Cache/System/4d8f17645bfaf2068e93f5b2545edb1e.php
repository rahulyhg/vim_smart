...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <form action="<?php echo U('Off/staff_edit');?>" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
                <div class="col-md-12" style="float: left">
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class=" icon-layers font-green"></i>
                                <span class="caption-subject font-green sbold uppercase">更新员工</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-2 control-label" for="type_id">项目名称
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9">
                                        <select class="form-control select2" name="village_id" id="type" onchange="staff_room(this)">
                                            <?php if(is_array($vallage)): $i = 0; $__LIST__ = $vallage;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["village_id"]); ?>" <?php if($v['village_id'] == $staff['village_id']): ?>selected="selected"<?php endif; ?>><?php echo ($v["village_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                        ...
                        <div class="form-group form-md-line-input">
                            <label class="col-md-2 control-label" for="type_id">位置/房间号
                                <span class="required">*</span>
                            </label>
                            <div class="col-md-9" >
                                <select class="form-control select2" name="room" id="type1" onchange="room_change(this)" >
                                    <?php if(is_array($room)): $i = 0; $__LIST__ = $room;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["room"]); ?>" <?php if($v['room'] == $staff['room']): ?>selected="selected"<?php endif; ?>><?php echo ($v["room"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="bed_number" id="phone" value="<?php echo ($staff['bed_number']); ?>" placeholder="请输入床位数" required  readonly="readonly"/>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="department" id="location" value="<?php echo ($staff['department']); ?>" placeholder="请输入部门" required readonly="readonly"/>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="comment" id="tax_rate" value="<?php echo ($staff['comment']); ?>" placeholder="请输入备注" readonly="readonly"/>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" placeholder="" name="name" id="operator" value="<?php echo ($staff_name['name']); ?>"/>
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <input type="hidden" name="staff_id" value="" class="staff" id="type2">
                                <input type="hidden" name="name_id" value="<?php echo ($staff_name['id']); ?>" class="staff">
                                <div class="col-md-offset-2 col-md-9">
                                    <button type="submit" class="btn green" id="submit">确认提交</button>
...
<script>
    KindEditor.ready(function(K) {
        ...
        K('#J_selectImage').click(function () {
            ...
            editor.uploadJson = "<?php echo U('Off/store_ajax_upload_pic');?>";
    ...
    function deleteImage(path, obj) {
        $.post("<?php echo U('Off/store_ajax_del_pic');?>",{path:path});
    ...
    function room_change(obj) {
        var room=$(obj).val();
        var village_id = $('#type').val();
        $.ajax({
            url:"<?php echo U('Off/staff_house_info');?>",
            data:{'room':room,'village_id':village_id},
            type:'post',
            success:function(delmsg){
                var data = $.parseJSON(delmsg);
                if(data.bed_number == "床位已满"){
                    $("#submit").attr("disabled", true);
                }else{
                    $("#submit").attr("disabled", false);
                }
                $("#phone").val(data.bed_number);
                $("#location").val(data.department);
                $("#tax_rate").val(data.comment);
                $("#type2").val(data.staff_id);
            },
            error:function (res) {
                lay.msg(res);
            }
    ...
    function staff_room(obj) {
        var village_id =$(obj).val();
        $.ajax({
            url:"<?php echo U('Off/staff_room');?>",
            data:{'village_id':village_id},
            type:'post',
            success:function(delmsg){
                var data = $.parseJSON(delmsg);
                var html = '';
                html+='<select class="form-control select2" name="room" id="type1" onchange="room_change(this)" id="room_info">';
                html+='<option value="0">请选择</option>';
                $.each(data,function(i,item){
                    html+='<option value="'+item.room+'">'+item.room+'</option>';
                });
                html+='</select>';
                console.log(html);
                $("#type1").html(html);
