...
<!--头部设置-->
<?php
$title = array( 'title'=>'巡检管理', 'describe'=>'', ); $breadcrumb = array( array('物业服务','#'), array('巡检管理','#'), ); ?>
<!--头部设置结束-->
...
<div class="table-toolbar">
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="btn-group">
                <a href="<?php echo U('PropertyService/point_safety_list',array('is_del'=>0));?>">
            ...
            <div class="btn-group">
                <a href="<?php echo U('PropertyService/products_custom_list');?>">
    ...
    <div class="input-group input-large date-picker input-daterange">
        <input type="text" class="form-control" name="check_time_from" id="check_time_from" style="width: 120px;" value="<?php echo $_GET['check_time']?:'年-月' ?>">
        <!-- <span class="input-group-addon"> to </span>
        <input type="text" class="form-control" name="check_time_from" id="check_time_from" style="width: 120px;" value="<?php echo $_GET['check_time_to']?:date('Y-m') ?>"> -->
    </div>
    <br/>
    <?php if($_GET['point_status'] == '' and $_GET['check_time'] != ''): ?><div class="row">
            <div class="col-md-12">
                <div class="btn-group">
                    总巡检点数量：<span style="color: blue"> <?php echo ($pointCount); ?></span> 个，已巡检点数量：<span style="color: green"> <?php echo ($nowPointCount); ?></span> 个, 未巡检点数量：<a href="<?php echo U('no_check_point',array('work_time'=>$_GET['work_time']?:'','d_time'=>$_GET['d_time']?:''));?>"> <?php echo ($lowPointCount); ?></a> 个。
                </div>
            </div>
        </div><?php endif; ?>
</div>
...
<div id="shopList" class="grid-view">
    <table class="table table-striped table-bordered table-hover" id="sample_1" >
        ...
        <?php if(is_array($pointRecord)): $i = 0; $__LIST__ = $pointRecord;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
                ...
                <?php if($vo['point_status'][0] == 'status_1-0' and $vo['point_status'][1] == 'status_2-0' and $vo['point_status'][2] == 'status_3-0' and $vo['point_status'][3] == 'status_4-0' and $vo['point_status'][4] == 'status_5-0'): ?><td><div class="tagDiv" style="color: green">正常</div></td>
                <?php else: ?>
                ...
                <td class="button-column">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-left" role="menu" style="position:relative; margin-left:-90px;">
                            <li>
                                <a href="<?php echo U('point_safety_detail',array('id'=>$vo['pigcms_id']));?>"
                                   data-toggle="modal"
...
<div id="didida" style="border: 1px solid #333333;">
    <table class="table table-striped table-bordered table-hover">
        ...
        <?php if(is_array($year_pointRecord)): foreach($year_pointRecord as $key=>$vo): ?><tr>
