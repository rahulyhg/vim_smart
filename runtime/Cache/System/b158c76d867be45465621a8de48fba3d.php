                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="<?php echo U('Off/off_zone_add');?>">
                                            <button id="sample_editable_1_new" class="btn sbold green">新建区域
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th>区域名称</th>
                                <th  style="width: 350px; text-align: center;">父级区域</th>
                            ...
                            <?php if(is_array($typeArr)): foreach($typeArr as $key=>$vo): ?><tr>
                                    ...
                                    <td><a href="<?php echo U('Off/off_list_news',array('zone_id'=>$vo['id']));?>"><?php echo ($vo["zone_name"]); ?></a></td>
                                    <td>顶级分类</td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="<?php echo U('Off/off_zone_update',array('id'=>$vo['id']));?>">
                                ...
                                <?php if(isset($vo['son'])): if(is_array($vo['son'])): foreach($vo['son'] as $key=>$v): ?><tr>
                                            ...
                                            <td><?php echo ($v["id"]); ?></td>
                                            <td><a href="<?php echo U('Off/off_list_news',array('zone_id'=>$v['id']));?>">|---<?php echo ($v["zone_name"]); ?></a></td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                        <li>
                                                            <a href="<?php echo U('Off/off_zone_update',array('id'=>$v['id']));?>">
                                                                <i class="icon-docs"></i> 更新 </a>
                                                        </li>
                                        ...
                                        <?php if(isset($v['g_son'])): if(is_array($v['g_son'])): foreach($v['g_son'] as $key=>$sv): ?><tr>
                                                    ...
                                                    <td><a href="<?php echo U('Off/off_list_news',array('zone_id'=>$sv['id']));?>">|---|---<?php echo ($sv["zone_name"]); ?></a></td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                                <li>
                                                                    <a href="<?php echo U('Off/off_zone_update',array('id'=>$sv['id']));?>">
                                                                        <i class="icon-docs"></i> 更新 </a>
                                                                </li>
    ...
    function delete_pr_info(obj) {
        layer.msg('你确定要删除么？本操作不可恢复！', {
            ...
            ,yes: function(index){
                ...
                //通过ajax异步删除
                $.ajax({
                    url:"<?php echo U('Off/off_zone_delete');?>",
                    data:{'id':id},
                    type:'post',
