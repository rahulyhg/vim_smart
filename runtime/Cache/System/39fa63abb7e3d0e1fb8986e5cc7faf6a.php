    ...
    <div class="form-actions">
        <div class="row">
            <div class="col-md-offset-2 col-md-9">
                <input type="button" class="btn green" onclick="window.location.href='<?php echo U("owner_uptown_import_update_step1");?>'" value="物业费信息初始化"/>
            </div>
        </div>
    </div>
    <div>
        <form action="<?php echo U('owner_uptown_import_step2');?>" id="form" method="post" enctype="multipart/form-data" >
