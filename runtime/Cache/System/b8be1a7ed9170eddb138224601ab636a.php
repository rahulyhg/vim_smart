                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="<?php echo U('Admin/admin_add_news');?>">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th style="width:8%;">帐号</th>
                                <th style="width:8%;">姓名</th>
                                <th style="width:10%;">电话</th>
                                <th style="width:5%;">Email</th>
                                <!--<th>QQ</th>-->
                                <th style="width:12%;">所属项目</th>
                                <th style="width:8%;">所属公司</th>
                                <th style="width:8%;">所属商户</th>
                                <th style="width:5%;">角色名</th>
                                <th style="width:5%;">最后登录时间</th>
                                <th style="width:3%;" class="textcenter">登陆次数</th>
                                <th style="width:3%;" class="textcenter">状态</th>
                                <th style="width:17%;">操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php if(is_array($admins)): foreach($admins as $key=>$vo): ?><tr class="odd gradeX">
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="<?php echo U('Admin/admin_add_news',array('id'=>$vo['id']));?>">
                                                        <i class="icon-docs"></i> 更新 </a>
                                                </li>
                                              <!--  <li>
                                                    <a href="javascript:void(0);" onclick="window.top.artiframe('<?php echo U('Index/menu',array('admin_id'=>$vo['id']));?>','分配权限',800,500,true,false,false,editbtn,'edit',true);"><i class="icon-docs"></i>分配权限</a>
                                                </li>-->
                                            </ul>
                                        </div>
                                    </td>
