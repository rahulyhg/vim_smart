                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="<?php echo U('House/role_edit_new');?>">
                                            <button id="sample_editable_1_new" class="btn sbold green">添加角色
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tbody>
                            <?php if(is_array($role_list)): foreach($role_list as $key=>$v): ?><tr class="odd gradeX">
                                    <td>
                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                    ...
                                    <?php if($v['belong_user'] != ''): ?><td style="color: blue;"><?php echo ($v["belong_user"]); ?><a class="btn green btn-xs" href="<?php echo U('Admin/index_news',array('role_id'=>$v['role_id']));?>" style="float: right">更多</a></td>
                                    <?php else: ?>
                                        <td style="color: red;">该角色未分配人员</td><?php endif; ?>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu" style="position:relative;">
                                                <li>
                                                    <a href="<?php echo U('House/role_edit_new',array('role_id'=>$v['role_id']));?>">
                                                        <i class="icon-docs"></i> 更新 </a>
                                                </li>
                                                <li onclick="delete_pr_info(this)" id="<?php echo ($v["role_id"]); ?>">
                                                    <a href="javascript:;">
