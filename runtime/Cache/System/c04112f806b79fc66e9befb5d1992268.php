...
<div class="page-container">
    ...
    <div>
        <form action="<?php echo U('owner_uptown_import_update_step2');?>" id="form" method="post" enctype="multipart/form-data" >
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-9">
                    <div class="md-checkbox-list">
                        <?php if(is_array($project_list)): foreach($project_list as $key=>$row): if($row['desc'] != '汇园'): ?><div class="md-radio">
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-9">
                    <div class="md-checkbox-list">
                        <?php if(is_array($fee_type)): foreach($fee_type as $key=>$row): ?><div class="md-radio">
                                <input name="fee_lastyear_id" for="<?php echo ($row['otherfee_type_name']); ?>" type="radio" class="mt-radio" value="<?php echo ($row['otherfee_type_id']); ?>" id="checkbox2_<?php echo ($key); ?>">
                                <label for="checkbox2_<?php echo ($key); ?>" class="text-success">
                                    <span class="inc"></span>
                                    <span class="check"></span>
                                    <span class="box"></span> <?php echo ($row['otherfee_type_name']); ?> </label>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-9">
                    <input name="year"  type="text"  value="<?php echo ($row['pigcms_id']); ?>">
                </div>
            </div>
        ...
        <script>
            function submit1() {
                ...
                swal({
                        title: "是否对"+project_id+"进行初始化信息操作?",
                        text: "请确认",
                        type: "warning",
