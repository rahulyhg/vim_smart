...
<div id="app">
    ...
    <form action="<?php echo U('audit_act');?>" method="post" id="frm1">
        ...
        <div class="weui-footer weui-footer_fixed-bottom">
            <div class="weui-form-preview__ft">
                ...
                <input type="hidden" name="village_id" v-bind:value="msg_info.village_id">
    ...
    <div id="msg_detail" class="weui-popup__container">
        ...
        <div class="weui-popup__modal">
            ...
            <!--                <iframe src="<?php echo U('view_msg',array('msg_id'=>I('get.msg_id')));?>" style="height: 100%;width: 100%;border-width: 0;"></iframe>
-->
...
<script>
    ...
    new Vue({
        ...
        methods:{
          get_progress(status){
            if(status==1) {
              var rop_href = "<?php echo U('send_ROP',$_GET);?>";
    ...
    $.ajax({
        url:'<?php echo U('view_msg',array('msg_id'=>I('get.msg_id')));?>',
        type:"GET",
        dataType:"html",
